...
We recommend that you migrate to [AWS SDK for JavaScript v3][aws-sdk-js-v3], which has been GA since
December 2020. Here is [why and how you should use it][v3-recommended-blog]. You can try migration
scripts in [aws-sdk-js-codemod][aws-sdk-js-codemod] to migrate your application from v2 to v3.
