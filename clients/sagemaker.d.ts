...
declare class SageMaker extends Service {
  ...
  /**
   * Waits for the notebookInstance_Running state by periodically calling the underlying SageMaker.describeNotebookInstanceoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "notebookInstance_Running", params: SageMaker.Types.DescribeNotebookInstanceInput, callback?: (err: AWSError, data: SageMaker.Types.DescribeNotebookInstanceOutput) => void): Request<SageMaker.Types.DescribeNotebookInstanceOutput, AWSError>;
  /**
   * Waits for the notebookInstance_Running state by periodically calling the underlying SageMaker.describeNotebookInstanceoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "notebookInstance_Running", callback?: (err: AWSError, data: SageMaker.Types.DescribeNotebookInstanceOutput) => void): Request<SageMaker.Types.DescribeNotebookInstanceOutput, AWSError>;
  /**
   * Waits for the notebookInstance_Stopped state by periodically calling the underlying SageMaker.describeNotebookInstanceoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "notebookInstance_Stopped", params: SageMaker.Types.DescribeNotebookInstanceInput, callback?: (err: AWSError, data: SageMaker.Types.DescribeNotebookInstanceOutput) => void): Request<SageMaker.Types.DescribeNotebookInstanceOutput, AWSError>;
  /**
   * Waits for the notebookInstance_Stopped state by periodically calling the underlying SageMaker.describeNotebookInstanceoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "notebookInstance_Stopped", callback?: (err: AWSError, data: SageMaker.Types.DescribeNotebookInstanceOutput) => void): Request<SageMaker.Types.DescribeNotebookInstanceOutput, AWSError>;
  /**
   * Waits for the notebookInstance_Deleted state by periodically calling the underlying SageMaker.describeNotebookInstanceoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "notebookInstance_Deleted", params: SageMaker.Types.DescribeNotebookInstanceInput, callback?: (err: AWSError, data: SageMaker.Types.DescribeNotebookInstanceOutput) => void): Request<SageMaker.Types.DescribeNotebookInstanceOutput, AWSError>;
  /**
   * Waits for the notebookInstance_Deleted state by periodically calling the underlying SageMaker.describeNotebookInstanceoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "notebookInstance_Deleted", callback?: (err: AWSError, data: SageMaker.Types.DescribeNotebookInstanceOutput) => void): Request<SageMaker.Types.DescribeNotebookInstanceOutput, AWSError>;
  /**
   * Waits for the trainingJob_Stopped state by periodically calling the underlying SageMaker.describeTrainingJoboperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "trainingJob_Stopped", params: SageMaker.Types.DescribeTrainingJobRequest, callback?: (err: AWSError, data: SageMaker.Types.DescribeTrainingJobResponse) => void): Request<SageMaker.Types.DescribeTrainingJobResponse, AWSError>;
  /**
   * Waits for the trainingJob_Stopped state by periodically calling the underlying SageMaker.describeTrainingJoboperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "trainingJob_Stopped", callback?: (err: AWSError, data: SageMaker.Types.DescribeTrainingJobResponse) => void): Request<SageMaker.Types.DescribeTrainingJobResponse, AWSError>;
  /**
   * Waits for the trainingJob_Deleted state by periodically calling the underlying SageMaker.describeTrainingJoboperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "trainingJob_Deleted", params: SageMaker.Types.DescribeTrainingJobRequest, callback?: (err: AWSError, data: SageMaker.Types.DescribeTrainingJobResponse) => void): Request<SageMaker.Types.DescribeTrainingJobResponse, AWSError>;
  /**
   * Waits for the trainingJob_Deleted state by periodically calling the underlying SageMaker.describeTrainingJoboperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "trainingJob_Deleted", callback?: (err: AWSError, data: SageMaker.Types.DescribeTrainingJobResponse) => void): Request<SageMaker.Types.DescribeTrainingJobResponse, AWSError>;
  /**
   * Waits for the trainingJob_Created state by periodically calling the underlying SageMaker.describeTrainingJoboperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "trainingJob_Created", params: SageMaker.Types.DescribeTrainingJobRequest, callback?: (err: AWSError, data: SageMaker.Types.DescribeTrainingJobResponse) => void): Request<SageMaker.Types.DescribeTrainingJobResponse, AWSError>;
  /**
   * Waits for the trainingJob_Created state by periodically calling the underlying SageMaker.describeTrainingJoboperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "trainingJob_Created", callback?: (err: AWSError, data: SageMaker.Types.DescribeTrainingJobResponse) => void): Request<SageMaker.Types.DescribeTrainingJobResponse, AWSError>;
  /**
   * Waits for the endpoint_Created state by periodically calling the underlying SageMaker.describeEndpointoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "endpoint_Created", params: SageMaker.Types.DescribeEndpointInput, callback?: (err: AWSError, data: SageMaker.Types.DescribeEndpointOutput) => void): Request<SageMaker.Types.DescribeEndpointOutput, AWSError>;
  /**
   * Waits for the endpoint_Created state by periodically calling the underlying SageMaker.describeEndpointoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "endpoint_Created", callback?: (err: AWSError, data: SageMaker.Types.DescribeEndpointOutput) => void): Request<SageMaker.Types.DescribeEndpointOutput, AWSError>;
  /**
   * Waits for the endpoint_Deleted state by periodically calling the underlying SageMaker.describeEndpointoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "endpoint_Deleted", params: SageMaker.Types.DescribeEndpointInput, callback?: (err: AWSError, data: SageMaker.Types.DescribeEndpointOutput) => void): Request<SageMaker.Types.DescribeEndpointOutput, AWSError>;
  /**
   * Waits for the endpoint_Deleted state by periodically calling the underlying SageMaker.describeEndpointoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "endpoint_Deleted", callback?: (err: AWSError, data: SageMaker.Types.DescribeEndpointOutput) => void): Request<SageMaker.Types.DescribeEndpointOutput, AWSError>;
  /**
   * Waits for the endpoint_Updated state by periodically calling the underlying SageMaker.describeEndpointoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "endpoint_Updated", params: SageMaker.Types.DescribeEndpointInput, callback?: (err: AWSError, data: SageMaker.Types.DescribeEndpointOutput) => void): Request<SageMaker.Types.DescribeEndpointOutput, AWSError>;
  /**
   * Waits for the endpoint_Updated state by periodically calling the underlying SageMaker.describeEndpointoperation every 120 seconds (at most 120 times).
   */
  waitFor(state: "endpoint_Updated", callback?: (err: AWSError, data: SageMaker.Types.DescribeEndpointOutput) => void): Request<SageMaker.Types.DescribeEndpointOutput, AWSError>;
}
declare namespace SageMaker {
  ...
  export interface CreateModelInput {
     ...
     */
    SupplementalContainers?: ContainerDefinitionList;
    /**
  ...
  export type ProductionVariantInstanceType = "ml.c4.2xlarge"|"ml.c4.8xlarge"|"ml.c4.xlarge"|"ml.c5.2xlarge"|"ml.c5.9xlarge"|"ml.c5.xlarge"|"ml.m4.xlarge"|"ml.p2.xlarge"|"ml.p3.2xlarge"|"ml.t2.medium"|string;
  ...
  export type TrainingInstanceType = "ml.m4.xlarge"|"ml.m4.4xlarge"|"ml.m4.10xlarge"|"ml.c4.xlarge"|"ml.c4.2xlarge"|"ml.c4.8xlarge"|"ml.p2.xlarge"|"ml.p2.8xlarge"|"ml.p2.16xlarge"|"ml.p3.2xlarge"|"ml.p3.8xlarge"|"ml.p3.16xlarge"|"ml.c5.xlarge"|"ml.c5.2xlarge"|"ml.c5.4xlarge"|"ml.c5.9xlarge"|"ml.c5.18xlarge"|string;
