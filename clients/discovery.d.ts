...
declare class Discovery extends Service {
   ...
   */
  createTags(params: Discovery.CreateTagsRequest, callback?: (err: AWSError, data: Discovery.CreateTagsResponse) => void): Request<Discovery.CreateTagsResponse, AWSError>;
  /**
   * Creates one or more tags for configuration items. Tags are metadata that help you categorize IT assets. This API accepts a list of multiple configuration items.
   */
  createTags(callback?: (err: AWSError, data: Discovery.CreateTagsResponse) => void): Request<Discovery.CreateTagsResponse, AWSError>;
  /**
   * Deletes the association between configuration items and one or more tags. This API accepts a list of multiple configuration items.
   */
  deleteTags(params: Discovery.DeleteTagsRequest, callback?: (err: AWSError, data: Discovery.DeleteTagsResponse) => void): Request<Discovery.DeleteTagsResponse, AWSError>;
  /**
   * Deletes the association between configuration items and one or more tags. This API accepts a list of multiple configuration items.
   */
  deleteTags(callback?: (err: AWSError, data: Discovery.DeleteTagsResponse) => void): Request<Discovery.DeleteTagsResponse, AWSError>;
  /**
   * Lists AWS agents by ID or lists all agents associated with your user account if you did not specify an agent ID.
   */
  describeAgents(params: Discovery.DescribeAgentsRequest, callback?: (err: AWSError, data: Discovery.DescribeAgentsResponse) => void): Request<Discovery.DescribeAgentsResponse, AWSError>;
  /**
   * Lists AWS agents by ID or lists all agents associated with your user account if you did not specify an agent ID.
   */
  describeAgents(callback?: (err: AWSError, data: Discovery.DescribeAgentsResponse) => void): Request<Discovery.DescribeAgentsResponse, AWSError>;
  /**
   ...
   */
  describeConfigurations(params: Discovery.DescribeConfigurationsRequest, callback?: (err: AWSError, data: Discovery.DescribeConfigurationsResponse) => void): Request<Discovery.DescribeConfigurationsResponse, AWSError>;
  /**
   * Retrieves a list of attributes for a specific configuration ID. For example, the output for a server configuration item includes a list of attributes about the server, including host name, operating system, number of network cards, etc.
   */
  describeConfigurations(callback?: (err: AWSError, data: Discovery.DescribeConfigurationsResponse) => void): Request<Discovery.DescribeConfigurationsResponse, AWSError>;
  /**
   * Retrieves the status of a given export process. You can retrieve status from a maximum of 100 processes.
   */
  describeExportConfigurations(params: Discovery.DescribeExportConfigurationsRequest, callback?: (err: AWSError, data: Discovery.DescribeExportConfigurationsResponse) => void): Request<Discovery.DescribeExportConfigurationsResponse, AWSError>;
  /**
   * Retrieves the status of a given export process. You can retrieve status from a maximum of 100 processes.
   */
  describeExportConfigurations(callback?: (err: AWSError, data: Discovery.DescribeExportConfigurationsResponse) => void): Request<Discovery.DescribeExportConfigurationsResponse, AWSError>;
  /**
   * Retrieves a list of configuration items that are tagged with a specific tag. Or retrieves a list of all tags assigned to a specific configuration item.
   */
  describeTags(params: Discovery.DescribeTagsRequest, callback?: (err: AWSError, data: Discovery.DescribeTagsResponse) => void): Request<Discovery.DescribeTagsResponse, AWSError>;
  /**
   * Retrieves a list of configuration items that are tagged with a specific tag. Or retrieves a list of all tags assigned to a specific configuration item.
   */
  describeTags(callback?: (err: AWSError, data: Discovery.DescribeTagsResponse) => void): Request<Discovery.DescribeTagsResponse, AWSError>;
  /**
   ...
   */
  exportConfigurations(params: {}, callback?: (err: AWSError, data: Discovery.ExportConfigurationsResponse) => void): Request<Discovery.ExportConfigurationsResponse, AWSError>;
  /**
   * Exports all discovered configuration data to an Amazon S3 bucket or an application that enables you to view and evaluate the data. Data includes tags and tag associations, processes, connections, servers, and system performance. This API returns an export ID which you can query using the GetExportStatus API. The system imposes a limit of two configuration exports in six hours.
   */
  exportConfigurations(callback?: (err: AWSError, data: Discovery.ExportConfigurationsResponse) => void): Request<Discovery.ExportConfigurationsResponse, AWSError>;
  /**
   ...
   */
  listConfigurations(params: Discovery.ListConfigurationsRequest, callback?: (err: AWSError, data: Discovery.ListConfigurationsResponse) => void): Request<Discovery.ListConfigurationsResponse, AWSError>;
  /**
   * Retrieves a list of configurations items according to the criteria you specify in a filter. The filter criteria identify relationship requirements.
   */
  listConfigurations(callback?: (err: AWSError, data: Discovery.ListConfigurationsResponse) => void): Request<Discovery.ListConfigurationsResponse, AWSError>;
  /**
   ...
   */
  startDataCollectionByAgentIds(params: Discovery.StartDataCollectionByAgentIdsRequest, callback?: (err: AWSError, data: Discovery.StartDataCollectionByAgentIdsResponse) => void): Request<Discovery.StartDataCollectionByAgentIdsResponse, AWSError>;
  /**
   * Instructs the specified agents to start collecting data. Agents can reside on host servers or virtual machines in your data center.
   */
  startDataCollectionByAgentIds(callback?: (err: AWSError, data: Discovery.StartDataCollectionByAgentIdsResponse) => void): Request<Discovery.StartDataCollectionByAgentIdsResponse, AWSError>;
  /**
   * Instructs the specified agents to stop collecting data.
   */
  stopDataCollectionByAgentIds(params: Discovery.StopDataCollectionByAgentIdsRequest, callback?: (err: AWSError, data: Discovery.StopDataCollectionByAgentIdsResponse) => void): Request<Discovery.StopDataCollectionByAgentIdsResponse, AWSError>;
  /**
   * Instructs the specified agents to stop collecting data.
   */
  stopDataCollectionByAgentIds(callback?: (err: AWSError, data: Discovery.StopDataCollectionByAgentIdsResponse) => void): Request<Discovery.StopDataCollectionByAgentIdsResponse, AWSError>;
}
