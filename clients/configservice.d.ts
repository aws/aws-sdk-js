...
declare class ConfigService extends Service {
  ...
  /**
   * Creates and updates the configuration aggregator with the selected source accounts and regions.  AWS Config should be enabled in accounts and regions you want to aggreagate. 
   */
