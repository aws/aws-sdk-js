...
declare namespace ConfigService {
  ...
  export type ConfigurationItemStatus = "Ok"|"Failed"|"Discovered"|"Deleted"|"OK"|"ResourceDiscovered"|"ResourceNotRecorded"|"ResourceDeleted"|"ResourceDeletedNotRecorded"|string;
