...
declare class ECS extends Service {
   ...
   */
  deleteService(params: ECS.DeleteServiceRequest, callback?: (err: AWSError, data: ECS.DeleteServiceResponse) => void): Request<ECS.DeleteServiceResponse, AWSError>;
  /**
   * Deletes a specified service within a cluster. You can delete a service if you have no running tasks in it and the desired task count is zero. If the service is actively maintaining tasks, you cannot delete it, and you must update the service to a desired task count of zero. For more information, see UpdateService.  When you delete a service, if there are still running tasks that require cleanup, the service status moves from ACTIVE to DRAINING, and the service is no longer visible in the console or in ListServices API operations. After the tasks have stopped, then the service status moves from DRAINING to INACTIVE. Services in the DRAINING or INACTIVE status can still be viewed with DescribeServices API operations; however, in the future, INACTIVE services may be cleaned up and purged from Amazon ECS record keeping, and DescribeServices API operations on those services will return a ServiceNotFoundException error. 
   */
  deleteService(callback?: (err: AWSError, data: ECS.DeleteServiceResponse) => void): Request<ECS.DeleteServiceResponse, AWSError>;
  /**
   ...
   */
  deregisterContainerInstance(params: ECS.DeregisterContainerInstanceRequest, callback?: (err: AWSError, data: ECS.DeregisterContainerInstanceResponse) => void): Request<ECS.DeregisterContainerInstanceResponse, AWSError>;
  /**
   * Deregisters an Amazon ECS container instance from the specified cluster. This instance is no longer available to run tasks. If you intend to use the container instance for some other purpose after deregistration, you should stop all of the tasks running on the container instance before deregistration to avoid any orphaned tasks from consuming resources. Deregistering a container instance removes the instance from a cluster, but it does not terminate the EC2 instance; if you are finished using the instance, be sure to terminate it in the Amazon EC2 console to stop billing.  If you terminate a running container instance with a connected Amazon ECS container agent, the agent automatically deregisters the instance from your cluster (stopped container instances or instances with disconnected agents are not automatically deregistered when terminated). 
   */
  deregisterContainerInstance(callback?: (err: AWSError, data: ECS.DeregisterContainerInstanceResponse) => void): Request<ECS.DeregisterContainerInstanceResponse, AWSError>;
  /**
   ...
   */
  deregisterTaskDefinition(params: ECS.DeregisterTaskDefinitionRequest, callback?: (err: AWSError, data: ECS.DeregisterTaskDefinitionResponse) => void): Request<ECS.DeregisterTaskDefinitionResponse, AWSError>;
  /**
   * Deregisters the specified task definition by family and revision. Upon deregistration, the task definition is marked as INACTIVE. Existing tasks and services that reference an INACTIVE task definition continue to run without disruption. Existing services that reference an INACTIVE task definition can still scale up or down by modifying the service's desired count. You cannot use an INACTIVE task definition to run new tasks or create new services, and you cannot update an existing service to reference an INACTIVE task definition (although there may be up to a 10 minute window following deregistration where these restrictions have not yet taken effect).
   */
  deregisterTaskDefinition(callback?: (err: AWSError, data: ECS.DeregisterTaskDefinitionResponse) => void): Request<ECS.DeregisterTaskDefinitionResponse, AWSError>;
  /**
   * Describes one or more of your clusters.
   */
  describeClusters(params: ECS.DescribeClustersRequest, callback?: (err: AWSError, data: ECS.DescribeClustersResponse) => void): Request<ECS.DescribeClustersResponse, AWSError>;
  /**
   * Describes one or more of your clusters.
   */
  describeClusters(callback?: (err: AWSError, data: ECS.DescribeClustersResponse) => void): Request<ECS.DescribeClustersResponse, AWSError>;
  /**
   * Describes Amazon EC2 Container Service container instances. Returns metadata about registered and remaining resources on each container instance requested.
   */
  describeContainerInstances(params: ECS.DescribeContainerInstancesRequest, callback?: (err: AWSError, data: ECS.DescribeContainerInstancesResponse) => void): Request<ECS.DescribeContainerInstancesResponse, AWSError>;
  /**
   * Describes Amazon EC2 Container Service container instances. Returns metadata about registered and remaining resources on each container instance requested.
   */
  describeContainerInstances(callback?: (err: AWSError, data: ECS.DescribeContainerInstancesResponse) => void): Request<ECS.DescribeContainerInstancesResponse, AWSError>;
  /**
   * Describes the specified services running in your cluster.
   */
  describeServices(params: ECS.DescribeServicesRequest, callback?: (err: AWSError, data: ECS.DescribeServicesResponse) => void): Request<ECS.DescribeServicesResponse, AWSError>;
  /**
   * Describes the specified services running in your cluster.
   */
  describeServices(callback?: (err: AWSError, data: ECS.DescribeServicesResponse) => void): Request<ECS.DescribeServicesResponse, AWSError>;
  /**
   * Describes a task definition. You can specify a family and revision to find information about a specific task definition, or you can simply specify the family to find the latest ACTIVE revision in that family.  You can only describe INACTIVE task definitions while an active task or service references them. 
   */
  describeTaskDefinition(params: ECS.DescribeTaskDefinitionRequest, callback?: (err: AWSError, data: ECS.DescribeTaskDefinitionResponse) => void): Request<ECS.DescribeTaskDefinitionResponse, AWSError>;
  /**
   * Describes a task definition. You can specify a family and revision to find information about a specific task definition, or you can simply specify the family to find the latest ACTIVE revision in that family.  You can only describe INACTIVE task definitions while an active task or service references them. 
   */
  describeTaskDefinition(callback?: (err: AWSError, data: ECS.DescribeTaskDefinitionResponse) => void): Request<ECS.DescribeTaskDefinitionResponse, AWSError>;
  /**
   * Describes a specified task or tasks.
   */
  describeTasks(params: ECS.DescribeTasksRequest, callback?: (err: AWSError, data: ECS.DescribeTasksResponse) => void): Request<ECS.DescribeTasksResponse, AWSError>;
  /**
   * Describes a specified task or tasks.
   */
  describeTasks(callback?: (err: AWSError, data: ECS.DescribeTasksResponse) => void): Request<ECS.DescribeTasksResponse, AWSError>;
  /**
   ...
   */
  discoverPollEndpoint(params: ECS.DiscoverPollEndpointRequest, callback?: (err: AWSError, data: ECS.DiscoverPollEndpointResponse) => void): Request<ECS.DiscoverPollEndpointResponse, AWSError>;
  /**
   *  This action is only used by the Amazon EC2 Container Service agent, and it is not intended for use outside of the agent.  Returns an endpoint for the Amazon EC2 Container Service agent to poll for updates.
   */
  discoverPollEndpoint(callback?: (err: AWSError, data: ECS.DiscoverPollEndpointResponse) => void): Request<ECS.DiscoverPollEndpointResponse, AWSError>;
  /**
   * Returns a list of existing clusters.
   */
  listClusters(params: ECS.ListClustersRequest, callback?: (err: AWSError, data: ECS.ListClustersResponse) => void): Request<ECS.ListClustersResponse, AWSError>;
  /**
   * Returns a list of existing clusters.
   */
  listClusters(callback?: (err: AWSError, data: ECS.ListClustersResponse) => void): Request<ECS.ListClustersResponse, AWSError>;
  /**
   * Returns a list of container instances in a specified cluster.
   */
  listContainerInstances(params: ECS.ListContainerInstancesRequest, callback?: (err: AWSError, data: ECS.ListContainerInstancesResponse) => void): Request<ECS.ListContainerInstancesResponse, AWSError>;
  /**
   * Returns a list of container instances in a specified cluster.
   */
  listContainerInstances(callback?: (err: AWSError, data: ECS.ListContainerInstancesResponse) => void): Request<ECS.ListContainerInstancesResponse, AWSError>;
  /**
   * Lists the services that are running in a specified cluster.
   */
  listServices(params: ECS.ListServicesRequest, callback?: (err: AWSError, data: ECS.ListServicesResponse) => void): Request<ECS.ListServicesResponse, AWSError>;
  /**
   * Lists the services that are running in a specified cluster.
   */
  listServices(callback?: (err: AWSError, data: ECS.ListServicesResponse) => void): Request<ECS.ListServicesResponse, AWSError>;
  /**
   ...
   */
  listTaskDefinitionFamilies(params: ECS.ListTaskDefinitionFamiliesRequest, callback?: (err: AWSError, data: ECS.ListTaskDefinitionFamiliesResponse) => void): Request<ECS.ListTaskDefinitionFamiliesResponse, AWSError>;
  /**
   * Returns a list of task definition families that are registered to your account (which may include task definition families that no longer have any ACTIVE task definition revisions). You can filter out task definition families that do not contain any ACTIVE task definition revisions by setting the status parameter to ACTIVE. You can also filter the results with the familyPrefix parameter.
   */
  listTaskDefinitionFamilies(callback?: (err: AWSError, data: ECS.ListTaskDefinitionFamiliesResponse) => void): Request<ECS.ListTaskDefinitionFamiliesResponse, AWSError>;
  /**
   * Returns a list of task definitions that are registered to your account. You can filter the results by family name with the familyPrefix parameter or by status with the status parameter.
   */
  listTaskDefinitions(params: ECS.ListTaskDefinitionsRequest, callback?: (err: AWSError, data: ECS.ListTaskDefinitionsResponse) => void): Request<ECS.ListTaskDefinitionsResponse, AWSError>;
  /**
   * Returns a list of task definitions that are registered to your account. You can filter the results by family name with the familyPrefix parameter or by status with the status parameter.
   */
  listTaskDefinitions(callback?: (err: AWSError, data: ECS.ListTaskDefinitionsResponse) => void): Request<ECS.ListTaskDefinitionsResponse, AWSError>;
  /**
   ...
   */
  listTasks(params: ECS.ListTasksRequest, callback?: (err: AWSError, data: ECS.ListTasksResponse) => void): Request<ECS.ListTasksResponse, AWSError>;
  /**
   * Returns a list of tasks for a specified cluster. You can filter the results by family name, by a particular container instance, or by the desired status of the task with the family, containerInstance, and desiredStatus parameters. Recently-stopped tasks might appear in the returned results. Currently, stopped tasks appear in the returned results for at least one hour. 
   */
  listTasks(callback?: (err: AWSError, data: ECS.ListTasksResponse) => void): Request<ECS.ListTasksResponse, AWSError>;
  /**
   ...
   */
  registerContainerInstance(params: ECS.RegisterContainerInstanceRequest, callback?: (err: AWSError, data: ECS.RegisterContainerInstanceResponse) => void): Request<ECS.RegisterContainerInstanceResponse, AWSError>;
  /**
   *  This action is only used by the Amazon EC2 Container Service agent, and it is not intended for use outside of the agent.  Registers an EC2 instance into the specified cluster. This instance becomes available to place containers on.
   */
  registerContainerInstance(callback?: (err: AWSError, data: ECS.RegisterContainerInstanceResponse) => void): Request<ECS.RegisterContainerInstanceResponse, AWSError>;
  /**
   ...
   */
  registerTaskDefinition(params: ECS.RegisterTaskDefinitionRequest, callback?: (err: AWSError, data: ECS.RegisterTaskDefinitionResponse) => void): Request<ECS.RegisterTaskDefinitionResponse, AWSError>;
  /**
   * Registers a new task definition from the supplied family and containerDefinitions. Optionally, you can add data volumes to your containers with the volumes parameter. For more information about task definition parameters and defaults, see Amazon ECS Task Definitions in the Amazon EC2 Container Service Developer Guide. You can specify an IAM role for your task with the taskRoleArn parameter. When you specify an IAM role for a task, its containers can then use the latest versions of the AWS CLI or SDKs to make API requests to the AWS services that are specified in the IAM policy associated with the role. For more information, see IAM Roles for Tasks in the Amazon EC2 Container Service Developer Guide. You can specify a Docker networking mode for the containers in your task definition with the networkMode parameter. The available network modes correspond to those described in Network settings in the Docker run reference.
   */
  registerTaskDefinition(callback?: (err: AWSError, data: ECS.RegisterTaskDefinitionResponse) => void): Request<ECS.RegisterTaskDefinitionResponse, AWSError>;
  /**
   ...
   */
  runTask(params: ECS.RunTaskRequest, callback?: (err: AWSError, data: ECS.RunTaskResponse) => void): Request<ECS.RunTaskResponse, AWSError>;
  /**
   * Start a task using random placement and the default Amazon ECS scheduler. To use your own scheduler or place a task on a specific container instance, use StartTask instead.  The count parameter is limited to 10 tasks per call. 
   */
  runTask(callback?: (err: AWSError, data: ECS.RunTaskResponse) => void): Request<ECS.RunTaskResponse, AWSError>;
  /**
   ...
   */
  startTask(params: ECS.StartTaskRequest, callback?: (err: AWSError, data: ECS.StartTaskResponse) => void): Request<ECS.StartTaskResponse, AWSError>;
  /**
   * Starts a new task from the specified task definition on the specified container instance or instances. To use the default Amazon ECS scheduler to place your task, use RunTask instead.  The list of container instances to start tasks on is limited to 10. 
   */
  startTask(callback?: (err: AWSError, data: ECS.StartTaskResponse) => void): Request<ECS.StartTaskResponse, AWSError>;
  /**
   ...
   */
  stopTask(params: ECS.StopTaskRequest, callback?: (err: AWSError, data: ECS.StopTaskResponse) => void): Request<ECS.StopTaskResponse, AWSError>;
  /**
   * Stops a running task. When StopTask is called on a task, the equivalent of docker stop is issued to the containers running in the task. This results in a SIGTERM and a 30-second timeout, after which SIGKILL is sent and the containers are forcibly stopped. If the container handles the SIGTERM gracefully and exits within 30 seconds from receiving it, no SIGKILL is sent.
   */
  stopTask(callback?: (err: AWSError, data: ECS.StopTaskResponse) => void): Request<ECS.StopTaskResponse, AWSError>;
  /**
   ...
   */
  submitContainerStateChange(params: ECS.SubmitContainerStateChangeRequest, callback?: (err: AWSError, data: ECS.SubmitContainerStateChangeResponse) => void): Request<ECS.SubmitContainerStateChangeResponse, AWSError>;
  /**
   *  This action is only used by the Amazon EC2 Container Service agent, and it is not intended for use outside of the agent.  Sent to acknowledge that a container changed states.
   */
  submitContainerStateChange(callback?: (err: AWSError, data: ECS.SubmitContainerStateChangeResponse) => void): Request<ECS.SubmitContainerStateChangeResponse, AWSError>;
  /**
   ...
   */
  submitTaskStateChange(params: ECS.SubmitTaskStateChangeRequest, callback?: (err: AWSError, data: ECS.SubmitTaskStateChangeResponse) => void): Request<ECS.SubmitTaskStateChangeResponse, AWSError>;
  /**
   *  This action is only used by the Amazon EC2 Container Service agent, and it is not intended for use outside of the agent.  Sent to acknowledge that a task changed states.
   */
  submitTaskStateChange(callback?: (err: AWSError, data: ECS.SubmitTaskStateChangeResponse) => void): Request<ECS.SubmitTaskStateChangeResponse, AWSError>;
  /**
   ...
   */
  updateContainerAgent(params: ECS.UpdateContainerAgentRequest, callback?: (err: AWSError, data: ECS.UpdateContainerAgentResponse) => void): Request<ECS.UpdateContainerAgentResponse, AWSError>;
  /**
   * Updates the Amazon ECS container agent on a specified container instance. Updating the Amazon ECS container agent does not interrupt running tasks or services on the container instance. The process for updating the agent differs depending on whether your container instance was launched with the Amazon ECS-optimized AMI or another operating system.  UpdateContainerAgent requires the Amazon ECS-optimized AMI or Amazon Linux with the ecs-init service installed and running. For help updating the Amazon ECS container agent on other operating systems, see Manually Updating the Amazon ECS Container Agent in the Amazon EC2 Container Service Developer Guide.
   */
  updateContainerAgent(callback?: (err: AWSError, data: ECS.UpdateContainerAgentResponse) => void): Request<ECS.UpdateContainerAgentResponse, AWSError>;
  /**
   ...
   */
  updateService(params: ECS.UpdateServiceRequest, callback?: (err: AWSError, data: ECS.UpdateServiceResponse) => void): Request<ECS.UpdateServiceResponse, AWSError>;
  /**
   * Modifies the desired count, deployment configuration, or task definition used in a service. You can add to or subtract from the number of instantiations of a task definition in a service by specifying the cluster that the service is running in and a new desiredCount parameter. You can use UpdateService to modify your task definition and deploy a new version of your service. You can also update the deployment configuration of a service. When a deployment is triggered by updating the task definition of a service, the service scheduler uses the deployment configuration parameters, minimumHealthyPercent and maximumPercent, to determine the deployment strategy. If the minimumHealthyPercent is below 100%, the scheduler can ignore the desiredCount temporarily during a deployment. For example, if your service has a desiredCount of four tasks, a minimumHealthyPercent of 50% allows the scheduler to stop two existing tasks before starting two new tasks. Tasks for services that do not use a load balancer are considered healthy if they are in the RUNNING state; tasks for services that do use a load balancer are considered healthy if they are in the RUNNING state and the container instance it is hosted on is reported as healthy by the load balancer. The maximumPercent parameter represents an upper limit on the number of running tasks during a deployment, which enables you to define the deployment batch size. For example, if your service has a desiredCount of four tasks, a maximumPercent value of 200% starts four new tasks before stopping the four older tasks (provided that the cluster resources required to do this are available). When UpdateService stops a task during a deployment, the equivalent of docker stop is issued to the containers running in the task. This results in a SIGTERM and a 30-second timeout, after which SIGKILL is sent and the containers are forcibly stopped. If the container handles the SIGTERM gracefully and exits within 30 seconds from receiving it, no SIGKILL is sent. When the service scheduler launches new tasks, it attempts to balance them across the Availability Zones in your cluster with the following logic:   Determine which of the container instances in your cluster can support your service's task definition (for example, they have the required CPU, memory, ports, and container instance attributes).   Sort the valid container instances by the fewest number of running tasks for this service in the same Availability Zone as the instance. For example, if zone A has one running service task and zones B and C each have zero, valid container instances in either zone B or C are considered optimal for placement.   Place the new service task on a valid container instance in an optimal Availability Zone (based on the previous steps), favoring container instances with the fewest number of running tasks for this service.  
   */
  updateService(callback?: (err: AWSError, data: ECS.UpdateServiceResponse) => void): Request<ECS.UpdateServiceResponse, AWSError>;
  /**
   ...
   */
  waitFor(state: "TasksRunning", params: ECS.DescribeTasksRequest, callback?: (err: AWSError, data: ECS.DescribeTasksResponse) => void): Request<ECS.DescribeTasksResponse, AWSError>;
  /**
   * Waits for the TasksRunning state by periodically calling the underlying ECS.describeTasksoperation every 6 seconds (at most 100 times).
   */
  waitFor(state: "TasksRunning", callback?: (err: AWSError, data: ECS.DescribeTasksResponse) => void): Request<ECS.DescribeTasksResponse, AWSError>;
  /**
   ...
   */
  waitFor(state: "TasksStopped", params: ECS.DescribeTasksRequest, callback?: (err: AWSError, data: ECS.DescribeTasksResponse) => void): Request<ECS.DescribeTasksResponse, AWSError>;
  /**
   * Waits for the TasksStopped state by periodically calling the underlying ECS.describeTasksoperation every 6 seconds (at most 100 times).
   */
  waitFor(state: "TasksStopped", callback?: (err: AWSError, data: ECS.DescribeTasksResponse) => void): Request<ECS.DescribeTasksResponse, AWSError>;
  /**
   ...
   */
  waitFor(state: "ServicesStable", params: ECS.DescribeServicesRequest, callback?: (err: AWSError, data: ECS.DescribeServicesResponse) => void): Request<ECS.DescribeServicesResponse, AWSError>;
  /**
   * Waits for the ServicesStable state by periodically calling the underlying ECS.describeServicesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ServicesStable", callback?: (err: AWSError, data: ECS.DescribeServicesResponse) => void): Request<ECS.DescribeServicesResponse, AWSError>;
  /**
   ...
   */
  waitFor(state: "ServicesInactive", params: ECS.DescribeServicesRequest, callback?: (err: AWSError, data: ECS.DescribeServicesResponse) => void): Request<ECS.DescribeServicesResponse, AWSError>;
  /**
   * Waits for the ServicesInactive state by periodically calling the underlying ECS.describeServicesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ServicesInactive", callback?: (err: AWSError, data: ECS.DescribeServicesResponse) => void): Request<ECS.DescribeServicesResponse, AWSError>;
}
