...
declare class EMR extends Service {
   ...
   */
  addInstanceGroups(params: EMR.AddInstanceGroupsInput, callback?: (err: AWSError, data: EMR.AddInstanceGroupsOutput) => void): Request<EMR.AddInstanceGroupsOutput, AWSError>;
  /**
   * AddInstanceGroups adds an instance group to a running cluster.
   */
  addInstanceGroups(callback?: (err: AWSError, data: EMR.AddInstanceGroupsOutput) => void): Request<EMR.AddInstanceGroupsOutput, AWSError>;
  /**
   ...
   */
  addJobFlowSteps(params: EMR.AddJobFlowStepsInput, callback?: (err: AWSError, data: EMR.AddJobFlowStepsOutput) => void): Request<EMR.AddJobFlowStepsOutput, AWSError>;
  /**
   * AddJobFlowSteps adds new steps to a running job flow. A maximum of 256 steps are allowed in each job flow. If your job flow is long-running (such as a Hive data warehouse) or complex, you may require more than 256 steps to process your data. You can bypass the 256-step limitation in various ways, including using the SSH shell to connect to the master node and submitting queries directly to the software running on the master node, such as Hive and Hadoop. For more information on how to do this, go to Add More than 256 Steps to a Job Flow in the Amazon Elastic MapReduce Developer's Guide. A step specifies the location of a JAR file stored either on the master node of the job flow or in Amazon S3. Each step is performed by the main function of the main class of the JAR file. The main class can be specified either in the manifest of the JAR or by using the MainFunction parameter of the step. Elastic MapReduce executes each step in the order listed. For a step to be considered complete, the main function must exit with a zero exit code and all Hadoop jobs started while the step was running must have completed and run successfully. You can only add steps to a job flow that is in one of the following states: STARTING, BOOTSTRAPPING, RUNNING, or WAITING.
   */
  addJobFlowSteps(callback?: (err: AWSError, data: EMR.AddJobFlowStepsOutput) => void): Request<EMR.AddJobFlowStepsOutput, AWSError>;
  /**
   ...
   */
  addTags(params: EMR.AddTagsInput, callback?: (err: AWSError, data: EMR.AddTagsOutput) => void): Request<EMR.AddTagsOutput, AWSError>;
  /**
   * Adds tags to an Amazon EMR resource. Tags make it easier to associate clusters in various ways, such as grouping clusters to track your Amazon EMR resource allocation costs. For more information, see Tagging Amazon EMR Resources. 
   */
  addTags(callback?: (err: AWSError, data: EMR.AddTagsOutput) => void): Request<EMR.AddTagsOutput, AWSError>;
  /**
   ...
   */
  createSecurityConfiguration(params: EMR.CreateSecurityConfigurationInput, callback?: (err: AWSError, data: EMR.CreateSecurityConfigurationOutput) => void): Request<EMR.CreateSecurityConfigurationOutput, AWSError>;
  /**
   * Creates a security configuration using EMR Security Configurations, which are stored in the service. Security Configurations enable you to more easily create a configuration, reuse it, and apply it whenever a cluster is created.
   */
  createSecurityConfiguration(callback?: (err: AWSError, data: EMR.CreateSecurityConfigurationOutput) => void): Request<EMR.CreateSecurityConfigurationOutput, AWSError>;
  /**
   * Deletes a security configuration.
   */
  deleteSecurityConfiguration(params: EMR.DeleteSecurityConfigurationInput, callback?: (err: AWSError, data: EMR.DeleteSecurityConfigurationOutput) => void): Request<EMR.DeleteSecurityConfigurationOutput, AWSError>;
  /**
   * Deletes a security configuration.
   */
  deleteSecurityConfiguration(callback?: (err: AWSError, data: EMR.DeleteSecurityConfigurationOutput) => void): Request<EMR.DeleteSecurityConfigurationOutput, AWSError>;
  /**
   * Provides cluster-level details including status, hardware and software configuration, VPC settings, and so on. For information about the cluster steps, see ListSteps.
   */
  describeCluster(params: EMR.DescribeClusterInput, callback?: (err: AWSError, data: EMR.DescribeClusterOutput) => void): Request<EMR.DescribeClusterOutput, AWSError>;
  /**
   * Provides cluster-level details including status, hardware and software configuration, VPC settings, and so on. For information about the cluster steps, see ListSteps.
   */
  describeCluster(callback?: (err: AWSError, data: EMR.DescribeClusterOutput) => void): Request<EMR.DescribeClusterOutput, AWSError>;
  /**
   ...
   */
  describeJobFlows(params: EMR.DescribeJobFlowsInput, callback?: (err: AWSError, data: EMR.DescribeJobFlowsOutput) => void): Request<EMR.DescribeJobFlowsOutput, AWSError>;
  /**
   *  This API is deprecated and will eventually be removed. We recommend you use ListClusters, DescribeCluster, ListSteps, ListInstanceGroups and ListBootstrapActions instead. DescribeJobFlows returns a list of job flows that match all of the supplied parameters. The parameters can include a list of job flow IDs, job flow states, and restrictions on job flow creation date and time. Regardless of supplied parameters, only job flows created within the last two months are returned. If no parameters are supplied, then job flows matching either of the following criteria are returned:   Job flows created and completed in the last two weeks    Job flows created within the last two months that are in one of the following states: RUNNING, WAITING, SHUTTING_DOWN, STARTING    Amazon Elastic MapReduce can return a maximum of 512 job flow descriptions.
   */
  describeJobFlows(callback?: (err: AWSError, data: EMR.DescribeJobFlowsOutput) => void): Request<EMR.DescribeJobFlowsOutput, AWSError>;
  /**
   * Provides the details of a security configuration by returning the configuration JSON.
   */
  describeSecurityConfiguration(params: EMR.DescribeSecurityConfigurationInput, callback?: (err: AWSError, data: EMR.DescribeSecurityConfigurationOutput) => void): Request<EMR.DescribeSecurityConfigurationOutput, AWSError>;
  /**
   * Provides the details of a security configuration by returning the configuration JSON.
   */
  describeSecurityConfiguration(callback?: (err: AWSError, data: EMR.DescribeSecurityConfigurationOutput) => void): Request<EMR.DescribeSecurityConfigurationOutput, AWSError>;
  /**
   * Provides more detail about the cluster step.
   */
  describeStep(params: EMR.DescribeStepInput, callback?: (err: AWSError, data: EMR.DescribeStepOutput) => void): Request<EMR.DescribeStepOutput, AWSError>;
  /**
   * Provides more detail about the cluster step.
   */
  describeStep(callback?: (err: AWSError, data: EMR.DescribeStepOutput) => void): Request<EMR.DescribeStepOutput, AWSError>;
  /**
   * Provides information about the bootstrap actions associated with a cluster.
   */
  listBootstrapActions(params: EMR.ListBootstrapActionsInput, callback?: (err: AWSError, data: EMR.ListBootstrapActionsOutput) => void): Request<EMR.ListBootstrapActionsOutput, AWSError>;
  /**
   * Provides information about the bootstrap actions associated with a cluster.
   */
  listBootstrapActions(callback?: (err: AWSError, data: EMR.ListBootstrapActionsOutput) => void): Request<EMR.ListBootstrapActionsOutput, AWSError>;
  /**
   * Provides the status of all clusters visible to this AWS account. Allows you to filter the list of clusters based on certain criteria; for example, filtering by cluster creation date and time or by status. This call returns a maximum of 50 clusters per call, but returns a marker to track the paging of the cluster list across multiple ListClusters calls.
   */
  listClusters(params: EMR.ListClustersInput, callback?: (err: AWSError, data: EMR.ListClustersOutput) => void): Request<EMR.ListClustersOutput, AWSError>;
  /**
   * Provides the status of all clusters visible to this AWS account. Allows you to filter the list of clusters based on certain criteria; for example, filtering by cluster creation date and time or by status. This call returns a maximum of 50 clusters per call, but returns a marker to track the paging of the cluster list across multiple ListClusters calls.
   */
  listClusters(callback?: (err: AWSError, data: EMR.ListClustersOutput) => void): Request<EMR.ListClustersOutput, AWSError>;
  /**
   * Provides all available details about the instance groups in a cluster.
   */
  listInstanceGroups(params: EMR.ListInstanceGroupsInput, callback?: (err: AWSError, data: EMR.ListInstanceGroupsOutput) => void): Request<EMR.ListInstanceGroupsOutput, AWSError>;
  /**
   * Provides all available details about the instance groups in a cluster.
   */
  listInstanceGroups(callback?: (err: AWSError, data: EMR.ListInstanceGroupsOutput) => void): Request<EMR.ListInstanceGroupsOutput, AWSError>;
  /**
   * Provides information about the cluster instances that Amazon EMR provisions on behalf of a user when it creates the cluster. For example, this operation indicates when the EC2 instances reach the Ready state, when instances become available to Amazon EMR to use for jobs, and the IP addresses for cluster instances, etc.
   */
  listInstances(params: EMR.ListInstancesInput, callback?: (err: AWSError, data: EMR.ListInstancesOutput) => void): Request<EMR.ListInstancesOutput, AWSError>;
  /**
   * Provides information about the cluster instances that Amazon EMR provisions on behalf of a user when it creates the cluster. For example, this operation indicates when the EC2 instances reach the Ready state, when instances become available to Amazon EMR to use for jobs, and the IP addresses for cluster instances, etc.
   */
  listInstances(callback?: (err: AWSError, data: EMR.ListInstancesOutput) => void): Request<EMR.ListInstancesOutput, AWSError>;
  /**
   * Lists all the security configurations visible to this account, providing their creation dates and times, and their names. This call returns a maximum of 50 clusters per call, but returns a marker to track the paging of the cluster list across multiple ListSecurityConfigurations calls.
   */
  listSecurityConfigurations(params: EMR.ListSecurityConfigurationsInput, callback?: (err: AWSError, data: EMR.ListSecurityConfigurationsOutput) => void): Request<EMR.ListSecurityConfigurationsOutput, AWSError>;
  /**
   * Lists all the security configurations visible to this account, providing their creation dates and times, and their names. This call returns a maximum of 50 clusters per call, but returns a marker to track the paging of the cluster list across multiple ListSecurityConfigurations calls.
   */
  listSecurityConfigurations(callback?: (err: AWSError, data: EMR.ListSecurityConfigurationsOutput) => void): Request<EMR.ListSecurityConfigurationsOutput, AWSError>;
  /**
   * Provides a list of steps for the cluster.
   */
  listSteps(params: EMR.ListStepsInput, callback?: (err: AWSError, data: EMR.ListStepsOutput) => void): Request<EMR.ListStepsOutput, AWSError>;
  /**
   * Provides a list of steps for the cluster.
   */
  listSteps(callback?: (err: AWSError, data: EMR.ListStepsOutput) => void): Request<EMR.ListStepsOutput, AWSError>;
  /**
   * ModifyInstanceGroups modifies the number of nodes and configuration settings of an instance group. The input parameters include the new target instance count for the group and the instance group ID. The call will either succeed or fail atomically.
   */
  modifyInstanceGroups(params: EMR.ModifyInstanceGroupsInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * ModifyInstanceGroups modifies the number of nodes and configuration settings of an instance group. The input parameters include the new target instance count for the group and the instance group ID. The call will either succeed or fail atomically.
   */
   ...
   */
  removeTags(params: EMR.RemoveTagsInput, callback?: (err: AWSError, data: EMR.RemoveTagsOutput) => void): Request<EMR.RemoveTagsOutput, AWSError>;
  /**
   * Removes tags from an Amazon EMR resource. Tags make it easier to associate clusters in various ways, such as grouping clusters to track your Amazon EMR resource allocation costs. For more information, see Tagging Amazon EMR Resources.  The following example removes the stack tag with value Prod from a cluster:
   */
  removeTags(callback?: (err: AWSError, data: EMR.RemoveTagsOutput) => void): Request<EMR.RemoveTagsOutput, AWSError>;
  /**
   ...
   */
  runJobFlow(params: EMR.RunJobFlowInput, callback?: (err: AWSError, data: EMR.RunJobFlowOutput) => void): Request<EMR.RunJobFlowOutput, AWSError>;
  /**
   *  RunJobFlow creates and starts running a new job flow. The job flow will run the steps specified. Once the job flow completes, the cluster is stopped and the HDFS partition is lost. To prevent loss of data, configure the last step of the job flow to store results in Amazon S3. If the JobFlowInstancesConfig KeepJobFlowAliveWhenNoSteps parameter is set to TRUE, the job flow will transition to the WAITING state rather than shutting down once the steps have completed.  For additional protection, you can set the JobFlowInstancesConfig TerminationProtected parameter to TRUE to lock the job flow and prevent it from being terminated by API call, user intervention, or in the event of a job flow error. A maximum of 256 steps are allowed in each job flow. If your job flow is long-running (such as a Hive data warehouse) or complex, you may require more than 256 steps to process your data. You can bypass the 256-step limitation in various ways, including using the SSH shell to connect to the master node and submitting queries directly to the software running on the master node, such as Hive and Hadoop. For more information on how to do this, go to Add More than 256 Steps to a Job Flow in the Amazon Elastic MapReduce Developer's Guide. For long running job flows, we recommend that you periodically store your results.
   */
  runJobFlow(callback?: (err: AWSError, data: EMR.RunJobFlowOutput) => void): Request<EMR.RunJobFlowOutput, AWSError>;
  /**
   ...
   */
  setTerminationProtection(params: EMR.SetTerminationProtectionInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * SetTerminationProtection locks a job flow so the Amazon EC2 instances in the cluster cannot be terminated by user intervention, an API call, or in the event of a job-flow error. The cluster still terminates upon successful completion of the job flow. Calling SetTerminationProtection on a job flow is analogous to calling the Amazon EC2 DisableAPITermination API on all of the EC2 instances in a cluster. SetTerminationProtection is used to prevent accidental termination of a job flow and to ensure that in the event of an error, the instances will persist so you can recover any data stored in their ephemeral instance storage.  To terminate a job flow that has been locked by setting SetTerminationProtection to true, you must first unlock the job flow by a subsequent call to SetTerminationProtection in which you set the value to false.   For more information, go to Protecting a Job Flow from Termination in the Amazon Elastic MapReduce Developer's Guide. 
   */
   ...
   */
  setVisibleToAllUsers(params: EMR.SetVisibleToAllUsersInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Sets whether all AWS Identity and Access Management (IAM) users under your account can access the specified job flows. This action works on running job flows. You can also set the visibility of a job flow when you launch it using the VisibleToAllUsers parameter of RunJobFlow. The SetVisibleToAllUsers action can be called only by an IAM user who created the job flow or the AWS account that owns the job flow.
   */
   ...
   */
  terminateJobFlows(params: EMR.TerminateJobFlowsInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * TerminateJobFlows shuts a list of job flows down. When a job flow is shut down, any step not yet completed is canceled and the EC2 instances on which the job flow is running are stopped. Any log files not already saved are uploaded to Amazon S3 if a LogUri was specified when the job flow was created. The maximum number of JobFlows allowed is 10. The call to TerminateJobFlows is asynchronous. Depending on the configuration of the job flow, it may take up to 5-20 minutes for the job flow to completely terminate and release allocated resources, such as Amazon EC2 instances.
   */
   ...
   */
  waitFor(state: "ClusterRunning", params: EMR.DescribeClusterInput, callback?: (err: AWSError, data: EMR.DescribeClusterOutput) => void): Request<EMR.DescribeClusterOutput, AWSError>;
  /**
   * Waits for the ClusterRunning state by periodically calling the underlying EMR.describeClusteroperation every 30 seconds (at most 60 times).
   */
  waitFor(state: "ClusterRunning", callback?: (err: AWSError, data: EMR.DescribeClusterOutput) => void): Request<EMR.DescribeClusterOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "StepComplete", params: EMR.DescribeStepInput, callback?: (err: AWSError, data: EMR.DescribeStepOutput) => void): Request<EMR.DescribeStepOutput, AWSError>;
  /**
   * Waits for the StepComplete state by periodically calling the underlying EMR.describeStepoperation every 30 seconds (at most 60 times).
   */
  waitFor(state: "StepComplete", callback?: (err: AWSError, data: EMR.DescribeStepOutput) => void): Request<EMR.DescribeStepOutput, AWSError>;
}
