...
declare namespace Panorama {
  ...
  export type ApplicationInstanceStatus = "DEPLOYMENT_PENDING"|"DEPLOYMENT_REQUESTED"|"DEPLOYMENT_IN_PROGRESS"|"DEPLOYMENT_ERROR"|"DEPLOYMENT_SUCCEEDED"|"REMOVAL_PENDING"|"REMOVAL_REQUESTED"|"REMOVAL_IN_PROGRESS"|"REMOVAL_FAILED"|"REMOVAL_SUCCEEDED"|"DEPLOYMENT_FAILED";
  ...
  export type ConnectionType = "STATIC_IP"|"DHCP";
  ...
  export type DeviceAggregatedStatus = "ERROR"|"AWAITING_PROVISIONING"|"PENDING"|"FAILED"|"DELETING"|"ONLINE"|"OFFLINE"|"LEASE_EXPIRED"|"UPDATE_NEEDED"|"REBOOTING";
  export type DeviceArn = string;
  export type DeviceBrand = "AWS_PANORAMA"|"LENOVO";
  export type DeviceConnectionStatus = "ONLINE"|"OFFLINE"|"AWAITING_CREDENTIALS"|"NOT_AVAILABLE"|"ERROR";
  ...
  export type DeviceReportedStatus = "STOPPING"|"STOPPED"|"STOP_ERROR"|"REMOVAL_FAILED"|"REMOVAL_IN_PROGRESS"|"STARTING"|"RUNNING"|"INSTALL_ERROR"|"LAUNCHED"|"LAUNCH_ERROR"|"INSTALL_IN_PROGRESS";
  export type DeviceSerialNumber = string;
  export type DeviceStatus = "AWAITING_PROVISIONING"|"PENDING"|"SUCCEEDED"|"FAILED"|"ERROR"|"DELETING";
  export type DeviceType = "PANORAMA_APPLIANCE_DEVELOPER_KIT"|"PANORAMA_APPLIANCE";
  ...
  export type JobResourceType = "PACKAGE";
  export type JobTagsList = JobResourceTags[];
  export type JobType = "OTA"|"REBOOT";
  ...
  export type ListDevicesSortBy = "DEVICE_ID"|"CREATED_TIME"|"NAME"|"DEVICE_AGGREGATED_STATUS";
  ...
  export type NetworkConnectionStatus = "CONNECTED"|"NOT_CONNECTED"|"CONNECTING";
  ...
  export type NodeCategory = "BUSINESS_LOGIC"|"ML_MODEL"|"MEDIA_SOURCE"|"MEDIA_SINK";
  ...
  export type NodeFromTemplateJobStatus = "PENDING"|"SUCCEEDED"|"FAILED";
  ...
  export type NodeInstanceStatus = "RUNNING"|"ERROR"|"NOT_AVAILABLE"|"PAUSED";
  ...
  export type NodeSignalValue = "PAUSE"|"RESUME";
  ...
  export type PackageImportJobStatus = "PENDING"|"SUCCEEDED"|"FAILED";
  export type PackageImportJobStatusMessage = string;
  export type PackageImportJobType = "NODE_PACKAGE_VERSION"|"MARKETPLACE_NODE_PACKAGE_VERSION";
  ...
  export type PortType = "BOOLEAN"|"STRING"|"INT32"|"FLOAT32"|"MEDIA";
  ...
  export type StatusFilter = "DEPLOYMENT_SUCCEEDED"|"DEPLOYMENT_ERROR"|"REMOVAL_SUCCEEDED"|"REMOVAL_FAILED"|"PROCESSING_DEPLOYMENT"|"PROCESSING_REMOVAL"|"DEPLOYMENT_FAILED";
  ...
  export type TemplateType = "RTSP_CAMERA_STREAM";
  ...
  export type UpdateProgress = "PENDING"|"IN_PROGRESS"|"VERIFYING"|"REBOOTING"|"DOWNLOADING"|"COMPLETED"|"FAILED";
