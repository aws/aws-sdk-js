...
declare class EC2 extends Service {
   ...
   */
  acceptReservedInstancesExchangeQuote(params: EC2.AcceptReservedInstancesExchangeQuoteRequest, callback?: (err: AWSError, data: EC2.AcceptReservedInstancesExchangeQuoteResult) => void): Request<EC2.AcceptReservedInstancesExchangeQuoteResult, AWSError>;
  /**
   * Purchases Convertible Reserved Instance offerings described in the GetReservedInstancesExchangeQuote call.
   */
  acceptReservedInstancesExchangeQuote(callback?: (err: AWSError, data: EC2.AcceptReservedInstancesExchangeQuoteResult) => void): Request<EC2.AcceptReservedInstancesExchangeQuoteResult, AWSError>;
  /**
   ...
   */
  acceptVpcPeeringConnection(params: EC2.AcceptVpcPeeringConnectionRequest, callback?: (err: AWSError, data: EC2.AcceptVpcPeeringConnectionResult) => void): Request<EC2.AcceptVpcPeeringConnectionResult, AWSError>;
  /**
   * Accept a VPC peering connection request. To accept a request, the VPC peering connection must be in the pending-acceptance state, and you must be the owner of the peer VPC. Use the DescribeVpcPeeringConnections request to view your outstanding VPC peering connection requests.
   */
  acceptVpcPeeringConnection(callback?: (err: AWSError, data: EC2.AcceptVpcPeeringConnectionResult) => void): Request<EC2.AcceptVpcPeeringConnectionResult, AWSError>;
  /**
   ...
   */
  allocateAddress(params: EC2.AllocateAddressRequest, callback?: (err: AWSError, data: EC2.AllocateAddressResult) => void): Request<EC2.AllocateAddressResult, AWSError>;
  /**
   * Acquires an Elastic IP address. An Elastic IP address is for use either in the EC2-Classic platform or in a VPC. For more information, see Elastic IP Addresses in the Amazon Elastic Compute Cloud User Guide.
   */
  allocateAddress(callback?: (err: AWSError, data: EC2.AllocateAddressResult) => void): Request<EC2.AllocateAddressResult, AWSError>;
  /**
   * Allocates a Dedicated Host to your account. At minimum you need to specify the instance size type, Availability Zone, and quantity of hosts you want to allocate.
   */
  allocateHosts(params: EC2.AllocateHostsRequest, callback?: (err: AWSError, data: EC2.AllocateHostsResult) => void): Request<EC2.AllocateHostsResult, AWSError>;
  /**
   * Allocates a Dedicated Host to your account. At minimum you need to specify the instance size type, Availability Zone, and quantity of hosts you want to allocate.
   */
  allocateHosts(callback?: (err: AWSError, data: EC2.AllocateHostsResult) => void): Request<EC2.AllocateHostsResult, AWSError>;
  /**
   ...
   */
  assignPrivateIpAddresses(params: EC2.AssignPrivateIpAddressesRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Assigns one or more secondary private IP addresses to the specified network interface. You can specify one or more specific secondary IP addresses, or you can specify the number of secondary IP addresses to be automatically assigned within the subnet's CIDR block range. The number of secondary IP addresses that you can assign to an instance varies by instance type. For information about instance types, see Instance Types in the Amazon Elastic Compute Cloud User Guide. For more information about Elastic IP addresses, see Elastic IP Addresses in the Amazon Elastic Compute Cloud User Guide. AssignPrivateIpAddresses is available only in EC2-VPC.
   */
   ...
   */
  associateAddress(params: EC2.AssociateAddressRequest, callback?: (err: AWSError, data: EC2.AssociateAddressResult) => void): Request<EC2.AssociateAddressResult, AWSError>;
  /**
   * Associates an Elastic IP address with an instance or a network interface. An Elastic IP address is for use in either the EC2-Classic platform or in a VPC. For more information, see Elastic IP Addresses in the Amazon Elastic Compute Cloud User Guide. [EC2-Classic, VPC in an EC2-VPC-only account] If the Elastic IP address is already associated with a different instance, it is disassociated from that instance and associated with the specified instance. [VPC in an EC2-Classic account] If you don't specify a private IP address, the Elastic IP address is associated with the primary IP address. If the Elastic IP address is already associated with a different instance or a network interface, you get an error unless you allow reassociation.  This is an idempotent operation. If you perform the operation more than once, Amazon EC2 doesn't return an error, and you may be charged for each time the Elastic IP address is remapped to the same instance. For more information, see the Elastic IP Addresses section of Amazon EC2 Pricing. 
   */
  associateAddress(callback?: (err: AWSError, data: EC2.AssociateAddressResult) => void): Request<EC2.AssociateAddressResult, AWSError>;
  /**
   ...
   */
  associateDhcpOptions(params: EC2.AssociateDhcpOptionsRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Associates a set of DHCP options (that you've previously created) with the specified VPC, or associates no DHCP options with the VPC. After you associate the options with the VPC, any existing instances and all new instances that you launch in that VPC use the options. You don't need to restart or relaunch the instances. They automatically pick up the changes within a few hours, depending on how frequently the instance renews its DHCP lease. You can explicitly renew the lease using the operating system on the instance. For more information, see DHCP Options Sets in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  associateRouteTable(params: EC2.AssociateRouteTableRequest, callback?: (err: AWSError, data: EC2.AssociateRouteTableResult) => void): Request<EC2.AssociateRouteTableResult, AWSError>;
  /**
   * Associates a subnet with a route table. The subnet and route table must be in the same VPC. This association causes traffic originating from the subnet to be routed according to the routes in the route table. The action returns an association ID, which you need in order to disassociate the route table from the subnet later. A route table can be associated with multiple subnets. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide.
   */
  associateRouteTable(callback?: (err: AWSError, data: EC2.AssociateRouteTableResult) => void): Request<EC2.AssociateRouteTableResult, AWSError>;
  /**
   ...
   */
  attachClassicLinkVpc(params: EC2.AttachClassicLinkVpcRequest, callback?: (err: AWSError, data: EC2.AttachClassicLinkVpcResult) => void): Request<EC2.AttachClassicLinkVpcResult, AWSError>;
  /**
   * Links an EC2-Classic instance to a ClassicLink-enabled VPC through one or more of the VPC's security groups. You cannot link an EC2-Classic instance to more than one VPC at a time. You can only link an instance that's in the running state. An instance is automatically unlinked from a VPC when it's stopped - you can link it to the VPC again when you restart it. After you've linked an instance, you cannot change the VPC security groups that are associated with it. To change the security groups, you must first unlink the instance, and then link it again. Linking your instance to a VPC is sometimes referred to as attaching your instance.
   */
  attachClassicLinkVpc(callback?: (err: AWSError, data: EC2.AttachClassicLinkVpcResult) => void): Request<EC2.AttachClassicLinkVpcResult, AWSError>;
  /**
   * Attaches an Internet gateway to a VPC, enabling connectivity between the Internet and the VPC. For more information about your VPC and Internet gateway, see the Amazon Virtual Private Cloud User Guide.
   */
  attachInternetGateway(params: EC2.AttachInternetGatewayRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Attaches an Internet gateway to a VPC, enabling connectivity between the Internet and the VPC. For more information about your VPC and Internet gateway, see the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  attachNetworkInterface(params: EC2.AttachNetworkInterfaceRequest, callback?: (err: AWSError, data: EC2.AttachNetworkInterfaceResult) => void): Request<EC2.AttachNetworkInterfaceResult, AWSError>;
  /**
   * Attaches a network interface to an instance.
   */
  attachNetworkInterface(callback?: (err: AWSError, data: EC2.AttachNetworkInterfaceResult) => void): Request<EC2.AttachNetworkInterfaceResult, AWSError>;
  /**
   ...
   */
  attachVolume(params: EC2.AttachVolumeRequest, callback?: (err: AWSError, data: EC2.VolumeAttachment) => void): Request<EC2.VolumeAttachment, AWSError>;
  /**
   * Attaches an EBS volume to a running or stopped instance and exposes it to the instance with the specified device name. Encrypted EBS volumes may only be attached to instances that support Amazon EBS encryption. For more information, see Amazon EBS Encryption in the Amazon Elastic Compute Cloud User Guide. For a list of supported device names, see Attaching an EBS Volume to an Instance. Any device names that aren't reserved for instance store volumes can be used for EBS volumes. For more information, see Amazon EC2 Instance Store in the Amazon Elastic Compute Cloud User Guide. If a volume has an AWS Marketplace product code:   The volume can be attached only to a stopped instance.   AWS Marketplace product codes are copied from the volume to the instance.   You must be subscribed to the product.   The instance type and operating system of the instance must support the product. For example, you can't detach a volume from a Windows instance and attach it to a Linux instance.   For an overview of the AWS Marketplace, see Introducing AWS Marketplace. For more information about EBS volumes, see Attaching Amazon EBS Volumes in the Amazon Elastic Compute Cloud User Guide.
   */
  attachVolume(callback?: (err: AWSError, data: EC2.VolumeAttachment) => void): Request<EC2.VolumeAttachment, AWSError>;
  /**
   ...
   */
  attachVpnGateway(params: EC2.AttachVpnGatewayRequest, callback?: (err: AWSError, data: EC2.AttachVpnGatewayResult) => void): Request<EC2.AttachVpnGatewayResult, AWSError>;
  /**
   * Attaches a virtual private gateway to a VPC. For more information, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  attachVpnGateway(callback?: (err: AWSError, data: EC2.AttachVpnGatewayResult) => void): Request<EC2.AttachVpnGatewayResult, AWSError>;
  /**
   ...
   */
  authorizeSecurityGroupEgress(params: EC2.AuthorizeSecurityGroupEgressRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * [EC2-VPC only] Adds one or more egress rules to a security group for use with a VPC. Specifically, this action permits instances to send traffic to one or more destination CIDR IP address ranges, or to one or more destination security groups for the same VPC. This action doesn't apply to security groups for use in EC2-Classic. For more information, see Security Groups for Your VPC in the Amazon Virtual Private Cloud User Guide.  You can have up to 50 rules per security group (covering both ingress and egress rules).  Each rule consists of the protocol (for example, TCP), plus either a CIDR range or a source group. For the TCP and UDP protocols, you must also specify the destination port or port range. For the ICMP protocol, you must also specify the ICMP type and code. You can use -1 for the type or code to mean all types or all codes. Rule changes are propagated to affected instances as quickly as possible. However, a small delay might occur.
   */
   ...
   */
  authorizeSecurityGroupIngress(params: EC2.AuthorizeSecurityGroupIngressRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Adds one or more ingress rules to a security group.  EC2-Classic: You can have up to 100 rules per group. EC2-VPC: You can have up to 50 rules per group (covering both ingress and egress rules).  Rule changes are propagated to instances within the security group as quickly as possible. However, a small delay might occur. [EC2-Classic] This action gives one or more CIDR IP address ranges permission to access a security group in your account, or gives one or more security groups (called the source groups) permission to access a security group for your account. A source group can be for your own AWS account, or another. [EC2-VPC] This action gives one or more CIDR IP address ranges permission to access a security group in your VPC, or gives one or more other security groups (called the source groups) permission to access a security group for your VPC. The security groups must all be for the same VPC.
   */
   ...
   */
  bundleInstance(params: EC2.BundleInstanceRequest, callback?: (err: AWSError, data: EC2.BundleInstanceResult) => void): Request<EC2.BundleInstanceResult, AWSError>;
  /**
   * Bundles an Amazon instance store-backed Windows instance. During bundling, only the root device volume (C:\) is bundled. Data on other instance store volumes is not preserved.  This action is not applicable for Linux/Unix instances or Windows instances that are backed by Amazon EBS.  For more information, see Creating an Instance Store-Backed Windows AMI.
   */
  bundleInstance(callback?: (err: AWSError, data: EC2.BundleInstanceResult) => void): Request<EC2.BundleInstanceResult, AWSError>;
  /**
   * Cancels a bundling operation for an instance store-backed Windows instance.
   */
  cancelBundleTask(params: EC2.CancelBundleTaskRequest, callback?: (err: AWSError, data: EC2.CancelBundleTaskResult) => void): Request<EC2.CancelBundleTaskResult, AWSError>;
  /**
   * Cancels a bundling operation for an instance store-backed Windows instance.
   */
  cancelBundleTask(callback?: (err: AWSError, data: EC2.CancelBundleTaskResult) => void): Request<EC2.CancelBundleTaskResult, AWSError>;
  /**
   ...
   */
  cancelConversionTask(params: EC2.CancelConversionRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Cancels an active conversion task. The task can be the import of an instance or volume. The action removes all artifacts of the conversion, including a partially uploaded volume or instance. If the conversion is complete or is in the process of transferring the final disk image, the command fails and returns an exception. For more information, see Importing a Virtual Machine Using the Amazon EC2 CLI.
   */
   ...
   */
  cancelExportTask(params: EC2.CancelExportTaskRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Cancels an active export task. The request removes all artifacts of the export, including any partially-created Amazon S3 objects. If the export task is complete or is in the process of transferring the final disk image, the command fails and returns an error.
   */
   ...
   */
  cancelImportTask(params: EC2.CancelImportTaskRequest, callback?: (err: AWSError, data: EC2.CancelImportTaskResult) => void): Request<EC2.CancelImportTaskResult, AWSError>;
  /**
   * Cancels an in-process import virtual machine or import snapshot task.
   */
  cancelImportTask(callback?: (err: AWSError, data: EC2.CancelImportTaskResult) => void): Request<EC2.CancelImportTaskResult, AWSError>;
  /**
   ...
   */
  cancelReservedInstancesListing(params: EC2.CancelReservedInstancesListingRequest, callback?: (err: AWSError, data: EC2.CancelReservedInstancesListingResult) => void): Request<EC2.CancelReservedInstancesListingResult, AWSError>;
  /**
   * Cancels the specified Reserved Instance listing in the Reserved Instance Marketplace. For more information, see Reserved Instance Marketplace in the Amazon Elastic Compute Cloud User Guide.
   */
  cancelReservedInstancesListing(callback?: (err: AWSError, data: EC2.CancelReservedInstancesListingResult) => void): Request<EC2.CancelReservedInstancesListingResult, AWSError>;
  /**
   ...
   */
  cancelSpotFleetRequests(params: EC2.CancelSpotFleetRequestsRequest, callback?: (err: AWSError, data: EC2.CancelSpotFleetRequestsResponse) => void): Request<EC2.CancelSpotFleetRequestsResponse, AWSError>;
  /**
   * Cancels the specified Spot fleet requests. After you cancel a Spot fleet request, the Spot fleet launches no new Spot instances. You must specify whether the Spot fleet should also terminate its Spot instances. If you terminate the instances, the Spot fleet request enters the cancelled_terminating state. Otherwise, the Spot fleet request enters the cancelled_running state and the instances continue to run until they are interrupted or you terminate them manually.
   */
  cancelSpotFleetRequests(callback?: (err: AWSError, data: EC2.CancelSpotFleetRequestsResponse) => void): Request<EC2.CancelSpotFleetRequestsResponse, AWSError>;
  /**
   ...
   */
  cancelSpotInstanceRequests(params: EC2.CancelSpotInstanceRequestsRequest, callback?: (err: AWSError, data: EC2.CancelSpotInstanceRequestsResult) => void): Request<EC2.CancelSpotInstanceRequestsResult, AWSError>;
  /**
   * Cancels one or more Spot instance requests. Spot instances are instances that Amazon EC2 starts on your behalf when the bid price that you specify exceeds the current Spot price. Amazon EC2 periodically sets the Spot price based on available Spot instance capacity and current Spot instance requests. For more information, see Spot Instance Requests in the Amazon Elastic Compute Cloud User Guide.  Canceling a Spot instance request does not terminate running Spot instances associated with the request. 
   */
  cancelSpotInstanceRequests(callback?: (err: AWSError, data: EC2.CancelSpotInstanceRequestsResult) => void): Request<EC2.CancelSpotInstanceRequestsResult, AWSError>;
  /**
   * Determines whether a product code is associated with an instance. This action can only be used by the owner of the product code. It is useful when a product code owner needs to verify whether another user's instance is eligible for support.
   */
  confirmProductInstance(params: EC2.ConfirmProductInstanceRequest, callback?: (err: AWSError, data: EC2.ConfirmProductInstanceResult) => void): Request<EC2.ConfirmProductInstanceResult, AWSError>;
  /**
   * Determines whether a product code is associated with an instance. This action can only be used by the owner of the product code. It is useful when a product code owner needs to verify whether another user's instance is eligible for support.
   */
  confirmProductInstance(callback?: (err: AWSError, data: EC2.ConfirmProductInstanceResult) => void): Request<EC2.ConfirmProductInstanceResult, AWSError>;
  /**
   * Initiates the copy of an AMI from the specified source region to the current region. You specify the destination region by using its endpoint when making the request. For more information, see Copying AMIs in the Amazon Elastic Compute Cloud User Guide.
   */
  copyImage(params: EC2.CopyImageRequest, callback?: (err: AWSError, data: EC2.CopyImageResult) => void): Request<EC2.CopyImageResult, AWSError>;
  /**
   * Initiates the copy of an AMI from the specified source region to the current region. You specify the destination region by using its endpoint when making the request. For more information, see Copying AMIs in the Amazon Elastic Compute Cloud User Guide.
   */
  copyImage(callback?: (err: AWSError, data: EC2.CopyImageResult) => void): Request<EC2.CopyImageResult, AWSError>;
  /**
   ...
   */
  copySnapshot(params: EC2.CopySnapshotRequest, callback?: (err: AWSError, data: EC2.CopySnapshotResult) => void): Request<EC2.CopySnapshotResult, AWSError>;
  /**
   * Copies a point-in-time snapshot of an EBS volume and stores it in Amazon S3. You can copy the snapshot within the same region or from one region to another. You can use the snapshot to create EBS volumes or Amazon Machine Images (AMIs). The snapshot is copied to the regional endpoint that you send the HTTP request to. Copies of encrypted EBS snapshots remain encrypted. Copies of unencrypted snapshots remain unencrypted, unless the Encrypted flag is specified during the snapshot copy operation. By default, encrypted snapshot copies use the default AWS Key Management Service (AWS KMS) customer master key (CMK); however, you can specify a non-default CMK with the KmsKeyId parameter.   To copy an encrypted snapshot that has been shared from another account, you must have permissions for the CMK used to encrypt the snapshot.   Snapshots created by the CopySnapshot action have an arbitrary volume ID that should not be used for any purpose.  For more information, see Copying an Amazon EBS Snapshot in the Amazon Elastic Compute Cloud User Guide.
   */
  copySnapshot(callback?: (err: AWSError, data: EC2.CopySnapshotResult) => void): Request<EC2.CopySnapshotResult, AWSError>;
  /**
   ...
   */
  createCustomerGateway(params: EC2.CreateCustomerGatewayRequest, callback?: (err: AWSError, data: EC2.CreateCustomerGatewayResult) => void): Request<EC2.CreateCustomerGatewayResult, AWSError>;
  /**
   * Provides information to AWS about your VPN customer gateway device. The customer gateway is the appliance at your end of the VPN connection. (The device on the AWS side of the VPN connection is the virtual private gateway.) You must provide the Internet-routable IP address of the customer gateway's external interface. The IP address must be static and may be behind a device performing network address translation (NAT). For devices that use Border Gateway Protocol (BGP), you can also provide the device's BGP Autonomous System Number (ASN). You can use an existing ASN assigned to your network. If you don't have an ASN already, you can use a private ASN (in the 64512 - 65534 range).  Amazon EC2 supports all 2-byte ASN numbers in the range of 1 - 65534, with the exception of 7224, which is reserved in the us-east-1 region, and 9059, which is reserved in the eu-west-1 region.  For more information about VPN customer gateways, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.  You cannot create more than one customer gateway with the same VPN type, IP address, and BGP ASN parameter values. If you run an identical request more than one time, the first request creates the customer gateway, and subsequent requests return information about the existing customer gateway. The subsequent requests do not create new customer gateway resources. 
   */
  createCustomerGateway(callback?: (err: AWSError, data: EC2.CreateCustomerGatewayResult) => void): Request<EC2.CreateCustomerGatewayResult, AWSError>;
  /**
   ...
   */
  createDhcpOptions(params: EC2.CreateDhcpOptionsRequest, callback?: (err: AWSError, data: EC2.CreateDhcpOptionsResult) => void): Request<EC2.CreateDhcpOptionsResult, AWSError>;
  /**
   * Creates a set of DHCP options for your VPC. After creating the set, you must associate it with the VPC, causing all existing and new instances that you launch in the VPC to use this set of DHCP options. The following are the individual DHCP options you can specify. For more information about the options, see RFC 2132.    domain-name-servers - The IP addresses of up to four domain name servers, or AmazonProvidedDNS. The default DHCP option set specifies AmazonProvidedDNS. If specifying more than one domain name server, specify the IP addresses in a single parameter, separated by commas. If you want your instance to receive a custom DNS hostname as specified in domain-name, you must set domain-name-servers to a custom DNS server.    domain-name - If you're using AmazonProvidedDNS in "us-east-1", specify "ec2.internal". If you're using AmazonProvidedDNS in another region, specify "region.compute.internal" (for example, "ap-northeast-1.compute.internal"). Otherwise, specify a domain name (for example, "MyCompany.com"). This value is used to complete unqualified DNS hostnames. Important: Some Linux operating systems accept multiple domain names separated by spaces. However, Windows and other Linux operating systems treat the value as a single domain, which results in unexpected behavior. If your DHCP options set is associated with a VPC that has instances with multiple operating systems, specify only one domain name.    ntp-servers - The IP addresses of up to four Network Time Protocol (NTP) servers.    netbios-name-servers - The IP addresses of up to four NetBIOS name servers.    netbios-node-type - The NetBIOS node type (1, 2, 4, or 8). We recommend that you specify 2 (broadcast and multicast are not currently supported). For more information about these node types, see RFC 2132.   Your VPC automatically starts out with a set of DHCP options that includes only a DNS server that we provide (AmazonProvidedDNS). If you create a set of options, and if your VPC has an Internet gateway, make sure to set the domain-name-servers option either to AmazonProvidedDNS or to a domain name server of your choice. For more information about DHCP options, see DHCP Options Sets in the Amazon Virtual Private Cloud User Guide.
   */
  createDhcpOptions(callback?: (err: AWSError, data: EC2.CreateDhcpOptionsResult) => void): Request<EC2.CreateDhcpOptionsResult, AWSError>;
  /**
   ...
   */
  createFlowLogs(params: EC2.CreateFlowLogsRequest, callback?: (err: AWSError, data: EC2.CreateFlowLogsResult) => void): Request<EC2.CreateFlowLogsResult, AWSError>;
  /**
   * Creates one or more flow logs to capture IP traffic for a specific network interface, subnet, or VPC. Flow logs are delivered to a specified log group in Amazon CloudWatch Logs. If you specify a VPC or subnet in the request, a log stream is created in CloudWatch Logs for each network interface in the subnet or VPC. Log streams can include information about accepted and rejected traffic to a network interface. You can view the data in your log streams using Amazon CloudWatch Logs. In your request, you must also specify an IAM role that has permission to publish logs to CloudWatch Logs.
   */
  createFlowLogs(callback?: (err: AWSError, data: EC2.CreateFlowLogsResult) => void): Request<EC2.CreateFlowLogsResult, AWSError>;
  /**
   ...
   */
  createImage(params: EC2.CreateImageRequest, callback?: (err: AWSError, data: EC2.CreateImageResult) => void): Request<EC2.CreateImageResult, AWSError>;
  /**
   * Creates an Amazon EBS-backed AMI from an Amazon EBS-backed instance that is either running or stopped. If you customized your instance with instance store volumes or EBS volumes in addition to the root device volume, the new AMI contains block device mapping information for those volumes. When you launch an instance from this new AMI, the instance automatically launches with those additional volumes. For more information, see Creating Amazon EBS-Backed Linux AMIs in the Amazon Elastic Compute Cloud User Guide.
   */
  createImage(callback?: (err: AWSError, data: EC2.CreateImageResult) => void): Request<EC2.CreateImageResult, AWSError>;
  /**
   ...
   */
  createInstanceExportTask(params: EC2.CreateInstanceExportTaskRequest, callback?: (err: AWSError, data: EC2.CreateInstanceExportTaskResult) => void): Request<EC2.CreateInstanceExportTaskResult, AWSError>;
  /**
   * Exports a running or stopped instance to an S3 bucket. For information about the supported operating systems, image formats, and known limitations for the types of instances you can export, see Exporting an Instance as a VM Using VM Import/Export in the VM Import/Export User Guide.
   */
  createInstanceExportTask(callback?: (err: AWSError, data: EC2.CreateInstanceExportTaskResult) => void): Request<EC2.CreateInstanceExportTaskResult, AWSError>;
  /**
   ...
   */
  createInternetGateway(params: EC2.CreateInternetGatewayRequest, callback?: (err: AWSError, data: EC2.CreateInternetGatewayResult) => void): Request<EC2.CreateInternetGatewayResult, AWSError>;
  /**
   * Creates an Internet gateway for use with a VPC. After creating the Internet gateway, you attach it to a VPC using AttachInternetGateway. For more information about your VPC and Internet gateway, see the Amazon Virtual Private Cloud User Guide.
   */
  createInternetGateway(callback?: (err: AWSError, data: EC2.CreateInternetGatewayResult) => void): Request<EC2.CreateInternetGatewayResult, AWSError>;
  /**
   ...
   */
  createKeyPair(params: EC2.CreateKeyPairRequest, callback?: (err: AWSError, data: EC2.KeyPair) => void): Request<EC2.KeyPair, AWSError>;
  /**
   * Creates a 2048-bit RSA key pair with the specified name. Amazon EC2 stores the public key and displays the private key for you to save to a file. The private key is returned as an unencrypted PEM encoded PKCS#8 private key. If a key with the specified name already exists, Amazon EC2 returns an error. You can have up to five thousand key pairs per region. The key pair returned to you is available only in the region in which you create it. To create a key pair that is available in all regions, use ImportKeyPair. For more information about key pairs, see Key Pairs in the Amazon Elastic Compute Cloud User Guide.
   */
  createKeyPair(callback?: (err: AWSError, data: EC2.KeyPair) => void): Request<EC2.KeyPair, AWSError>;
  /**
   ...
   */
  createNatGateway(params: EC2.CreateNatGatewayRequest, callback?: (err: AWSError, data: EC2.CreateNatGatewayResult) => void): Request<EC2.CreateNatGatewayResult, AWSError>;
  /**
   * Creates a NAT gateway in the specified subnet. A NAT gateway can be used to enable instances in a private subnet to connect to the Internet. This action creates a network interface in the specified subnet with a private IP address from the IP address range of the subnet. For more information, see NAT Gateways in the Amazon Virtual Private Cloud User Guide.
   */
  createNatGateway(callback?: (err: AWSError, data: EC2.CreateNatGatewayResult) => void): Request<EC2.CreateNatGatewayResult, AWSError>;
  /**
   ...
   */
  createNetworkAcl(params: EC2.CreateNetworkAclRequest, callback?: (err: AWSError, data: EC2.CreateNetworkAclResult) => void): Request<EC2.CreateNetworkAclResult, AWSError>;
  /**
   * Creates a network ACL in a VPC. Network ACLs provide an optional layer of security (in addition to security groups) for the instances in your VPC. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
  createNetworkAcl(callback?: (err: AWSError, data: EC2.CreateNetworkAclResult) => void): Request<EC2.CreateNetworkAclResult, AWSError>;
  /**
   ...
   */
  createNetworkAclEntry(params: EC2.CreateNetworkAclEntryRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates an entry (a rule) in a network ACL with the specified rule number. Each network ACL has a set of numbered ingress rules and a separate set of numbered egress rules. When determining whether a packet should be allowed in or out of a subnet associated with the ACL, we process the entries in the ACL according to the rule numbers, in ascending order. Each network ACL has a set of ingress rules and a separate set of egress rules. We recommend that you leave room between the rule numbers (for example, 100, 110, 120, ...), and not number them one right after the other (for example, 101, 102, 103, ...). This makes it easier to add a rule between existing ones without having to renumber the rules. After you add an entry, you can't modify it; you must either replace it, or create an entry and delete the old one. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  createNetworkInterface(params: EC2.CreateNetworkInterfaceRequest, callback?: (err: AWSError, data: EC2.CreateNetworkInterfaceResult) => void): Request<EC2.CreateNetworkInterfaceResult, AWSError>;
  /**
   * Creates a network interface in the specified subnet. For more information about network interfaces, see Elastic Network Interfaces in the Amazon Elastic Compute Cloud User Guide.
   */
  createNetworkInterface(callback?: (err: AWSError, data: EC2.CreateNetworkInterfaceResult) => void): Request<EC2.CreateNetworkInterfaceResult, AWSError>;
  /**
   ...
   */
  createPlacementGroup(params: EC2.CreatePlacementGroupRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates a placement group that you launch cluster instances into. You must give the group a name that's unique within the scope of your account. For more information about placement groups and cluster instances, see Cluster Instances in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  createReservedInstancesListing(params: EC2.CreateReservedInstancesListingRequest, callback?: (err: AWSError, data: EC2.CreateReservedInstancesListingResult) => void): Request<EC2.CreateReservedInstancesListingResult, AWSError>;
  /**
   * Creates a listing for Amazon EC2 Standard Reserved Instances to be sold in the Reserved Instance Marketplace. You can submit one Standard Reserved Instance listing at a time. To get a list of your Standard Reserved Instances, you can use the DescribeReservedInstances operation. The Reserved Instance Marketplace matches sellers who want to resell Standard Reserved Instance capacity that they no longer need with buyers who want to purchase additional capacity. Reserved Instances bought and sold through the Reserved Instance Marketplace work like any other Reserved Instances. To sell your Standard Reserved Instances, you must first register as a seller in the Reserved Instance Marketplace. After completing the registration process, you can create a Reserved Instance Marketplace listing of some or all of your Standard Reserved Instances, and specify the upfront price to receive for them. Your Standard Reserved Instance listings then become available for purchase. To view the details of your Standard Reserved Instance listing, you can use the DescribeReservedInstancesListings operation. For more information, see Reserved Instance Marketplace in the Amazon Elastic Compute Cloud User Guide.
   */
  createReservedInstancesListing(callback?: (err: AWSError, data: EC2.CreateReservedInstancesListingResult) => void): Request<EC2.CreateReservedInstancesListingResult, AWSError>;
  /**
   ...
   */
  createRoute(params: EC2.CreateRouteRequest, callback?: (err: AWSError, data: EC2.CreateRouteResult) => void): Request<EC2.CreateRouteResult, AWSError>;
  /**
   * Creates a route in a route table within a VPC. You must specify one of the following targets: Internet gateway or virtual private gateway, NAT instance, NAT gateway, VPC peering connection, or network interface. When determining how to route traffic, we use the route with the most specific match. For example, let's say the traffic is destined for 192.0.2.3, and the route table includes the following two routes:    192.0.2.0/24 (goes to some target A)    192.0.2.0/28 (goes to some target B)   Both routes apply to the traffic destined for 192.0.2.3. However, the second route in the list covers a smaller number of IP addresses and is therefore more specific, so we use that route to determine where to target the traffic. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide.
   */
  createRoute(callback?: (err: AWSError, data: EC2.CreateRouteResult) => void): Request<EC2.CreateRouteResult, AWSError>;
  /**
   ...
   */
  createRouteTable(params: EC2.CreateRouteTableRequest, callback?: (err: AWSError, data: EC2.CreateRouteTableResult) => void): Request<EC2.CreateRouteTableResult, AWSError>;
  /**
   * Creates a route table for the specified VPC. After you create a route table, you can add routes and associate the table with a subnet. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide.
   */
  createRouteTable(callback?: (err: AWSError, data: EC2.CreateRouteTableResult) => void): Request<EC2.CreateRouteTableResult, AWSError>;
  /**
   ...
   */
  createSecurityGroup(params: EC2.CreateSecurityGroupRequest, callback?: (err: AWSError, data: EC2.CreateSecurityGroupResult) => void): Request<EC2.CreateSecurityGroupResult, AWSError>;
  /**
   * Creates a security group. A security group is for use with instances either in the EC2-Classic platform or in a specific VPC. For more information, see Amazon EC2 Security Groups in the Amazon Elastic Compute Cloud User Guide and Security Groups for Your VPC in the Amazon Virtual Private Cloud User Guide.  EC2-Classic: You can have up to 500 security groups. EC2-VPC: You can create up to 500 security groups per VPC.  When you create a security group, you specify a friendly name of your choice. You can have a security group for use in EC2-Classic with the same name as a security group for use in a VPC. However, you can't have two security groups for use in EC2-Classic with the same name or two security groups for use in a VPC with the same name. You have a default security group for use in EC2-Classic and a default security group for use in your VPC. If you don't specify a security group when you launch an instance, the instance is launched into the appropriate default security group. A default security group includes a default rule that grants instances unrestricted network access to each other. You can add or remove rules from your security groups using AuthorizeSecurityGroupIngress, AuthorizeSecurityGroupEgress, RevokeSecurityGroupIngress, and RevokeSecurityGroupEgress.
   */
  createSecurityGroup(callback?: (err: AWSError, data: EC2.CreateSecurityGroupResult) => void): Request<EC2.CreateSecurityGroupResult, AWSError>;
  /**
   ...
   */
  createSnapshot(params: EC2.CreateSnapshotRequest, callback?: (err: AWSError, data: EC2.Snapshot) => void): Request<EC2.Snapshot, AWSError>;
  /**
   * Creates a snapshot of an EBS volume and stores it in Amazon S3. You can use snapshots for backups, to make copies of EBS volumes, and to save data before shutting down an instance. When a snapshot is created, any AWS Marketplace product codes that are associated with the source volume are propagated to the snapshot. You can take a snapshot of an attached volume that is in use. However, snapshots only capture data that has been written to your EBS volume at the time the snapshot command is issued; this may exclude any data that has been cached by any applications or the operating system. If you can pause any file systems on the volume long enough to take a snapshot, your snapshot should be complete. However, if you cannot pause all file writes to the volume, you should unmount the volume from within the instance, issue the snapshot command, and then remount the volume to ensure a consistent and complete snapshot. You may remount and use your volume while the snapshot status is pending. To create a snapshot for EBS volumes that serve as root devices, you should stop the instance before taking the snapshot. Snapshots that are taken from encrypted volumes are automatically encrypted. Volumes that are created from encrypted snapshots are also automatically encrypted. Your encrypted volumes and any associated snapshots always remain protected. For more information, see Amazon Elastic Block Store and Amazon EBS Encryption in the Amazon Elastic Compute Cloud User Guide.
   */
  createSnapshot(callback?: (err: AWSError, data: EC2.Snapshot) => void): Request<EC2.Snapshot, AWSError>;
  /**
   ...
   */
  createSpotDatafeedSubscription(params: EC2.CreateSpotDatafeedSubscriptionRequest, callback?: (err: AWSError, data: EC2.CreateSpotDatafeedSubscriptionResult) => void): Request<EC2.CreateSpotDatafeedSubscriptionResult, AWSError>;
  /**
   * Creates a data feed for Spot instances, enabling you to view Spot instance usage logs. You can create one data feed per AWS account. For more information, see Spot Instance Data Feed in the Amazon Elastic Compute Cloud User Guide.
   */
  createSpotDatafeedSubscription(callback?: (err: AWSError, data: EC2.CreateSpotDatafeedSubscriptionResult) => void): Request<EC2.CreateSpotDatafeedSubscriptionResult, AWSError>;
  /**
   ...
   */
  createSubnet(params: EC2.CreateSubnetRequest, callback?: (err: AWSError, data: EC2.CreateSubnetResult) => void): Request<EC2.CreateSubnetResult, AWSError>;
  /**
   * Creates a subnet in an existing VPC. When you create each subnet, you provide the VPC ID and the CIDR block you want for the subnet. After you create a subnet, you can't change its CIDR block. The subnet's CIDR block can be the same as the VPC's CIDR block (assuming you want only a single subnet in the VPC), or a subset of the VPC's CIDR block. If you create more than one subnet in a VPC, the subnets' CIDR blocks must not overlap. The smallest subnet (and VPC) you can create uses a /28 netmask (16 IP addresses), and the largest uses a /16 netmask (65,536 IP addresses).  AWS reserves both the first four and the last IP address in each subnet's CIDR block. They're not available for use.  If you add more than one subnet to a VPC, they're set up in a star topology with a logical router in the middle. If you launch an instance in a VPC using an Amazon EBS-backed AMI, the IP address doesn't change if you stop and restart the instance (unlike a similar instance launched outside a VPC, which gets a new IP address when restarted). It's therefore possible to have a subnet with no running instances (they're all stopped), but no remaining IP addresses available. For more information about subnets, see Your VPC and Subnets in the Amazon Virtual Private Cloud User Guide.
   */
  createSubnet(callback?: (err: AWSError, data: EC2.CreateSubnetResult) => void): Request<EC2.CreateSubnetResult, AWSError>;
  /**
   ...
   */
  createTags(params: EC2.CreateTagsRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Adds or overwrites one or more tags for the specified Amazon EC2 resource or resources. Each resource can have a maximum of 50 tags. Each tag consists of a key and optional value. Tag keys must be unique per resource. For more information about tags, see Tagging Your Resources in the Amazon Elastic Compute Cloud User Guide. For more information about creating IAM policies that control users' access to resources based on tags, see Supported Resource-Level Permissions for Amazon EC2 API Actions in the Amazon Elastic Compute Cloud User Guide.
   */
  createTags(callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates an EBS volume that can be attached to an instance in the same Availability Zone. The volume is created in the regional endpoint that you send the HTTP request to. For more information see Regions and Endpoints. You can create a new empty volume or restore a volume from an EBS snapshot. Any AWS Marketplace product codes from the snapshot are propagated to the volume. You can create encrypted volumes with the Encrypted parameter. Encrypted volumes may only be attached to instances that support Amazon EBS encryption. Volumes that are created from encrypted snapshots are also automatically encrypted. For more information, see Amazon EBS Encryption in the Amazon Elastic Compute Cloud User Guide. For more information, see Creating or Restoring an Amazon EBS Volume in the Amazon Elastic Compute Cloud User Guide.
   */
  createVolume(params: EC2.CreateVolumeRequest, callback?: (err: AWSError, data: EC2.Volume) => void): Request<EC2.Volume, AWSError>;
  /**
   * Creates an EBS volume that can be attached to an instance in the same Availability Zone. The volume is created in the regional endpoint that you send the HTTP request to. For more information see Regions and Endpoints. You can create a new empty volume or restore a volume from an EBS snapshot. Any AWS Marketplace product codes from the snapshot are propagated to the volume. You can create encrypted volumes with the Encrypted parameter. Encrypted volumes may only be attached to instances that support Amazon EBS encryption. Volumes that are created from encrypted snapshots are also automatically encrypted. For more information, see Amazon EBS Encryption in the Amazon Elastic Compute Cloud User Guide. For more information, see Creating or Restoring an Amazon EBS Volume in the Amazon Elastic Compute Cloud User Guide.
   */
  createVolume(callback?: (err: AWSError, data: EC2.Volume) => void): Request<EC2.Volume, AWSError>;
  /**
   ...
   */
  createVpc(params: EC2.CreateVpcRequest, callback?: (err: AWSError, data: EC2.CreateVpcResult) => void): Request<EC2.CreateVpcResult, AWSError>;
  /**
   * Creates a VPC with the specified CIDR block. The smallest VPC you can create uses a /28 netmask (16 IP addresses), and the largest uses a /16 netmask (65,536 IP addresses). To help you decide how big to make your VPC, see Your VPC and Subnets in the Amazon Virtual Private Cloud User Guide. By default, each instance you launch in the VPC has the default DHCP options, which includes only a default DNS server that we provide (AmazonProvidedDNS). For more information about DHCP options, see DHCP Options Sets in the Amazon Virtual Private Cloud User Guide. You can specify the instance tenancy value for the VPC when you create it. You can't change this value for the VPC after you create it. For more information, see Dedicated Instances in the Amazon Virtual Private Cloud User Guide.
   */
  createVpc(callback?: (err: AWSError, data: EC2.CreateVpcResult) => void): Request<EC2.CreateVpcResult, AWSError>;
  /**
   ...
   */
  createVpcEndpoint(params: EC2.CreateVpcEndpointRequest, callback?: (err: AWSError, data: EC2.CreateVpcEndpointResult) => void): Request<EC2.CreateVpcEndpointResult, AWSError>;
  /**
   * Creates a VPC endpoint for a specified AWS service. An endpoint enables you to create a private connection between your VPC and another AWS service in your account. You can specify an endpoint policy to attach to the endpoint that will control access to the service from your VPC. You can also specify the VPC route tables that use the endpoint. Currently, only endpoints to Amazon S3 are supported.
   */
  createVpcEndpoint(callback?: (err: AWSError, data: EC2.CreateVpcEndpointResult) => void): Request<EC2.CreateVpcEndpointResult, AWSError>;
  /**
   ...
   */
  createVpcPeeringConnection(params: EC2.CreateVpcPeeringConnectionRequest, callback?: (err: AWSError, data: EC2.CreateVpcPeeringConnectionResult) => void): Request<EC2.CreateVpcPeeringConnectionResult, AWSError>;
  /**
   * Requests a VPC peering connection between two VPCs: a requester VPC that you own and a peer VPC with which to create the connection. The peer VPC can belong to another AWS account. The requester VPC and peer VPC cannot have overlapping CIDR blocks. The owner of the peer VPC must accept the peering request to activate the peering connection. The VPC peering connection request expires after 7 days, after which it cannot be accepted or rejected. A CreateVpcPeeringConnection request between VPCs with overlapping CIDR blocks results in the VPC peering connection having a status of failed.
   */
  createVpcPeeringConnection(callback?: (err: AWSError, data: EC2.CreateVpcPeeringConnectionResult) => void): Request<EC2.CreateVpcPeeringConnectionResult, AWSError>;
  /**
   ...
   */
  createVpnConnection(params: EC2.CreateVpnConnectionRequest, callback?: (err: AWSError, data: EC2.CreateVpnConnectionResult) => void): Request<EC2.CreateVpnConnectionResult, AWSError>;
  /**
   * Creates a VPN connection between an existing virtual private gateway and a VPN customer gateway. The only supported connection type is ipsec.1. The response includes information that you need to give to your network administrator to configure your customer gateway.  We strongly recommend that you use HTTPS when calling this operation because the response contains sensitive cryptographic information for configuring your customer gateway.  If you decide to shut down your VPN connection for any reason and later create a new VPN connection, you must reconfigure your customer gateway with the new information returned from this call. This is an idempotent operation. If you perform the operation more than once, Amazon EC2 doesn't return an error. For more information about VPN connections, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  createVpnConnection(callback?: (err: AWSError, data: EC2.CreateVpnConnectionResult) => void): Request<EC2.CreateVpnConnectionResult, AWSError>;
  /**
   ...
   */
  createVpnConnectionRoute(params: EC2.CreateVpnConnectionRouteRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates a static route associated with a VPN connection between an existing virtual private gateway and a VPN customer gateway. The static route allows traffic to be routed from the virtual private gateway to the VPN customer gateway. For more information about VPN connections, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  createVpnGateway(params: EC2.CreateVpnGatewayRequest, callback?: (err: AWSError, data: EC2.CreateVpnGatewayResult) => void): Request<EC2.CreateVpnGatewayResult, AWSError>;
  /**
   * Creates a virtual private gateway. A virtual private gateway is the endpoint on the VPC side of your VPN connection. You can create a virtual private gateway before creating the VPC itself. For more information about virtual private gateways, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  createVpnGateway(callback?: (err: AWSError, data: EC2.CreateVpnGatewayResult) => void): Request<EC2.CreateVpnGatewayResult, AWSError>;
  /**
   * Deletes the specified customer gateway. You must delete the VPN connection before you can delete the customer gateway.
   */
  deleteCustomerGateway(params: EC2.DeleteCustomerGatewayRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified customer gateway. You must delete the VPN connection before you can delete the customer gateway.
   */
   ...
   */
  deleteDhcpOptions(params: EC2.DeleteDhcpOptionsRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified set of DHCP options. You must disassociate the set of DHCP options before you can delete it. You can disassociate the set of DHCP options by associating either a new set of options or the default set of options with the VPC.
   */
   ...
   */
  deleteFlowLogs(params: EC2.DeleteFlowLogsRequest, callback?: (err: AWSError, data: EC2.DeleteFlowLogsResult) => void): Request<EC2.DeleteFlowLogsResult, AWSError>;
  /**
   * Deletes one or more flow logs.
   */
  deleteFlowLogs(callback?: (err: AWSError, data: EC2.DeleteFlowLogsResult) => void): Request<EC2.DeleteFlowLogsResult, AWSError>;
  /**
   * Deletes the specified Internet gateway. You must detach the Internet gateway from the VPC before you can delete it.
   */
  deleteInternetGateway(params: EC2.DeleteInternetGatewayRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified Internet gateway. You must detach the Internet gateway from the VPC before you can delete it.
   */
   ...
   */
  deleteKeyPair(params: EC2.DeleteKeyPairRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified key pair, by removing the public key from Amazon EC2.
   */
   ...
   */
  deleteNatGateway(params: EC2.DeleteNatGatewayRequest, callback?: (err: AWSError, data: EC2.DeleteNatGatewayResult) => void): Request<EC2.DeleteNatGatewayResult, AWSError>;
  /**
   * Deletes the specified NAT gateway. Deleting a NAT gateway disassociates its Elastic IP address, but does not release the address from your account. Deleting a NAT gateway does not delete any NAT gateway routes in your route tables.
   */
  deleteNatGateway(callback?: (err: AWSError, data: EC2.DeleteNatGatewayResult) => void): Request<EC2.DeleteNatGatewayResult, AWSError>;
  /**
   * Deletes the specified network ACL. You can't delete the ACL if it's associated with any subnets. You can't delete the default network ACL.
   */
  deleteNetworkAcl(params: EC2.DeleteNetworkAclRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified network ACL. You can't delete the ACL if it's associated with any subnets. You can't delete the default network ACL.
   */
   ...
   */
  deleteNetworkAclEntry(params: EC2.DeleteNetworkAclEntryRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified ingress or egress entry (rule) from the specified network ACL.
   */
   ...
   */
  deleteNetworkInterface(params: EC2.DeleteNetworkInterfaceRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified network interface. You must detach the network interface before you can delete it.
   */
   ...
   */
  deletePlacementGroup(params: EC2.DeletePlacementGroupRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified placement group. You must terminate all instances in the placement group before you can delete the placement group. For more information about placement groups and cluster instances, see Cluster Instances in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  deleteRoute(params: EC2.DeleteRouteRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified route from the specified route table.
   */
   ...
   */
  deleteRouteTable(params: EC2.DeleteRouteTableRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified route table. You must disassociate the route table from any subnets before you can delete it. You can't delete the main route table.
   */
   ...
   */
  deleteSecurityGroup(params: EC2.DeleteSecurityGroupRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes a security group. If you attempt to delete a security group that is associated with an instance, or is referenced by another security group, the operation fails with InvalidGroup.InUse in EC2-Classic or DependencyViolation in EC2-VPC.
   */
   ...
   */
  deleteSnapshot(params: EC2.DeleteSnapshotRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified snapshot. When you make periodic snapshots of a volume, the snapshots are incremental, and only the blocks on the device that have changed since your last snapshot are saved in the new snapshot. When you delete a snapshot, only the data not needed for any other snapshot is removed. So regardless of which prior snapshots have been deleted, all active snapshots will have access to all the information needed to restore the volume. You cannot delete a snapshot of the root device of an EBS volume used by a registered AMI. You must first de-register the AMI before you can delete the snapshot. For more information, see Deleting an Amazon EBS Snapshot in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  deleteSpotDatafeedSubscription(params: EC2.DeleteSpotDatafeedSubscriptionRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the data feed for Spot instances.
   */
   ...
   */
  deleteSubnet(params: EC2.DeleteSubnetRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified subnet. You must terminate all running instances in the subnet before you can delete the subnet.
   */
   ...
   */
  deleteTags(params: EC2.DeleteTagsRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified set of tags from the specified set of resources. This call is designed to follow a DescribeTags request. For more information about tags, see Tagging Your Resources in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  deleteVolume(params: EC2.DeleteVolumeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified EBS volume. The volume must be in the available state (not attached to an instance).  The volume may remain in the deleting state for several minutes.  For more information, see Deleting an Amazon EBS Volume in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  deleteVpc(params: EC2.DeleteVpcRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified VPC. You must detach or delete all gateways and resources that are associated with the VPC before you can delete it. For example, you must terminate all instances running in the VPC, delete all security groups associated with the VPC (except the default one), delete all route tables associated with the VPC (except the default one), and so on.
   */
   ...
   */
  deleteVpcEndpoints(params: EC2.DeleteVpcEndpointsRequest, callback?: (err: AWSError, data: EC2.DeleteVpcEndpointsResult) => void): Request<EC2.DeleteVpcEndpointsResult, AWSError>;
  /**
   * Deletes one or more specified VPC endpoints. Deleting the endpoint also deletes the endpoint routes in the route tables that were associated with the endpoint.
   */
  deleteVpcEndpoints(callback?: (err: AWSError, data: EC2.DeleteVpcEndpointsResult) => void): Request<EC2.DeleteVpcEndpointsResult, AWSError>;
  /**
   * Deletes a VPC peering connection. Either the owner of the requester VPC or the owner of the peer VPC can delete the VPC peering connection if it's in the active state. The owner of the requester VPC can delete a VPC peering connection in the pending-acceptance state. 
   */
  deleteVpcPeeringConnection(params: EC2.DeleteVpcPeeringConnectionRequest, callback?: (err: AWSError, data: EC2.DeleteVpcPeeringConnectionResult) => void): Request<EC2.DeleteVpcPeeringConnectionResult, AWSError>;
  /**
   * Deletes a VPC peering connection. Either the owner of the requester VPC or the owner of the peer VPC can delete the VPC peering connection if it's in the active state. The owner of the requester VPC can delete a VPC peering connection in the pending-acceptance state. 
   */
  deleteVpcPeeringConnection(callback?: (err: AWSError, data: EC2.DeleteVpcPeeringConnectionResult) => void): Request<EC2.DeleteVpcPeeringConnectionResult, AWSError>;
  /**
   * Deletes the specified VPN connection. If you're deleting the VPC and its associated components, we recommend that you detach the virtual private gateway from the VPC and delete the VPC before deleting the VPN connection. If you believe that the tunnel credentials for your VPN connection have been compromised, you can delete the VPN connection and create a new one that has new keys, without needing to delete the VPC or virtual private gateway. If you create a new VPN connection, you must reconfigure the customer gateway using the new configuration information returned with the new VPN connection ID.
   */
  deleteVpnConnection(params: EC2.DeleteVpnConnectionRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified VPN connection. If you're deleting the VPC and its associated components, we recommend that you detach the virtual private gateway from the VPC and delete the VPC before deleting the VPN connection. If you believe that the tunnel credentials for your VPN connection have been compromised, you can delete the VPN connection and create a new one that has new keys, without needing to delete the VPC or virtual private gateway. If you create a new VPN connection, you must reconfigure the customer gateway using the new configuration information returned with the new VPN connection ID.
   */
   ...
   */
  deleteVpnConnectionRoute(params: EC2.DeleteVpnConnectionRouteRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified static route associated with a VPN connection between an existing virtual private gateway and a VPN customer gateway. The static route allows traffic to be routed from the virtual private gateway to the VPN customer gateway.
   */
   ...
   */
  deleteVpnGateway(params: EC2.DeleteVpnGatewayRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified virtual private gateway. We recommend that before you delete a virtual private gateway, you detach it from the VPC and delete the VPN connection. Note that you don't need to delete the virtual private gateway if you plan to delete and recreate the VPN connection between your VPC and your network.
   */
   ...
   */
  deregisterImage(params: EC2.DeregisterImageRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deregisters the specified AMI. After you deregister an AMI, it can't be used to launch new instances. This command does not delete the AMI.
   */
   ...
   */
  describeAccountAttributes(params: EC2.DescribeAccountAttributesRequest, callback?: (err: AWSError, data: EC2.DescribeAccountAttributesResult) => void): Request<EC2.DescribeAccountAttributesResult, AWSError>;
  /**
   * Describes attributes of your AWS account. The following are the supported account attributes:    supported-platforms: Indicates whether your account can launch instances into EC2-Classic and EC2-VPC, or only into EC2-VPC.    default-vpc: The ID of the default VPC for your account, or none.    max-instances: The maximum number of On-Demand instances that you can run.    vpc-max-security-groups-per-interface: The maximum number of security groups that you can assign to a network interface.    max-elastic-ips: The maximum number of Elastic IP addresses that you can allocate for use with EC2-Classic.     vpc-max-elastic-ips: The maximum number of Elastic IP addresses that you can allocate for use with EC2-VPC.  
   */
  describeAccountAttributes(callback?: (err: AWSError, data: EC2.DescribeAccountAttributesResult) => void): Request<EC2.DescribeAccountAttributesResult, AWSError>;
  /**
   ...
   */
  describeAddresses(params: EC2.DescribeAddressesRequest, callback?: (err: AWSError, data: EC2.DescribeAddressesResult) => void): Request<EC2.DescribeAddressesResult, AWSError>;
  /**
   * Describes one or more of your Elastic IP addresses. An Elastic IP address is for use in either the EC2-Classic platform or in a VPC. For more information, see Elastic IP Addresses in the Amazon Elastic Compute Cloud User Guide.
   */
  describeAddresses(callback?: (err: AWSError, data: EC2.DescribeAddressesResult) => void): Request<EC2.DescribeAddressesResult, AWSError>;
  /**
   ...
   */
  describeAvailabilityZones(params: EC2.DescribeAvailabilityZonesRequest, callback?: (err: AWSError, data: EC2.DescribeAvailabilityZonesResult) => void): Request<EC2.DescribeAvailabilityZonesResult, AWSError>;
  /**
   * Describes one or more of the Availability Zones that are available to you. The results include zones only for the region you're currently using. If there is an event impacting an Availability Zone, you can use this request to view the state and any provided message for that Availability Zone. For more information, see Regions and Availability Zones in the Amazon Elastic Compute Cloud User Guide.
   */
  describeAvailabilityZones(callback?: (err: AWSError, data: EC2.DescribeAvailabilityZonesResult) => void): Request<EC2.DescribeAvailabilityZonesResult, AWSError>;
  /**
   ...
   */
  describeBundleTasks(params: EC2.DescribeBundleTasksRequest, callback?: (err: AWSError, data: EC2.DescribeBundleTasksResult) => void): Request<EC2.DescribeBundleTasksResult, AWSError>;
  /**
   * Describes one or more of your bundling tasks.  Completed bundle tasks are listed for only a limited time. If your bundle task is no longer in the list, you can still register an AMI from it. Just use RegisterImage with the Amazon S3 bucket name and image manifest name you provided to the bundle task. 
   */
  describeBundleTasks(callback?: (err: AWSError, data: EC2.DescribeBundleTasksResult) => void): Request<EC2.DescribeBundleTasksResult, AWSError>;
  /**
   * Describes one or more of your linked EC2-Classic instances. This request only returns information about EC2-Classic instances linked to a VPC through ClassicLink; you cannot use this request to return information about other instances.
   */
  describeClassicLinkInstances(params: EC2.DescribeClassicLinkInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeClassicLinkInstancesResult) => void): Request<EC2.DescribeClassicLinkInstancesResult, AWSError>;
  /**
   * Describes one or more of your linked EC2-Classic instances. This request only returns information about EC2-Classic instances linked to a VPC through ClassicLink; you cannot use this request to return information about other instances.
   */
  describeClassicLinkInstances(callback?: (err: AWSError, data: EC2.DescribeClassicLinkInstancesResult) => void): Request<EC2.DescribeClassicLinkInstancesResult, AWSError>;
  /**
   ...
   */
  describeConversionTasks(params: EC2.DescribeConversionTasksRequest, callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   * Describes one or more of your conversion tasks. For more information, see the VM Import/Export User Guide. For information about the import manifest referenced by this API action, see VM Import Manifest.
   */
  describeConversionTasks(callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   ...
   */
  describeCustomerGateways(params: EC2.DescribeCustomerGatewaysRequest, callback?: (err: AWSError, data: EC2.DescribeCustomerGatewaysResult) => void): Request<EC2.DescribeCustomerGatewaysResult, AWSError>;
  /**
   * Describes one or more of your VPN customer gateways. For more information about VPN customer gateways, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  describeCustomerGateways(callback?: (err: AWSError, data: EC2.DescribeCustomerGatewaysResult) => void): Request<EC2.DescribeCustomerGatewaysResult, AWSError>;
  /**
   ...
   */
  describeDhcpOptions(params: EC2.DescribeDhcpOptionsRequest, callback?: (err: AWSError, data: EC2.DescribeDhcpOptionsResult) => void): Request<EC2.DescribeDhcpOptionsResult, AWSError>;
  /**
   * Describes one or more of your DHCP options sets. For more information about DHCP options sets, see DHCP Options Sets in the Amazon Virtual Private Cloud User Guide.
   */
  describeDhcpOptions(callback?: (err: AWSError, data: EC2.DescribeDhcpOptionsResult) => void): Request<EC2.DescribeDhcpOptionsResult, AWSError>;
  /**
   * Describes one or more of your export tasks.
   */
  describeExportTasks(params: EC2.DescribeExportTasksRequest, callback?: (err: AWSError, data: EC2.DescribeExportTasksResult) => void): Request<EC2.DescribeExportTasksResult, AWSError>;
  /**
   * Describes one or more of your export tasks.
   */
  describeExportTasks(callback?: (err: AWSError, data: EC2.DescribeExportTasksResult) => void): Request<EC2.DescribeExportTasksResult, AWSError>;
  /**
   * Describes one or more flow logs. To view the information in your flow logs (the log streams for the network interfaces), you must use the CloudWatch Logs console or the CloudWatch Logs API.
   */
  describeFlowLogs(params: EC2.DescribeFlowLogsRequest, callback?: (err: AWSError, data: EC2.DescribeFlowLogsResult) => void): Request<EC2.DescribeFlowLogsResult, AWSError>;
  /**
   * Describes one or more flow logs. To view the information in your flow logs (the log streams for the network interfaces), you must use the CloudWatch Logs console or the CloudWatch Logs API.
   */
  describeFlowLogs(callback?: (err: AWSError, data: EC2.DescribeFlowLogsResult) => void): Request<EC2.DescribeFlowLogsResult, AWSError>;
  /**
   ...
   */
  describeHostReservationOfferings(params: EC2.DescribeHostReservationOfferingsRequest, callback?: (err: AWSError, data: EC2.DescribeHostReservationOfferingsResult) => void): Request<EC2.DescribeHostReservationOfferingsResult, AWSError>;
  /**
   * Describes the Dedicated Host Reservations that are available to purchase. The results describe all the Dedicated Host Reservation offerings, including offerings that may not match the instance family and region of your Dedicated Hosts. When purchasing an offering, ensure that the the instance family and region of the offering matches that of the Dedicated Host/s it will be associated with. For an overview of supported instance types, see Dedicated Hosts Overview in the Amazon Elastic Compute Cloud User Guide. 
   */
  describeHostReservationOfferings(callback?: (err: AWSError, data: EC2.DescribeHostReservationOfferingsResult) => void): Request<EC2.DescribeHostReservationOfferingsResult, AWSError>;
  /**
   * Describes Dedicated Host Reservations which are associated with Dedicated Hosts in your account.
   */
  describeHostReservations(params: EC2.DescribeHostReservationsRequest, callback?: (err: AWSError, data: EC2.DescribeHostReservationsResult) => void): Request<EC2.DescribeHostReservationsResult, AWSError>;
  /**
   * Describes Dedicated Host Reservations which are associated with Dedicated Hosts in your account.
   */
  describeHostReservations(callback?: (err: AWSError, data: EC2.DescribeHostReservationsResult) => void): Request<EC2.DescribeHostReservationsResult, AWSError>;
  /**
   ...
   */
  describeHosts(params: EC2.DescribeHostsRequest, callback?: (err: AWSError, data: EC2.DescribeHostsResult) => void): Request<EC2.DescribeHostsResult, AWSError>;
  /**
   * Describes one or more of your Dedicated Hosts. The results describe only the Dedicated Hosts in the region you're currently using. All listed instances consume capacity on your Dedicated Host. Dedicated Hosts that have recently been released will be listed with the state released.
   */
  describeHosts(callback?: (err: AWSError, data: EC2.DescribeHostsResult) => void): Request<EC2.DescribeHostsResult, AWSError>;
  /**
   ...
   */
  describeIdFormat(params: EC2.DescribeIdFormatRequest, callback?: (err: AWSError, data: EC2.DescribeIdFormatResult) => void): Request<EC2.DescribeIdFormatResult, AWSError>;
  /**
   * Describes the ID format settings for your resources on a per-region basis, for example, to view which resource types are enabled for longer IDs. This request only returns information about resource types whose ID formats can be modified; it does not return information about other resource types. The following resource types support longer IDs: instance | reservation | snapshot | volume.  These settings apply to the IAM user who makes the request; they do not apply to the entire AWS account. By default, an IAM user defaults to the same settings as the root user, unless they explicitly override the settings by running the ModifyIdFormat command. Resources created with longer IDs are visible to all IAM users, regardless of these settings and provided that they have permission to use the relevant Describe command for the resource type.
   */
  describeIdFormat(callback?: (err: AWSError, data: EC2.DescribeIdFormatResult) => void): Request<EC2.DescribeIdFormatResult, AWSError>;
  /**
   ...
   */
  describeIdentityIdFormat(params: EC2.DescribeIdentityIdFormatRequest, callback?: (err: AWSError, data: EC2.DescribeIdentityIdFormatResult) => void): Request<EC2.DescribeIdentityIdFormatResult, AWSError>;
  /**
   * Describes the ID format settings for resources for the specified IAM user, IAM role, or root user. For example, you can view the resource types that are enabled for longer IDs. This request only returns information about resource types whose ID formats can be modified; it does not return information about other resource types. For more information, see Resource IDs in the Amazon Elastic Compute Cloud User Guide.  The following resource types support longer IDs: instance | reservation | snapshot | volume.  These settings apply to the principal specified in the request. They do not apply to the principal that makes the request.
   */
  describeIdentityIdFormat(callback?: (err: AWSError, data: EC2.DescribeIdentityIdFormatResult) => void): Request<EC2.DescribeIdentityIdFormatResult, AWSError>;
  /**
   * Describes the specified attribute of the specified AMI. You can specify only one attribute at a time.
   */
  describeImageAttribute(params: EC2.DescribeImageAttributeRequest, callback?: (err: AWSError, data: EC2.ImageAttribute) => void): Request<EC2.ImageAttribute, AWSError>;
  /**
   * Describes the specified attribute of the specified AMI. You can specify only one attribute at a time.
   */
  describeImageAttribute(callback?: (err: AWSError, data: EC2.ImageAttribute) => void): Request<EC2.ImageAttribute, AWSError>;
  /**
   ...
   */
  describeImages(params: EC2.DescribeImagesRequest, callback?: (err: AWSError, data: EC2.DescribeImagesResult) => void): Request<EC2.DescribeImagesResult, AWSError>;
  /**
   * Describes one or more of the images (AMIs, AKIs, and ARIs) available to you. Images available to you include public images, private images that you own, and private images owned by other AWS accounts but for which you have explicit launch permissions.  Deregistered images are included in the returned results for an unspecified interval after deregistration. 
   */
  describeImages(callback?: (err: AWSError, data: EC2.DescribeImagesResult) => void): Request<EC2.DescribeImagesResult, AWSError>;
  /**
   * Displays details about an import virtual machine or import snapshot tasks that are already created.
   */
  describeImportImageTasks(params: EC2.DescribeImportImageTasksRequest, callback?: (err: AWSError, data: EC2.DescribeImportImageTasksResult) => void): Request<EC2.DescribeImportImageTasksResult, AWSError>;
  /**
   * Displays details about an import virtual machine or import snapshot tasks that are already created.
   */
  describeImportImageTasks(callback?: (err: AWSError, data: EC2.DescribeImportImageTasksResult) => void): Request<EC2.DescribeImportImageTasksResult, AWSError>;
  /**
   * Describes your import snapshot tasks.
   */
  describeImportSnapshotTasks(params: EC2.DescribeImportSnapshotTasksRequest, callback?: (err: AWSError, data: EC2.DescribeImportSnapshotTasksResult) => void): Request<EC2.DescribeImportSnapshotTasksResult, AWSError>;
  /**
   * Describes your import snapshot tasks.
   */
  describeImportSnapshotTasks(callback?: (err: AWSError, data: EC2.DescribeImportSnapshotTasksResult) => void): Request<EC2.DescribeImportSnapshotTasksResult, AWSError>;
  /**
   * Describes the specified attribute of the specified instance. You can specify only one attribute at a time. Valid attribute values are: instanceType | kernel | ramdisk | userData | disableApiTermination | instanceInitiatedShutdownBehavior | rootDeviceName | blockDeviceMapping | productCodes | sourceDestCheck | groupSet | ebsOptimized | sriovNetSupport 
   */
  describeInstanceAttribute(params: EC2.DescribeInstanceAttributeRequest, callback?: (err: AWSError, data: EC2.InstanceAttribute) => void): Request<EC2.InstanceAttribute, AWSError>;
  /**
   * Describes the specified attribute of the specified instance. You can specify only one attribute at a time. Valid attribute values are: instanceType | kernel | ramdisk | userData | disableApiTermination | instanceInitiatedShutdownBehavior | rootDeviceName | blockDeviceMapping | productCodes | sourceDestCheck | groupSet | ebsOptimized | sriovNetSupport 
   */
  describeInstanceAttribute(callback?: (err: AWSError, data: EC2.InstanceAttribute) => void): Request<EC2.InstanceAttribute, AWSError>;
  /**
   ...
   */
  describeInstanceStatus(params: EC2.DescribeInstanceStatusRequest, callback?: (err: AWSError, data: EC2.DescribeInstanceStatusResult) => void): Request<EC2.DescribeInstanceStatusResult, AWSError>;
  /**
   * Describes the status of one or more instances. By default, only running instances are described, unless specified otherwise. Instance status includes the following components:    Status checks - Amazon EC2 performs status checks on running EC2 instances to identify hardware and software issues. For more information, see Status Checks for Your Instances and Troubleshooting Instances with Failed Status Checks in the Amazon Elastic Compute Cloud User Guide.    Scheduled events - Amazon EC2 can schedule events (such as reboot, stop, or terminate) for your instances related to hardware issues, software updates, or system maintenance. For more information, see Scheduled Events for Your Instances in the Amazon Elastic Compute Cloud User Guide.    Instance state - You can manage your instances from the moment you launch them through their termination. For more information, see Instance Lifecycle in the Amazon Elastic Compute Cloud User Guide.  
   */
  describeInstanceStatus(callback?: (err: AWSError, data: EC2.DescribeInstanceStatusResult) => void): Request<EC2.DescribeInstanceStatusResult, AWSError>;
  /**
   ...
   */
  describeInstances(params: EC2.DescribeInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   * Describes one or more of your instances. If you specify one or more instance IDs, Amazon EC2 returns information for those instances. If you do not specify instance IDs, Amazon EC2 returns information for all relevant instances. If you specify an instance ID that is not valid, an error is returned. If you specify an instance that you do not own, it is not included in the returned results. Recently terminated instances might appear in the returned results. This interval is usually less than one hour. If you describe instances in the rare case where an Availability Zone is experiencing a service disruption and you specify instance IDs that are in the affected zone, or do not specify any instance IDs at all, the call fails. If you describe instances and specify only instance IDs that are in an unaffected zone, the call works normally.
   */
  describeInstances(callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   * Describes one or more of your Internet gateways.
   */
  describeInternetGateways(params: EC2.DescribeInternetGatewaysRequest, callback?: (err: AWSError, data: EC2.DescribeInternetGatewaysResult) => void): Request<EC2.DescribeInternetGatewaysResult, AWSError>;
  /**
   * Describes one or more of your Internet gateways.
   */
  describeInternetGateways(callback?: (err: AWSError, data: EC2.DescribeInternetGatewaysResult) => void): Request<EC2.DescribeInternetGatewaysResult, AWSError>;
  /**
   ...
   */
  describeKeyPairs(params: EC2.DescribeKeyPairsRequest, callback?: (err: AWSError, data: EC2.DescribeKeyPairsResult) => void): Request<EC2.DescribeKeyPairsResult, AWSError>;
  /**
   * Describes one or more of your key pairs. For more information about key pairs, see Key Pairs in the Amazon Elastic Compute Cloud User Guide.
   */
  describeKeyPairs(callback?: (err: AWSError, data: EC2.DescribeKeyPairsResult) => void): Request<EC2.DescribeKeyPairsResult, AWSError>;
  /**
   * Describes your Elastic IP addresses that are being moved to the EC2-VPC platform, or that are being restored to the EC2-Classic platform. This request does not return information about any other Elastic IP addresses in your account.
   */
  describeMovingAddresses(params: EC2.DescribeMovingAddressesRequest, callback?: (err: AWSError, data: EC2.DescribeMovingAddressesResult) => void): Request<EC2.DescribeMovingAddressesResult, AWSError>;
  /**
   * Describes your Elastic IP addresses that are being moved to the EC2-VPC platform, or that are being restored to the EC2-Classic platform. This request does not return information about any other Elastic IP addresses in your account.
   */
  describeMovingAddresses(callback?: (err: AWSError, data: EC2.DescribeMovingAddressesResult) => void): Request<EC2.DescribeMovingAddressesResult, AWSError>;
  /**
   * Describes one or more of the your NAT gateways.
   */
  describeNatGateways(params: EC2.DescribeNatGatewaysRequest, callback?: (err: AWSError, data: EC2.DescribeNatGatewaysResult) => void): Request<EC2.DescribeNatGatewaysResult, AWSError>;
  /**
   * Describes one or more of the your NAT gateways.
   */
  describeNatGateways(callback?: (err: AWSError, data: EC2.DescribeNatGatewaysResult) => void): Request<EC2.DescribeNatGatewaysResult, AWSError>;
  /**
   ...
   */
  describeNetworkAcls(params: EC2.DescribeNetworkAclsRequest, callback?: (err: AWSError, data: EC2.DescribeNetworkAclsResult) => void): Request<EC2.DescribeNetworkAclsResult, AWSError>;
  /**
   * Describes one or more of your network ACLs. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
  describeNetworkAcls(callback?: (err: AWSError, data: EC2.DescribeNetworkAclsResult) => void): Request<EC2.DescribeNetworkAclsResult, AWSError>;
  /**
   * Describes a network interface attribute. You can specify only one attribute at a time.
   */
  describeNetworkInterfaceAttribute(params: EC2.DescribeNetworkInterfaceAttributeRequest, callback?: (err: AWSError, data: EC2.DescribeNetworkInterfaceAttributeResult) => void): Request<EC2.DescribeNetworkInterfaceAttributeResult, AWSError>;
  /**
   * Describes a network interface attribute. You can specify only one attribute at a time.
   */
  describeNetworkInterfaceAttribute(callback?: (err: AWSError, data: EC2.DescribeNetworkInterfaceAttributeResult) => void): Request<EC2.DescribeNetworkInterfaceAttributeResult, AWSError>;
  /**
   * Describes one or more of your network interfaces.
   */
  describeNetworkInterfaces(params: EC2.DescribeNetworkInterfacesRequest, callback?: (err: AWSError, data: EC2.DescribeNetworkInterfacesResult) => void): Request<EC2.DescribeNetworkInterfacesResult, AWSError>;
  /**
   * Describes one or more of your network interfaces.
   */
  describeNetworkInterfaces(callback?: (err: AWSError, data: EC2.DescribeNetworkInterfacesResult) => void): Request<EC2.DescribeNetworkInterfacesResult, AWSError>;
  /**
   * Describes one or more of your placement groups. For more information about placement groups and cluster instances, see Cluster Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  describePlacementGroups(params: EC2.DescribePlacementGroupsRequest, callback?: (err: AWSError, data: EC2.DescribePlacementGroupsResult) => void): Request<EC2.DescribePlacementGroupsResult, AWSError>;
  /**
   * Describes one or more of your placement groups. For more information about placement groups and cluster instances, see Cluster Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  describePlacementGroups(callback?: (err: AWSError, data: EC2.DescribePlacementGroupsResult) => void): Request<EC2.DescribePlacementGroupsResult, AWSError>;
  /**
   * Describes available AWS services in a prefix list format, which includes the prefix list name and prefix list ID of the service and the IP address range for the service. A prefix list ID is required for creating an outbound security group rule that allows traffic from a VPC to access an AWS service through a VPC endpoint.
   */
  describePrefixLists(params: EC2.DescribePrefixListsRequest, callback?: (err: AWSError, data: EC2.DescribePrefixListsResult) => void): Request<EC2.DescribePrefixListsResult, AWSError>;
  /**
   * Describes available AWS services in a prefix list format, which includes the prefix list name and prefix list ID of the service and the IP address range for the service. A prefix list ID is required for creating an outbound security group rule that allows traffic from a VPC to access an AWS service through a VPC endpoint.
   */
  describePrefixLists(callback?: (err: AWSError, data: EC2.DescribePrefixListsResult) => void): Request<EC2.DescribePrefixListsResult, AWSError>;
  /**
   ...
   */
  describeRegions(params: EC2.DescribeRegionsRequest, callback?: (err: AWSError, data: EC2.DescribeRegionsResult) => void): Request<EC2.DescribeRegionsResult, AWSError>;
  /**
   * Describes one or more regions that are currently available to you. For a list of the regions supported by Amazon EC2, see Regions and Endpoints.
   */
  describeRegions(callback?: (err: AWSError, data: EC2.DescribeRegionsResult) => void): Request<EC2.DescribeRegionsResult, AWSError>;
  /**
   ...
   */
  describeReservedInstances(params: EC2.DescribeReservedInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeReservedInstancesResult) => void): Request<EC2.DescribeReservedInstancesResult, AWSError>;
  /**
   * Describes one or more of the Reserved Instances that you purchased. For more information about Reserved Instances, see Reserved Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  describeReservedInstances(callback?: (err: AWSError, data: EC2.DescribeReservedInstancesResult) => void): Request<EC2.DescribeReservedInstancesResult, AWSError>;
  /**
   ...
   */
  describeReservedInstancesListings(params: EC2.DescribeReservedInstancesListingsRequest, callback?: (err: AWSError, data: EC2.DescribeReservedInstancesListingsResult) => void): Request<EC2.DescribeReservedInstancesListingsResult, AWSError>;
  /**
   * Describes your account's Reserved Instance listings in the Reserved Instance Marketplace. The Reserved Instance Marketplace matches sellers who want to resell Reserved Instance capacity that they no longer need with buyers who want to purchase additional capacity. Reserved Instances bought and sold through the Reserved Instance Marketplace work like any other Reserved Instances. As a seller, you choose to list some or all of your Reserved Instances, and you specify the upfront price to receive for them. Your Reserved Instances are then listed in the Reserved Instance Marketplace and are available for purchase. As a buyer, you specify the configuration of the Reserved Instance to purchase, and the Marketplace matches what you're searching for with what's available. The Marketplace first sells the lowest priced Reserved Instances to you, and continues to sell available Reserved Instance listings to you until your demand is met. You are charged based on the total price of all of the listings that you purchase. For more information, see Reserved Instance Marketplace in the Amazon Elastic Compute Cloud User Guide.
   */
  describeReservedInstancesListings(callback?: (err: AWSError, data: EC2.DescribeReservedInstancesListingsResult) => void): Request<EC2.DescribeReservedInstancesListingsResult, AWSError>;
  /**
   * Describes the modifications made to your Reserved Instances. If no parameter is specified, information about all your Reserved Instances modification requests is returned. If a modification ID is specified, only information about the specific modification is returned. For more information, see Modifying Reserved Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  describeReservedInstancesModifications(params: EC2.DescribeReservedInstancesModificationsRequest, callback?: (err: AWSError, data: EC2.DescribeReservedInstancesModificationsResult) => void): Request<EC2.DescribeReservedInstancesModificationsResult, AWSError>;
  /**
   * Describes the modifications made to your Reserved Instances. If no parameter is specified, information about all your Reserved Instances modification requests is returned. If a modification ID is specified, only information about the specific modification is returned. For more information, see Modifying Reserved Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  describeReservedInstancesModifications(callback?: (err: AWSError, data: EC2.DescribeReservedInstancesModificationsResult) => void): Request<EC2.DescribeReservedInstancesModificationsResult, AWSError>;
  /**
   * Describes Reserved Instance offerings that are available for purchase. With Reserved Instances, you purchase the right to launch instances for a period of time. During that time period, you do not receive insufficient capacity errors, and you pay a lower usage rate than the rate charged for On-Demand instances for the actual time used. If you have listed your own Reserved Instances for sale in the Reserved Instance Marketplace, they will be excluded from these results. This is to ensure that you do not purchase your own Reserved Instances. For more information, see Reserved Instance Marketplace in the Amazon Elastic Compute Cloud User Guide.
   */
  describeReservedInstancesOfferings(params: EC2.DescribeReservedInstancesOfferingsRequest, callback?: (err: AWSError, data: EC2.DescribeReservedInstancesOfferingsResult) => void): Request<EC2.DescribeReservedInstancesOfferingsResult, AWSError>;
  /**
   * Describes Reserved Instance offerings that are available for purchase. With Reserved Instances, you purchase the right to launch instances for a period of time. During that time period, you do not receive insufficient capacity errors, and you pay a lower usage rate than the rate charged for On-Demand instances for the actual time used. If you have listed your own Reserved Instances for sale in the Reserved Instance Marketplace, they will be excluded from these results. This is to ensure that you do not purchase your own Reserved Instances. For more information, see Reserved Instance Marketplace in the Amazon Elastic Compute Cloud User Guide.
   */
  describeReservedInstancesOfferings(callback?: (err: AWSError, data: EC2.DescribeReservedInstancesOfferingsResult) => void): Request<EC2.DescribeReservedInstancesOfferingsResult, AWSError>;
  /**
   ...
   */
  describeRouteTables(params: EC2.DescribeRouteTablesRequest, callback?: (err: AWSError, data: EC2.DescribeRouteTablesResult) => void): Request<EC2.DescribeRouteTablesResult, AWSError>;
  /**
   * Describes one or more of your route tables. Each subnet in your VPC must be associated with a route table. If a subnet is not explicitly associated with any route table, it is implicitly associated with the main route table. This command does not return the subnet ID for implicit associations. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide.
   */
  describeRouteTables(callback?: (err: AWSError, data: EC2.DescribeRouteTablesResult) => void): Request<EC2.DescribeRouteTablesResult, AWSError>;
  /**
   ...
   */
  describeScheduledInstanceAvailability(params: EC2.DescribeScheduledInstanceAvailabilityRequest, callback?: (err: AWSError, data: EC2.DescribeScheduledInstanceAvailabilityResult) => void): Request<EC2.DescribeScheduledInstanceAvailabilityResult, AWSError>;
  /**
   * Finds available schedules that meet the specified criteria. You can search for an available schedule no more than 3 months in advance. You must meet the minimum required duration of 1,200 hours per year. For example, the minimum daily schedule is 4 hours, the minimum weekly schedule is 24 hours, and the minimum monthly schedule is 100 hours. After you find a schedule that meets your needs, call PurchaseScheduledInstances to purchase Scheduled Instances with that schedule.
   */
  describeScheduledInstanceAvailability(callback?: (err: AWSError, data: EC2.DescribeScheduledInstanceAvailabilityResult) => void): Request<EC2.DescribeScheduledInstanceAvailabilityResult, AWSError>;
  /**
   * Describes one or more of your Scheduled Instances.
   */
  describeScheduledInstances(params: EC2.DescribeScheduledInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeScheduledInstancesResult) => void): Request<EC2.DescribeScheduledInstancesResult, AWSError>;
  /**
   * Describes one or more of your Scheduled Instances.
   */
  describeScheduledInstances(callback?: (err: AWSError, data: EC2.DescribeScheduledInstancesResult) => void): Request<EC2.DescribeScheduledInstancesResult, AWSError>;
  /**
   * [EC2-VPC only] Describes the VPCs on the other side of a VPC peering connection that are referencing the security groups you've specified in this request.
   */
  describeSecurityGroupReferences(params: EC2.DescribeSecurityGroupReferencesRequest, callback?: (err: AWSError, data: EC2.DescribeSecurityGroupReferencesResult) => void): Request<EC2.DescribeSecurityGroupReferencesResult, AWSError>;
  /**
   * [EC2-VPC only] Describes the VPCs on the other side of a VPC peering connection that are referencing the security groups you've specified in this request.
   */
  describeSecurityGroupReferences(callback?: (err: AWSError, data: EC2.DescribeSecurityGroupReferencesResult) => void): Request<EC2.DescribeSecurityGroupReferencesResult, AWSError>;
  /**
   ...
   */
  describeSecurityGroups(params: EC2.DescribeSecurityGroupsRequest, callback?: (err: AWSError, data: EC2.DescribeSecurityGroupsResult) => void): Request<EC2.DescribeSecurityGroupsResult, AWSError>;
  /**
   * Describes one or more of your security groups. A security group is for use with instances either in the EC2-Classic platform or in a specific VPC. For more information, see Amazon EC2 Security Groups in the Amazon Elastic Compute Cloud User Guide and Security Groups for Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  describeSecurityGroups(callback?: (err: AWSError, data: EC2.DescribeSecurityGroupsResult) => void): Request<EC2.DescribeSecurityGroupsResult, AWSError>;
  /**
   ...
   */
  describeSnapshotAttribute(params: EC2.DescribeSnapshotAttributeRequest, callback?: (err: AWSError, data: EC2.DescribeSnapshotAttributeResult) => void): Request<EC2.DescribeSnapshotAttributeResult, AWSError>;
  /**
   * Describes the specified attribute of the specified snapshot. You can specify only one attribute at a time. For more information about EBS snapshots, see Amazon EBS Snapshots in the Amazon Elastic Compute Cloud User Guide.
   */
  describeSnapshotAttribute(callback?: (err: AWSError, data: EC2.DescribeSnapshotAttributeResult) => void): Request<EC2.DescribeSnapshotAttributeResult, AWSError>;
  /**
   ...
   */
  describeSnapshots(params: EC2.DescribeSnapshotsRequest, callback?: (err: AWSError, data: EC2.DescribeSnapshotsResult) => void): Request<EC2.DescribeSnapshotsResult, AWSError>;
  /**
   * Describes one or more of the EBS snapshots available to you. Available snapshots include public snapshots available for any AWS account to launch, private snapshots that you own, and private snapshots owned by another AWS account but for which you've been given explicit create volume permissions. The create volume permissions fall into the following categories:    public: The owner of the snapshot granted create volume permissions for the snapshot to the all group. All AWS accounts have create volume permissions for these snapshots.    explicit: The owner of the snapshot granted create volume permissions to a specific AWS account.    implicit: An AWS account has implicit create volume permissions for all snapshots it owns.   The list of snapshots returned can be modified by specifying snapshot IDs, snapshot owners, or AWS accounts with create volume permissions. If no options are specified, Amazon EC2 returns all snapshots for which you have create volume permissions. If you specify one or more snapshot IDs, only snapshots that have the specified IDs are returned. If you specify an invalid snapshot ID, an error is returned. If you specify a snapshot ID for which you do not have access, it is not included in the returned results. If you specify one or more snapshot owners using the OwnerIds option, only snapshots from the specified owners and for which you have access are returned. The results can include the AWS account IDs of the specified owners, amazon for snapshots owned by Amazon, or self for snapshots that you own. If you specify a list of restorable users, only snapshots with create snapshot permissions for those users are returned. You can specify AWS account IDs (if you own the snapshots), self for snapshots for which you own or have explicit permissions, or all for public snapshots. If you are describing a long list of snapshots, you can paginate the output to make the list more manageable. The MaxResults parameter sets the maximum number of results returned in a single page. If the list of results exceeds your MaxResults value, then that number of results is returned along with a NextToken value that can be passed to a subsequent DescribeSnapshots request to retrieve the remaining results. For more information about EBS snapshots, see Amazon EBS Snapshots in the Amazon Elastic Compute Cloud User Guide.
   */
  describeSnapshots(callback?: (err: AWSError, data: EC2.DescribeSnapshotsResult) => void): Request<EC2.DescribeSnapshotsResult, AWSError>;
  /**
   ...
   */
  describeSpotDatafeedSubscription(params: EC2.DescribeSpotDatafeedSubscriptionRequest, callback?: (err: AWSError, data: EC2.DescribeSpotDatafeedSubscriptionResult) => void): Request<EC2.DescribeSpotDatafeedSubscriptionResult, AWSError>;
  /**
   * Describes the data feed for Spot instances. For more information, see Spot Instance Data Feed in the Amazon Elastic Compute Cloud User Guide.
   */
  describeSpotDatafeedSubscription(callback?: (err: AWSError, data: EC2.DescribeSpotDatafeedSubscriptionResult) => void): Request<EC2.DescribeSpotDatafeedSubscriptionResult, AWSError>;
  /**
   * Describes the running instances for the specified Spot fleet.
   */
  describeSpotFleetInstances(params: EC2.DescribeSpotFleetInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeSpotFleetInstancesResponse) => void): Request<EC2.DescribeSpotFleetInstancesResponse, AWSError>;
  /**
   * Describes the running instances for the specified Spot fleet.
   */
  describeSpotFleetInstances(callback?: (err: AWSError, data: EC2.DescribeSpotFleetInstancesResponse) => void): Request<EC2.DescribeSpotFleetInstancesResponse, AWSError>;
  /**
   ...
   */
  describeSpotFleetRequestHistory(params: EC2.DescribeSpotFleetRequestHistoryRequest, callback?: (err: AWSError, data: EC2.DescribeSpotFleetRequestHistoryResponse) => void): Request<EC2.DescribeSpotFleetRequestHistoryResponse, AWSError>;
  /**
   * Describes the events for the specified Spot fleet request during the specified time. Spot fleet events are delayed by up to 30 seconds before they can be described. This ensures that you can query by the last evaluated time and not miss a recorded event.
   */
  describeSpotFleetRequestHistory(callback?: (err: AWSError, data: EC2.DescribeSpotFleetRequestHistoryResponse) => void): Request<EC2.DescribeSpotFleetRequestHistoryResponse, AWSError>;
  /**
   ...
   */
  describeSpotFleetRequests(params: EC2.DescribeSpotFleetRequestsRequest, callback?: (err: AWSError, data: EC2.DescribeSpotFleetRequestsResponse) => void): Request<EC2.DescribeSpotFleetRequestsResponse, AWSError>;
  /**
   * Describes your Spot fleet requests. Spot fleet requests are deleted 48 hours after they are canceled and their instances are terminated.
   */
  describeSpotFleetRequests(callback?: (err: AWSError, data: EC2.DescribeSpotFleetRequestsResponse) => void): Request<EC2.DescribeSpotFleetRequestsResponse, AWSError>;
  /**
   ...
   */
  describeSpotInstanceRequests(params: EC2.DescribeSpotInstanceRequestsRequest, callback?: (err: AWSError, data: EC2.DescribeSpotInstanceRequestsResult) => void): Request<EC2.DescribeSpotInstanceRequestsResult, AWSError>;
  /**
   * Describes the Spot instance requests that belong to your account. Spot instances are instances that Amazon EC2 launches when the bid price that you specify exceeds the current Spot price. Amazon EC2 periodically sets the Spot price based on available Spot instance capacity and current Spot instance requests. For more information, see Spot Instance Requests in the Amazon Elastic Compute Cloud User Guide. You can use DescribeSpotInstanceRequests to find a running Spot instance by examining the response. If the status of the Spot instance is fulfilled, the instance ID appears in the response and contains the identifier of the instance. Alternatively, you can use DescribeInstances with a filter to look for instances where the instance lifecycle is spot. Spot instance requests are deleted 4 hours after they are canceled and their instances are terminated.
   */
  describeSpotInstanceRequests(callback?: (err: AWSError, data: EC2.DescribeSpotInstanceRequestsResult) => void): Request<EC2.DescribeSpotInstanceRequestsResult, AWSError>;
  /**
   ...
   */
  describeSpotPriceHistory(params: EC2.DescribeSpotPriceHistoryRequest, callback?: (err: AWSError, data: EC2.DescribeSpotPriceHistoryResult) => void): Request<EC2.DescribeSpotPriceHistoryResult, AWSError>;
  /**
   * Describes the Spot price history. The prices returned are listed in chronological order, from the oldest to the most recent, for up to the past 90 days. For more information, see Spot Instance Pricing History in the Amazon Elastic Compute Cloud User Guide. When you specify a start and end time, this operation returns the prices of the instance types within the time range that you specified and the time when the price changed. The price is valid within the time period that you specified; the response merely indicates the last time that the price changed.
   */
  describeSpotPriceHistory(callback?: (err: AWSError, data: EC2.DescribeSpotPriceHistoryResult) => void): Request<EC2.DescribeSpotPriceHistoryResult, AWSError>;
  /**
   * [EC2-VPC only] Describes the stale security group rules for security groups in a specified VPC. Rules are stale when they reference a deleted security group in a peer VPC, or a security group in a peer VPC for which the VPC peering connection has been deleted.
   */
  describeStaleSecurityGroups(params: EC2.DescribeStaleSecurityGroupsRequest, callback?: (err: AWSError, data: EC2.DescribeStaleSecurityGroupsResult) => void): Request<EC2.DescribeStaleSecurityGroupsResult, AWSError>;
  /**
   * [EC2-VPC only] Describes the stale security group rules for security groups in a specified VPC. Rules are stale when they reference a deleted security group in a peer VPC, or a security group in a peer VPC for which the VPC peering connection has been deleted.
   */
  describeStaleSecurityGroups(callback?: (err: AWSError, data: EC2.DescribeStaleSecurityGroupsResult) => void): Request<EC2.DescribeStaleSecurityGroupsResult, AWSError>;
  /**
   ...
   */
  describeSubnets(params: EC2.DescribeSubnetsRequest, callback?: (err: AWSError, data: EC2.DescribeSubnetsResult) => void): Request<EC2.DescribeSubnetsResult, AWSError>;
  /**
   * Describes one or more of your subnets. For more information about subnets, see Your VPC and Subnets in the Amazon Virtual Private Cloud User Guide.
   */
  describeSubnets(callback?: (err: AWSError, data: EC2.DescribeSubnetsResult) => void): Request<EC2.DescribeSubnetsResult, AWSError>;
  /**
   ...
   */
  describeTags(params: EC2.DescribeTagsRequest, callback?: (err: AWSError, data: EC2.DescribeTagsResult) => void): Request<EC2.DescribeTagsResult, AWSError>;
  /**
   * Describes one or more of the tags for your EC2 resources. For more information about tags, see Tagging Your Resources in the Amazon Elastic Compute Cloud User Guide.
   */
  describeTags(callback?: (err: AWSError, data: EC2.DescribeTagsResult) => void): Request<EC2.DescribeTagsResult, AWSError>;
  /**
   ...
   */
  describeVolumeAttribute(params: EC2.DescribeVolumeAttributeRequest, callback?: (err: AWSError, data: EC2.DescribeVolumeAttributeResult) => void): Request<EC2.DescribeVolumeAttributeResult, AWSError>;
  /**
   * Describes the specified attribute of the specified volume. You can specify only one attribute at a time. For more information about EBS volumes, see Amazon EBS Volumes in the Amazon Elastic Compute Cloud User Guide.
   */
  describeVolumeAttribute(callback?: (err: AWSError, data: EC2.DescribeVolumeAttributeResult) => void): Request<EC2.DescribeVolumeAttributeResult, AWSError>;
  /**
   ...
   */
  describeVolumeStatus(params: EC2.DescribeVolumeStatusRequest, callback?: (err: AWSError, data: EC2.DescribeVolumeStatusResult) => void): Request<EC2.DescribeVolumeStatusResult, AWSError>;
  /**
   * Describes the status of the specified volumes. Volume status provides the result of the checks performed on your volumes to determine events that can impair the performance of your volumes. The performance of a volume can be affected if an issue occurs on the volume's underlying host. If the volume's underlying host experiences a power outage or system issue, after the system is restored, there could be data inconsistencies on the volume. Volume events notify you if this occurs. Volume actions notify you if any action needs to be taken in response to the event. The DescribeVolumeStatus operation provides the following information about the specified volumes:  Status: Reflects the current status of the volume. The possible values are ok, impaired , warning, or insufficient-data. If all checks pass, the overall status of the volume is ok. If the check fails, the overall status is impaired. If the status is insufficient-data, then the checks may still be taking place on your volume at the time. We recommend that you retry the request. For more information on volume status, see Monitoring the Status of Your Volumes.  Events: Reflect the cause of a volume status and may require you to take action. For example, if your volume returns an impaired status, then the volume event might be potential-data-inconsistency. This means that your volume has been affected by an issue with the underlying host, has all I/O operations disabled, and may have inconsistent data.  Actions: Reflect the actions you may have to take in response to an event. For example, if the status of the volume is impaired and the volume event shows potential-data-inconsistency, then the action shows enable-volume-io. This means that you may want to enable the I/O operations for the volume by calling the EnableVolumeIO action and then check the volume for data consistency.  Volume status is based on the volume status checks, and does not reflect the volume state. Therefore, volume status does not indicate volumes in the error state (for example, when a volume is incapable of accepting I/O.) 
   */
  describeVolumeStatus(callback?: (err: AWSError, data: EC2.DescribeVolumeStatusResult) => void): Request<EC2.DescribeVolumeStatusResult, AWSError>;
  /**
   ...
   */
  describeVolumes(params: EC2.DescribeVolumesRequest, callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   * Describes the specified EBS volumes. If you are describing a long list of volumes, you can paginate the output to make the list more manageable. The MaxResults parameter sets the maximum number of results returned in a single page. If the list of results exceeds your MaxResults value, then that number of results is returned along with a NextToken value that can be passed to a subsequent DescribeVolumes request to retrieve the remaining results. For more information about EBS volumes, see Amazon EBS Volumes in the Amazon Elastic Compute Cloud User Guide.
   */
  describeVolumes(callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   * Describes the specified attribute of the specified VPC. You can specify only one attribute at a time.
   */
  describeVpcAttribute(params: EC2.DescribeVpcAttributeRequest, callback?: (err: AWSError, data: EC2.DescribeVpcAttributeResult) => void): Request<EC2.DescribeVpcAttributeResult, AWSError>;
  /**
   * Describes the specified attribute of the specified VPC. You can specify only one attribute at a time.
   */
  describeVpcAttribute(callback?: (err: AWSError, data: EC2.DescribeVpcAttributeResult) => void): Request<EC2.DescribeVpcAttributeResult, AWSError>;
  /**
   * Describes the ClassicLink status of one or more VPCs.
   */
  describeVpcClassicLink(params: EC2.DescribeVpcClassicLinkRequest, callback?: (err: AWSError, data: EC2.DescribeVpcClassicLinkResult) => void): Request<EC2.DescribeVpcClassicLinkResult, AWSError>;
  /**
   * Describes the ClassicLink status of one or more VPCs.
   */
  describeVpcClassicLink(callback?: (err: AWSError, data: EC2.DescribeVpcClassicLinkResult) => void): Request<EC2.DescribeVpcClassicLinkResult, AWSError>;
  /**
   ...
   */
  describeVpcClassicLinkDnsSupport(params: EC2.DescribeVpcClassicLinkDnsSupportRequest, callback?: (err: AWSError, data: EC2.DescribeVpcClassicLinkDnsSupportResult) => void): Request<EC2.DescribeVpcClassicLinkDnsSupportResult, AWSError>;
  /**
   * Describes the ClassicLink DNS support status of one or more VPCs. If enabled, the DNS hostname of a linked EC2-Classic instance resolves to its private IP address when addressed from an instance in the VPC to which it's linked. Similarly, the DNS hostname of an instance in a VPC resolves to its private IP address when addressed from a linked EC2-Classic instance. For more information about ClassicLink, see ClassicLink in the Amazon Elastic Compute Cloud User Guide.
   */
  describeVpcClassicLinkDnsSupport(callback?: (err: AWSError, data: EC2.DescribeVpcClassicLinkDnsSupportResult) => void): Request<EC2.DescribeVpcClassicLinkDnsSupportResult, AWSError>;
  /**
   * Describes all supported AWS services that can be specified when creating a VPC endpoint.
   */
  describeVpcEndpointServices(params: EC2.DescribeVpcEndpointServicesRequest, callback?: (err: AWSError, data: EC2.DescribeVpcEndpointServicesResult) => void): Request<EC2.DescribeVpcEndpointServicesResult, AWSError>;
  /**
   * Describes all supported AWS services that can be specified when creating a VPC endpoint.
   */
  describeVpcEndpointServices(callback?: (err: AWSError, data: EC2.DescribeVpcEndpointServicesResult) => void): Request<EC2.DescribeVpcEndpointServicesResult, AWSError>;
  /**
   * Describes one or more of your VPC endpoints.
   */
  describeVpcEndpoints(params: EC2.DescribeVpcEndpointsRequest, callback?: (err: AWSError, data: EC2.DescribeVpcEndpointsResult) => void): Request<EC2.DescribeVpcEndpointsResult, AWSError>;
  /**
   * Describes one or more of your VPC endpoints.
   */
  describeVpcEndpoints(callback?: (err: AWSError, data: EC2.DescribeVpcEndpointsResult) => void): Request<EC2.DescribeVpcEndpointsResult, AWSError>;
  /**
   * Describes one or more of your VPC peering connections.
   */
  describeVpcPeeringConnections(params: EC2.DescribeVpcPeeringConnectionsRequest, callback?: (err: AWSError, data: EC2.DescribeVpcPeeringConnectionsResult) => void): Request<EC2.DescribeVpcPeeringConnectionsResult, AWSError>;
  /**
   * Describes one or more of your VPC peering connections.
   */
  describeVpcPeeringConnections(callback?: (err: AWSError, data: EC2.DescribeVpcPeeringConnectionsResult) => void): Request<EC2.DescribeVpcPeeringConnectionsResult, AWSError>;
  /**
   * Describes one or more of your VPCs.
   */
  describeVpcs(params: EC2.DescribeVpcsRequest, callback?: (err: AWSError, data: EC2.DescribeVpcsResult) => void): Request<EC2.DescribeVpcsResult, AWSError>;
  /**
   * Describes one or more of your VPCs.
   */
  describeVpcs(callback?: (err: AWSError, data: EC2.DescribeVpcsResult) => void): Request<EC2.DescribeVpcsResult, AWSError>;
  /**
   ...
   */
  describeVpnConnections(params: EC2.DescribeVpnConnectionsRequest, callback?: (err: AWSError, data: EC2.DescribeVpnConnectionsResult) => void): Request<EC2.DescribeVpnConnectionsResult, AWSError>;
  /**
   * Describes one or more of your VPN connections. For more information about VPN connections, see Adding a Hardware Virtual Private Gateway to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  describeVpnConnections(callback?: (err: AWSError, data: EC2.DescribeVpnConnectionsResult) => void): Request<EC2.DescribeVpnConnectionsResult, AWSError>;
  /**
   ...
   */
  describeVpnGateways(params: EC2.DescribeVpnGatewaysRequest, callback?: (err: AWSError, data: EC2.DescribeVpnGatewaysResult) => void): Request<EC2.DescribeVpnGatewaysResult, AWSError>;
  /**
   * Describes one or more of your virtual private gateways. For more information about virtual private gateways, see Adding an IPsec Hardware VPN to Your VPC in the Amazon Virtual Private Cloud User Guide.
   */
  describeVpnGateways(callback?: (err: AWSError, data: EC2.DescribeVpnGatewaysResult) => void): Request<EC2.DescribeVpnGatewaysResult, AWSError>;
  /**
   * Unlinks (detaches) a linked EC2-Classic instance from a VPC. After the instance has been unlinked, the VPC security groups are no longer associated with it. An instance is automatically unlinked from a VPC when it's stopped.
   */
  detachClassicLinkVpc(params: EC2.DetachClassicLinkVpcRequest, callback?: (err: AWSError, data: EC2.DetachClassicLinkVpcResult) => void): Request<EC2.DetachClassicLinkVpcResult, AWSError>;
  /**
   * Unlinks (detaches) a linked EC2-Classic instance from a VPC. After the instance has been unlinked, the VPC security groups are no longer associated with it. An instance is automatically unlinked from a VPC when it's stopped.
   */
  detachClassicLinkVpc(callback?: (err: AWSError, data: EC2.DetachClassicLinkVpcResult) => void): Request<EC2.DetachClassicLinkVpcResult, AWSError>;
  /**
   ...
   */
  detachInternetGateway(params: EC2.DetachInternetGatewayRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Detaches an Internet gateway from a VPC, disabling connectivity between the Internet and the VPC. The VPC must not contain any running instances with Elastic IP addresses.
   */
   ...
   */
  detachNetworkInterface(params: EC2.DetachNetworkInterfaceRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Detaches a network interface from an instance.
   */
   ...
   */
  detachVolume(params: EC2.DetachVolumeRequest, callback?: (err: AWSError, data: EC2.VolumeAttachment) => void): Request<EC2.VolumeAttachment, AWSError>;
  /**
   * Detaches an EBS volume from an instance. Make sure to unmount any file systems on the device within your operating system before detaching the volume. Failure to do so can result in the volume becoming stuck in the busy state while detaching. If this happens, detachment can be delayed indefinitely until you unmount the volume, force detachment, reboot the instance, or all three. If an EBS volume is the root device of an instance, it can't be detached while the instance is running. To detach the root volume, stop the instance first. When a volume with an AWS Marketplace product code is detached from an instance, the product code is no longer associated with the instance. For more information, see Detaching an Amazon EBS Volume in the Amazon Elastic Compute Cloud User Guide.
   */
  detachVolume(callback?: (err: AWSError, data: EC2.VolumeAttachment) => void): Request<EC2.VolumeAttachment, AWSError>;
  /**
   ...
   */
  detachVpnGateway(params: EC2.DetachVpnGatewayRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Detaches a virtual private gateway from a VPC. You do this if you're planning to turn off the VPC and not use it anymore. You can confirm a virtual private gateway has been completely detached from a VPC by describing the virtual private gateway (any attachments to the virtual private gateway are also described). You must wait for the attachment's state to switch to detached before you can delete the VPC or attach a different VPC to the virtual private gateway.
   */
   ...
   */
  disableVgwRoutePropagation(params: EC2.DisableVgwRoutePropagationRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Disables a virtual private gateway (VGW) from propagating routes to a specified route table of a VPC.
   */
   ...
   */
  disableVpcClassicLink(params: EC2.DisableVpcClassicLinkRequest, callback?: (err: AWSError, data: EC2.DisableVpcClassicLinkResult) => void): Request<EC2.DisableVpcClassicLinkResult, AWSError>;
  /**
   * Disables ClassicLink for a VPC. You cannot disable ClassicLink for a VPC that has EC2-Classic instances linked to it.
   */
  disableVpcClassicLink(callback?: (err: AWSError, data: EC2.DisableVpcClassicLinkResult) => void): Request<EC2.DisableVpcClassicLinkResult, AWSError>;
  /**
   ...
   */
  disableVpcClassicLinkDnsSupport(params: EC2.DisableVpcClassicLinkDnsSupportRequest, callback?: (err: AWSError, data: EC2.DisableVpcClassicLinkDnsSupportResult) => void): Request<EC2.DisableVpcClassicLinkDnsSupportResult, AWSError>;
  /**
   * Disables ClassicLink DNS support for a VPC. If disabled, DNS hostnames resolve to public IP addresses when addressed between a linked EC2-Classic instance and instances in the VPC to which it's linked. For more information about ClassicLink, see ClassicLink in the Amazon Elastic Compute Cloud User Guide.
   */
  disableVpcClassicLinkDnsSupport(callback?: (err: AWSError, data: EC2.DisableVpcClassicLinkDnsSupportResult) => void): Request<EC2.DisableVpcClassicLinkDnsSupportResult, AWSError>;
  /**
   ...
   */
  disassociateAddress(params: EC2.DisassociateAddressRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Disassociates an Elastic IP address from the instance or network interface it's associated with. An Elastic IP address is for use in either the EC2-Classic platform or in a VPC. For more information, see Elastic IP Addresses in the Amazon Elastic Compute Cloud User Guide. This is an idempotent operation. If you perform the operation more than once, Amazon EC2 doesn't return an error.
   */
   ...
   */
  disassociateRouteTable(params: EC2.DisassociateRouteTableRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Disassociates a subnet from a route table. After you perform this action, the subnet no longer uses the routes in the route table. Instead, it uses the routes in the VPC's main route table. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  enableVgwRoutePropagation(params: EC2.EnableVgwRoutePropagationRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Enables a virtual private gateway (VGW) to propagate routes to the specified route table of a VPC.
   */
   ...
   */
  enableVolumeIO(params: EC2.EnableVolumeIORequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Enables I/O operations for a volume that had I/O operations disabled because the data on the volume was potentially inconsistent.
   */
   ...
   */
  enableVpcClassicLink(params: EC2.EnableVpcClassicLinkRequest, callback?: (err: AWSError, data: EC2.EnableVpcClassicLinkResult) => void): Request<EC2.EnableVpcClassicLinkResult, AWSError>;
  /**
   * Enables a VPC for ClassicLink. You can then link EC2-Classic instances to your ClassicLink-enabled VPC to allow communication over private IP addresses. You cannot enable your VPC for ClassicLink if any of your VPC's route tables have existing routes for address ranges within the 10.0.0.0/8 IP address range, excluding local routes for VPCs in the 10.0.0.0/16 and 10.1.0.0/16 IP address ranges. For more information, see ClassicLink in the Amazon Elastic Compute Cloud User Guide.
   */
  enableVpcClassicLink(callback?: (err: AWSError, data: EC2.EnableVpcClassicLinkResult) => void): Request<EC2.EnableVpcClassicLinkResult, AWSError>;
  /**
   * Enables a VPC to support DNS hostname resolution for ClassicLink. If enabled, the DNS hostname of a linked EC2-Classic instance resolves to its private IP address when addressed from an instance in the VPC to which it's linked. Similarly, the DNS hostname of an instance in a VPC resolves to its private IP address when addressed from a linked EC2-Classic instance. For more information about ClassicLink, see ClassicLink in the Amazon Elastic Compute Cloud User Guide.
   */
  enableVpcClassicLinkDnsSupport(params: EC2.EnableVpcClassicLinkDnsSupportRequest, callback?: (err: AWSError, data: EC2.EnableVpcClassicLinkDnsSupportResult) => void): Request<EC2.EnableVpcClassicLinkDnsSupportResult, AWSError>;
  /**
   * Enables a VPC to support DNS hostname resolution for ClassicLink. If enabled, the DNS hostname of a linked EC2-Classic instance resolves to its private IP address when addressed from an instance in the VPC to which it's linked. Similarly, the DNS hostname of an instance in a VPC resolves to its private IP address when addressed from a linked EC2-Classic instance. For more information about ClassicLink, see ClassicLink in the Amazon Elastic Compute Cloud User Guide.
   */
  enableVpcClassicLinkDnsSupport(callback?: (err: AWSError, data: EC2.EnableVpcClassicLinkDnsSupportResult) => void): Request<EC2.EnableVpcClassicLinkDnsSupportResult, AWSError>;
  /**
   ...
   */
  getConsoleOutput(params: EC2.GetConsoleOutputRequest, callback?: (err: AWSError, data: EC2.GetConsoleOutputResult) => void): Request<EC2.GetConsoleOutputResult, AWSError>;
  /**
   * Gets the console output for the specified instance. Instances do not have a physical monitor through which you can view their console output. They also lack physical controls that allow you to power up, reboot, or shut them down. To allow these actions, we provide them through the Amazon EC2 API and command line interface. Instance console output is buffered and posted shortly after instance boot, reboot, and termination. Amazon EC2 preserves the most recent 64 KB output which is available for at least one hour after the most recent post. For Linux instances, the instance console output displays the exact console output that would normally be displayed on a physical monitor attached to a computer. This output is buffered because the instance produces it and then posts it to a store where the instance's owner can retrieve it. For Windows instances, the instance console output includes output from the EC2Config service.
   */
  getConsoleOutput(callback?: (err: AWSError, data: EC2.GetConsoleOutputResult) => void): Request<EC2.GetConsoleOutputResult, AWSError>;
  /**
   ...
   */
  getConsoleScreenshot(params: EC2.GetConsoleScreenshotRequest, callback?: (err: AWSError, data: EC2.GetConsoleScreenshotResult) => void): Request<EC2.GetConsoleScreenshotResult, AWSError>;
  /**
   * Retrieve a JPG-format screenshot of a running instance to help with troubleshooting. The returned content is Base64-encoded.
   */
  getConsoleScreenshot(callback?: (err: AWSError, data: EC2.GetConsoleScreenshotResult) => void): Request<EC2.GetConsoleScreenshotResult, AWSError>;
  /**
   ...
   */
  getHostReservationPurchasePreview(params: EC2.GetHostReservationPurchasePreviewRequest, callback?: (err: AWSError, data: EC2.GetHostReservationPurchasePreviewResult) => void): Request<EC2.GetHostReservationPurchasePreviewResult, AWSError>;
  /**
   * Preview a reservation purchase with configurations that match those of your Dedicated Host. You must have active Dedicated Hosts in your account before you purchase a reservation. This is a preview of the PurchaseHostReservation action and does not result in the offering being purchased.
   */
  getHostReservationPurchasePreview(callback?: (err: AWSError, data: EC2.GetHostReservationPurchasePreviewResult) => void): Request<EC2.GetHostReservationPurchasePreviewResult, AWSError>;
  /**
   ...
   */
  getPasswordData(params: EC2.GetPasswordDataRequest, callback?: (err: AWSError, data: EC2.GetPasswordDataResult) => void): Request<EC2.GetPasswordDataResult, AWSError>;
  /**
   * Retrieves the encrypted administrator password for an instance running Windows. The Windows password is generated at boot if the EC2Config service plugin, Ec2SetPassword, is enabled. This usually only happens the first time an AMI is launched, and then Ec2SetPassword is automatically disabled. The password is not generated for rebundled AMIs unless Ec2SetPassword is enabled before bundling. The password is encrypted using the key pair that you specified when you launched the instance. You must provide the corresponding key pair file. Password generation and encryption takes a few moments. We recommend that you wait up to 15 minutes after launching an instance before trying to retrieve the generated password.
   */
  getPasswordData(callback?: (err: AWSError, data: EC2.GetPasswordDataResult) => void): Request<EC2.GetPasswordDataResult, AWSError>;
  /**
   ...
   */
  getReservedInstancesExchangeQuote(params: EC2.GetReservedInstancesExchangeQuoteRequest, callback?: (err: AWSError, data: EC2.GetReservedInstancesExchangeQuoteResult) => void): Request<EC2.GetReservedInstancesExchangeQuoteResult, AWSError>;
  /**
   * Returns details about the values and term of your specified Convertible Reserved Instances. When an offering ID is specified it returns information about whether the exchange is valid and can be performed.
   */
  getReservedInstancesExchangeQuote(callback?: (err: AWSError, data: EC2.GetReservedInstancesExchangeQuoteResult) => void): Request<EC2.GetReservedInstancesExchangeQuoteResult, AWSError>;
  /**
   * Import single or multi-volume disk images or EBS snapshots into an Amazon Machine Image (AMI). For more information, see Importing a VM as an Image Using VM Import/Export in the VM Import/Export User Guide.
   */
  importImage(params: EC2.ImportImageRequest, callback?: (err: AWSError, data: EC2.ImportImageResult) => void): Request<EC2.ImportImageResult, AWSError>;
  /**
   * Import single or multi-volume disk images or EBS snapshots into an Amazon Machine Image (AMI). For more information, see Importing a VM as an Image Using VM Import/Export in the VM Import/Export User Guide.
   */
  importImage(callback?: (err: AWSError, data: EC2.ImportImageResult) => void): Request<EC2.ImportImageResult, AWSError>;
  /**
   ...
   */
  importInstance(params: EC2.ImportInstanceRequest, callback?: (err: AWSError, data: EC2.ImportInstanceResult) => void): Request<EC2.ImportInstanceResult, AWSError>;
  /**
   * Creates an import instance task using metadata from the specified disk image. ImportInstance only supports single-volume VMs. To import multi-volume VMs, use ImportImage. For more information, see Importing a Virtual Machine Using the Amazon EC2 CLI. For information about the import manifest referenced by this API action, see VM Import Manifest.
   */
  importInstance(callback?: (err: AWSError, data: EC2.ImportInstanceResult) => void): Request<EC2.ImportInstanceResult, AWSError>;
  /**
   ...
   */
  importKeyPair(params: EC2.ImportKeyPairRequest, callback?: (err: AWSError, data: EC2.ImportKeyPairResult) => void): Request<EC2.ImportKeyPairResult, AWSError>;
  /**
   * Imports the public key from an RSA key pair that you created with a third-party tool. Compare this with CreateKeyPair, in which AWS creates the key pair and gives the keys to you (AWS keeps a copy of the public key). With ImportKeyPair, you create the key pair and give AWS just the public key. The private key is never transferred between you and AWS. For more information about key pairs, see Key Pairs in the Amazon Elastic Compute Cloud User Guide.
   */
  importKeyPair(callback?: (err: AWSError, data: EC2.ImportKeyPairResult) => void): Request<EC2.ImportKeyPairResult, AWSError>;
  /**
   * Imports a disk into an EBS snapshot.
   */
  importSnapshot(params: EC2.ImportSnapshotRequest, callback?: (err: AWSError, data: EC2.ImportSnapshotResult) => void): Request<EC2.ImportSnapshotResult, AWSError>;
  /**
   * Imports a disk into an EBS snapshot.
   */
  importSnapshot(callback?: (err: AWSError, data: EC2.ImportSnapshotResult) => void): Request<EC2.ImportSnapshotResult, AWSError>;
  /**
   ...
   */
  importVolume(params: EC2.ImportVolumeRequest, callback?: (err: AWSError, data: EC2.ImportVolumeResult) => void): Request<EC2.ImportVolumeResult, AWSError>;
  /**
   * Creates an import volume task using metadata from the specified disk image.For more information, see Importing Disks to Amazon EBS. For information about the import manifest referenced by this API action, see VM Import Manifest.
   */
  importVolume(callback?: (err: AWSError, data: EC2.ImportVolumeResult) => void): Request<EC2.ImportVolumeResult, AWSError>;
  /**
   * Modify the auto-placement setting of a Dedicated Host. When auto-placement is enabled, AWS will place instances that you launch with a tenancy of host, but without targeting a specific host ID, onto any available Dedicated Host in your account which has auto-placement enabled. When auto-placement is disabled, you need to provide a host ID if you want the instance to launch onto a specific host. If no host ID is provided, the instance will be launched onto a suitable host which has auto-placement enabled.
   */
  modifyHosts(params: EC2.ModifyHostsRequest, callback?: (err: AWSError, data: EC2.ModifyHostsResult) => void): Request<EC2.ModifyHostsResult, AWSError>;
  /**
   * Modify the auto-placement setting of a Dedicated Host. When auto-placement is enabled, AWS will place instances that you launch with a tenancy of host, but without targeting a specific host ID, onto any available Dedicated Host in your account which has auto-placement enabled. When auto-placement is disabled, you need to provide a host ID if you want the instance to launch onto a specific host. If no host ID is provided, the instance will be launched onto a suitable host which has auto-placement enabled.
   */
  modifyHosts(callback?: (err: AWSError, data: EC2.ModifyHostsResult) => void): Request<EC2.ModifyHostsResult, AWSError>;
  /**
   ...
   */
  modifyIdFormat(params: EC2.ModifyIdFormatRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies the ID format for the specified resource on a per-region basis. You can specify that resources should receive longer IDs (17-character IDs) when they are created. The following resource types support longer IDs: instance | reservation | snapshot | volume. This setting applies to the IAM user who makes the request; it does not apply to the entire AWS account. By default, an IAM user defaults to the same settings as the root user. If you're using this action as the root user, then these settings apply to the entire account, unless an IAM user explicitly overrides these settings for themselves. For more information, see Resource IDs in the Amazon Elastic Compute Cloud User Guide.  Resources created with longer IDs are visible to all IAM roles and users, regardless of these settings and provided that they have permission to use the relevant Describe command for the resource type.
   */
   ...
   */
  modifyIdentityIdFormat(params: EC2.ModifyIdentityIdFormatRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies the ID format of a resource for a specified IAM user, IAM role, or the root user for an account; or all IAM users, IAM roles, and the root user for an account. You can specify that resources should receive longer IDs (17-character IDs) when they are created.  The following resource types support longer IDs: instance | reservation | snapshot | volume. For more information, see Resource IDs in the Amazon Elastic Compute Cloud User Guide.  This setting applies to the principal specified in the request; it does not apply to the principal that makes the request.  Resources created with longer IDs are visible to all IAM roles and users, regardless of these settings and provided that they have permission to use the relevant Describe command for the resource type.
   */
   ...
   */
  modifyImageAttribute(params: EC2.ModifyImageAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies the specified attribute of the specified AMI. You can specify only one attribute at a time.  AWS Marketplace product codes cannot be modified. Images with an AWS Marketplace product code cannot be made public.   The SriovNetSupport enhanced networking attribute cannot be changed using this command. Instead, enable SriovNetSupport on an instance and create an AMI from the instance. This will result in an image with SriovNetSupport enabled. 
   */
   ...
   */
  modifyInstanceAttribute(params: EC2.ModifyInstanceAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies the specified attribute of the specified instance. You can specify only one attribute at a time. To modify some attributes, the instance must be stopped. For more information, see Modifying Attributes of a Stopped Instance in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  modifyInstancePlacement(params: EC2.ModifyInstancePlacementRequest, callback?: (err: AWSError, data: EC2.ModifyInstancePlacementResult) => void): Request<EC2.ModifyInstancePlacementResult, AWSError>;
  /**
   * Set the instance affinity value for a specific stopped instance and modify the instance tenancy setting. Instance affinity is disabled by default. When instance affinity is host and it is not associated with a specific Dedicated Host, the next time it is launched it will automatically be associated with the host it lands on. This relationship will persist if the instance is stopped/started, or rebooted. You can modify the host ID associated with a stopped instance. If a stopped instance has a new host ID association, the instance will target that host when restarted. You can modify the tenancy of a stopped instance with a tenancy of host or dedicated. Affinity, hostID, and tenancy are not required parameters, but at least one of them must be specified in the request. Affinity and tenancy can be modified in the same request, but tenancy can only be modified on instances that are stopped.
   */
  modifyInstancePlacement(callback?: (err: AWSError, data: EC2.ModifyInstancePlacementResult) => void): Request<EC2.ModifyInstancePlacementResult, AWSError>;
  /**
   * Modifies the specified network interface attribute. You can specify only one attribute at a time.
   */
  modifyNetworkInterfaceAttribute(params: EC2.ModifyNetworkInterfaceAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies the specified network interface attribute. You can specify only one attribute at a time.
   */
   ...
   */
  modifyReservedInstances(params: EC2.ModifyReservedInstancesRequest, callback?: (err: AWSError, data: EC2.ModifyReservedInstancesResult) => void): Request<EC2.ModifyReservedInstancesResult, AWSError>;
  /**
   * Modifies the Availability Zone, instance count, instance type, or network platform (EC2-Classic or EC2-VPC) of your Standard Reserved Instances. The Reserved Instances to be modified must be identical, except for Availability Zone, network platform, and instance type. For more information, see Modifying Reserved Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  modifyReservedInstances(callback?: (err: AWSError, data: EC2.ModifyReservedInstancesResult) => void): Request<EC2.ModifyReservedInstancesResult, AWSError>;
  /**
   ...
   */
  modifySnapshotAttribute(params: EC2.ModifySnapshotAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Adds or removes permission settings for the specified snapshot. You may add or remove specified AWS account IDs from a snapshot's list of create volume permissions, but you cannot do both in a single API call. If you need to both add and remove account IDs for a snapshot, you must use multiple API calls.  Encrypted snapshots and snapshots with AWS Marketplace product codes cannot be made public. Snapshots encrypted with your default CMK cannot be shared with other accounts.  For more information on modifying snapshot permissions, see Sharing Snapshots in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  modifySpotFleetRequest(params: EC2.ModifySpotFleetRequestRequest, callback?: (err: AWSError, data: EC2.ModifySpotFleetRequestResponse) => void): Request<EC2.ModifySpotFleetRequestResponse, AWSError>;
  /**
   * Modifies the specified Spot fleet request. While the Spot fleet request is being modified, it is in the modifying state. To scale up your Spot fleet, increase its target capacity. The Spot fleet launches the additional Spot instances according to the allocation strategy for the Spot fleet request. If the allocation strategy is lowestPrice, the Spot fleet launches instances using the Spot pool with the lowest price. If the allocation strategy is diversified, the Spot fleet distributes the instances across the Spot pools. To scale down your Spot fleet, decrease its target capacity. First, the Spot fleet cancels any open bids that exceed the new target capacity. You can request that the Spot fleet terminate Spot instances until the size of the fleet no longer exceeds the new target capacity. If the allocation strategy is lowestPrice, the Spot fleet terminates the instances with the highest price per unit. If the allocation strategy is diversified, the Spot fleet terminates instances across the Spot pools. Alternatively, you can request that the Spot fleet keep the fleet at its current size, but not replace any Spot instances that are interrupted or that you terminate manually.
   */
  modifySpotFleetRequest(callback?: (err: AWSError, data: EC2.ModifySpotFleetRequestResponse) => void): Request<EC2.ModifySpotFleetRequestResponse, AWSError>;
  /**
   * Modifies a subnet attribute.
   */
  modifySubnetAttribute(params: EC2.ModifySubnetAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies a subnet attribute.
   */
   ...
   */
  modifyVolumeAttribute(params: EC2.ModifyVolumeAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies a volume attribute. By default, all I/O operations for the volume are suspended when the data on the volume is determined to be potentially inconsistent, to prevent undetectable, latent data corruption. The I/O access to the volume can be resumed by first enabling I/O access and then checking the data consistency on your volume. You can change the default behavior to resume I/O operations. We recommend that you change this only for boot volumes or for volumes that are stateless or disposable.
   */
   ...
   */
  modifyVpcAttribute(params: EC2.ModifyVpcAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Modifies the specified attribute of the specified VPC.
   */
   ...
   */
  modifyVpcEndpoint(params: EC2.ModifyVpcEndpointRequest, callback?: (err: AWSError, data: EC2.ModifyVpcEndpointResult) => void): Request<EC2.ModifyVpcEndpointResult, AWSError>;
  /**
   * Modifies attributes of a specified VPC endpoint. You can modify the policy associated with the endpoint, and you can add and remove route tables associated with the endpoint.
   */
  modifyVpcEndpoint(callback?: (err: AWSError, data: EC2.ModifyVpcEndpointResult) => void): Request<EC2.ModifyVpcEndpointResult, AWSError>;
  /**
   ...
   */
  modifyVpcPeeringConnectionOptions(params: EC2.ModifyVpcPeeringConnectionOptionsRequest, callback?: (err: AWSError, data: EC2.ModifyVpcPeeringConnectionOptionsResult) => void): Request<EC2.ModifyVpcPeeringConnectionOptionsResult, AWSError>;
  /**
   * Modifies the VPC peering connection options on one side of a VPC peering connection. You can do the following:   Enable/disable communication over the peering connection between an EC2-Classic instance that's linked to your VPC (using ClassicLink) and instances in the peer VPC.   Enable/disable communication over the peering connection between instances in your VPC and an EC2-Classic instance that's linked to the peer VPC.   Enable/disable a local VPC to resolve public DNS hostnames to private IP addresses when queried from instances in the peer VPC.   If the peered VPCs are in different accounts, each owner must initiate a separate request to modify the peering connection options, depending on whether their VPC was the requester or accepter for the VPC peering connection. If the peered VPCs are in the same account, you can modify the requester and accepter options in the same request. To confirm which VPC is the accepter and requester for a VPC peering connection, use the DescribeVpcPeeringConnections command.
   */
  modifyVpcPeeringConnectionOptions(callback?: (err: AWSError, data: EC2.ModifyVpcPeeringConnectionOptionsResult) => void): Request<EC2.ModifyVpcPeeringConnectionOptionsResult, AWSError>;
  /**
   ...
   */
  monitorInstances(params: EC2.MonitorInstancesRequest, callback?: (err: AWSError, data: EC2.MonitorInstancesResult) => void): Request<EC2.MonitorInstancesResult, AWSError>;
  /**
   * Enables monitoring for a running instance. For more information about monitoring instances, see Monitoring Your Instances and Volumes in the Amazon Elastic Compute Cloud User Guide.
   */
  monitorInstances(callback?: (err: AWSError, data: EC2.MonitorInstancesResult) => void): Request<EC2.MonitorInstancesResult, AWSError>;
  /**
   * Moves an Elastic IP address from the EC2-Classic platform to the EC2-VPC platform. The Elastic IP address must be allocated to your account for more than 24 hours, and it must not be associated with an instance. After the Elastic IP address is moved, it is no longer available for use in the EC2-Classic platform, unless you move it back using the RestoreAddressToClassic request. You cannot move an Elastic IP address that was originally allocated for use in the EC2-VPC platform to the EC2-Classic platform. 
   */
  moveAddressToVpc(params: EC2.MoveAddressToVpcRequest, callback?: (err: AWSError, data: EC2.MoveAddressToVpcResult) => void): Request<EC2.MoveAddressToVpcResult, AWSError>;
  /**
   * Moves an Elastic IP address from the EC2-Classic platform to the EC2-VPC platform. The Elastic IP address must be allocated to your account for more than 24 hours, and it must not be associated with an instance. After the Elastic IP address is moved, it is no longer available for use in the EC2-Classic platform, unless you move it back using the RestoreAddressToClassic request. You cannot move an Elastic IP address that was originally allocated for use in the EC2-VPC platform to the EC2-Classic platform. 
   */
  moveAddressToVpc(callback?: (err: AWSError, data: EC2.MoveAddressToVpcResult) => void): Request<EC2.MoveAddressToVpcResult, AWSError>;
  /**
   * Purchase a reservation with configurations that match those of your Dedicated Host. You must have active Dedicated Hosts in your account before you purchase a reservation. This action results in the specified reservation being purchased and charged to your account.
   */
  purchaseHostReservation(params: EC2.PurchaseHostReservationRequest, callback?: (err: AWSError, data: EC2.PurchaseHostReservationResult) => void): Request<EC2.PurchaseHostReservationResult, AWSError>;
  /**
   * Purchase a reservation with configurations that match those of your Dedicated Host. You must have active Dedicated Hosts in your account before you purchase a reservation. This action results in the specified reservation being purchased and charged to your account.
   */
  purchaseHostReservation(callback?: (err: AWSError, data: EC2.PurchaseHostReservationResult) => void): Request<EC2.PurchaseHostReservationResult, AWSError>;
  /**
   ...
   */
  purchaseReservedInstancesOffering(params: EC2.PurchaseReservedInstancesOfferingRequest, callback?: (err: AWSError, data: EC2.PurchaseReservedInstancesOfferingResult) => void): Request<EC2.PurchaseReservedInstancesOfferingResult, AWSError>;
  /**
   * Purchases a Reserved Instance for use with your account. With Reserved Instances, you pay a lower hourly rate compared to On-Demand instance pricing. Use DescribeReservedInstancesOfferings to get a list of Reserved Instance offerings that match your specifications. After you've purchased a Reserved Instance, you can check for your new Reserved Instance with DescribeReservedInstances. For more information, see Reserved Instances and Reserved Instance Marketplace in the Amazon Elastic Compute Cloud User Guide.
   */
  purchaseReservedInstancesOffering(callback?: (err: AWSError, data: EC2.PurchaseReservedInstancesOfferingResult) => void): Request<EC2.PurchaseReservedInstancesOfferingResult, AWSError>;
  /**
   ...
   */
  purchaseScheduledInstances(params: EC2.PurchaseScheduledInstancesRequest, callback?: (err: AWSError, data: EC2.PurchaseScheduledInstancesResult) => void): Request<EC2.PurchaseScheduledInstancesResult, AWSError>;
  /**
   * Purchases one or more Scheduled Instances with the specified schedule. Scheduled Instances enable you to purchase Amazon EC2 compute capacity by the hour for a one-year term. Before you can purchase a Scheduled Instance, you must call DescribeScheduledInstanceAvailability to check for available schedules and obtain a purchase token. After you purchase a Scheduled Instance, you must call RunScheduledInstances during each scheduled time period. After you purchase a Scheduled Instance, you can't cancel, modify, or resell your purchase.
   */
  purchaseScheduledInstances(callback?: (err: AWSError, data: EC2.PurchaseScheduledInstancesResult) => void): Request<EC2.PurchaseScheduledInstancesResult, AWSError>;
  /**
   ...
   */
  rebootInstances(params: EC2.RebootInstancesRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Requests a reboot of one or more instances. This operation is asynchronous; it only queues a request to reboot the specified instances. The operation succeeds if the instances are valid and belong to you. Requests to reboot terminated instances are ignored. If an instance does not cleanly shut down within four minutes, Amazon EC2 performs a hard reboot. For more information about troubleshooting, see Getting Console Output and Rebooting Instances in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  registerImage(params: EC2.RegisterImageRequest, callback?: (err: AWSError, data: EC2.RegisterImageResult) => void): Request<EC2.RegisterImageResult, AWSError>;
  /**
   * Registers an AMI. When you're creating an AMI, this is the final step you must complete before you can launch an instance from the AMI. For more information about creating AMIs, see Creating Your Own AMIs in the Amazon Elastic Compute Cloud User Guide.  For Amazon EBS-backed instances, CreateImage creates and registers the AMI in a single request, so you don't have to register the AMI yourself.  You can also use RegisterImage to create an Amazon EBS-backed Linux AMI from a snapshot of a root device volume. For more information, see Launching an Instance from a Snapshot in the Amazon Elastic Compute Cloud User Guide.  Some Linux distributions, such as Red Hat Enterprise Linux (RHEL) and SUSE Linux Enterprise Server (SLES), use the EC2 billingProduct code associated with an AMI to verify subscription status for package updates. Creating an AMI from an EBS snapshot does not maintain this billing code, and subsequent instances launched from such an AMI will not be able to connect to package update infrastructure. Similarly, although you can create a Windows AMI from a snapshot, you can't successfully launch an instance from the AMI. To create Windows AMIs or to create AMIs for Linux operating systems that must retain AMI billing codes to work properly, see CreateImage.  If needed, you can deregister an AMI at any time. Any modifications you make to an AMI backed by an instance store volume invalidates its registration. If you make changes to an image, deregister the previous image and register the new image.  You can't register an image where a secondary (non-root) snapshot has AWS Marketplace product codes. 
   */
  registerImage(callback?: (err: AWSError, data: EC2.RegisterImageResult) => void): Request<EC2.RegisterImageResult, AWSError>;
  /**
   * Rejects a VPC peering connection request. The VPC peering connection must be in the pending-acceptance state. Use the DescribeVpcPeeringConnections request to view your outstanding VPC peering connection requests. To delete an active VPC peering connection, or to delete a VPC peering connection request that you initiated, use DeleteVpcPeeringConnection.
   */
  rejectVpcPeeringConnection(params: EC2.RejectVpcPeeringConnectionRequest, callback?: (err: AWSError, data: EC2.RejectVpcPeeringConnectionResult) => void): Request<EC2.RejectVpcPeeringConnectionResult, AWSError>;
  /**
   * Rejects a VPC peering connection request. The VPC peering connection must be in the pending-acceptance state. Use the DescribeVpcPeeringConnections request to view your outstanding VPC peering connection requests. To delete an active VPC peering connection, or to delete a VPC peering connection request that you initiated, use DeleteVpcPeeringConnection.
   */
  rejectVpcPeeringConnection(callback?: (err: AWSError, data: EC2.RejectVpcPeeringConnectionResult) => void): Request<EC2.RejectVpcPeeringConnectionResult, AWSError>;
  /**
   ...
   */
  releaseAddress(params: EC2.ReleaseAddressRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Releases the specified Elastic IP address. After releasing an Elastic IP address, it is released to the IP address pool and might be unavailable to you. Be sure to update your DNS records and any servers or devices that communicate with the address. If you attempt to release an Elastic IP address that you already released, you'll get an AuthFailure error if the address is already allocated to another AWS account. [EC2-Classic, default VPC] Releasing an Elastic IP address automatically disassociates it from any instance that it's associated with. To disassociate an Elastic IP address without releasing it, use DisassociateAddress. [Nondefault VPC] You must use DisassociateAddress to disassociate the Elastic IP address before you try to release it. Otherwise, Amazon EC2 returns an error (InvalidIPAddress.InUse).
   */
   ...
   */
  releaseHosts(params: EC2.ReleaseHostsRequest, callback?: (err: AWSError, data: EC2.ReleaseHostsResult) => void): Request<EC2.ReleaseHostsResult, AWSError>;
  /**
   * When you no longer want to use an On-Demand Dedicated Host it can be released. On-Demand billing is stopped and the host goes into released state. The host ID of Dedicated Hosts that have been released can no longer be specified in another request, e.g., ModifyHosts. You must stop or terminate all instances on a host before it can be released. When Dedicated Hosts are released, it make take some time for them to stop counting toward your limit and you may receive capacity errors when trying to allocate new Dedicated hosts. Try waiting a few minutes, and then try again. Released hosts will still appear in a DescribeHosts response.
   */
  releaseHosts(callback?: (err: AWSError, data: EC2.ReleaseHostsResult) => void): Request<EC2.ReleaseHostsResult, AWSError>;
  /**
   * Changes which network ACL a subnet is associated with. By default when you create a subnet, it's automatically associated with the default network ACL. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
  replaceNetworkAclAssociation(params: EC2.ReplaceNetworkAclAssociationRequest, callback?: (err: AWSError, data: EC2.ReplaceNetworkAclAssociationResult) => void): Request<EC2.ReplaceNetworkAclAssociationResult, AWSError>;
  /**
   * Changes which network ACL a subnet is associated with. By default when you create a subnet, it's automatically associated with the default network ACL. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
  replaceNetworkAclAssociation(callback?: (err: AWSError, data: EC2.ReplaceNetworkAclAssociationResult) => void): Request<EC2.ReplaceNetworkAclAssociationResult, AWSError>;
  /**
   * Replaces an entry (rule) in a network ACL. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
  replaceNetworkAclEntry(params: EC2.ReplaceNetworkAclEntryRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Replaces an entry (rule) in a network ACL. For more information about network ACLs, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  replaceRoute(params: EC2.ReplaceRouteRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Replaces an existing route within a route table in a VPC. You must provide only one of the following: Internet gateway or virtual private gateway, NAT instance, NAT gateway, VPC peering connection, or network interface. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  replaceRouteTableAssociation(params: EC2.ReplaceRouteTableAssociationRequest, callback?: (err: AWSError, data: EC2.ReplaceRouteTableAssociationResult) => void): Request<EC2.ReplaceRouteTableAssociationResult, AWSError>;
  /**
   * Changes the route table associated with a given subnet in a VPC. After the operation completes, the subnet uses the routes in the new route table it's associated with. For more information about route tables, see Route Tables in the Amazon Virtual Private Cloud User Guide. You can also use ReplaceRouteTableAssociation to change which table is the main route table in the VPC. You just specify the main route table's association ID and the route table to be the new main route table.
   */
  replaceRouteTableAssociation(callback?: (err: AWSError, data: EC2.ReplaceRouteTableAssociationResult) => void): Request<EC2.ReplaceRouteTableAssociationResult, AWSError>;
  /**
   ...
   */
  reportInstanceStatus(params: EC2.ReportInstanceStatusRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Submits feedback about the status of an instance. The instance must be in the running state. If your experience with the instance differs from the instance status returned by DescribeInstanceStatus, use ReportInstanceStatus to report your experience with the instance. Amazon EC2 collects this information to improve the accuracy of status checks. Use of this action does not change the value returned by DescribeInstanceStatus.
   */
   ...
   */
  requestSpotFleet(params: EC2.RequestSpotFleetRequest, callback?: (err: AWSError, data: EC2.RequestSpotFleetResponse) => void): Request<EC2.RequestSpotFleetResponse, AWSError>;
  /**
   * Creates a Spot fleet request. You can submit a single request that includes multiple launch specifications that vary by instance type, AMI, Availability Zone, or subnet. By default, the Spot fleet requests Spot instances in the Spot pool where the price per unit is the lowest. Each launch specification can include its own instance weighting that reflects the value of the instance type to your application workload. Alternatively, you can specify that the Spot fleet distribute the target capacity across the Spot pools included in its launch specifications. By ensuring that the Spot instances in your Spot fleet are in different Spot pools, you can improve the availability of your fleet. For more information, see Spot Fleet Requests in the Amazon Elastic Compute Cloud User Guide.
   */
  requestSpotFleet(callback?: (err: AWSError, data: EC2.RequestSpotFleetResponse) => void): Request<EC2.RequestSpotFleetResponse, AWSError>;
  /**
   * Creates a Spot instance request. Spot instances are instances that Amazon EC2 launches when the bid price that you specify exceeds the current Spot price. Amazon EC2 periodically sets the Spot price based on available Spot Instance capacity and current Spot instance requests. For more information, see Spot Instance Requests in the Amazon Elastic Compute Cloud User Guide.
   */
  requestSpotInstances(params: EC2.RequestSpotInstancesRequest, callback?: (err: AWSError, data: EC2.RequestSpotInstancesResult) => void): Request<EC2.RequestSpotInstancesResult, AWSError>;
  /**
   * Creates a Spot instance request. Spot instances are instances that Amazon EC2 launches when the bid price that you specify exceeds the current Spot price. Amazon EC2 periodically sets the Spot price based on available Spot Instance capacity and current Spot instance requests. For more information, see Spot Instance Requests in the Amazon Elastic Compute Cloud User Guide.
   */
  requestSpotInstances(callback?: (err: AWSError, data: EC2.RequestSpotInstancesResult) => void): Request<EC2.RequestSpotInstancesResult, AWSError>;
  /**
   * Resets an attribute of an AMI to its default value.  The productCodes attribute can't be reset. 
   */
  resetImageAttribute(params: EC2.ResetImageAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Resets an attribute of an AMI to its default value.  The productCodes attribute can't be reset. 
   */
   ...
   */
  resetInstanceAttribute(params: EC2.ResetInstanceAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Resets an attribute of an instance to its default value. To reset the kernel or ramdisk, the instance must be in a stopped state. To reset the sourceDestCheck, the instance can be either running or stopped. The sourceDestCheck attribute controls whether source/destination checking is enabled. The default value is true, which means checking is enabled. This value must be false for a NAT instance to perform NAT. For more information, see NAT Instances in the Amazon Virtual Private Cloud User Guide.
   */
   ...
   */
  resetNetworkInterfaceAttribute(params: EC2.ResetNetworkInterfaceAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Resets a network interface attribute. You can specify only one attribute at a time.
   */
   ...
   */
  resetSnapshotAttribute(params: EC2.ResetSnapshotAttributeRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Resets permission settings for the specified snapshot. For more information on modifying snapshot permissions, see Sharing Snapshots in the Amazon Elastic Compute Cloud User Guide.
   */
   ...
   */
  restoreAddressToClassic(params: EC2.RestoreAddressToClassicRequest, callback?: (err: AWSError, data: EC2.RestoreAddressToClassicResult) => void): Request<EC2.RestoreAddressToClassicResult, AWSError>;
  /**
   * Restores an Elastic IP address that was previously moved to the EC2-VPC platform back to the EC2-Classic platform. You cannot move an Elastic IP address that was originally allocated for use in EC2-VPC. The Elastic IP address must not be associated with an instance or network interface.
   */
  restoreAddressToClassic(callback?: (err: AWSError, data: EC2.RestoreAddressToClassicResult) => void): Request<EC2.RestoreAddressToClassicResult, AWSError>;
  /**
   ...
   */
  revokeSecurityGroupEgress(params: EC2.RevokeSecurityGroupEgressRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * [EC2-VPC only] Removes one or more egress rules from a security group for EC2-VPC. This action doesn't apply to security groups for use in EC2-Classic. The values that you specify in the revoke request (for example, ports) must match the existing rule's values for the rule to be revoked. Each rule consists of the protocol and the CIDR range or source security group. For the TCP and UDP protocols, you must also specify the destination port or range of ports. For the ICMP protocol, you must also specify the ICMP type and code. Rule changes are propagated to instances within the security group as quickly as possible. However, a small delay might occur.
   */
   ...
   */
  revokeSecurityGroupIngress(params: EC2.RevokeSecurityGroupIngressRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Removes one or more ingress rules from a security group. The values that you specify in the revoke request (for example, ports) must match the existing rule's values for the rule to be removed. Each rule consists of the protocol and the CIDR range or source security group. For the TCP and UDP protocols, you must also specify the destination port or range of ports. For the ICMP protocol, you must also specify the ICMP type and code. Rule changes are propagated to instances within the security group as quickly as possible. However, a small delay might occur.
   */
   ...
   */
  runInstances(params: EC2.RunInstancesRequest, callback?: (err: AWSError, data: EC2.Reservation) => void): Request<EC2.Reservation, AWSError>;
  /**
   * Launches the specified number of instances using an AMI for which you have permissions. When you launch an instance, it enters the pending state. After the instance is ready for you, it enters the running state. To check the state of your instance, call DescribeInstances. To ensure faster instance launches, break up large requests into smaller batches. For example, create five separate launch requests for 100 instances each instead of one launch request for 500 instances. To tag your instance, ensure that it is running as CreateTags requires a resource ID. For more information about tagging, see Tagging Your Amazon EC2 Resources. If you don't specify a security group when launching an instance, Amazon EC2 uses the default security group. For more information, see Security Groups in the Amazon Elastic Compute Cloud User Guide. [EC2-VPC only accounts] If you don't specify a subnet in the request, we choose a default subnet from your default VPC for you. [EC2-Classic accounts] If you're launching into EC2-Classic and you don't specify an Availability Zone, we choose one for you. Linux instances have access to the public key of the key pair at boot. You can use this key to provide secure access to the instance. Amazon EC2 public images use this feature to provide secure access without passwords. For more information, see Key Pairs in the Amazon Elastic Compute Cloud User Guide. You can provide optional user data when launching an instance. For more information, see Instance Metadata in the Amazon Elastic Compute Cloud User Guide. If any of the AMIs have a product code attached for which the user has not subscribed, RunInstances fails. Some instance types can only be launched into a VPC. If you do not have a default VPC, or if you do not specify a subnet ID in the request, RunInstances fails. For more information, see Instance Types Available Only in a VPC. For more information about troubleshooting, see What To Do If An Instance Immediately Terminates, and Troubleshooting Connecting to Your Instance in the Amazon Elastic Compute Cloud User Guide.
   */
  runInstances(callback?: (err: AWSError, data: EC2.Reservation) => void): Request<EC2.Reservation, AWSError>;
  /**
   ...
   */
  runScheduledInstances(params: EC2.RunScheduledInstancesRequest, callback?: (err: AWSError, data: EC2.RunScheduledInstancesResult) => void): Request<EC2.RunScheduledInstancesResult, AWSError>;
  /**
   * Launches the specified Scheduled Instances. Before you can launch a Scheduled Instance, you must purchase it and obtain an identifier using PurchaseScheduledInstances. You must launch a Scheduled Instance during its scheduled time period. You can't stop or reboot a Scheduled Instance, but you can terminate it as needed. If you terminate a Scheduled Instance before the current scheduled time period ends, you can launch it again after a few minutes. For more information, see Scheduled Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  runScheduledInstances(callback?: (err: AWSError, data: EC2.RunScheduledInstancesResult) => void): Request<EC2.RunScheduledInstancesResult, AWSError>;
  /**
   ...
   */
  startInstances(params: EC2.StartInstancesRequest, callback?: (err: AWSError, data: EC2.StartInstancesResult) => void): Request<EC2.StartInstancesResult, AWSError>;
  /**
   * Starts an Amazon EBS-backed AMI that you've previously stopped. Instances that use Amazon EBS volumes as their root devices can be quickly stopped and started. When an instance is stopped, the compute resources are released and you are not billed for hourly instance usage. However, your root partition Amazon EBS volume remains, continues to persist your data, and you are charged for Amazon EBS volume usage. You can restart your instance at any time. Each time you transition an instance from stopped to started, Amazon EC2 charges a full instance hour, even if transitions happen multiple times within a single hour. Before stopping an instance, make sure it is in a state from which it can be restarted. Stopping an instance does not preserve data stored in RAM. Performing this operation on an instance that uses an instance store as its root device returns an error. For more information, see Stopping Instances in the Amazon Elastic Compute Cloud User Guide.
   */
  startInstances(callback?: (err: AWSError, data: EC2.StartInstancesResult) => void): Request<EC2.StartInstancesResult, AWSError>;
  /**
   ...
   */
  stopInstances(params: EC2.StopInstancesRequest, callback?: (err: AWSError, data: EC2.StopInstancesResult) => void): Request<EC2.StopInstancesResult, AWSError>;
  /**
   * Stops an Amazon EBS-backed instance. We don't charge hourly usage for a stopped instance, or data transfer fees; however, your root partition Amazon EBS volume remains, continues to persist your data, and you are charged for Amazon EBS volume usage. Each time you transition an instance from stopped to started, Amazon EC2 charges a full instance hour, even if transitions happen multiple times within a single hour. You can't start or stop Spot instances, and you can't stop instance store-backed instances. When you stop an instance, we shut it down. You can restart your instance at any time. Before stopping an instance, make sure it is in a state from which it can be restarted. Stopping an instance does not preserve data stored in RAM. Stopping an instance is different to rebooting or terminating it. For example, when you stop an instance, the root device and any other devices attached to the instance persist. When you terminate an instance, the root device and any other devices attached during the instance launch are automatically deleted. For more information about the differences between rebooting, stopping, and terminating instances, see Instance Lifecycle in the Amazon Elastic Compute Cloud User Guide. When you stop an instance, we attempt to shut it down forcibly after a short while. If your instance appears stuck in the stopping state after a period of time, there may be an issue with the underlying host computer. For more information, see Troubleshooting Stopping Your Instance in the Amazon Elastic Compute Cloud User Guide.
   */
  stopInstances(callback?: (err: AWSError, data: EC2.StopInstancesResult) => void): Request<EC2.StopInstancesResult, AWSError>;
  /**
   ...
   */
  terminateInstances(params: EC2.TerminateInstancesRequest, callback?: (err: AWSError, data: EC2.TerminateInstancesResult) => void): Request<EC2.TerminateInstancesResult, AWSError>;
  /**
   * Shuts down one or more instances. This operation is idempotent; if you terminate an instance more than once, each call succeeds.  If you specify multiple instances and the request fails (for example, because of a single incorrect instance ID), none of the instances are terminated. Terminated instances remain visible after termination (for approximately one hour). By default, Amazon EC2 deletes all EBS volumes that were attached when the instance launched. Volumes attached after instance launch continue running. You can stop, start, and terminate EBS-backed instances. You can only terminate instance store-backed instances. What happens to an instance differs if you stop it or terminate it. For example, when you stop an instance, the root device and any other devices attached to the instance persist. When you terminate an instance, any attached EBS volumes with the DeleteOnTermination block device mapping parameter set to true are automatically deleted. For more information about the differences between stopping and terminating instances, see Instance Lifecycle in the Amazon Elastic Compute Cloud User Guide. For more information about troubleshooting, see Troubleshooting Terminating Your Instance in the Amazon Elastic Compute Cloud User Guide.
   */
  terminateInstances(callback?: (err: AWSError, data: EC2.TerminateInstancesResult) => void): Request<EC2.TerminateInstancesResult, AWSError>;
  /**
   * Unassigns one or more secondary private IP addresses from a network interface.
   */
  unassignPrivateIpAddresses(params: EC2.UnassignPrivateIpAddressesRequest, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Unassigns one or more secondary private IP addresses from a network interface.
   */
   ...
   */
  unmonitorInstances(params: EC2.UnmonitorInstancesRequest, callback?: (err: AWSError, data: EC2.UnmonitorInstancesResult) => void): Request<EC2.UnmonitorInstancesResult, AWSError>;
  /**
   * Disables monitoring for a running instance. For more information about monitoring instances, see Monitoring Your Instances and Volumes in the Amazon Elastic Compute Cloud User Guide.
   */
  unmonitorInstances(callback?: (err: AWSError, data: EC2.UnmonitorInstancesResult) => void): Request<EC2.UnmonitorInstancesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceExists", params: EC2.DescribeInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   * Waits for the InstanceExists state by periodically calling the underlying EC2.describeInstancesoperation every 5 seconds (at most 40 times).
   */
  waitFor(state: "InstanceExists", callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "BundleTaskComplete", params: EC2.DescribeBundleTasksRequest, callback?: (err: AWSError, data: EC2.DescribeBundleTasksResult) => void): Request<EC2.DescribeBundleTasksResult, AWSError>;
  /**
   * Waits for the BundleTaskComplete state by periodically calling the underlying EC2.describeBundleTasksoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "BundleTaskComplete", callback?: (err: AWSError, data: EC2.DescribeBundleTasksResult) => void): Request<EC2.DescribeBundleTasksResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ConversionTaskCancelled", params: EC2.DescribeConversionTasksRequest, callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   * Waits for the ConversionTaskCancelled state by periodically calling the underlying EC2.describeConversionTasksoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ConversionTaskCancelled", callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ConversionTaskCompleted", params: EC2.DescribeConversionTasksRequest, callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   * Waits for the ConversionTaskCompleted state by periodically calling the underlying EC2.describeConversionTasksoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ConversionTaskCompleted", callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ConversionTaskDeleted", params: EC2.DescribeConversionTasksRequest, callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   * Waits for the ConversionTaskDeleted state by periodically calling the underlying EC2.describeConversionTasksoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ConversionTaskDeleted", callback?: (err: AWSError, data: EC2.DescribeConversionTasksResult) => void): Request<EC2.DescribeConversionTasksResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "CustomerGatewayAvailable", params: EC2.DescribeCustomerGatewaysRequest, callback?: (err: AWSError, data: EC2.DescribeCustomerGatewaysResult) => void): Request<EC2.DescribeCustomerGatewaysResult, AWSError>;
  /**
   * Waits for the CustomerGatewayAvailable state by periodically calling the underlying EC2.describeCustomerGatewaysoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "CustomerGatewayAvailable", callback?: (err: AWSError, data: EC2.DescribeCustomerGatewaysResult) => void): Request<EC2.DescribeCustomerGatewaysResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ExportTaskCancelled", params: EC2.DescribeExportTasksRequest, callback?: (err: AWSError, data: EC2.DescribeExportTasksResult) => void): Request<EC2.DescribeExportTasksResult, AWSError>;
  /**
   * Waits for the ExportTaskCancelled state by periodically calling the underlying EC2.describeExportTasksoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ExportTaskCancelled", callback?: (err: AWSError, data: EC2.DescribeExportTasksResult) => void): Request<EC2.DescribeExportTasksResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ExportTaskCompleted", params: EC2.DescribeExportTasksRequest, callback?: (err: AWSError, data: EC2.DescribeExportTasksResult) => void): Request<EC2.DescribeExportTasksResult, AWSError>;
  /**
   * Waits for the ExportTaskCompleted state by periodically calling the underlying EC2.describeExportTasksoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ExportTaskCompleted", callback?: (err: AWSError, data: EC2.DescribeExportTasksResult) => void): Request<EC2.DescribeExportTasksResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ImageExists", params: EC2.DescribeImagesRequest, callback?: (err: AWSError, data: EC2.DescribeImagesResult) => void): Request<EC2.DescribeImagesResult, AWSError>;
  /**
   * Waits for the ImageExists state by periodically calling the underlying EC2.describeImagesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ImageExists", callback?: (err: AWSError, data: EC2.DescribeImagesResult) => void): Request<EC2.DescribeImagesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "ImageAvailable", params: EC2.DescribeImagesRequest, callback?: (err: AWSError, data: EC2.DescribeImagesResult) => void): Request<EC2.DescribeImagesResult, AWSError>;
  /**
   * Waits for the ImageAvailable state by periodically calling the underlying EC2.describeImagesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "ImageAvailable", callback?: (err: AWSError, data: EC2.DescribeImagesResult) => void): Request<EC2.DescribeImagesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceRunning", params: EC2.DescribeInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   * Waits for the InstanceRunning state by periodically calling the underlying EC2.describeInstancesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "InstanceRunning", callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceStatusOk", params: EC2.DescribeInstanceStatusRequest, callback?: (err: AWSError, data: EC2.DescribeInstanceStatusResult) => void): Request<EC2.DescribeInstanceStatusResult, AWSError>;
  /**
   * Waits for the InstanceStatusOk state by periodically calling the underlying EC2.describeInstanceStatusoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "InstanceStatusOk", callback?: (err: AWSError, data: EC2.DescribeInstanceStatusResult) => void): Request<EC2.DescribeInstanceStatusResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceStopped", params: EC2.DescribeInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   * Waits for the InstanceStopped state by periodically calling the underlying EC2.describeInstancesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "InstanceStopped", callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceTerminated", params: EC2.DescribeInstancesRequest, callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   * Waits for the InstanceTerminated state by periodically calling the underlying EC2.describeInstancesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "InstanceTerminated", callback?: (err: AWSError, data: EC2.DescribeInstancesResult) => void): Request<EC2.DescribeInstancesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "KeyPairExists", params: EC2.DescribeKeyPairsRequest, callback?: (err: AWSError, data: EC2.DescribeKeyPairsResult) => void): Request<EC2.DescribeKeyPairsResult, AWSError>;
  /**
   * Waits for the KeyPairExists state by periodically calling the underlying EC2.describeKeyPairsoperation every 5 seconds (at most 6 times).
   */
  waitFor(state: "KeyPairExists", callback?: (err: AWSError, data: EC2.DescribeKeyPairsResult) => void): Request<EC2.DescribeKeyPairsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "NatGatewayAvailable", params: EC2.DescribeNatGatewaysRequest, callback?: (err: AWSError, data: EC2.DescribeNatGatewaysResult) => void): Request<EC2.DescribeNatGatewaysResult, AWSError>;
  /**
   * Waits for the NatGatewayAvailable state by periodically calling the underlying EC2.describeNatGatewaysoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "NatGatewayAvailable", callback?: (err: AWSError, data: EC2.DescribeNatGatewaysResult) => void): Request<EC2.DescribeNatGatewaysResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "NetworkInterfaceAvailable", params: EC2.DescribeNetworkInterfacesRequest, callback?: (err: AWSError, data: EC2.DescribeNetworkInterfacesResult) => void): Request<EC2.DescribeNetworkInterfacesResult, AWSError>;
  /**
   * Waits for the NetworkInterfaceAvailable state by periodically calling the underlying EC2.describeNetworkInterfacesoperation every 20 seconds (at most 10 times).
   */
  waitFor(state: "NetworkInterfaceAvailable", callback?: (err: AWSError, data: EC2.DescribeNetworkInterfacesResult) => void): Request<EC2.DescribeNetworkInterfacesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "PasswordDataAvailable", params: EC2.GetPasswordDataRequest, callback?: (err: AWSError, data: EC2.GetPasswordDataResult) => void): Request<EC2.GetPasswordDataResult, AWSError>;
  /**
   * Waits for the PasswordDataAvailable state by periodically calling the underlying EC2.getPasswordDataoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "PasswordDataAvailable", callback?: (err: AWSError, data: EC2.GetPasswordDataResult) => void): Request<EC2.GetPasswordDataResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "SnapshotCompleted", params: EC2.DescribeSnapshotsRequest, callback?: (err: AWSError, data: EC2.DescribeSnapshotsResult) => void): Request<EC2.DescribeSnapshotsResult, AWSError>;
  /**
   * Waits for the SnapshotCompleted state by periodically calling the underlying EC2.describeSnapshotsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "SnapshotCompleted", callback?: (err: AWSError, data: EC2.DescribeSnapshotsResult) => void): Request<EC2.DescribeSnapshotsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "SpotInstanceRequestFulfilled", params: EC2.DescribeSpotInstanceRequestsRequest, callback?: (err: AWSError, data: EC2.DescribeSpotInstanceRequestsResult) => void): Request<EC2.DescribeSpotInstanceRequestsResult, AWSError>;
  /**
   * Waits for the SpotInstanceRequestFulfilled state by periodically calling the underlying EC2.describeSpotInstanceRequestsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "SpotInstanceRequestFulfilled", callback?: (err: AWSError, data: EC2.DescribeSpotInstanceRequestsResult) => void): Request<EC2.DescribeSpotInstanceRequestsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "SubnetAvailable", params: EC2.DescribeSubnetsRequest, callback?: (err: AWSError, data: EC2.DescribeSubnetsResult) => void): Request<EC2.DescribeSubnetsResult, AWSError>;
  /**
   * Waits for the SubnetAvailable state by periodically calling the underlying EC2.describeSubnetsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "SubnetAvailable", callback?: (err: AWSError, data: EC2.DescribeSubnetsResult) => void): Request<EC2.DescribeSubnetsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "SystemStatusOk", params: EC2.DescribeInstanceStatusRequest, callback?: (err: AWSError, data: EC2.DescribeInstanceStatusResult) => void): Request<EC2.DescribeInstanceStatusResult, AWSError>;
  /**
   * Waits for the SystemStatusOk state by periodically calling the underlying EC2.describeInstanceStatusoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "SystemStatusOk", callback?: (err: AWSError, data: EC2.DescribeInstanceStatusResult) => void): Request<EC2.DescribeInstanceStatusResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VolumeAvailable", params: EC2.DescribeVolumesRequest, callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   * Waits for the VolumeAvailable state by periodically calling the underlying EC2.describeVolumesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VolumeAvailable", callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VolumeDeleted", params: EC2.DescribeVolumesRequest, callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   * Waits for the VolumeDeleted state by periodically calling the underlying EC2.describeVolumesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VolumeDeleted", callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VolumeInUse", params: EC2.DescribeVolumesRequest, callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   * Waits for the VolumeInUse state by periodically calling the underlying EC2.describeVolumesoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VolumeInUse", callback?: (err: AWSError, data: EC2.DescribeVolumesResult) => void): Request<EC2.DescribeVolumesResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VpcAvailable", params: EC2.DescribeVpcsRequest, callback?: (err: AWSError, data: EC2.DescribeVpcsResult) => void): Request<EC2.DescribeVpcsResult, AWSError>;
  /**
   * Waits for the VpcAvailable state by periodically calling the underlying EC2.describeVpcsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VpcAvailable", callback?: (err: AWSError, data: EC2.DescribeVpcsResult) => void): Request<EC2.DescribeVpcsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VpcExists", params: EC2.DescribeVpcsRequest, callback?: (err: AWSError, data: EC2.DescribeVpcsResult) => void): Request<EC2.DescribeVpcsResult, AWSError>;
  /**
   * Waits for the VpcExists state by periodically calling the underlying EC2.describeVpcsoperation every 1 seconds (at most 5 times).
   */
  waitFor(state: "VpcExists", callback?: (err: AWSError, data: EC2.DescribeVpcsResult) => void): Request<EC2.DescribeVpcsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VpnConnectionAvailable", params: EC2.DescribeVpnConnectionsRequest, callback?: (err: AWSError, data: EC2.DescribeVpnConnectionsResult) => void): Request<EC2.DescribeVpnConnectionsResult, AWSError>;
  /**
   * Waits for the VpnConnectionAvailable state by periodically calling the underlying EC2.describeVpnConnectionsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VpnConnectionAvailable", callback?: (err: AWSError, data: EC2.DescribeVpnConnectionsResult) => void): Request<EC2.DescribeVpnConnectionsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VpnConnectionDeleted", params: EC2.DescribeVpnConnectionsRequest, callback?: (err: AWSError, data: EC2.DescribeVpnConnectionsResult) => void): Request<EC2.DescribeVpnConnectionsResult, AWSError>;
  /**
   * Waits for the VpnConnectionDeleted state by periodically calling the underlying EC2.describeVpnConnectionsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VpnConnectionDeleted", callback?: (err: AWSError, data: EC2.DescribeVpnConnectionsResult) => void): Request<EC2.DescribeVpnConnectionsResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "VpcPeeringConnectionExists", params: EC2.DescribeVpcPeeringConnectionsRequest, callback?: (err: AWSError, data: EC2.DescribeVpcPeeringConnectionsResult) => void): Request<EC2.DescribeVpcPeeringConnectionsResult, AWSError>;
  /**
   * Waits for the VpcPeeringConnectionExists state by periodically calling the underlying EC2.describeVpcPeeringConnectionsoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "VpcPeeringConnectionExists", callback?: (err: AWSError, data: EC2.DescribeVpcPeeringConnectionsResult) => void): Request<EC2.DescribeVpcPeeringConnectionsResult, AWSError>;
}
