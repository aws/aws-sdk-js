...
declare class RDS extends Service {
   ...
   */
  addSourceIdentifierToSubscription(params: RDS.AddSourceIdentifierToSubscriptionMessage, callback?: (err: AWSError, data: RDS.AddSourceIdentifierToSubscriptionResult) => void): Request<RDS.AddSourceIdentifierToSubscriptionResult, AWSError>;
  /**
   * Adds a source identifier to an existing RDS event notification subscription.
   */
  addSourceIdentifierToSubscription(callback?: (err: AWSError, data: RDS.AddSourceIdentifierToSubscriptionResult) => void): Request<RDS.AddSourceIdentifierToSubscriptionResult, AWSError>;
  /**
   ...
   */
  addTagsToResource(params: RDS.AddTagsToResourceMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Adds metadata tags to an Amazon RDS resource. These tags can also be used with cost allocation reporting to track cost associated with Amazon RDS resources, or used in a Condition statement in an IAM policy for Amazon RDS. For an overview on tagging Amazon RDS resources, see Tagging Amazon RDS Resources.
   */
   ...
   */
  applyPendingMaintenanceAction(params: RDS.ApplyPendingMaintenanceActionMessage, callback?: (err: AWSError, data: RDS.ApplyPendingMaintenanceActionResult) => void): Request<RDS.ApplyPendingMaintenanceActionResult, AWSError>;
  /**
   * Applies a pending maintenance action to a resource (for example, to a DB instance).
   */
  applyPendingMaintenanceAction(callback?: (err: AWSError, data: RDS.ApplyPendingMaintenanceActionResult) => void): Request<RDS.ApplyPendingMaintenanceActionResult, AWSError>;
  /**
   ...
   */
  authorizeDBSecurityGroupIngress(params: RDS.AuthorizeDBSecurityGroupIngressMessage, callback?: (err: AWSError, data: RDS.AuthorizeDBSecurityGroupIngressResult) => void): Request<RDS.AuthorizeDBSecurityGroupIngressResult, AWSError>;
  /**
   * Enables ingress to a DBSecurityGroup using one of two forms of authorization. First, EC2 or VPC security groups can be added to the DBSecurityGroup if the application using the database is running on EC2 or VPC instances. Second, IP ranges are available if the application accessing your database is running on the Internet. Required parameters for this API are one of CIDR range, EC2SecurityGroupId for VPC, or (EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId for non-VPC).  You cannot authorize ingress from an EC2 security group in one region to an Amazon RDS DB instance in another. You cannot authorize ingress from a VPC security group in one VPC to an Amazon RDS DB instance in another.  For an overview of CIDR ranges, go to the Wikipedia Tutorial. 
   */
  authorizeDBSecurityGroupIngress(callback?: (err: AWSError, data: RDS.AuthorizeDBSecurityGroupIngressResult) => void): Request<RDS.AuthorizeDBSecurityGroupIngressResult, AWSError>;
  /**
   * Copies the specified DB cluster parameter group.
   */
  copyDBClusterParameterGroup(params: RDS.CopyDBClusterParameterGroupMessage, callback?: (err: AWSError, data: RDS.CopyDBClusterParameterGroupResult) => void): Request<RDS.CopyDBClusterParameterGroupResult, AWSError>;
  /**
   * Copies the specified DB cluster parameter group.
   */
  copyDBClusterParameterGroup(callback?: (err: AWSError, data: RDS.CopyDBClusterParameterGroupResult) => void): Request<RDS.CopyDBClusterParameterGroupResult, AWSError>;
  /**
   * Creates a snapshot of a DB cluster. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  copyDBClusterSnapshot(params: RDS.CopyDBClusterSnapshotMessage, callback?: (err: AWSError, data: RDS.CopyDBClusterSnapshotResult) => void): Request<RDS.CopyDBClusterSnapshotResult, AWSError>;
  /**
   * Creates a snapshot of a DB cluster. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  copyDBClusterSnapshot(callback?: (err: AWSError, data: RDS.CopyDBClusterSnapshotResult) => void): Request<RDS.CopyDBClusterSnapshotResult, AWSError>;
  /**
   * Copies the specified DB parameter group.
   */
  copyDBParameterGroup(params: RDS.CopyDBParameterGroupMessage, callback?: (err: AWSError, data: RDS.CopyDBParameterGroupResult) => void): Request<RDS.CopyDBParameterGroupResult, AWSError>;
  /**
   * Copies the specified DB parameter group.
   */
  copyDBParameterGroup(callback?: (err: AWSError, data: RDS.CopyDBParameterGroupResult) => void): Request<RDS.CopyDBParameterGroupResult, AWSError>;
  /**
   ...
   */
  copyDBSnapshot(params: RDS.CopyDBSnapshotMessage, callback?: (err: AWSError, data: RDS.CopyDBSnapshotResult) => void): Request<RDS.CopyDBSnapshotResult, AWSError>;
  /**
   * Copies the specified DB snapshot. The source DB snapshot must be in the "available" state. If you are copying from a shared manual DB snapshot, the SourceDBSnapshotIdentifier must be the ARN of the shared DB snapshot.
   */
  copyDBSnapshot(callback?: (err: AWSError, data: RDS.CopyDBSnapshotResult) => void): Request<RDS.CopyDBSnapshotResult, AWSError>;
  /**
   * Copies the specified option group.
   */
  copyOptionGroup(params: RDS.CopyOptionGroupMessage, callback?: (err: AWSError, data: RDS.CopyOptionGroupResult) => void): Request<RDS.CopyOptionGroupResult, AWSError>;
  /**
   * Copies the specified option group.
   */
  copyOptionGroup(callback?: (err: AWSError, data: RDS.CopyOptionGroupResult) => void): Request<RDS.CopyOptionGroupResult, AWSError>;
  /**
   ...
   */
  createDBCluster(params: RDS.CreateDBClusterMessage, callback?: (err: AWSError, data: RDS.CreateDBClusterResult) => void): Request<RDS.CreateDBClusterResult, AWSError>;
  /**
   * Creates a new Amazon Aurora DB cluster. You can use the ReplicationSourceIdentifier parameter to create the DB cluster as a Read Replica of another DB cluster. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  createDBCluster(callback?: (err: AWSError, data: RDS.CreateDBClusterResult) => void): Request<RDS.CreateDBClusterResult, AWSError>;
  /**
   ...
   */
  createDBClusterParameterGroup(params: RDS.CreateDBClusterParameterGroupMessage, callback?: (err: AWSError, data: RDS.CreateDBClusterParameterGroupResult) => void): Request<RDS.CreateDBClusterParameterGroupResult, AWSError>;
  /**
   * Creates a new DB cluster parameter group. Parameters in a DB cluster parameter group apply to all of the instances in a DB cluster.  A DB cluster parameter group is initially created with the default parameters for the database engine used by instances in the DB cluster. To provide custom values for any of the parameters, you must modify the group after creating it using ModifyDBClusterParameterGroup. Once you've created a DB cluster parameter group, you need to associate it with your DB cluster using ModifyDBCluster. When you associate a new DB cluster parameter group with a running DB cluster, you need to reboot the DB instances in the DB cluster without failover for the new DB cluster parameter group and associated settings to take effect.   After you create a DB cluster parameter group, you should wait at least 5 minutes before creating your first DB cluster that uses that DB cluster parameter group as the default parameter group. This allows Amazon RDS to fully complete the create action before the DB cluster parameter group is used as the default for a new DB cluster. This is especially important for parameters that are critical when creating the default database for a DB cluster, such as the character set for the default database defined by the character_set_database parameter. You can use the Parameter Groups option of the Amazon RDS console or the DescribeDBClusterParameters command to verify that your DB cluster parameter group has been created or modified.  For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  createDBClusterParameterGroup(callback?: (err: AWSError, data: RDS.CreateDBClusterParameterGroupResult) => void): Request<RDS.CreateDBClusterParameterGroupResult, AWSError>;
  /**
   * Creates a snapshot of a DB cluster. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  createDBClusterSnapshot(params: RDS.CreateDBClusterSnapshotMessage, callback?: (err: AWSError, data: RDS.CreateDBClusterSnapshotResult) => void): Request<RDS.CreateDBClusterSnapshotResult, AWSError>;
  /**
   * Creates a snapshot of a DB cluster. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  createDBClusterSnapshot(callback?: (err: AWSError, data: RDS.CreateDBClusterSnapshotResult) => void): Request<RDS.CreateDBClusterSnapshotResult, AWSError>;
  /**
   * Creates a new DB instance.
   */
  createDBInstance(params: RDS.CreateDBInstanceMessage, callback?: (err: AWSError, data: RDS.CreateDBInstanceResult) => void): Request<RDS.CreateDBInstanceResult, AWSError>;
  /**
   * Creates a new DB instance.
   */
  createDBInstance(callback?: (err: AWSError, data: RDS.CreateDBInstanceResult) => void): Request<RDS.CreateDBInstanceResult, AWSError>;
  /**
   ...
   */
  createDBInstanceReadReplica(params: RDS.CreateDBInstanceReadReplicaMessage, callback?: (err: AWSError, data: RDS.CreateDBInstanceReadReplicaResult) => void): Request<RDS.CreateDBInstanceReadReplicaResult, AWSError>;
  /**
   * Creates a DB instance for a DB instance running MySQL, MariaDB, or PostgreSQL that acts as a Read Replica of a source DB instance. All Read Replica DB instances are created as Single-AZ deployments with backups disabled. All other DB instance attributes (including DB security groups and DB parameter groups) are inherited from the source DB instance, except as specified below.  The source DB instance must have backup retention enabled. 
   */
  createDBInstanceReadReplica(callback?: (err: AWSError, data: RDS.CreateDBInstanceReadReplicaResult) => void): Request<RDS.CreateDBInstanceReadReplicaResult, AWSError>;
  /**
   ...
   */
  createDBParameterGroup(params: RDS.CreateDBParameterGroupMessage, callback?: (err: AWSError, data: RDS.CreateDBParameterGroupResult) => void): Request<RDS.CreateDBParameterGroupResult, AWSError>;
  /**
   * Creates a new DB parameter group.  A DB parameter group is initially created with the default parameters for the database engine used by the DB instance. To provide custom values for any of the parameters, you must modify the group after creating it using ModifyDBParameterGroup. Once you've created a DB parameter group, you need to associate it with your DB instance using ModifyDBInstance. When you associate a new DB parameter group with a running DB instance, you need to reboot the DB instance without failover for the new DB parameter group and associated settings to take effect.   After you create a DB parameter group, you should wait at least 5 minutes before creating your first DB instance that uses that DB parameter group as the default parameter group. This allows Amazon RDS to fully complete the create action before the parameter group is used as the default for a new DB instance. This is especially important for parameters that are critical when creating the default database for a DB instance, such as the character set for the default database defined by the character_set_database parameter. You can use the Parameter Groups option of the Amazon RDS console or the DescribeDBParameters command to verify that your DB parameter group has been created or modified. 
   */
  createDBParameterGroup(callback?: (err: AWSError, data: RDS.CreateDBParameterGroupResult) => void): Request<RDS.CreateDBParameterGroupResult, AWSError>;
  /**
   * Creates a new DB security group. DB security groups control access to a DB instance.
   */
  createDBSecurityGroup(params: RDS.CreateDBSecurityGroupMessage, callback?: (err: AWSError, data: RDS.CreateDBSecurityGroupResult) => void): Request<RDS.CreateDBSecurityGroupResult, AWSError>;
  /**
   * Creates a new DB security group. DB security groups control access to a DB instance.
   */
  createDBSecurityGroup(callback?: (err: AWSError, data: RDS.CreateDBSecurityGroupResult) => void): Request<RDS.CreateDBSecurityGroupResult, AWSError>;
  /**
   * Creates a DBSnapshot. The source DBInstance must be in "available" state.
   */
  createDBSnapshot(params: RDS.CreateDBSnapshotMessage, callback?: (err: AWSError, data: RDS.CreateDBSnapshotResult) => void): Request<RDS.CreateDBSnapshotResult, AWSError>;
  /**
   * Creates a DBSnapshot. The source DBInstance must be in "available" state.
   */
  createDBSnapshot(callback?: (err: AWSError, data: RDS.CreateDBSnapshotResult) => void): Request<RDS.CreateDBSnapshotResult, AWSError>;
  /**
   * Creates a new DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the region.
   */
  createDBSubnetGroup(params: RDS.CreateDBSubnetGroupMessage, callback?: (err: AWSError, data: RDS.CreateDBSubnetGroupResult) => void): Request<RDS.CreateDBSubnetGroupResult, AWSError>;
  /**
   * Creates a new DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the region.
   */
  createDBSubnetGroup(callback?: (err: AWSError, data: RDS.CreateDBSubnetGroupResult) => void): Request<RDS.CreateDBSubnetGroupResult, AWSError>;
  /**
   ...
   */
  createEventSubscription(params: RDS.CreateEventSubscriptionMessage, callback?: (err: AWSError, data: RDS.CreateEventSubscriptionResult) => void): Request<RDS.CreateEventSubscriptionResult, AWSError>;
  /**
   * Creates an RDS event notification subscription. This action requires a topic ARN (Amazon Resource Name) created by either the RDS console, the SNS console, or the SNS API. To obtain an ARN with SNS, you must create a topic in Amazon SNS and subscribe to the topic. The ARN is displayed in the SNS console. You can specify the type of source (SourceType) you want to be notified of, provide a list of RDS sources (SourceIds) that triggers the events, and provide a list of event categories (EventCategories) for events you want to be notified of. For example, you can specify SourceType = db-instance, SourceIds = mydbinstance1, mydbinstance2 and EventCategories = Availability, Backup. If you specify both the SourceType and SourceIds, such as SourceType = db-instance and SourceIdentifier = myDBInstance1, you will be notified of all the db-instance events for the specified source. If you specify a SourceType but do not specify a SourceIdentifier, you will receive notice of the events for that source type for all your RDS sources. If you do not specify either the SourceType nor the SourceIdentifier, you will be notified of events generated from all RDS sources belonging to your customer account.
   */
  createEventSubscription(callback?: (err: AWSError, data: RDS.CreateEventSubscriptionResult) => void): Request<RDS.CreateEventSubscriptionResult, AWSError>;
  /**
   * Creates a new option group. You can create up to 20 option groups.
   */
  createOptionGroup(params: RDS.CreateOptionGroupMessage, callback?: (err: AWSError, data: RDS.CreateOptionGroupResult) => void): Request<RDS.CreateOptionGroupResult, AWSError>;
  /**
   * Creates a new option group. You can create up to 20 option groups.
   */
  createOptionGroup(callback?: (err: AWSError, data: RDS.CreateOptionGroupResult) => void): Request<RDS.CreateOptionGroupResult, AWSError>;
  /**
   ...
   */
  deleteDBCluster(params: RDS.DeleteDBClusterMessage, callback?: (err: AWSError, data: RDS.DeleteDBClusterResult) => void): Request<RDS.DeleteDBClusterResult, AWSError>;
  /**
   * The DeleteDBCluster action deletes a previously provisioned DB cluster. When you delete a DB cluster, all automated backups for that DB cluster are deleted and cannot be recovered. Manual DB cluster snapshots of the specified DB cluster are not deleted.  For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  deleteDBCluster(callback?: (err: AWSError, data: RDS.DeleteDBClusterResult) => void): Request<RDS.DeleteDBClusterResult, AWSError>;
  /**
   ...
   */
  deleteDBClusterParameterGroup(params: RDS.DeleteDBClusterParameterGroupMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes a specified DB cluster parameter group. The DB cluster parameter group to be deleted cannot be associated with any DB clusters. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
   ...
   */
  deleteDBClusterSnapshot(params: RDS.DeleteDBClusterSnapshotMessage, callback?: (err: AWSError, data: RDS.DeleteDBClusterSnapshotResult) => void): Request<RDS.DeleteDBClusterSnapshotResult, AWSError>;
  /**
   * Deletes a DB cluster snapshot. If the snapshot is being copied, the copy operation is terminated.  The DB cluster snapshot must be in the available state to be deleted.  For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  deleteDBClusterSnapshot(callback?: (err: AWSError, data: RDS.DeleteDBClusterSnapshotResult) => void): Request<RDS.DeleteDBClusterSnapshotResult, AWSError>;
  /**
   ...
   */
  deleteDBInstance(params: RDS.DeleteDBInstanceMessage, callback?: (err: AWSError, data: RDS.DeleteDBInstanceResult) => void): Request<RDS.DeleteDBInstanceResult, AWSError>;
  /**
   * The DeleteDBInstance action deletes a previously provisioned DB instance. When you delete a DB instance, all automated backups for that instance are deleted and cannot be recovered. Manual DB snapshots of the DB instance to be deleted by DeleteDBInstance are not deleted.  If you request a final DB snapshot the status of the Amazon RDS DB instance is deleting until the DB snapshot is created. The API action DescribeDBInstance is used to monitor the status of this operation. The action cannot be canceled or reverted once submitted.  Note that when a DB instance is in a failure state and has a status of failed, incompatible-restore, or incompatible-network, you can only delete it when the SkipFinalSnapshot parameter is set to true. If the specified DB instance is part of an Amazon Aurora DB cluster, you cannot delete the DB instance if the following are true:   The DB cluster is a Read Replica of another Amazon Aurora DB cluster.   The DB instance is the only instance in the DB cluster.   To delete a DB instance in this case, first call the PromoteReadReplicaDBCluster API action to promote the DB cluster so it's no longer a Read Replica. After the promotion completes, then call the DeleteDBInstance API action to delete the final instance in the DB cluster.
   */
  deleteDBInstance(callback?: (err: AWSError, data: RDS.DeleteDBInstanceResult) => void): Request<RDS.DeleteDBInstanceResult, AWSError>;
  /**
   * Deletes a specified DBParameterGroup. The DBParameterGroup to be deleted cannot be associated with any DB instances.
   */
  deleteDBParameterGroup(params: RDS.DeleteDBParameterGroupMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes a specified DBParameterGroup. The DBParameterGroup to be deleted cannot be associated with any DB instances.
   */
   ...
   */
  deleteDBSecurityGroup(params: RDS.DeleteDBSecurityGroupMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes a DB security group.  The specified DB security group must not be associated with any DB instances. 
   */
   ...
   */
  deleteDBSnapshot(params: RDS.DeleteDBSnapshotMessage, callback?: (err: AWSError, data: RDS.DeleteDBSnapshotResult) => void): Request<RDS.DeleteDBSnapshotResult, AWSError>;
  /**
   * Deletes a DBSnapshot. If the snapshot is being copied, the copy operation is terminated.  The DBSnapshot must be in the available state to be deleted. 
   */
  deleteDBSnapshot(callback?: (err: AWSError, data: RDS.DeleteDBSnapshotResult) => void): Request<RDS.DeleteDBSnapshotResult, AWSError>;
  /**
   * Deletes a DB subnet group.  The specified database subnet group must not be associated with any DB instances. 
   */
  deleteDBSubnetGroup(params: RDS.DeleteDBSubnetGroupMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes a DB subnet group.  The specified database subnet group must not be associated with any DB instances. 
   */
   ...
   */
  deleteEventSubscription(params: RDS.DeleteEventSubscriptionMessage, callback?: (err: AWSError, data: RDS.DeleteEventSubscriptionResult) => void): Request<RDS.DeleteEventSubscriptionResult, AWSError>;
  /**
   * Deletes an RDS event notification subscription.
   */
  deleteEventSubscription(callback?: (err: AWSError, data: RDS.DeleteEventSubscriptionResult) => void): Request<RDS.DeleteEventSubscriptionResult, AWSError>;
  /**
   * Deletes an existing option group.
   */
  deleteOptionGroup(params: RDS.DeleteOptionGroupMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes an existing option group.
   */
   ...
   */
  describeAccountAttributes(params: RDS.DescribeAccountAttributesMessage, callback?: (err: AWSError, data: RDS.AccountAttributesMessage) => void): Request<RDS.AccountAttributesMessage, AWSError>;
  /**
   * Lists all of the attributes for a customer account. The attributes include Amazon RDS quotas for the account, such as the number of DB instances allowed. The description for a quota includes the quota name, current usage toward that quota, and the quota's maximum value. This command does not take any parameters.
   */
  describeAccountAttributes(callback?: (err: AWSError, data: RDS.AccountAttributesMessage) => void): Request<RDS.AccountAttributesMessage, AWSError>;
  /**
   * Lists the set of CA certificates provided by Amazon RDS for this AWS account.
   */
  describeCertificates(params: RDS.DescribeCertificatesMessage, callback?: (err: AWSError, data: RDS.CertificateMessage) => void): Request<RDS.CertificateMessage, AWSError>;
  /**
   * Lists the set of CA certificates provided by Amazon RDS for this AWS account.
   */
  describeCertificates(callback?: (err: AWSError, data: RDS.CertificateMessage) => void): Request<RDS.CertificateMessage, AWSError>;
  /**
   ...
   */
  describeDBClusterParameterGroups(params: RDS.DescribeDBClusterParameterGroupsMessage, callback?: (err: AWSError, data: RDS.DBClusterParameterGroupsMessage) => void): Request<RDS.DBClusterParameterGroupsMessage, AWSError>;
  /**
   *  Returns a list of DBClusterParameterGroup descriptions. If a DBClusterParameterGroupName parameter is specified, the list will contain only the description of the specified DB cluster parameter group.  For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  describeDBClusterParameterGroups(callback?: (err: AWSError, data: RDS.DBClusterParameterGroupsMessage) => void): Request<RDS.DBClusterParameterGroupsMessage, AWSError>;
  /**
   ...
   */
  describeDBClusterParameters(params: RDS.DescribeDBClusterParametersMessage, callback?: (err: AWSError, data: RDS.DBClusterParameterGroupDetails) => void): Request<RDS.DBClusterParameterGroupDetails, AWSError>;
  /**
   * Returns the detailed parameter list for a particular DB cluster parameter group. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  describeDBClusterParameters(callback?: (err: AWSError, data: RDS.DBClusterParameterGroupDetails) => void): Request<RDS.DBClusterParameterGroupDetails, AWSError>;
  /**
   ...
   */
  describeDBClusterSnapshotAttributes(params: RDS.DescribeDBClusterSnapshotAttributesMessage, callback?: (err: AWSError, data: RDS.DescribeDBClusterSnapshotAttributesResult) => void): Request<RDS.DescribeDBClusterSnapshotAttributesResult, AWSError>;
  /**
   * Returns a list of DB cluster snapshot attribute names and values for a manual DB cluster snapshot. When sharing snapshots with other AWS accounts, DescribeDBClusterSnapshotAttributes returns the restore attribute and a list of IDs for the AWS accounts that are authorized to copy or restore the manual DB cluster snapshot. If all is included in the list of values for the restore attribute, then the manual DB cluster snapshot is public and can be copied or restored by all AWS accounts. To add or remove access for an AWS account to copy or restore a manual DB cluster snapshot, or to make the manual DB cluster snapshot public or private, use the ModifyDBClusterSnapshotAttribute API action.
   */
  describeDBClusterSnapshotAttributes(callback?: (err: AWSError, data: RDS.DescribeDBClusterSnapshotAttributesResult) => void): Request<RDS.DescribeDBClusterSnapshotAttributesResult, AWSError>;
  /**
   ...
   */
  describeDBClusterSnapshots(params: RDS.DescribeDBClusterSnapshotsMessage, callback?: (err: AWSError, data: RDS.DBClusterSnapshotMessage) => void): Request<RDS.DBClusterSnapshotMessage, AWSError>;
  /**
   * Returns information about DB cluster snapshots. This API action supports pagination. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  describeDBClusterSnapshots(callback?: (err: AWSError, data: RDS.DBClusterSnapshotMessage) => void): Request<RDS.DBClusterSnapshotMessage, AWSError>;
  /**
   ...
   */
  describeDBClusters(params: RDS.DescribeDBClustersMessage, callback?: (err: AWSError, data: RDS.DBClusterMessage) => void): Request<RDS.DBClusterMessage, AWSError>;
  /**
   * Returns information about provisioned Aurora DB clusters. This API supports pagination. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  describeDBClusters(callback?: (err: AWSError, data: RDS.DBClusterMessage) => void): Request<RDS.DBClusterMessage, AWSError>;
  /**
   * Returns a list of the available DB engines.
   */
  describeDBEngineVersions(params: RDS.DescribeDBEngineVersionsMessage, callback?: (err: AWSError, data: RDS.DBEngineVersionMessage) => void): Request<RDS.DBEngineVersionMessage, AWSError>;
  /**
   * Returns a list of the available DB engines.
   */
  describeDBEngineVersions(callback?: (err: AWSError, data: RDS.DBEngineVersionMessage) => void): Request<RDS.DBEngineVersionMessage, AWSError>;
  /**
   * Returns information about provisioned RDS instances. This API supports pagination.
   */
  describeDBInstances(params: RDS.DescribeDBInstancesMessage, callback?: (err: AWSError, data: RDS.DBInstanceMessage) => void): Request<RDS.DBInstanceMessage, AWSError>;
  /**
   * Returns information about provisioned RDS instances. This API supports pagination.
   */
  describeDBInstances(callback?: (err: AWSError, data: RDS.DBInstanceMessage) => void): Request<RDS.DBInstanceMessage, AWSError>;
  /**
   * Returns a list of DB log files for the DB instance.
   */
  describeDBLogFiles(params: RDS.DescribeDBLogFilesMessage, callback?: (err: AWSError, data: RDS.DescribeDBLogFilesResponse) => void): Request<RDS.DescribeDBLogFilesResponse, AWSError>;
  /**
   * Returns a list of DB log files for the DB instance.
   */
  describeDBLogFiles(callback?: (err: AWSError, data: RDS.DescribeDBLogFilesResponse) => void): Request<RDS.DescribeDBLogFilesResponse, AWSError>;
  /**
   *  Returns a list of DBParameterGroup descriptions. If a DBParameterGroupName is specified, the list will contain only the description of the specified DB parameter group. 
   */
  describeDBParameterGroups(params: RDS.DescribeDBParameterGroupsMessage, callback?: (err: AWSError, data: RDS.DBParameterGroupsMessage) => void): Request<RDS.DBParameterGroupsMessage, AWSError>;
  /**
   *  Returns a list of DBParameterGroup descriptions. If a DBParameterGroupName is specified, the list will contain only the description of the specified DB parameter group. 
   */
  describeDBParameterGroups(callback?: (err: AWSError, data: RDS.DBParameterGroupsMessage) => void): Request<RDS.DBParameterGroupsMessage, AWSError>;
  /**
   * Returns the detailed parameter list for a particular DB parameter group.
   */
  describeDBParameters(params: RDS.DescribeDBParametersMessage, callback?: (err: AWSError, data: RDS.DBParameterGroupDetails) => void): Request<RDS.DBParameterGroupDetails, AWSError>;
  /**
   * Returns the detailed parameter list for a particular DB parameter group.
   */
  describeDBParameters(callback?: (err: AWSError, data: RDS.DBParameterGroupDetails) => void): Request<RDS.DBParameterGroupDetails, AWSError>;
  /**
   *  Returns a list of DBSecurityGroup descriptions. If a DBSecurityGroupName is specified, the list will contain only the descriptions of the specified DB security group. 
   */
  describeDBSecurityGroups(params: RDS.DescribeDBSecurityGroupsMessage, callback?: (err: AWSError, data: RDS.DBSecurityGroupMessage) => void): Request<RDS.DBSecurityGroupMessage, AWSError>;
  /**
   *  Returns a list of DBSecurityGroup descriptions. If a DBSecurityGroupName is specified, the list will contain only the descriptions of the specified DB security group. 
   */
  describeDBSecurityGroups(callback?: (err: AWSError, data: RDS.DBSecurityGroupMessage) => void): Request<RDS.DBSecurityGroupMessage, AWSError>;
  /**
   ...
   */
  describeDBSnapshotAttributes(params: RDS.DescribeDBSnapshotAttributesMessage, callback?: (err: AWSError, data: RDS.DescribeDBSnapshotAttributesResult) => void): Request<RDS.DescribeDBSnapshotAttributesResult, AWSError>;
  /**
   * Returns a list of DB snapshot attribute names and values for a manual DB snapshot. When sharing snapshots with other AWS accounts, DescribeDBSnapshotAttributes returns the restore attribute and a list of IDs for the AWS accounts that are authorized to copy or restore the manual DB snapshot. If all is included in the list of values for the restore attribute, then the manual DB snapshot is public and can be copied or restored by all AWS accounts. To add or remove access for an AWS account to copy or restore a manual DB snapshot, or to make the manual DB snapshot public or private, use the ModifyDBSnapshotAttribute API action.
   */
  describeDBSnapshotAttributes(callback?: (err: AWSError, data: RDS.DescribeDBSnapshotAttributesResult) => void): Request<RDS.DescribeDBSnapshotAttributesResult, AWSError>;
  /**
   * Returns information about DB snapshots. This API action supports pagination.
   */
  describeDBSnapshots(params: RDS.DescribeDBSnapshotsMessage, callback?: (err: AWSError, data: RDS.DBSnapshotMessage) => void): Request<RDS.DBSnapshotMessage, AWSError>;
  /**
   * Returns information about DB snapshots. This API action supports pagination.
   */
  describeDBSnapshots(callback?: (err: AWSError, data: RDS.DBSnapshotMessage) => void): Request<RDS.DBSnapshotMessage, AWSError>;
  /**
   * Returns a list of DBSubnetGroup descriptions. If a DBSubnetGroupName is specified, the list will contain only the descriptions of the specified DBSubnetGroup. For an overview of CIDR ranges, go to the Wikipedia Tutorial. 
   */
  describeDBSubnetGroups(params: RDS.DescribeDBSubnetGroupsMessage, callback?: (err: AWSError, data: RDS.DBSubnetGroupMessage) => void): Request<RDS.DBSubnetGroupMessage, AWSError>;
  /**
   * Returns a list of DBSubnetGroup descriptions. If a DBSubnetGroupName is specified, the list will contain only the descriptions of the specified DBSubnetGroup. For an overview of CIDR ranges, go to the Wikipedia Tutorial. 
   */
  describeDBSubnetGroups(callback?: (err: AWSError, data: RDS.DBSubnetGroupMessage) => void): Request<RDS.DBSubnetGroupMessage, AWSError>;
  /**
   ...
   */
  describeEngineDefaultClusterParameters(params: RDS.DescribeEngineDefaultClusterParametersMessage, callback?: (err: AWSError, data: RDS.DescribeEngineDefaultClusterParametersResult) => void): Request<RDS.DescribeEngineDefaultClusterParametersResult, AWSError>;
  /**
   * Returns the default engine and system parameter information for the cluster database engine. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  describeEngineDefaultClusterParameters(callback?: (err: AWSError, data: RDS.DescribeEngineDefaultClusterParametersResult) => void): Request<RDS.DescribeEngineDefaultClusterParametersResult, AWSError>;
  /**
   * Returns the default engine and system parameter information for the specified database engine.
   */
  describeEngineDefaultParameters(params: RDS.DescribeEngineDefaultParametersMessage, callback?: (err: AWSError, data: RDS.DescribeEngineDefaultParametersResult) => void): Request<RDS.DescribeEngineDefaultParametersResult, AWSError>;
  /**
   * Returns the default engine and system parameter information for the specified database engine.
   */
  describeEngineDefaultParameters(callback?: (err: AWSError, data: RDS.DescribeEngineDefaultParametersResult) => void): Request<RDS.DescribeEngineDefaultParametersResult, AWSError>;
  /**
   * Displays a list of categories for all event source types, or, if specified, for a specified source type. You can see a list of the event categories and source types in the  Events topic in the Amazon RDS User Guide. 
   */
  describeEventCategories(params: RDS.DescribeEventCategoriesMessage, callback?: (err: AWSError, data: RDS.EventCategoriesMessage) => void): Request<RDS.EventCategoriesMessage, AWSError>;
  /**
   * Displays a list of categories for all event source types, or, if specified, for a specified source type. You can see a list of the event categories and source types in the  Events topic in the Amazon RDS User Guide. 
   */
  describeEventCategories(callback?: (err: AWSError, data: RDS.EventCategoriesMessage) => void): Request<RDS.EventCategoriesMessage, AWSError>;
  /**
   * Lists all the subscription descriptions for a customer account. The description for a subscription includes SubscriptionName, SNSTopicARN, CustomerID, SourceType, SourceID, CreationTime, and Status. If you specify a SubscriptionName, lists the description for that subscription.
   */
  describeEventSubscriptions(params: RDS.DescribeEventSubscriptionsMessage, callback?: (err: AWSError, data: RDS.EventSubscriptionsMessage) => void): Request<RDS.EventSubscriptionsMessage, AWSError>;
  /**
   * Lists all the subscription descriptions for a customer account. The description for a subscription includes SubscriptionName, SNSTopicARN, CustomerID, SourceType, SourceID, CreationTime, and Status. If you specify a SubscriptionName, lists the description for that subscription.
   */
  describeEventSubscriptions(callback?: (err: AWSError, data: RDS.EventSubscriptionsMessage) => void): Request<RDS.EventSubscriptionsMessage, AWSError>;
  /**
   * Returns events related to DB instances, DB security groups, DB snapshots, and DB parameter groups for the past 14 days. Events specific to a particular DB instance, DB security group, database snapshot, or DB parameter group can be obtained by providing the name as a parameter. By default, the past hour of events are returned.
   */
  describeEvents(params: RDS.DescribeEventsMessage, callback?: (err: AWSError, data: RDS.EventsMessage) => void): Request<RDS.EventsMessage, AWSError>;
  /**
   * Returns events related to DB instances, DB security groups, DB snapshots, and DB parameter groups for the past 14 days. Events specific to a particular DB instance, DB security group, database snapshot, or DB parameter group can be obtained by providing the name as a parameter. By default, the past hour of events are returned.
   */
  describeEvents(callback?: (err: AWSError, data: RDS.EventsMessage) => void): Request<RDS.EventsMessage, AWSError>;
  /**
   * Describes all available options.
   */
  describeOptionGroupOptions(params: RDS.DescribeOptionGroupOptionsMessage, callback?: (err: AWSError, data: RDS.OptionGroupOptionsMessage) => void): Request<RDS.OptionGroupOptionsMessage, AWSError>;
  /**
   * Describes all available options.
   */
  describeOptionGroupOptions(callback?: (err: AWSError, data: RDS.OptionGroupOptionsMessage) => void): Request<RDS.OptionGroupOptionsMessage, AWSError>;
  /**
   * Describes the available option groups.
   */
  describeOptionGroups(params: RDS.DescribeOptionGroupsMessage, callback?: (err: AWSError, data: RDS.OptionGroups) => void): Request<RDS.OptionGroups, AWSError>;
  /**
   * Describes the available option groups.
   */
  describeOptionGroups(callback?: (err: AWSError, data: RDS.OptionGroups) => void): Request<RDS.OptionGroups, AWSError>;
  /**
   * Returns a list of orderable DB instance options for the specified engine.
   */
  describeOrderableDBInstanceOptions(params: RDS.DescribeOrderableDBInstanceOptionsMessage, callback?: (err: AWSError, data: RDS.OrderableDBInstanceOptionsMessage) => void): Request<RDS.OrderableDBInstanceOptionsMessage, AWSError>;
  /**
   * Returns a list of orderable DB instance options for the specified engine.
   */
  describeOrderableDBInstanceOptions(callback?: (err: AWSError, data: RDS.OrderableDBInstanceOptionsMessage) => void): Request<RDS.OrderableDBInstanceOptionsMessage, AWSError>;
  /**
   * Returns a list of resources (for example, DB instances) that have at least one pending maintenance action.
   */
  describePendingMaintenanceActions(params: RDS.DescribePendingMaintenanceActionsMessage, callback?: (err: AWSError, data: RDS.PendingMaintenanceActionsMessage) => void): Request<RDS.PendingMaintenanceActionsMessage, AWSError>;
  /**
   * Returns a list of resources (for example, DB instances) that have at least one pending maintenance action.
   */
  describePendingMaintenanceActions(callback?: (err: AWSError, data: RDS.PendingMaintenanceActionsMessage) => void): Request<RDS.PendingMaintenanceActionsMessage, AWSError>;
  /**
   * Returns information about reserved DB instances for this account, or about a specified reserved DB instance.
   */
  describeReservedDBInstances(params: RDS.DescribeReservedDBInstancesMessage, callback?: (err: AWSError, data: RDS.ReservedDBInstanceMessage) => void): Request<RDS.ReservedDBInstanceMessage, AWSError>;
  /**
   * Returns information about reserved DB instances for this account, or about a specified reserved DB instance.
   */
  describeReservedDBInstances(callback?: (err: AWSError, data: RDS.ReservedDBInstanceMessage) => void): Request<RDS.ReservedDBInstanceMessage, AWSError>;
  /**
   * Lists available reserved DB instance offerings.
   */
  describeReservedDBInstancesOfferings(params: RDS.DescribeReservedDBInstancesOfferingsMessage, callback?: (err: AWSError, data: RDS.ReservedDBInstancesOfferingMessage) => void): Request<RDS.ReservedDBInstancesOfferingMessage, AWSError>;
  /**
   * Lists available reserved DB instance offerings.
   */
  describeReservedDBInstancesOfferings(callback?: (err: AWSError, data: RDS.ReservedDBInstancesOfferingMessage) => void): Request<RDS.ReservedDBInstancesOfferingMessage, AWSError>;
  /**
   * Returns a list of the source AWS regions where the current AWS region can create a Read Replica or copy a DB snapshot from. This API action supports pagination.
   */
  describeSourceRegions(params: RDS.DescribeSourceRegionsMessage, callback?: (err: AWSError, data: RDS.SourceRegionMessage) => void): Request<RDS.SourceRegionMessage, AWSError>;
  /**
   * Returns a list of the source AWS regions where the current AWS region can create a Read Replica or copy a DB snapshot from. This API action supports pagination.
   */
  describeSourceRegions(callback?: (err: AWSError, data: RDS.SourceRegionMessage) => void): Request<RDS.SourceRegionMessage, AWSError>;
  /**
   * Downloads all or a portion of the specified log file, up to 1 MB in size.
   */
  downloadDBLogFilePortion(params: RDS.DownloadDBLogFilePortionMessage, callback?: (err: AWSError, data: RDS.DownloadDBLogFilePortionDetails) => void): Request<RDS.DownloadDBLogFilePortionDetails, AWSError>;
  /**
   * Downloads all or a portion of the specified log file, up to 1 MB in size.
   */
  downloadDBLogFilePortion(callback?: (err: AWSError, data: RDS.DownloadDBLogFilePortionDetails) => void): Request<RDS.DownloadDBLogFilePortionDetails, AWSError>;
  /**
   ...
   */
  failoverDBCluster(params: RDS.FailoverDBClusterMessage, callback?: (err: AWSError, data: RDS.FailoverDBClusterResult) => void): Request<RDS.FailoverDBClusterResult, AWSError>;
  /**
   * Forces a failover for a DB cluster. A failover for a DB cluster promotes one of the read-only instances in the DB cluster to the master DB instance (the cluster writer) and deletes the current primary instance. Amazon Aurora will automatically fail over to a read-only instance, if one exists, when the primary instance fails. You can force a failover when you want to simulate a failure of a DB instance for testing. Because each instance in a DB cluster has its own endpoint address, you will need to clean up and re-establish any existing connections that use those endpoint addresses when the failover is complete. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  failoverDBCluster(callback?: (err: AWSError, data: RDS.FailoverDBClusterResult) => void): Request<RDS.FailoverDBClusterResult, AWSError>;
  /**
   ...
   */
  listTagsForResource(params: RDS.ListTagsForResourceMessage, callback?: (err: AWSError, data: RDS.TagListMessage) => void): Request<RDS.TagListMessage, AWSError>;
  /**
   * Lists all tags on an Amazon RDS resource. For an overview on tagging an Amazon RDS resource, see Tagging Amazon RDS Resources.
   */
  listTagsForResource(callback?: (err: AWSError, data: RDS.TagListMessage) => void): Request<RDS.TagListMessage, AWSError>;
  /**
   * Modify a setting for an Amazon Aurora DB cluster. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  modifyDBCluster(params: RDS.ModifyDBClusterMessage, callback?: (err: AWSError, data: RDS.ModifyDBClusterResult) => void): Request<RDS.ModifyDBClusterResult, AWSError>;
  /**
   * Modify a setting for an Amazon Aurora DB cluster. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  modifyDBCluster(callback?: (err: AWSError, data: RDS.ModifyDBClusterResult) => void): Request<RDS.ModifyDBClusterResult, AWSError>;
  /**
   ...
   */
  modifyDBClusterParameterGroup(params: RDS.ModifyDBClusterParameterGroupMessage, callback?: (err: AWSError, data: RDS.DBClusterParameterGroupNameMessage) => void): Request<RDS.DBClusterParameterGroupNameMessage, AWSError>;
  /**
   *  Modifies the parameters of a DB cluster parameter group. To modify more than one parameter, submit a list of the following: ParameterName, ParameterValue, and ApplyMethod. A maximum of 20 parameters can be modified in a single request.  For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide.   Changes to dynamic parameters are applied immediately. Changes to static parameters require a reboot without failover to the DB cluster associated with the parameter group before the change can take effect.   After you create a DB cluster parameter group, you should wait at least 5 minutes before creating your first DB cluster that uses that DB cluster parameter group as the default parameter group. This allows Amazon RDS to fully complete the create action before the parameter group is used as the default for a new DB cluster. This is especially important for parameters that are critical when creating the default database for a DB cluster, such as the character set for the default database defined by the character_set_database parameter. You can use the Parameter Groups option of the Amazon RDS console or the DescribeDBClusterParameters command to verify that your DB cluster parameter group has been created or modified. 
   */
  modifyDBClusterParameterGroup(callback?: (err: AWSError, data: RDS.DBClusterParameterGroupNameMessage) => void): Request<RDS.DBClusterParameterGroupNameMessage, AWSError>;
  /**
   ...
   */
  modifyDBClusterSnapshotAttribute(params: RDS.ModifyDBClusterSnapshotAttributeMessage, callback?: (err: AWSError, data: RDS.ModifyDBClusterSnapshotAttributeResult) => void): Request<RDS.ModifyDBClusterSnapshotAttributeResult, AWSError>;
  /**
   * Adds an attribute and values to, or removes an attribute and values from, a manual DB cluster snapshot. To share a manual DB cluster snapshot with other AWS accounts, specify restore as the AttributeName and use the ValuesToAdd parameter to add a list of IDs of the AWS accounts that are authorized to restore the manual DB cluster snapshot. Use the value all to make the manual DB cluster snapshot public, which means that it can be copied or restored by all AWS accounts. Do not add the all value for any manual DB cluster snapshots that contain private information that you don't want available to all AWS accounts. To view which AWS accounts have access to copy or restore a manual DB cluster snapshot, or whether a manual DB cluster snapshot public or private, use the DescribeDBClusterSnapshotAttributes API action. If a manual DB cluster snapshot is encrypted, it cannot be shared.
   */
  modifyDBClusterSnapshotAttribute(callback?: (err: AWSError, data: RDS.ModifyDBClusterSnapshotAttributeResult) => void): Request<RDS.ModifyDBClusterSnapshotAttributeResult, AWSError>;
  /**
   * Modifies settings for a DB instance. You can change one or more database configuration parameters by specifying these parameters and the new values in the request.
   */
  modifyDBInstance(params: RDS.ModifyDBInstanceMessage, callback?: (err: AWSError, data: RDS.ModifyDBInstanceResult) => void): Request<RDS.ModifyDBInstanceResult, AWSError>;
  /**
   * Modifies settings for a DB instance. You can change one or more database configuration parameters by specifying these parameters and the new values in the request.
   */
  modifyDBInstance(callback?: (err: AWSError, data: RDS.ModifyDBInstanceResult) => void): Request<RDS.ModifyDBInstanceResult, AWSError>;
  /**
   ...
   */
  modifyDBParameterGroup(params: RDS.ModifyDBParameterGroupMessage, callback?: (err: AWSError, data: RDS.DBParameterGroupNameMessage) => void): Request<RDS.DBParameterGroupNameMessage, AWSError>;
  /**
   *  Modifies the parameters of a DB parameter group. To modify more than one parameter, submit a list of the following: ParameterName, ParameterValue, and ApplyMethod. A maximum of 20 parameters can be modified in a single request.   Changes to dynamic parameters are applied immediately. Changes to static parameters require a reboot without failover to the DB instance associated with the parameter group before the change can take effect.   After you modify a DB parameter group, you should wait at least 5 minutes before creating your first DB instance that uses that DB parameter group as the default parameter group. This allows Amazon RDS to fully complete the modify action before the parameter group is used as the default for a new DB instance. This is especially important for parameters that are critical when creating the default database for a DB instance, such as the character set for the default database defined by the character_set_database parameter. You can use the Parameter Groups option of the Amazon RDS console or the DescribeDBParameters command to verify that your DB parameter group has been created or modified. 
   */
  modifyDBParameterGroup(callback?: (err: AWSError, data: RDS.DBParameterGroupNameMessage) => void): Request<RDS.DBParameterGroupNameMessage, AWSError>;
  /**
   ...
   */
  modifyDBSnapshotAttribute(params: RDS.ModifyDBSnapshotAttributeMessage, callback?: (err: AWSError, data: RDS.ModifyDBSnapshotAttributeResult) => void): Request<RDS.ModifyDBSnapshotAttributeResult, AWSError>;
  /**
   * Adds an attribute and values to, or removes an attribute and values from, a manual DB snapshot. To share a manual DB snapshot with other AWS accounts, specify restore as the AttributeName and use the ValuesToAdd parameter to add a list of IDs of the AWS accounts that are authorized to restore the manual DB snapshot. Uses the value all to make the manual DB snapshot public, which means it can be copied or restored by all AWS accounts. Do not add the all value for any manual DB snapshots that contain private information that you don't want available to all AWS accounts. To view which AWS accounts have access to copy or restore a manual DB snapshot, or whether a manual DB snapshot public or private, use the DescribeDBSnapshotAttributes API action. If the manual DB snapshot is encrypted, it cannot be shared.
   */
  modifyDBSnapshotAttribute(callback?: (err: AWSError, data: RDS.ModifyDBSnapshotAttributeResult) => void): Request<RDS.ModifyDBSnapshotAttributeResult, AWSError>;
  /**
   * Modifies an existing DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the region.
   */
  modifyDBSubnetGroup(params: RDS.ModifyDBSubnetGroupMessage, callback?: (err: AWSError, data: RDS.ModifyDBSubnetGroupResult) => void): Request<RDS.ModifyDBSubnetGroupResult, AWSError>;
  /**
   * Modifies an existing DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the region.
   */
  modifyDBSubnetGroup(callback?: (err: AWSError, data: RDS.ModifyDBSubnetGroupResult) => void): Request<RDS.ModifyDBSubnetGroupResult, AWSError>;
  /**
   ...
   */
  modifyEventSubscription(params: RDS.ModifyEventSubscriptionMessage, callback?: (err: AWSError, data: RDS.ModifyEventSubscriptionResult) => void): Request<RDS.ModifyEventSubscriptionResult, AWSError>;
  /**
   * Modifies an existing RDS event notification subscription. Note that you cannot modify the source identifiers using this call; to change source identifiers for a subscription, use the AddSourceIdentifierToSubscription and RemoveSourceIdentifierFromSubscription calls. You can see a list of the event categories for a given SourceType in the Events topic in the Amazon RDS User Guide or by using the DescribeEventCategories action.
   */
  modifyEventSubscription(callback?: (err: AWSError, data: RDS.ModifyEventSubscriptionResult) => void): Request<RDS.ModifyEventSubscriptionResult, AWSError>;
  /**
   * Modifies an existing option group.
   */
  modifyOptionGroup(params: RDS.ModifyOptionGroupMessage, callback?: (err: AWSError, data: RDS.ModifyOptionGroupResult) => void): Request<RDS.ModifyOptionGroupResult, AWSError>;
  /**
   * Modifies an existing option group.
   */
  modifyOptionGroup(callback?: (err: AWSError, data: RDS.ModifyOptionGroupResult) => void): Request<RDS.ModifyOptionGroupResult, AWSError>;
  /**
   ...
   */
  promoteReadReplica(params: RDS.PromoteReadReplicaMessage, callback?: (err: AWSError, data: RDS.PromoteReadReplicaResult) => void): Request<RDS.PromoteReadReplicaResult, AWSError>;
  /**
   * Promotes a Read Replica DB instance to a standalone DB instance.  We recommend that you enable automated backups on your Read Replica before promoting the Read Replica. This ensures that no backup is taken during the promotion process. Once the instance is promoted to a primary instance, backups are taken based on your backup settings. 
   */
  promoteReadReplica(callback?: (err: AWSError, data: RDS.PromoteReadReplicaResult) => void): Request<RDS.PromoteReadReplicaResult, AWSError>;
  /**
   * Promotes a Read Replica DB cluster to a standalone DB cluster.
   */
  promoteReadReplicaDBCluster(params: RDS.PromoteReadReplicaDBClusterMessage, callback?: (err: AWSError, data: RDS.PromoteReadReplicaDBClusterResult) => void): Request<RDS.PromoteReadReplicaDBClusterResult, AWSError>;
  /**
   * Promotes a Read Replica DB cluster to a standalone DB cluster.
   */
  promoteReadReplicaDBCluster(callback?: (err: AWSError, data: RDS.PromoteReadReplicaDBClusterResult) => void): Request<RDS.PromoteReadReplicaDBClusterResult, AWSError>;
  /**
   * Purchases a reserved DB instance offering.
   */
  purchaseReservedDBInstancesOffering(params: RDS.PurchaseReservedDBInstancesOfferingMessage, callback?: (err: AWSError, data: RDS.PurchaseReservedDBInstancesOfferingResult) => void): Request<RDS.PurchaseReservedDBInstancesOfferingResult, AWSError>;
  /**
   * Purchases a reserved DB instance offering.
   */
  purchaseReservedDBInstancesOffering(callback?: (err: AWSError, data: RDS.PurchaseReservedDBInstancesOfferingResult) => void): Request<RDS.PurchaseReservedDBInstancesOfferingResult, AWSError>;
  /**
   ...
   */
  rebootDBInstance(params: RDS.RebootDBInstanceMessage, callback?: (err: AWSError, data: RDS.RebootDBInstanceResult) => void): Request<RDS.RebootDBInstanceResult, AWSError>;
  /**
   * Rebooting a DB instance restarts the database engine service. A reboot also applies to the DB instance any modifications to the associated DB parameter group that were pending. Rebooting a DB instance results in a momentary outage of the instance, during which the DB instance status is set to rebooting. If the RDS instance is configured for MultiAZ, it is possible that the reboot will be conducted through a failover. An Amazon RDS event is created when the reboot is completed. If your DB instance is deployed in multiple Availability Zones, you can force a failover from one AZ to the other during the reboot. You might force a failover to test the availability of your DB instance deployment or to restore operations to the original AZ after a failover occurs. The time required to reboot is a function of the specific database engine's crash recovery process. To improve the reboot time, we recommend that you reduce database activities as much as possible during the reboot process to reduce rollback activity for in-transit transactions.
   */
  rebootDBInstance(callback?: (err: AWSError, data: RDS.RebootDBInstanceResult) => void): Request<RDS.RebootDBInstanceResult, AWSError>;
  /**
   * Removes a source identifier from an existing RDS event notification subscription.
   */
  removeSourceIdentifierFromSubscription(params: RDS.RemoveSourceIdentifierFromSubscriptionMessage, callback?: (err: AWSError, data: RDS.RemoveSourceIdentifierFromSubscriptionResult) => void): Request<RDS.RemoveSourceIdentifierFromSubscriptionResult, AWSError>;
  /**
   * Removes a source identifier from an existing RDS event notification subscription.
   */
  removeSourceIdentifierFromSubscription(callback?: (err: AWSError, data: RDS.RemoveSourceIdentifierFromSubscriptionResult) => void): Request<RDS.RemoveSourceIdentifierFromSubscriptionResult, AWSError>;
  /**
   ...
   */
  removeTagsFromResource(params: RDS.RemoveTagsFromResourceMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Removes metadata tags from an Amazon RDS resource. For an overview on tagging an Amazon RDS resource, see Tagging Amazon RDS Resources.
   */
   ...
   */
  resetDBClusterParameterGroup(params: RDS.ResetDBClusterParameterGroupMessage, callback?: (err: AWSError, data: RDS.DBClusterParameterGroupNameMessage) => void): Request<RDS.DBClusterParameterGroupNameMessage, AWSError>;
  /**
   *  Modifies the parameters of a DB cluster parameter group to the default value. To reset specific parameters submit a list of the following: ParameterName and ApplyMethod. To reset the entire DB cluster parameter group, specify the DBClusterParameterGroupName and ResetAllParameters parameters.   When resetting the entire group, dynamic parameters are updated immediately and static parameters are set to pending-reboot to take effect on the next DB instance restart or RebootDBInstance request. You must call RebootDBInstance for every DB instance in your DB cluster that you want the updated static parameter to apply to. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  resetDBClusterParameterGroup(callback?: (err: AWSError, data: RDS.DBClusterParameterGroupNameMessage) => void): Request<RDS.DBClusterParameterGroupNameMessage, AWSError>;
  /**
   ...
   */
  resetDBParameterGroup(params: RDS.ResetDBParameterGroupMessage, callback?: (err: AWSError, data: RDS.DBParameterGroupNameMessage) => void): Request<RDS.DBParameterGroupNameMessage, AWSError>;
  /**
   *  Modifies the parameters of a DB parameter group to the engine/system default value. To reset specific parameters submit a list of the following: ParameterName and ApplyMethod. To reset the entire DB parameter group, specify the DBParameterGroup name and ResetAllParameters parameters. When resetting the entire group, dynamic parameters are updated immediately and static parameters are set to pending-reboot to take effect on the next DB instance restart or RebootDBInstance request. 
   */
  resetDBParameterGroup(callback?: (err: AWSError, data: RDS.DBParameterGroupNameMessage) => void): Request<RDS.DBParameterGroupNameMessage, AWSError>;
  /**
   ...
   */
  restoreDBClusterFromS3(params: RDS.RestoreDBClusterFromS3Message, callback?: (err: AWSError, data: RDS.RestoreDBClusterFromS3Result) => void): Request<RDS.RestoreDBClusterFromS3Result, AWSError>;
  /**
   * Creates an Amazon Aurora DB cluster from data stored in an Amazon S3 bucket. Amazon RDS must be authorized to access the Amazon S3 bucket and the data must be created using the Percona XtraBackup utility as described in Migrating Data from MySQL by Using an Amazon S3 Bucket.
   */
  restoreDBClusterFromS3(callback?: (err: AWSError, data: RDS.RestoreDBClusterFromS3Result) => void): Request<RDS.RestoreDBClusterFromS3Result, AWSError>;
  /**
   ...
   */
  restoreDBClusterFromSnapshot(params: RDS.RestoreDBClusterFromSnapshotMessage, callback?: (err: AWSError, data: RDS.RestoreDBClusterFromSnapshotResult) => void): Request<RDS.RestoreDBClusterFromSnapshotResult, AWSError>;
  /**
   * Creates a new DB cluster from a DB cluster snapshot. The target DB cluster is created from the source DB cluster restore point with the same configuration as the original source DB cluster, except that the new DB cluster is created with the default security group. For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  restoreDBClusterFromSnapshot(callback?: (err: AWSError, data: RDS.RestoreDBClusterFromSnapshotResult) => void): Request<RDS.RestoreDBClusterFromSnapshotResult, AWSError>;
  /**
   ...
   */
  restoreDBClusterToPointInTime(params: RDS.RestoreDBClusterToPointInTimeMessage, callback?: (err: AWSError, data: RDS.RestoreDBClusterToPointInTimeResult) => void): Request<RDS.RestoreDBClusterToPointInTimeResult, AWSError>;
  /**
   *  Restores a DB cluster to an arbitrary point in time. Users can restore to any point in time before LatestRestorableTime for up to BackupRetentionPeriod days. The target DB cluster is created from the source DB cluster with the same configuration as the original DB cluster, except that the new DB cluster is created with the default DB security group.  For more information on Amazon Aurora, see Aurora on Amazon RDS in the Amazon RDS User Guide. 
   */
  restoreDBClusterToPointInTime(callback?: (err: AWSError, data: RDS.RestoreDBClusterToPointInTimeResult) => void): Request<RDS.RestoreDBClusterToPointInTimeResult, AWSError>;
  /**
   ...
   */
  restoreDBInstanceFromDBSnapshot(params: RDS.RestoreDBInstanceFromDBSnapshotMessage, callback?: (err: AWSError, data: RDS.RestoreDBInstanceFromDBSnapshotResult) => void): Request<RDS.RestoreDBInstanceFromDBSnapshotResult, AWSError>;
  /**
   * Creates a new DB instance from a DB snapshot. The target database is created from the source database restore point with the most of original configuration with the default security group and the default DB parameter group. By default, the new DB instance is created as a single-AZ deployment except when the instance is a SQL Server instance that has an option group that is associated with mirroring; in this case, the instance becomes a mirrored AZ deployment and not a single-AZ deployment. If your intent is to replace your original DB instance with the new, restored DB instance, then rename your original DB instance before you call the RestoreDBInstanceFromDBSnapshot action. RDS does not allow two DB instances with the same name. Once you have renamed your original DB instance with a different identifier, then you can pass the original name of the DB instance as the DBInstanceIdentifier in the call to the RestoreDBInstanceFromDBSnapshot action. The result is that you will replace the original DB instance with the DB instance created from the snapshot. If you are restoring from a shared manual DB snapshot, the DBSnapshotIdentifier must be the ARN of the shared DB snapshot.
   */
  restoreDBInstanceFromDBSnapshot(callback?: (err: AWSError, data: RDS.RestoreDBInstanceFromDBSnapshotResult) => void): Request<RDS.RestoreDBInstanceFromDBSnapshotResult, AWSError>;
  /**
   ...
   */
  restoreDBInstanceToPointInTime(params: RDS.RestoreDBInstanceToPointInTimeMessage, callback?: (err: AWSError, data: RDS.RestoreDBInstanceToPointInTimeResult) => void): Request<RDS.RestoreDBInstanceToPointInTimeResult, AWSError>;
  /**
   * Restores a DB instance to an arbitrary point in time. You can restore to any point in time before the time identified by the LatestRestorableTime property. You can restore to a point up to the number of days specified by the BackupRetentionPeriod property. The target database is created with most of the original configuration, but in a system-selected availability zone, with the default security group, the default subnet group, and the default DB parameter group. By default, the new DB instance is created as a single-AZ deployment except when the instance is a SQL Server instance that has an option group that is associated with mirroring; in this case, the instance becomes a mirrored deployment and not a single-AZ deployment.
   */
  restoreDBInstanceToPointInTime(callback?: (err: AWSError, data: RDS.RestoreDBInstanceToPointInTimeResult) => void): Request<RDS.RestoreDBInstanceToPointInTimeResult, AWSError>;
  /**
   * Revokes ingress from a DBSecurityGroup for previously authorized IP ranges or EC2 or VPC Security Groups. Required parameters for this API are one of CIDRIP, EC2SecurityGroupId for VPC, or (EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId).
   */
  revokeDBSecurityGroupIngress(params: RDS.RevokeDBSecurityGroupIngressMessage, callback?: (err: AWSError, data: RDS.RevokeDBSecurityGroupIngressResult) => void): Request<RDS.RevokeDBSecurityGroupIngressResult, AWSError>;
  /**
   * Revokes ingress from a DBSecurityGroup for previously authorized IP ranges or EC2 or VPC Security Groups. Required parameters for this API are one of CIDRIP, EC2SecurityGroupId for VPC, or (EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId).
   */
  revokeDBSecurityGroupIngress(callback?: (err: AWSError, data: RDS.RevokeDBSecurityGroupIngressResult) => void): Request<RDS.RevokeDBSecurityGroupIngressResult, AWSError>;
  /**
   ...
   */
  waitFor(state: "DBInstanceAvailable", params: RDS.DescribeDBInstancesMessage, callback?: (err: AWSError, data: RDS.DBInstanceMessage) => void): Request<RDS.DBInstanceMessage, AWSError>;
  /**
   * Waits for the DBInstanceAvailable state by periodically calling the underlying RDS.describeDBInstancesoperation every 30 seconds (at most 60 times).
   */
  waitFor(state: "DBInstanceAvailable", callback?: (err: AWSError, data: RDS.DBInstanceMessage) => void): Request<RDS.DBInstanceMessage, AWSError>;
  /**
   ...
   */
  waitFor(state: "DBInstanceDeleted", params: RDS.DescribeDBInstancesMessage, callback?: (err: AWSError, data: RDS.DBInstanceMessage) => void): Request<RDS.DBInstanceMessage, AWSError>;
  /**
   * Waits for the DBInstanceDeleted state by periodically calling the underlying RDS.describeDBInstancesoperation every 30 seconds (at most 60 times).
   */
  waitFor(state: "DBInstanceDeleted", callback?: (err: AWSError, data: RDS.DBInstanceMessage) => void): Request<RDS.DBInstanceMessage, AWSError>;
}
declare namespace RDS {
  ...
  export interface ModifyDBInstanceMessage {
    ...
    DBInstanceClass?: String;
    /**
     * The new DB subnet group for the DB instance. You can use this parameter to move your DB instance to a different VPC, or to a different subnet group in the same VPC. If your DB instance is not in a VPC, you can also use this parameter to move your DB instance into a VPC. For more information, see Updating the VPC for a DB Instance.  Changing the subnet group causes an outage during the change. The change is applied during the next maintenance window, unless you specify true for the ApplyImmediately parameter.  Constraints: Must contain no more than 255 alphanumeric characters, periods, underscores, spaces, or hyphens. Example: mySubnetGroup 
     */
    DBSubnetGroupName?: String;
    /**
