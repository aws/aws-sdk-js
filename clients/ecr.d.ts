...
declare class ECR extends Service {
   ...
   */
  batchCheckLayerAvailability(params: ECR.BatchCheckLayerAvailabilityRequest, callback?: (err: AWSError, data: ECR.BatchCheckLayerAvailabilityResponse) => void): Request<ECR.BatchCheckLayerAvailabilityResponse, AWSError>;
  /**
   * Check the availability of multiple image layers in a specified registry and repository.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers. Use the docker CLI to pull, tag, and push images. 
   */
  batchCheckLayerAvailability(callback?: (err: AWSError, data: ECR.BatchCheckLayerAvailabilityResponse) => void): Request<ECR.BatchCheckLayerAvailabilityResponse, AWSError>;
  /**
   * Deletes a list of specified images within a specified repository. Images are specified with either imageTag or imageDigest.
   */
  batchDeleteImage(params: ECR.BatchDeleteImageRequest, callback?: (err: AWSError, data: ECR.BatchDeleteImageResponse) => void): Request<ECR.BatchDeleteImageResponse, AWSError>;
  /**
   * Deletes a list of specified images within a specified repository. Images are specified with either imageTag or imageDigest.
   */
  batchDeleteImage(callback?: (err: AWSError, data: ECR.BatchDeleteImageResponse) => void): Request<ECR.BatchDeleteImageResponse, AWSError>;
  /**
   * Gets detailed information for specified images within a specified repository. Images are specified with either imageTag or imageDigest.
   */
  batchGetImage(params: ECR.BatchGetImageRequest, callback?: (err: AWSError, data: ECR.BatchGetImageResponse) => void): Request<ECR.BatchGetImageResponse, AWSError>;
  /**
   * Gets detailed information for specified images within a specified repository. Images are specified with either imageTag or imageDigest.
   */
  batchGetImage(callback?: (err: AWSError, data: ECR.BatchGetImageResponse) => void): Request<ECR.BatchGetImageResponse, AWSError>;
  /**
   ...
   */
  completeLayerUpload(params: ECR.CompleteLayerUploadRequest, callback?: (err: AWSError, data: ECR.CompleteLayerUploadResponse) => void): Request<ECR.CompleteLayerUploadResponse, AWSError>;
  /**
   * Inform Amazon ECR that the image layer upload for a specified registry, repository name, and upload ID, has completed. You can optionally provide a sha256 digest of the image layer for data validation purposes.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers. Use the docker CLI to pull, tag, and push images. 
   */
  completeLayerUpload(callback?: (err: AWSError, data: ECR.CompleteLayerUploadResponse) => void): Request<ECR.CompleteLayerUploadResponse, AWSError>;
  /**
   * Creates an image repository.
   */
  createRepository(params: ECR.CreateRepositoryRequest, callback?: (err: AWSError, data: ECR.CreateRepositoryResponse) => void): Request<ECR.CreateRepositoryResponse, AWSError>;
  /**
   * Creates an image repository.
   */
  createRepository(callback?: (err: AWSError, data: ECR.CreateRepositoryResponse) => void): Request<ECR.CreateRepositoryResponse, AWSError>;
  /**
   * Deletes an existing image repository. If a repository contains images, you must use the force option to delete it.
   */
  deleteRepository(params: ECR.DeleteRepositoryRequest, callback?: (err: AWSError, data: ECR.DeleteRepositoryResponse) => void): Request<ECR.DeleteRepositoryResponse, AWSError>;
  /**
   * Deletes an existing image repository. If a repository contains images, you must use the force option to delete it.
   */
  deleteRepository(callback?: (err: AWSError, data: ECR.DeleteRepositoryResponse) => void): Request<ECR.DeleteRepositoryResponse, AWSError>;
  /**
   * Deletes the repository policy from a specified repository.
   */
  deleteRepositoryPolicy(params: ECR.DeleteRepositoryPolicyRequest, callback?: (err: AWSError, data: ECR.DeleteRepositoryPolicyResponse) => void): Request<ECR.DeleteRepositoryPolicyResponse, AWSError>;
  /**
   * Deletes the repository policy from a specified repository.
   */
  deleteRepositoryPolicy(callback?: (err: AWSError, data: ECR.DeleteRepositoryPolicyResponse) => void): Request<ECR.DeleteRepositoryPolicyResponse, AWSError>;
  /**
   * Describes image repositories in a registry.
   */
  describeRepositories(params: ECR.DescribeRepositoriesRequest, callback?: (err: AWSError, data: ECR.DescribeRepositoriesResponse) => void): Request<ECR.DescribeRepositoriesResponse, AWSError>;
  /**
   * Describes image repositories in a registry.
   */
  describeRepositories(callback?: (err: AWSError, data: ECR.DescribeRepositoriesResponse) => void): Request<ECR.DescribeRepositoriesResponse, AWSError>;
  /**
   ...
   */
  getAuthorizationToken(params: ECR.GetAuthorizationTokenRequest, callback?: (err: AWSError, data: ECR.GetAuthorizationTokenResponse) => void): Request<ECR.GetAuthorizationTokenResponse, AWSError>;
  /**
   * Retrieves a token that is valid for a specified registry for 12 hours. This command allows you to use the docker CLI to push and pull images with Amazon ECR. If you do not specify a registry, the default registry is assumed. The authorizationToken returned for each registry specified is a base64 encoded string that can be decoded and used in a docker login command to authenticate to a registry. The AWS CLI offers an aws ecr get-login command that simplifies the login process.
   */
  getAuthorizationToken(callback?: (err: AWSError, data: ECR.GetAuthorizationTokenResponse) => void): Request<ECR.GetAuthorizationTokenResponse, AWSError>;
  /**
   ...
   */
  getDownloadUrlForLayer(params: ECR.GetDownloadUrlForLayerRequest, callback?: (err: AWSError, data: ECR.GetDownloadUrlForLayerResponse) => void): Request<ECR.GetDownloadUrlForLayerResponse, AWSError>;
  /**
   * Retrieves the pre-signed Amazon S3 download URL corresponding to an image layer. You can only get URLs for image layers that are referenced in an image.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers. Use the docker CLI to pull, tag, and push images. 
   */
  getDownloadUrlForLayer(callback?: (err: AWSError, data: ECR.GetDownloadUrlForLayerResponse) => void): Request<ECR.GetDownloadUrlForLayerResponse, AWSError>;
  /**
   * Retrieves the repository policy for a specified repository.
   */
  getRepositoryPolicy(params: ECR.GetRepositoryPolicyRequest, callback?: (err: AWSError, data: ECR.GetRepositoryPolicyResponse) => void): Request<ECR.GetRepositoryPolicyResponse, AWSError>;
  /**
   * Retrieves the repository policy for a specified repository.
   */
  getRepositoryPolicy(callback?: (err: AWSError, data: ECR.GetRepositoryPolicyResponse) => void): Request<ECR.GetRepositoryPolicyResponse, AWSError>;
  /**
   ...
   */
  initiateLayerUpload(params: ECR.InitiateLayerUploadRequest, callback?: (err: AWSError, data: ECR.InitiateLayerUploadResponse) => void): Request<ECR.InitiateLayerUploadResponse, AWSError>;
  /**
   * Notify Amazon ECR that you intend to upload an image layer.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers. Use the docker CLI to pull, tag, and push images. 
   */
  initiateLayerUpload(callback?: (err: AWSError, data: ECR.InitiateLayerUploadResponse) => void): Request<ECR.InitiateLayerUploadResponse, AWSError>;
  /**
   ...
   */
  listImages(params: ECR.ListImagesRequest, callback?: (err: AWSError, data: ECR.ListImagesResponse) => void): Request<ECR.ListImagesResponse, AWSError>;
  /**
   * Lists all the image IDs for a given repository. You can filter images based on whether or not they are tagged by setting the tagStatus parameter to TAGGED or UNTAGGED. For example, you can filter your results to return only UNTAGGED images and then pipe that result to a BatchDeleteImage operation to delete them. Or, you can filter your results to return only TAGGED images to list all of the tags in your repository.
   */
  listImages(callback?: (err: AWSError, data: ECR.ListImagesResponse) => void): Request<ECR.ListImagesResponse, AWSError>;
  /**
   ...
   */
  putImage(params: ECR.PutImageRequest, callback?: (err: AWSError, data: ECR.PutImageResponse) => void): Request<ECR.PutImageResponse, AWSError>;
  /**
   * Creates or updates the image manifest associated with an image.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers. Use the docker CLI to pull, tag, and push images. 
   */
  putImage(callback?: (err: AWSError, data: ECR.PutImageResponse) => void): Request<ECR.PutImageResponse, AWSError>;
  /**
   * Applies a repository policy on a specified repository to control access permissions.
   */
  setRepositoryPolicy(params: ECR.SetRepositoryPolicyRequest, callback?: (err: AWSError, data: ECR.SetRepositoryPolicyResponse) => void): Request<ECR.SetRepositoryPolicyResponse, AWSError>;
  /**
   * Applies a repository policy on a specified repository to control access permissions.
   */
  setRepositoryPolicy(callback?: (err: AWSError, data: ECR.SetRepositoryPolicyResponse) => void): Request<ECR.SetRepositoryPolicyResponse, AWSError>;
  /**
   ...
   */
  uploadLayerPart(params: ECR.UploadLayerPartRequest, callback?: (err: AWSError, data: ECR.UploadLayerPartResponse) => void): Request<ECR.UploadLayerPartResponse, AWSError>;
  /**
   * Uploads an image layer part to Amazon ECR.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers. Use the docker CLI to pull, tag, and push images. 
   */
  uploadLayerPart(callback?: (err: AWSError, data: ECR.UploadLayerPartResponse) => void): Request<ECR.UploadLayerPartResponse, AWSError>;
}
