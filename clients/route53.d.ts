...
declare class Route53 extends Service {
   ...
   */
  createHealthCheck(params: Route53.CreateHealthCheckRequest, callback?: (err: AWSError, data: Route53.CreateHealthCheckResponse) => void): Request<Route53.CreateHealthCheckResponse, AWSError>;
  /**
   * Creates a new health check. To create a new health check, send a POST request to the /2013-04-01/healthcheck resource. The request body must include an XML document with a CreateHealthCheckRequest element. The response returns the CreateHealthCheckResponse element, containing the health check ID specified when adding health check to a resource record set. For information about adding health checks to resource record sets, see ResourceRecordSet$HealthCheckId in ChangeResourceRecordSets.  If you are registering Amazon EC2 instances with an Elastic Load Balancing (ELB) load balancer, do not create Amazon Route 53 health checks for the Amazon EC2 instances. When you register an Amazon EC2 instance with a load balancer, you configure settings for an ELB health check, which performs a similar function to an Amazon Route 53 health check. You can associate health checks with failover resource record sets in a private hosted zone. Note the following:   Amazon Route 53 health checkers are outside the VPC. To check the health of an endpoint within a VPC by IP address, you must assign a public IP address to the instance in the VPC.   You can configure a health checker to check the health of an external resource that the instance relies on, such as a database server.   You can create a CloudWatch metric, associate an alarm with the metric, and then create a health check that is based on the state of the alarm. For example, you might create a CloudWatch metric that checks the status of the Amazon EC2 StatusCheckFailed metric, add an alarm to the metric, and then create a health check that is based on the state of the alarm. For information about creating CloudWatch metrics and alarms by using the CloudWatch console, see the Amazon CloudWatch Developer Guide.  
   */
  createHealthCheck(callback?: (err: AWSError, data: Route53.CreateHealthCheckResponse) => void): Request<Route53.CreateHealthCheckResponse, AWSError>;
  /**
   * Creates a new public hosted zone, used to specify how the Domain Name System (DNS) routes traffic on the Internet for a domain, such as example.com, and its subdomains.   Public hosted zones cannot be converted to a private hosted zone or vice versa. Instead, create a new hosted zone with the same name and create new resource record sets.  Send a POST request to the /Amazon Route 53 API version/hostedzone resource. The request body must include an XML document with a CreateHostedZoneRequest element. The response returns the CreateHostedZoneResponse element containing metadata about the hosted zone. Fore more information about charges for hosted zones, see AmazonAmazon Route 53 Pricing. Note the following:   You cannot create a hosted zone for a top-level domain (TLD).   Amazon Route 53 automatically creates a default SOA record and four NS records for the zone. For more information about SOA and NS records, see NS and SOA Records that Amazon Route 53 Creates for a Hosted Zone in the Amazon Route 53 Developer Guide.   If your domain is registered with a registrar other than Amazon Route 53, you must update the name servers with your registrar to make Amazon Route 53 your DNS service. For more information, see Configuring Amazon Route 53 as your DNS Service in the Amazon Route 53 Developer's Guide.   After creating a zone, its initial status is PENDING. This means that it is not yet available on all DNS servers. The status of the zone changes to INSYNC when the NS and SOA records are available on all Amazon Route 53 DNS servers.  When trying to create a hosted zone using a reusable delegation set, specify an optional DelegationSetId, and Amazon Route 53 would assign those 4 NS records for the zone, instead of alloting a new one.
   */
  createHostedZone(params: Route53.CreateHostedZoneRequest, callback?: (err: AWSError, data: Route53.CreateHostedZoneResponse) => void): Request<Route53.CreateHostedZoneResponse, AWSError>;
  /**
   * Creates a new public hosted zone, used to specify how the Domain Name System (DNS) routes traffic on the Internet for a domain, such as example.com, and its subdomains.   Public hosted zones cannot be converted to a private hosted zone or vice versa. Instead, create a new hosted zone with the same name and create new resource record sets.  Send a POST request to the /Amazon Route 53 API version/hostedzone resource. The request body must include an XML document with a CreateHostedZoneRequest element. The response returns the CreateHostedZoneResponse element containing metadata about the hosted zone. Fore more information about charges for hosted zones, see AmazonAmazon Route 53 Pricing. Note the following:   You cannot create a hosted zone for a top-level domain (TLD).   Amazon Route 53 automatically creates a default SOA record and four NS records for the zone. For more information about SOA and NS records, see NS and SOA Records that Amazon Route 53 Creates for a Hosted Zone in the Amazon Route 53 Developer Guide.   If your domain is registered with a registrar other than Amazon Route 53, you must update the name servers with your registrar to make Amazon Route 53 your DNS service. For more information, see Configuring Amazon Route 53 as your DNS Service in the Amazon Route 53 Developer's Guide.   After creating a zone, its initial status is PENDING. This means that it is not yet available on all DNS servers. The status of the zone changes to INSYNC when the NS and SOA records are available on all Amazon Route 53 DNS servers.  When trying to create a hosted zone using a reusable delegation set, specify an optional DelegationSetId, and Amazon Route 53 would assign those 4 NS records for the zone, instead of alloting a new one.
   */
  createHostedZone(callback?: (err: AWSError, data: Route53.CreateHostedZoneResponse) => void): Request<Route53.CreateHostedZoneResponse, AWSError>;
  /**
   * Creates a delegation set (a group of four anem servers) that can be reused by multiple hosted zones. If a hosted zoned ID is specified, CreateReusableDelegationSet marks the delegation set associated with that zone as reusable Send a POST request to the /Amazon Route 53 API version/delegationset resource. The request body must include an XML document with a CreateReusableDelegationSetRequest element.  A reusable delegation set cannot be associated with a private hosted zone/  For more information, including a procedure on how to create and configure a reusable delegation set (also known as white label name servers), see Configuring White Label Name Servers.
   */
  createReusableDelegationSet(params: Route53.CreateReusableDelegationSetRequest, callback?: (err: AWSError, data: Route53.CreateReusableDelegationSetResponse) => void): Request<Route53.CreateReusableDelegationSetResponse, AWSError>;
  /**
   * Creates a delegation set (a group of four anem servers) that can be reused by multiple hosted zones. If a hosted zoned ID is specified, CreateReusableDelegationSet marks the delegation set associated with that zone as reusable Send a POST request to the /Amazon Route 53 API version/delegationset resource. The request body must include an XML document with a CreateReusableDelegationSetRequest element.  A reusable delegation set cannot be associated with a private hosted zone/  For more information, including a procedure on how to create and configure a reusable delegation set (also known as white label name servers), see Configuring White Label Name Servers.
   */
  createReusableDelegationSet(callback?: (err: AWSError, data: Route53.CreateReusableDelegationSetResponse) => void): Request<Route53.CreateReusableDelegationSetResponse, AWSError>;
  /**
   * Creates a traffic policy, which you use to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com). Send a POST request to the /Amazon Route 53 API version/trafficpolicy resource. The request body must include a document with a CreateTrafficPolicyRequest element. The response includes the CreateTrafficPolicyResponse element, which contains information about the new traffic policy.
   */
  createTrafficPolicy(params: Route53.CreateTrafficPolicyRequest, callback?: (err: AWSError, data: Route53.CreateTrafficPolicyResponse) => void): Request<Route53.CreateTrafficPolicyResponse, AWSError>;
  /**
   * Creates a traffic policy, which you use to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com). Send a POST request to the /Amazon Route 53 API version/trafficpolicy resource. The request body must include a document with a CreateTrafficPolicyRequest element. The response includes the CreateTrafficPolicyResponse element, which contains information about the new traffic policy.
   */
  createTrafficPolicy(callback?: (err: AWSError, data: Route53.CreateTrafficPolicyResponse) => void): Request<Route53.CreateTrafficPolicyResponse, AWSError>;
  /**
   ...
   */
  createTrafficPolicyInstance(params: Route53.CreateTrafficPolicyInstanceRequest, callback?: (err: AWSError, data: Route53.CreateTrafficPolicyInstanceResponse) => void): Request<Route53.CreateTrafficPolicyInstanceResponse, AWSError>;
  /**
   * Creates resource record sets in a specified hosted zone based on the settings in a specified traffic policy version. In addition, CreateTrafficPolicyInstance associates the resource record sets with a specified domain name (such as example.com) or subdomain name (such as www.example.com). Amazon Route 53 responds to DNS queries for the domain or subdomain name by using the resource record sets that CreateTrafficPolicyInstance created. Send a POST request to the /Amazon Route 53 API version/trafficpolicyinstance resource. The request body must include a document with a CreateTrafficPolicyRequest element. The response returns the CreateTrafficPolicyInstanceResponse element, which contains information about the traffic policy instance.
   */
  createTrafficPolicyInstance(callback?: (err: AWSError, data: Route53.CreateTrafficPolicyInstanceResponse) => void): Request<Route53.CreateTrafficPolicyInstanceResponse, AWSError>;
  /**
   ...
   */
  createTrafficPolicyVersion(params: Route53.CreateTrafficPolicyVersionRequest, callback?: (err: AWSError, data: Route53.CreateTrafficPolicyVersionResponse) => void): Request<Route53.CreateTrafficPolicyVersionResponse, AWSError>;
  /**
   * Creates a new version of an existing traffic policy. When you create a new version of a traffic policy, you specify the ID of the traffic policy that you want to update and a JSON-formatted document that describes the new version. You use traffic policies to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com). You can create a maximum of 1000 versions of a traffic policy. If you reach the limit and need to create another version, you'll need to start a new traffic policy. Send a POST request to the /Amazon Route 53 version/trafficpolicy/ resource. The request body includes a document with a CreateTrafficPolicyVersionRequest element. The response returns the CreateTrafficPolicyVersionResponse element, which contains information about the new version of the traffic policy.
   */
  createTrafficPolicyVersion(callback?: (err: AWSError, data: Route53.CreateTrafficPolicyVersionResponse) => void): Request<Route53.CreateTrafficPolicyVersionResponse, AWSError>;
  /**
   ...
   */
  deleteHealthCheck(params: Route53.DeleteHealthCheckRequest, callback?: (err: AWSError, data: Route53.DeleteHealthCheckResponse) => void): Request<Route53.DeleteHealthCheckResponse, AWSError>;
  /**
   * Deletes a health check. Send a DELETE request to the /2013-04-01/healthcheck/health check ID  resource.  Amazon Route 53 does not prevent you from deleting a health check even if the health check is associated with one or more resource record sets. If you delete a health check and you don't update the associated resource record sets, the future status of the health check cannot be predicted and may change. This will affect the routing of DNS queries for your DNS failover configuration. For more information, see Replacing and Deleting Health Checks in the Amazon Route 53 Developer Guide. 
   */
  deleteHealthCheck(callback?: (err: AWSError, data: Route53.DeleteHealthCheckResponse) => void): Request<Route53.DeleteHealthCheckResponse, AWSError>;
  /**
   ...
   */
  deleteHostedZone(params: Route53.DeleteHostedZoneRequest, callback?: (err: AWSError, data: Route53.DeleteHostedZoneResponse) => void): Request<Route53.DeleteHostedZoneResponse, AWSError>;
  /**
   * Deletes a hosted zone. Send a DELETE request to the /Amazon Route 53 API version/hostedzone/hosted zone ID  resource.  Delete a hosted zone only if there are no resource record sets other than the default SOA record and NS resource record sets. If the hosted zone contains other resource record sets, delete them before deleting the hosted zone. If you try to delete a hosted zone that contains other resource record sets, Amazon Route 53 denies your request with a HostedZoneNotEmpty error. For information about deleting records from your hosted zone, see ChangeResourceRecordSets. 
   */
  deleteHostedZone(callback?: (err: AWSError, data: Route53.DeleteHostedZoneResponse) => void): Request<Route53.DeleteHostedZoneResponse, AWSError>;
  /**
   ...
   */
  deleteReusableDelegationSet(params: Route53.DeleteReusableDelegationSetRequest, callback?: (err: AWSError, data: Route53.DeleteReusableDelegationSetResponse) => void): Request<Route53.DeleteReusableDelegationSetResponse, AWSError>;
  /**
   * Deletes a reusable delegation set. Send a DELETE request to the /2013-04-01/delegationset/delegation set ID  resource.   You can delete a reusable delegation set only if there are no associated hosted zones.  To verify that the reusable delegation set is not associated with any hosted zones, run the GetReusableDelegationSet action and specify the ID of the reusable delegation set that you want to delete.
   */
  deleteReusableDelegationSet(callback?: (err: AWSError, data: Route53.DeleteReusableDelegationSetResponse) => void): Request<Route53.DeleteReusableDelegationSetResponse, AWSError>;
  /**
   * Deletes a traffic policy. Send a DELETE request to the /Amazon Route 53 API version/trafficpolicy resource.
   */
  deleteTrafficPolicy(params: Route53.DeleteTrafficPolicyRequest, callback?: (err: AWSError, data: Route53.DeleteTrafficPolicyResponse) => void): Request<Route53.DeleteTrafficPolicyResponse, AWSError>;
  /**
   * Deletes a traffic policy. Send a DELETE request to the /Amazon Route 53 API version/trafficpolicy resource.
   */
  deleteTrafficPolicy(callback?: (err: AWSError, data: Route53.DeleteTrafficPolicyResponse) => void): Request<Route53.DeleteTrafficPolicyResponse, AWSError>;
  /**
   ...
   */
  deleteTrafficPolicyInstance(params: Route53.DeleteTrafficPolicyInstanceRequest, callback?: (err: AWSError, data: Route53.DeleteTrafficPolicyInstanceResponse) => void): Request<Route53.DeleteTrafficPolicyInstanceResponse, AWSError>;
  /**
   * Deletes a traffic policy instance and all of the resource record sets that Amazon Route 53 created when you created the instance. Send a DELETE request to the /Amazon Route 53 API version/trafficpolicy/traffic policy instance ID  resource.  In the Amazon Route 53 console, traffic policy instances are known as policy records. 
   */
  deleteTrafficPolicyInstance(callback?: (err: AWSError, data: Route53.DeleteTrafficPolicyInstanceResponse) => void): Request<Route53.DeleteTrafficPolicyInstanceResponse, AWSError>;
  /**
   * Disassociates a VPC from a Amazon Route 53 private hosted zone.  Send a POST request to the /Amazon Route 53 API version/hostedzone/hosted zone ID/disassociatevpc resource. The request body must include an XML document with a DisassociateVPCFromHostedZoneRequest element. The response returns the DisassociateVPCFromHostedZoneResponse element.  You can only disassociate a VPC from a private hosted zone when two or more VPCs are associated with that hosted zone. You cannot convert a private hosted zone into a public hosted zone. 
   */
  disassociateVPCFromHostedZone(params: Route53.DisassociateVPCFromHostedZoneRequest, callback?: (err: AWSError, data: Route53.DisassociateVPCFromHostedZoneResponse) => void): Request<Route53.DisassociateVPCFromHostedZoneResponse, AWSError>;
  /**
   * Disassociates a VPC from a Amazon Route 53 private hosted zone.  Send a POST request to the /Amazon Route 53 API version/hostedzone/hosted zone ID/disassociatevpc resource. The request body must include an XML document with a DisassociateVPCFromHostedZoneRequest element. The response returns the DisassociateVPCFromHostedZoneResponse element.  You can only disassociate a VPC from a private hosted zone when two or more VPCs are associated with that hosted zone. You cannot convert a private hosted zone into a public hosted zone. 
   */
  disassociateVPCFromHostedZone(callback?: (err: AWSError, data: Route53.DisassociateVPCFromHostedZoneResponse) => void): Request<Route53.DisassociateVPCFromHostedZoneResponse, AWSError>;
  /**
   ...
   */
  getChange(params: Route53.GetChangeRequest, callback?: (err: AWSError, data: Route53.GetChangeResponse) => void): Request<Route53.GetChangeResponse, AWSError>;
  /**
   * Returns the current status of a change batch request. The status is one of the following values:    PENDING indicates that the changes in this request have not replicated to all Amazon Route 53 DNS servers. This is the initial status of all change batch requests.    INSYNC indicates that the changes have replicated to all Amazon Route 53 DNS servers.   
   */
  getChange(callback?: (err: AWSError, data: Route53.GetChangeResponse) => void): Request<Route53.GetChangeResponse, AWSError>;
  /**
   * Returns the status and changes of a change batch request.
   */
  getChangeDetails(params: Route53.GetChangeDetailsRequest, callback?: (err: AWSError, data: Route53.GetChangeDetailsResponse) => void): Request<Route53.GetChangeDetailsResponse, AWSError>;
  /**
   * Returns the status and changes of a change batch request.
   */
  getChangeDetails(callback?: (err: AWSError, data: Route53.GetChangeDetailsResponse) => void): Request<Route53.GetChangeDetailsResponse, AWSError>;
  /**
   ...
   */
  getCheckerIpRanges(params: Route53.GetCheckerIpRangesRequest, callback?: (err: AWSError, data: Route53.GetCheckerIpRangesResponse) => void): Request<Route53.GetCheckerIpRangesResponse, AWSError>;
  /**
   * Retrieves a list of the IP ranges used by Amazon Route 53 health checkers to check the health of your resources. Send a GET request to the /Amazon Route 53 API version/checkeripranges resource. Use these IP addresses to configure router and firewall rules to allow health checkers to check the health of your resources.
   */
  getCheckerIpRanges(callback?: (err: AWSError, data: Route53.GetCheckerIpRangesResponse) => void): Request<Route53.GetCheckerIpRangesResponse, AWSError>;
  /**
   ...
   */
  getGeoLocation(params: Route53.GetGeoLocationRequest, callback?: (err: AWSError, data: Route53.GetGeoLocationResponse) => void): Request<Route53.GetGeoLocationResponse, AWSError>;
  /**
   * Retrieves a single geo location. Send a GET request to the /2013-04-01/geolocation resource with one of these options: continentcode | countrycode | countrycode and subdivisioncode.
   */
  getGeoLocation(callback?: (err: AWSError, data: Route53.GetGeoLocationResponse) => void): Request<Route53.GetGeoLocationResponse, AWSError>;
  /**
   ...
   */
  getHealthCheck(params: Route53.GetHealthCheckRequest, callback?: (err: AWSError, data: Route53.GetHealthCheckResponse) => void): Request<Route53.GetHealthCheckResponse, AWSError>;
  /**
   * Gets information about a specified health check. Send a GET request to the /2013-04-01/healthcheck/health check ID  resource. For more information about using the console to perform this operation, see Amazon Route 53 Health Checks and DNS Failover in the Amazon Route 53 Developer Guide.
   */
  getHealthCheck(callback?: (err: AWSError, data: Route53.GetHealthCheckResponse) => void): Request<Route53.GetHealthCheckResponse, AWSError>;
  /**
   * To retrieve a count of all your health checks, send a GET request to the /2013-04-01/healthcheckcount resource.
   */
  getHealthCheckCount(params: Route53.GetHealthCheckCountRequest, callback?: (err: AWSError, data: Route53.GetHealthCheckCountResponse) => void): Request<Route53.GetHealthCheckCountResponse, AWSError>;
  /**
   * To retrieve a count of all your health checks, send a GET request to the /2013-04-01/healthcheckcount resource.
   */
  getHealthCheckCount(callback?: (err: AWSError, data: Route53.GetHealthCheckCountResponse) => void): Request<Route53.GetHealthCheckCountResponse, AWSError>;
  /**
   ...
   */
  getHealthCheckLastFailureReason(params: Route53.GetHealthCheckLastFailureReasonRequest, callback?: (err: AWSError, data: Route53.GetHealthCheckLastFailureReasonResponse) => void): Request<Route53.GetHealthCheckLastFailureReasonResponse, AWSError>;
  /**
   * If you want to learn why a health check is currently failing or why it failed most recently (if at all), you can get the failure reason for the most recent failure. Send a GET request to the /Amazon Route 53 API version/healthcheck/health check ID/lastfailurereason resource.
   */
  getHealthCheckLastFailureReason(callback?: (err: AWSError, data: Route53.GetHealthCheckLastFailureReasonResponse) => void): Request<Route53.GetHealthCheckLastFailureReasonResponse, AWSError>;
  /**
   ...
   */
  getHealthCheckStatus(params: Route53.GetHealthCheckStatusRequest, callback?: (err: AWSError, data: Route53.GetHealthCheckStatusResponse) => void): Request<Route53.GetHealthCheckStatusResponse, AWSError>;
  /**
   * Gets status of a specified health check. Send a GET request to the /2013-04-01/healthcheck/health check ID/status resource. You can use this call to get a health check's current status. 
   */
  getHealthCheckStatus(callback?: (err: AWSError, data: Route53.GetHealthCheckStatusResponse) => void): Request<Route53.GetHealthCheckStatusResponse, AWSError>;
  /**
   ...
   */
  getHostedZone(params: Route53.GetHostedZoneRequest, callback?: (err: AWSError, data: Route53.GetHostedZoneResponse) => void): Request<Route53.GetHostedZoneResponse, AWSError>;
  /**
   * Retrieves the delegation set for a hosted zone, including the four name servers assigned to the hosted zone. Send a GET request to the /Amazon Route 53 API version/hostedzone/hosted zone ID  resource. 
   */
  getHostedZone(callback?: (err: AWSError, data: Route53.GetHostedZoneResponse) => void): Request<Route53.GetHostedZoneResponse, AWSError>;
  /**
   * Retrieves a count of all your hosted zones. Send a GET request to the /2013-04-01/hostedzonecount resource.
   */
  getHostedZoneCount(params: Route53.GetHostedZoneCountRequest, callback?: (err: AWSError, data: Route53.GetHostedZoneCountResponse) => void): Request<Route53.GetHostedZoneCountResponse, AWSError>;
  /**
   * Retrieves a count of all your hosted zones. Send a GET request to the /2013-04-01/hostedzonecount resource.
   */
  getHostedZoneCount(callback?: (err: AWSError, data: Route53.GetHostedZoneCountResponse) => void): Request<Route53.GetHostedZoneCountResponse, AWSError>;
  /**
   * Retrieves the reusable delegation set. Send a GET request to the /2013-04-01/delegationset/delegation set ID  resource.
   */
  getReusableDelegationSet(params: Route53.GetReusableDelegationSetRequest, callback?: (err: AWSError, data: Route53.GetReusableDelegationSetResponse) => void): Request<Route53.GetReusableDelegationSetResponse, AWSError>;
  /**
   * Retrieves the reusable delegation set. Send a GET request to the /2013-04-01/delegationset/delegation set ID  resource.
   */
  getReusableDelegationSet(callback?: (err: AWSError, data: Route53.GetReusableDelegationSetResponse) => void): Request<Route53.GetReusableDelegationSetResponse, AWSError>;
  /**
   ...
   */
  getTrafficPolicy(params: Route53.GetTrafficPolicyRequest, callback?: (err: AWSError, data: Route53.GetTrafficPolicyResponse) => void): Request<Route53.GetTrafficPolicyResponse, AWSError>;
  /**
   * Gets information about a specific traffic policy version. Send a GET request to the /Amazon Route 53 API version/trafficpolicy resource.
   */
  getTrafficPolicy(callback?: (err: AWSError, data: Route53.GetTrafficPolicyResponse) => void): Request<Route53.GetTrafficPolicyResponse, AWSError>;
  /**
   ...
   */
  getTrafficPolicyInstance(params: Route53.GetTrafficPolicyInstanceRequest, callback?: (err: AWSError, data: Route53.GetTrafficPolicyInstanceResponse) => void): Request<Route53.GetTrafficPolicyInstanceResponse, AWSError>;
  /**
   * Gets information about a specified traffic policy instance. Send a GET request to the /Amazon Route 53 API version/trafficpolicyinstance resource.  After you submit a CreateTrafficPolicyInstance or an UpdateTrafficPolicyInstance request, there's a brief delay while Amazon Route 53 creates the resource record sets that are specified in the traffic policy definition. For more information, see the State response element.   In the Amazon Route 53 console, traffic policy instances are known as policy records. 
   */
  getTrafficPolicyInstance(callback?: (err: AWSError, data: Route53.GetTrafficPolicyInstanceResponse) => void): Request<Route53.GetTrafficPolicyInstanceResponse, AWSError>;
  /**
   ...
   */
  getTrafficPolicyInstanceCount(params: Route53.GetTrafficPolicyInstanceCountRequest, callback?: (err: AWSError, data: Route53.GetTrafficPolicyInstanceCountResponse) => void): Request<Route53.GetTrafficPolicyInstanceCountResponse, AWSError>;
  /**
   * Gets the number of traffic policy instances that are associated with the current AWS account. To get the number of traffic policy instances, send a GET request to the /2013-04-01/trafficpolicyinstancecount resource.
   */
  getTrafficPolicyInstanceCount(callback?: (err: AWSError, data: Route53.GetTrafficPolicyInstanceCountResponse) => void): Request<Route53.GetTrafficPolicyInstanceCountResponse, AWSError>;
  /**
   * Gets the list of ChangeBatches in a given time period for a given hosted zone.
   */
  listChangeBatchesByHostedZone(params: Route53.ListChangeBatchesByHostedZoneRequest, callback?: (err: AWSError, data: Route53.ListChangeBatchesByHostedZoneResponse) => void): Request<Route53.ListChangeBatchesByHostedZoneResponse, AWSError>;
  /**
   * Gets the list of ChangeBatches in a given time period for a given hosted zone.
   */
  listChangeBatchesByHostedZone(callback?: (err: AWSError, data: Route53.ListChangeBatchesByHostedZoneResponse) => void): Request<Route53.ListChangeBatchesByHostedZoneResponse, AWSError>;
  /**
   * Gets the list of ChangeBatches in a given time period for a given hosted zone and RRSet.
   */
  listChangeBatchesByRRSet(params: Route53.ListChangeBatchesByRRSetRequest, callback?: (err: AWSError, data: Route53.ListChangeBatchesByRRSetResponse) => void): Request<Route53.ListChangeBatchesByRRSetResponse, AWSError>;
  /**
   * Gets the list of ChangeBatches in a given time period for a given hosted zone and RRSet.
   */
  listChangeBatchesByRRSet(callback?: (err: AWSError, data: Route53.ListChangeBatchesByRRSetResponse) => void): Request<Route53.ListChangeBatchesByRRSetResponse, AWSError>;
  /**
   ...
   */
  listGeoLocations(params: Route53.ListGeoLocationsRequest, callback?: (err: AWSError, data: Route53.ListGeoLocationsResponse) => void): Request<Route53.ListGeoLocationsResponse, AWSError>;
  /**
   * Retrieves a list of supported geo locations. Send a GET request to the /2013-04-01/geolocations resource. The response to this request includes a GeoLocationDetailsList element for each location that Amazon Route 53 supports. Countries are listed first, and continents are listed last. If Amazon Route 53 supports subdivisions for a country (for example, states or provinces), the subdivisions for that country are listed in alphabetical order immediately after the corresponding country. 
   */
  listGeoLocations(callback?: (err: AWSError, data: Route53.ListGeoLocationsResponse) => void): Request<Route53.ListGeoLocationsResponse, AWSError>;
  /**
   ...
   */
  listHealthChecks(params: Route53.ListHealthChecksRequest, callback?: (err: AWSError, data: Route53.ListHealthChecksResponse) => void): Request<Route53.ListHealthChecksResponse, AWSError>;
  /**
   * Retrieve a list of your health checks. Send a GET request to the /2013-04-01/healthcheck resource. The response to this request includes a HealthChecks element with zero or more HealthCheck child elements. By default, the list of health checks is displayed on a single page. You can control the length of the page that is displayed by using the MaxItems parameter. You can use the Marker parameter to control the health check that the list begins with. For information about listing health checks using the Amazon Route 53 console, see Amazon Route 53 Health Checks and DNS Failover.
   */
  listHealthChecks(callback?: (err: AWSError, data: Route53.ListHealthChecksResponse) => void): Request<Route53.ListHealthChecksResponse, AWSError>;
  /**
   ...
   */
  listHostedZones(params: Route53.ListHostedZonesRequest, callback?: (err: AWSError, data: Route53.ListHostedZonesResponse) => void): Request<Route53.ListHostedZonesResponse, AWSError>;
  /**
   * To retrieve a list of your public and private hosted zones, send a GET request to the /2013-04-01/hostedzone resource. The response to this request includes a HostedZones child element for each hosted zone created by the current AWS account. Amazon Route 53 returns a maximum of 100 items in each response. If you have a lot of hosted zones, you can use the maxitems parameter to list them in groups of up to 100. The response includes four values that help navigate from one group of maxitems hosted zones to the next:    MaxItemsis the value specified for the maxitems parameter in the request that produced the current response.   If the value of IsTruncated in the response is true, there are more hosted zones associated with the current AWS account.     NextMarkeris the hosted zone ID of the next hosted zone that is associated with the current AWS account. If you want to list more hosted zones, make another call to ListHostedZones, and specify the value of the NextMarker element in the marker parameter.  If IsTruncated is false, the NextMarker element is omitted from the response.   If you're making the second or subsequent call to ListHostedZones, the Marker element matches the value that you specified in the marker parameter in the previous request.  
   */
  listHostedZones(callback?: (err: AWSError, data: Route53.ListHostedZonesResponse) => void): Request<Route53.ListHostedZonesResponse, AWSError>;
  /**
   ...
   */
  listHostedZonesByName(params: Route53.ListHostedZonesByNameRequest, callback?: (err: AWSError, data: Route53.ListHostedZonesByNameResponse) => void): Request<Route53.ListHostedZonesByNameResponse, AWSError>;
  /**
   * Retrieves a list of your hosted zones in lexicographic order. Send a GET request to the /2013-04-01/hostedzonesbyname resource. The response includes a HostedZones child element for each hosted zone created by the current AWS account.   ListHostedZonesByName sorts hosted zones by name with the labels reversed. For example:    com.example.www.    Note the trailing dot, which can change the sort order in some circumstances. If the domain name includes escape characters or Punycode, ListHostedZonesByName alphabetizes the domain name using the escaped or Punycoded value, which is the format that Amazon Route 53 saves in its database. For example, to create a hosted zone for example.com, specify ex\344mple.com for the domain name. ListHostedZonesByName alphabetizes it as:    com.ex\344mple.    The labels are reversed and alphabetized using the escaped value. For more information about valid domain name formats, including internationalized domain names, see DNS Domain Name Format in the Amazon Route 53 Developer Guide. Amazon Route 53 returns up to 100 items in each response. If you have a lot of hosted zones, use the MaxItems parameter to list them in groups of up to 100. The response includes values that help navigate from one group of MaxItems hosted zones to the next:   The DNSName and HostedZoneId elements in the response contain the values, if any, specified for the dnsname and hostedzoneid parameters in the request that produced the current response.   The MaxItems element in the response contains the value, if any, that you specified for the maxitems parameter in the request that produced the current response.   If the value of IsTruncated in the response is true, there are more hosted zones associated with the current AWS account.  If IsTruncated is false, this response includes the last hosted zone that is associated with the current account. The NextDNSName element and NextHostedZoneId elements are omitted from the response.   The NextDNSName and NextHostedZoneId elements in the response contain the domain name and the hosted zone ID of the next hosted zone that is associated with the current AWS account. If you want to list more hosted zones, make another call to ListHostedZonesByName, and specify the value of NextDNSName and NextHostedZoneId in the dnsname and hostedzoneid parameters, respectively.  
   */
  listHostedZonesByName(callback?: (err: AWSError, data: Route53.ListHostedZonesByNameResponse) => void): Request<Route53.ListHostedZonesByNameResponse, AWSError>;
  /**
   * 
   */
  listResourceRecordSets(params: Route53.ListResourceRecordSetsRequest, callback?: (err: AWSError, data: Route53.ListResourceRecordSetsResponse) => void): Request<Route53.ListResourceRecordSetsResponse, AWSError>;
  /**
   * 
   */
  listResourceRecordSets(callback?: (err: AWSError, data: Route53.ListResourceRecordSetsResponse) => void): Request<Route53.ListResourceRecordSetsResponse, AWSError>;
  /**
   ...
   */
  listReusableDelegationSets(params: Route53.ListReusableDelegationSetsRequest, callback?: (err: AWSError, data: Route53.ListReusableDelegationSetsResponse) => void): Request<Route53.ListReusableDelegationSetsResponse, AWSError>;
  /**
   * To retrieve a list of your reusable delegation sets, send a GET request to the /2013-04-01/delegationset resource. The response to this request includes a DelegationSets element with zero, one, or multiple DelegationSet child elements. By default, the list of delegation sets is displayed on a single page. You can control the length of the page that is displayed by using the MaxItems parameter. You can use the Marker parameter to control the delegation set that the list begins with.    Amazon Route 53 returns a maximum of 100 items. If you set MaxItems to a value greater than 100, Amazon Route 53 returns only the first 100. 
   */
  listReusableDelegationSets(callback?: (err: AWSError, data: Route53.ListReusableDelegationSetsResponse) => void): Request<Route53.ListReusableDelegationSetsResponse, AWSError>;
  /**
   * 
   */
  listTagsForResource(params: Route53.ListTagsForResourceRequest, callback?: (err: AWSError, data: Route53.ListTagsForResourceResponse) => void): Request<Route53.ListTagsForResourceResponse, AWSError>;
  /**
   * 
   */
  listTagsForResource(callback?: (err: AWSError, data: Route53.ListTagsForResourceResponse) => void): Request<Route53.ListTagsForResourceResponse, AWSError>;
  /**
   * 
   */
  listTagsForResources(params: Route53.ListTagsForResourcesRequest, callback?: (err: AWSError, data: Route53.ListTagsForResourcesResponse) => void): Request<Route53.ListTagsForResourcesResponse, AWSError>;
  /**
   * 
   */
  listTagsForResources(callback?: (err: AWSError, data: Route53.ListTagsForResourcesResponse) => void): Request<Route53.ListTagsForResourcesResponse, AWSError>;
  /**
   ...
   */
  listTrafficPolicies(params: Route53.ListTrafficPoliciesRequest, callback?: (err: AWSError, data: Route53.ListTrafficPoliciesResponse) => void): Request<Route53.ListTrafficPoliciesResponse, AWSError>;
  /**
   * Gets information about the latest version for every traffic policy that is associated with the current AWS account. Send a GET request to the /Amazon Route 53 API version/trafficpolicy resource. Amazon Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policies, you can use the maxitems parameter to list them in groups of up to 100. The response includes three values that help you navigate from one group of maxitems traffic policies to the next:    IsTruncated  If the value of IsTruncated in the response is true, there are more traffic policies associated with the current AWS account. If IsTruncated is false, this response includes the last traffic policy that is associated with the current account.    TrafficPolicyIdMarker  If IsTruncated is true, TrafficPolicyIdMarker is the ID of the first traffic policy in the next group of MaxItems traffic policies. If you want to list more traffic policies, make another call to ListTrafficPolicies, and specify the value of the TrafficPolicyIdMarker element from the response in the TrafficPolicyIdMarker request parameter. If IsTruncated is false, the TrafficPolicyIdMarker element is omitted from the response.    MaxItems  The value that you specified for the MaxItems parameter in the request that produced the current response.  
   */
  listTrafficPolicies(callback?: (err: AWSError, data: Route53.ListTrafficPoliciesResponse) => void): Request<Route53.ListTrafficPoliciesResponse, AWSError>;
  /**
   ...
   */
  listTrafficPolicyInstances(params: Route53.ListTrafficPolicyInstancesRequest, callback?: (err: AWSError, data: Route53.ListTrafficPolicyInstancesResponse) => void): Request<Route53.ListTrafficPolicyInstancesResponse, AWSError>;
  /**
   * Gets information about the traffic policy instances that you created by using the current AWS account.  After you submit an UpdateTrafficPolicyInstance request, there's a brief delay while Amazon Route 53 creates the resource record sets that are specified in the traffic policy definition. For more information, see the State response element.  Send a GET request to the /Amazon Route 53 API version/trafficpolicyinstance resource. Amazon Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the MaxItems parameter to list them in groups of up to 100. The response includes five values that help you navigate from one group of MaxItems traffic policy instances to the next:    IsTruncated  If the value of IsTruncated in the response is true, there are more traffic policy instances associated with the current AWS account. If IsTruncated is false, this response includes the last traffic policy instance that is associated with the current account.    MaxItems  The value that you specified for the MaxItems parameter in the request that produced the current response.    HostedZoneIdMarker, TrafficPolicyInstanceNameMarker, and TrafficPolicyInstanceTypeMarker  If IsTruncated is true, these three values in the response represent the first traffic policy instance in the next group of MaxItems traffic policy instances. To list more traffic policy instances, make another call to ListTrafficPolicyInstances, and specify these values in the corresponding request parameters. If IsTruncated is false, all three elements are omitted from the response.  
   */
  listTrafficPolicyInstances(callback?: (err: AWSError, data: Route53.ListTrafficPolicyInstancesResponse) => void): Request<Route53.ListTrafficPolicyInstancesResponse, AWSError>;
  /**
   ...
   */
  listTrafficPolicyInstancesByHostedZone(params: Route53.ListTrafficPolicyInstancesByHostedZoneRequest, callback?: (err: AWSError, data: Route53.ListTrafficPolicyInstancesByHostedZoneResponse) => void): Request<Route53.ListTrafficPolicyInstancesByHostedZoneResponse, AWSError>;
  /**
   * Gets information about the traffic policy instances that you created in a specified hosted zone.  After you submit an UpdateTrafficPolicyInstance request, there's a brief delay while Amazon Route 53 creates the resource record sets that are specified in the traffic policy definition. For more information, see the State response element.  Send a GET request to the /Amazon Route 53 API version/trafficpolicyinstance resource and include the ID of the hosted zone. Amazon Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the MaxItems parameter to list them in groups of up to 100. The response includes four values that help you navigate from one group of MaxItems traffic policy instances to the next:    IsTruncated  If the value of IsTruncated in the response is true, there are more traffic policy instances associated with the current AWS account. If IsTruncated is false, this response includes the last traffic policy instance that is associated with the current account.    MaxItems  The value that you specified for the MaxItems parameter in the request that produced the current response.    TrafficPolicyInstanceNameMarker and TrafficPolicyInstanceTypeMarker  If IsTruncated is true, these two values in the response represent the first traffic policy instance in the next group of MaxItems traffic policy instances. To list more traffic policy instances, make another call to ListTrafficPolicyInstancesByHostedZone, and specify these values in the corresponding request parameters. If IsTruncated is false, all three elements are omitted from the response.  
   */
  listTrafficPolicyInstancesByHostedZone(callback?: (err: AWSError, data: Route53.ListTrafficPolicyInstancesByHostedZoneResponse) => void): Request<Route53.ListTrafficPolicyInstancesByHostedZoneResponse, AWSError>;
  /**
   ...
   */
  listTrafficPolicyInstancesByPolicy(params: Route53.ListTrafficPolicyInstancesByPolicyRequest, callback?: (err: AWSError, data: Route53.ListTrafficPolicyInstancesByPolicyResponse) => void): Request<Route53.ListTrafficPolicyInstancesByPolicyResponse, AWSError>;
  /**
   * Gets information about the traffic policy instances that you created by using a specify traffic policy version.  After you submit a CreateTrafficPolicyInstance or an UpdateTrafficPolicyInstance request, there's a brief delay while Amazon Route 53 creates the resource record sets that are specified in the traffic policy definition. For more information, see the State response element.  Send a GET request to the /Route 53 API version/trafficpolicyinstance resource and include the ID and version of the traffic policy. Amazon Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the MaxItems parameter to list them in groups of up to 100. The response includes five values that help you navigate from one group of MaxItems traffic policy instances to the next:    IsTruncated  If the value of IsTruncated in the response is true, there are more traffic policy instances associated with the specified traffic policy. If IsTruncated is false, this response includes the last traffic policy instance that is associated with the specified traffic policy.    MaxItems  The value that you specified for the MaxItems parameter in the request that produced the current response.    HostedZoneIdMarker, TrafficPolicyInstanceNameMarker, and TrafficPolicyInstanceTypeMarker  If IsTruncated is true, these values in the response represent the first traffic policy instance in the next group of MaxItems traffic policy instances. To list more traffic policy instances, make another call to ListTrafficPolicyInstancesByPolicy, and specify these values in the corresponding request parameters. If IsTruncated is false, all three elements are omitted from the response.  
   */
  listTrafficPolicyInstancesByPolicy(callback?: (err: AWSError, data: Route53.ListTrafficPolicyInstancesByPolicyResponse) => void): Request<Route53.ListTrafficPolicyInstancesByPolicyResponse, AWSError>;
  /**
   ...
   */
  listTrafficPolicyVersions(params: Route53.ListTrafficPolicyVersionsRequest, callback?: (err: AWSError, data: Route53.ListTrafficPolicyVersionsResponse) => void): Request<Route53.ListTrafficPolicyVersionsResponse, AWSError>;
  /**
   * Gets information about all of the versions for a specified traffic policy. Send a GET request to the /Amazon Route 53 API version/trafficpolicy resource and specify the ID of the traffic policy for which you want to list versions. Amazon Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policies, you can use the maxitems parameter to list them in groups of up to 100. The response includes three values that help you navigate from one group of maxitemsmaxitems traffic policies to the next:    IsTruncated  If the value of IsTruncated in the response is true, there are more traffic policy versions associated with the specified traffic policy. If IsTruncated is false, this response includes the last traffic policy version that is associated with the specified traffic policy.    TrafficPolicyVersionMarker  The ID of the next traffic policy version that is associated with the current AWS account. If you want to list more traffic policies, make another call to ListTrafficPolicyVersions, and specify the value of the TrafficPolicyVersionMarker element in the TrafficPolicyVersionMarker request parameter. If IsTruncated is false, Amazon Route 53 omits the TrafficPolicyVersionMarker element from the response.    MaxItems  The value that you specified for the MaxItems parameter in the request that produced the current response.  
   */
  listTrafficPolicyVersions(callback?: (err: AWSError, data: Route53.ListTrafficPolicyVersionsResponse) => void): Request<Route53.ListTrafficPolicyVersionsResponse, AWSError>;
  /**
   * 
   */
  testDNSAnswer(params: Route53.TestDNSAnswerRequest, callback?: (err: AWSError, data: Route53.TestDNSAnswerResponse) => void): Request<Route53.TestDNSAnswerResponse, AWSError>;
  /**
   * 
   */
  testDNSAnswer(callback?: (err: AWSError, data: Route53.TestDNSAnswerResponse) => void): Request<Route53.TestDNSAnswerResponse, AWSError>;
  /**
   ...
   */
  updateHealthCheck(params: Route53.UpdateHealthCheckRequest, callback?: (err: AWSError, data: Route53.UpdateHealthCheckResponse) => void): Request<Route53.UpdateHealthCheckResponse, AWSError>;
  /**
   * Updates an existing health check. Send a POST request to the /Amazon Route 53 API version/healthcheck/health check ID  resource. The request body must include an XML document with an UpdateHealthCheckRequest element. For more information about updating health checks, see Creating, Updating, and Deleting Health Checks in the Amazon Route 53 Developer Guide.
   */
  updateHealthCheck(callback?: (err: AWSError, data: Route53.UpdateHealthCheckResponse) => void): Request<Route53.UpdateHealthCheckResponse, AWSError>;
  /**
   * Updates the hosted zone comment. Send a POST request to the /2013-04-01/hostedzone/hosted zone ID  resource. 
   */
  updateHostedZoneComment(params: Route53.UpdateHostedZoneCommentRequest, callback?: (err: AWSError, data: Route53.UpdateHostedZoneCommentResponse) => void): Request<Route53.UpdateHostedZoneCommentResponse, AWSError>;
  /**
   * Updates the hosted zone comment. Send a POST request to the /2013-04-01/hostedzone/hosted zone ID  resource. 
   */
  updateHostedZoneComment(callback?: (err: AWSError, data: Route53.UpdateHostedZoneCommentResponse) => void): Request<Route53.UpdateHostedZoneCommentResponse, AWSError>;
  /**
   * Updates the comment for a specified traffic policy version. Send a POST request to the /Amazon Route 53 API version/trafficpolicy/ resource. The request body must include a document with an UpdateTrafficPolicyCommentRequest element.
   */
  updateTrafficPolicyComment(params: Route53.UpdateTrafficPolicyCommentRequest, callback?: (err: AWSError, data: Route53.UpdateTrafficPolicyCommentResponse) => void): Request<Route53.UpdateTrafficPolicyCommentResponse, AWSError>;
  /**
   * Updates the comment for a specified traffic policy version. Send a POST request to the /Amazon Route 53 API version/trafficpolicy/ resource. The request body must include a document with an UpdateTrafficPolicyCommentRequest element.
   */
  updateTrafficPolicyComment(callback?: (err: AWSError, data: Route53.UpdateTrafficPolicyCommentResponse) => void): Request<Route53.UpdateTrafficPolicyCommentResponse, AWSError>;
  /**
   ...
   */
  updateTrafficPolicyInstance(params: Route53.UpdateTrafficPolicyInstanceRequest, callback?: (err: AWSError, data: Route53.UpdateTrafficPolicyInstanceResponse) => void): Request<Route53.UpdateTrafficPolicyInstanceResponse, AWSError>;
  /**
   * Updates the resource record sets in a specified hosted zone that were created based on the settings in a specified traffic policy version. Send a POST request to the /Amazon Route 53 API version/trafficpolicyinstance/traffic policy ID  resource. The request body must include a document with an UpdateTrafficPolicyInstanceRequest element. When you update a traffic policy instance, Amazon Route 53 continues to respond to DNS queries for the root resource record set name (such as example.com) while it replaces one group of resource record sets with another. Amazon Route 53 performs the following operations:   Amazon Route 53 creates a new group of resource record sets based on the specified traffic policy. This is true regardless of how substantial the differences are between the existing resource record sets and the new resource record sets.    When all of the new resource record sets have been created, Amazon Route 53 starts to respond to DNS queries for the root resource record set name (such as example.com) by using the new resource record sets.   Amazon Route 53 deletes the old group of resource record sets that are associated with the root resource record set name.  
   */
  updateTrafficPolicyInstance(callback?: (err: AWSError, data: Route53.UpdateTrafficPolicyInstanceResponse) => void): Request<Route53.UpdateTrafficPolicyInstanceResponse, AWSError>;
  /**
   ...
   */
  waitFor(state: "ResourceRecordSetsChanged", params: Route53.GetChangeRequest, callback?: (err: AWSError, data: Route53.GetChangeResponse) => void): Request<Route53.GetChangeResponse, AWSError>;
  /**
   * Waits for the ResourceRecordSetsChanged state by periodically calling the underlying Route53.getChangeoperation every 30 seconds (at most 60 times).
   */
  waitFor(state: "ResourceRecordSetsChanged", callback?: (err: AWSError, data: Route53.GetChangeResponse) => void): Request<Route53.GetChangeResponse, AWSError>;
}
declare namespace Route53 {
  ...
  export interface GetGeoLocationRequest {
    /**
     * Amazon Route 53 supports the following contintent codes:    AF: Africa    AN: Antarctica    AS: Asia    EU: Europe    OC: Oceania    NA: North America    SA: South America  
     */
    ContinentCode?: GeoLocationContinentCode;
    /**
