...
interface Blob {}
declare class SecurityHub<Params extends SecurityHub.Types.ClientParams = {}> extends Service {
  /**
   * Constructs a service object. This object has one method for each API operation.
   */
  constructor(options?: SecurityHub.Types.ClientConfiguration<Params>)
  config: Config & SecurityHub.Types.ClientConfiguration<Params>;
  /**
   * Accepts the invitation to be monitored by a master SecurityHub account.
   */
  acceptInvitation(params: BoundInput<SecurityHub.Types.AcceptInvitationRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.AcceptInvitationResponse) => void): Request<SecurityHub.Types.AcceptInvitationResponse, AWSError>;
  /**
   * Accepts the invitation to be monitored by a master SecurityHub account.
   */
   ...
   */
  batchDisableStandards(params: BoundInput<SecurityHub.Types.BatchDisableStandardsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.BatchDisableStandardsResponse) => void): Request<SecurityHub.Types.BatchDisableStandardsResponse, AWSError>;
  /**
   * Disables the standards specified by the standards subscription ARNs. In the context of Security Hub, supported standards (for example, CIS AWS Foundations) are automated and continuous checks that help determine your compliance status against security industry (including AWS) best practices. 
   */
   ...
   */
  batchEnableStandards(params: BoundInput<SecurityHub.Types.BatchEnableStandardsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.BatchEnableStandardsResponse) => void): Request<SecurityHub.Types.BatchEnableStandardsResponse, AWSError>;
  /**
   * Enables the standards specified by the standards ARNs. In the context of Security Hub, supported standards (for example, CIS AWS Foundations) are automated and continuous checks that help determine your compliance status against security industry (including AWS) best practices. 
   */
   ...
   */
  batchImportFindings(params: BoundInput<SecurityHub.Types.BatchImportFindingsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.BatchImportFindingsResponse) => void): Request<SecurityHub.Types.BatchImportFindingsResponse, AWSError>;
  /**
   * Imports security findings that are generated by the integrated third-party products into Security Hub.
   */
   ...
   */
  createInsight(params: BoundInput<SecurityHub.Types.CreateInsightRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.CreateInsightResponse) => void): Request<SecurityHub.Types.CreateInsightResponse, AWSError>;
  /**
   * Creates an insight, which is a consolidation of findings that identifies a security area that requires attention or intervention.
   */
   ...
   */
  createMembers(params: BoundInput<SecurityHub.Types.CreateMembersRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.CreateMembersResponse) => void): Request<SecurityHub.Types.CreateMembersResponse, AWSError>;
  /**
   * Creates member Security Hub accounts in the current AWS account (which becomes the master Security Hub account) that has Security Hub enabled.
   */
   ...
   */
  declineInvitations(params: BoundInput<SecurityHub.Types.DeclineInvitationsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DeclineInvitationsResponse) => void): Request<SecurityHub.Types.DeclineInvitationsResponse, AWSError>;
  /**
   * Declines invitations that are sent to this AWS account (invitee) by the AWS accounts (inviters) that are specified by the account IDs. 
   */
   ...
   */
  deleteInsight(params: BoundInput<SecurityHub.Types.DeleteInsightRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DeleteInsightResponse) => void): Request<SecurityHub.Types.DeleteInsightResponse, AWSError>;
  /**
   * Deletes an insight that is specified by the insight ARN.
   */
   ...
   */
  deleteInvitations(params: BoundInput<SecurityHub.Types.DeleteInvitationsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DeleteInvitationsResponse) => void): Request<SecurityHub.Types.DeleteInvitationsResponse, AWSError>;
  /**
   * Deletes invitations that are sent to this AWS account (invitee) by the AWS accounts (inviters) that are specified by their account IDs. 
   */
   ...
   */
  deleteMembers(params: BoundInput<SecurityHub.Types.DeleteMembersRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DeleteMembersResponse) => void): Request<SecurityHub.Types.DeleteMembersResponse, AWSError>;
  /**
   * Deletes the Security Hub member accounts that are specified by the account IDs.
   */
   ...
   */
  disableImportFindingsForProduct(params: BoundInput<SecurityHub.Types.DisableImportFindingsForProductRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DisableImportFindingsForProductResponse) => void): Request<SecurityHub.Types.DisableImportFindingsForProductResponse, AWSError>;
  /**
   * Stops you from being able to import findings generated by integrated third-party providers into Security Hub.
   */
   ...
   */
  disableSecurityHub(params: BoundInput<SecurityHub.Types.DisableSecurityHubRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DisableSecurityHubResponse) => void): Request<SecurityHub.Types.DisableSecurityHubResponse, AWSError>;
  /**
   * Disables the AWS Security Hub Service.
   */
   ...
   */
  disassociateFromMasterAccount(params: BoundInput<SecurityHub.Types.DisassociateFromMasterAccountRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DisassociateFromMasterAccountResponse) => void): Request<SecurityHub.Types.DisassociateFromMasterAccountResponse, AWSError>;
  /**
   * Disassociates the current Security Hub member account from its master account.
   */
   ...
   */
  disassociateMembers(params: BoundInput<SecurityHub.Types.DisassociateMembersRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.DisassociateMembersResponse) => void): Request<SecurityHub.Types.DisassociateMembersResponse, AWSError>;
  /**
   * Disassociates the Security Hub member accounts that are specified by the account IDs from their master account. 
   */
   ...
   */
  enableImportFindingsForProduct(params: BoundInput<SecurityHub.Types.EnableImportFindingsForProductRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.EnableImportFindingsForProductResponse) => void): Request<SecurityHub.Types.EnableImportFindingsForProductResponse, AWSError>;
  /**
   * Enables you to import findings generated by integrated third-party providers into Security Hub.
   */
   ...
   */
  enableSecurityHub(params: BoundInput<SecurityHub.Types.EnableSecurityHubRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.EnableSecurityHubResponse) => void): Request<SecurityHub.Types.EnableSecurityHubResponse, AWSError>;
  /**
   * Enables the AWS Security Hub service.
   */
   ...
   */
  getEnabledStandards(params: BoundInput<SecurityHub.Types.GetEnabledStandardsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetEnabledStandardsResponse) => void): Request<SecurityHub.Types.GetEnabledStandardsResponse, AWSError>;
  /**
   * Lists and describes enabled standards.
   */
   ...
   */
  getFindings(params: BoundInput<SecurityHub.Types.GetFindingsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetFindingsResponse) => void): Request<SecurityHub.Types.GetFindingsResponse, AWSError>;
  /**
   * Lists and describes Security Hub-aggregated findings that are specified by filter attributes.
   */
   ...
   */
  getInsightResults(params: BoundInput<SecurityHub.Types.GetInsightResultsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetInsightResultsResponse) => void): Request<SecurityHub.Types.GetInsightResultsResponse, AWSError>;
  /**
   * Lists the results of the Security Hub insight specified by the insight ARN.
   */
   ...
   */
  getInsights(params: BoundInput<SecurityHub.Types.GetInsightsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetInsightsResponse) => void): Request<SecurityHub.Types.GetInsightsResponse, AWSError>;
  /**
   * Lists and describes insights that are specified by insight ARNs.
   */
   ...
   */
  getInvitationsCount(params: BoundInput<SecurityHub.Types.GetInvitationsCountRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetInvitationsCountResponse) => void): Request<SecurityHub.Types.GetInvitationsCountResponse, AWSError>;
  /**
   * Returns the count of all Security Hub membership invitations that were sent to the current member account, not including the currently accepted invitation. 
   */
   ...
   */
  getMasterAccount(params: BoundInput<SecurityHub.Types.GetMasterAccountRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetMasterAccountResponse) => void): Request<SecurityHub.Types.GetMasterAccountResponse, AWSError>;
  /**
   * Provides the details for the Security Hub master account to the current member account. 
   */
   ...
   */
  getMembers(params: BoundInput<SecurityHub.Types.GetMembersRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.GetMembersResponse) => void): Request<SecurityHub.Types.GetMembersResponse, AWSError>;
  /**
   * Returns the details on the Security Hub member accounts that are specified by the account IDs. 
   */
   ...
   */
  inviteMembers(params: BoundInput<SecurityHub.Types.InviteMembersRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.InviteMembersResponse) => void): Request<SecurityHub.Types.InviteMembersResponse, AWSError>;
  /**
   * Invites other AWS accounts to enable Security Hub and become Security Hub member accounts. When an account accepts the invitation and becomes a member account, the master account can view Security Hub findings of the member account. 
   */
   ...
   */
  listEnabledProductsForImport(params: BoundInput<SecurityHub.Types.ListEnabledProductsForImportRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.ListEnabledProductsForImportResponse) => void): Request<SecurityHub.Types.ListEnabledProductsForImportResponse, AWSError>;
  /**
   * Lists all Security Hub-integrated third-party findings providers.
   */
   ...
   */
  listInvitations(params: BoundInput<SecurityHub.Types.ListInvitationsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.ListInvitationsResponse) => void): Request<SecurityHub.Types.ListInvitationsResponse, AWSError>;
  /**
   * Lists all Security Hub membership invitations that were sent to the current AWS account. 
   */
   ...
   */
  listMembers(params: BoundInput<SecurityHub.Types.ListMembersRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.ListMembersResponse) => void): Request<SecurityHub.Types.ListMembersResponse, AWSError>;
  /**
   * Lists details about all member accounts for the current Security Hub master account.
   */
   ...
   */
  updateFindings(params: BoundInput<SecurityHub.Types.UpdateFindingsRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.UpdateFindingsResponse) => void): Request<SecurityHub.Types.UpdateFindingsResponse, AWSError>;
  /**
   * Updates the AWS Security Hub-aggregated findings specified by the filter attributes.
   */
   ...
   */
  updateInsight(params: BoundInput<SecurityHub.Types.UpdateInsightRequest, keyof Params>, callback?: (err: AWSError, data: SecurityHub.Types.UpdateInsightResponse) => void): Request<SecurityHub.Types.UpdateInsightResponse, AWSError>;
  /**
   * Updates the AWS Security Hub insight specified by the insight ARN.
   */
...
declare namespace SecurityHub {
  ...
  export type ClientParams = InputParams<AcceptInvitationRequest & BatchDisableStandardsRequest & BatchEnableStandardsRequest & BatchImportFindingsRequest & CreateInsightRequest & CreateMembersRequest & DeclineInvitationsRequest & DeleteInsightRequest & DeleteInvitationsRequest & DeleteMembersRequest & DisableImportFindingsForProductRequest & DisableSecurityHubRequest & DisassociateFromMasterAccountRequest & DisassociateMembersRequest & EnableImportFindingsForProductRequest & EnableSecurityHubRequest & GetEnabledStandardsRequest & GetFindingsRequest & GetInsightResultsRequest & GetInsightsRequest & GetInvitationsCountRequest & GetMasterAccountRequest & GetMembersRequest & InviteMembersRequest & ListEnabledProductsForImportRequest & ListInvitationsRequest & ListMembersRequest & UpdateFindingsRequest & UpdateInsightRequest>;
