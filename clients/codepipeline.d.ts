...
declare class CodePipeline extends Service {
   ...
   */
  acknowledgeJob(params: CodePipeline.AcknowledgeJobInput, callback?: (err: AWSError, data: CodePipeline.AcknowledgeJobOutput) => void): Request<CodePipeline.AcknowledgeJobOutput, AWSError>;
  /**
   * Returns information about a specified job and whether that job has been received by the job worker. Only used for custom actions.
   */
  acknowledgeJob(callback?: (err: AWSError, data: CodePipeline.AcknowledgeJobOutput) => void): Request<CodePipeline.AcknowledgeJobOutput, AWSError>;
  /**
   * Confirms a job worker has received the specified job. Only used for partner actions.
   */
  acknowledgeThirdPartyJob(params: CodePipeline.AcknowledgeThirdPartyJobInput, callback?: (err: AWSError, data: CodePipeline.AcknowledgeThirdPartyJobOutput) => void): Request<CodePipeline.AcknowledgeThirdPartyJobOutput, AWSError>;
  /**
   * Confirms a job worker has received the specified job. Only used for partner actions.
   */
  acknowledgeThirdPartyJob(callback?: (err: AWSError, data: CodePipeline.AcknowledgeThirdPartyJobOutput) => void): Request<CodePipeline.AcknowledgeThirdPartyJobOutput, AWSError>;
  /**
   * Creates a new custom action that can be used in all pipelines associated with the AWS account. Only used for custom actions.
   */
  createCustomActionType(params: CodePipeline.CreateCustomActionTypeInput, callback?: (err: AWSError, data: CodePipeline.CreateCustomActionTypeOutput) => void): Request<CodePipeline.CreateCustomActionTypeOutput, AWSError>;
  /**
   * Creates a new custom action that can be used in all pipelines associated with the AWS account. Only used for custom actions.
   */
  createCustomActionType(callback?: (err: AWSError, data: CodePipeline.CreateCustomActionTypeOutput) => void): Request<CodePipeline.CreateCustomActionTypeOutput, AWSError>;
  /**
   * Creates a pipeline.
   */
  createPipeline(params: CodePipeline.CreatePipelineInput, callback?: (err: AWSError, data: CodePipeline.CreatePipelineOutput) => void): Request<CodePipeline.CreatePipelineOutput, AWSError>;
  /**
   * Creates a pipeline.
   */
  createPipeline(callback?: (err: AWSError, data: CodePipeline.CreatePipelineOutput) => void): Request<CodePipeline.CreatePipelineOutput, AWSError>;
  /**
   ...
   */
  deleteCustomActionType(params: CodePipeline.DeleteCustomActionTypeInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Marks a custom action as deleted. PollForJobs for the custom action will fail after the action is marked for deletion. Only used for custom actions.  You cannot recreate a custom action after it has been deleted unless you increase the version number of the action. 
   */
   ...
   */
  deletePipeline(params: CodePipeline.DeletePipelineInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified pipeline.
   */
   ...
   */
  disableStageTransition(params: CodePipeline.DisableStageTransitionInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Prevents artifacts in a pipeline from transitioning to the next stage in the pipeline.
   */
   ...
   */
  enableStageTransition(params: CodePipeline.EnableStageTransitionInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Enables artifacts in a pipeline to transition to a stage in a pipeline.
   */
   ...
   */
  getJobDetails(params: CodePipeline.GetJobDetailsInput, callback?: (err: AWSError, data: CodePipeline.GetJobDetailsOutput) => void): Request<CodePipeline.GetJobDetailsOutput, AWSError>;
  /**
   * Returns information about a job. Only used for custom actions.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. Additionally, this API returns any secret values defined for the action. 
   */
  getJobDetails(callback?: (err: AWSError, data: CodePipeline.GetJobDetailsOutput) => void): Request<CodePipeline.GetJobDetailsOutput, AWSError>;
  /**
   * Returns the metadata, structure, stages, and actions of a pipeline. Can be used to return the entire structure of a pipeline in JSON format, which can then be modified and used to update the pipeline structure with UpdatePipeline.
   */
  getPipeline(params: CodePipeline.GetPipelineInput, callback?: (err: AWSError, data: CodePipeline.GetPipelineOutput) => void): Request<CodePipeline.GetPipelineOutput, AWSError>;
  /**
   * Returns the metadata, structure, stages, and actions of a pipeline. Can be used to return the entire structure of a pipeline in JSON format, which can then be modified and used to update the pipeline structure with UpdatePipeline.
   */
  getPipeline(callback?: (err: AWSError, data: CodePipeline.GetPipelineOutput) => void): Request<CodePipeline.GetPipelineOutput, AWSError>;
  /**
   * Returns information about an execution of a pipeline, including details about artifacts, the pipeline execution ID, and the name, version, and status of the pipeline.
   */
  getPipelineExecution(params: CodePipeline.GetPipelineExecutionInput, callback?: (err: AWSError, data: CodePipeline.GetPipelineExecutionOutput) => void): Request<CodePipeline.GetPipelineExecutionOutput, AWSError>;
  /**
   * Returns information about an execution of a pipeline, including details about artifacts, the pipeline execution ID, and the name, version, and status of the pipeline.
   */
  getPipelineExecution(callback?: (err: AWSError, data: CodePipeline.GetPipelineExecutionOutput) => void): Request<CodePipeline.GetPipelineExecutionOutput, AWSError>;
  /**
   * Returns information about the state of a pipeline, including the stages and actions.
   */
  getPipelineState(params: CodePipeline.GetPipelineStateInput, callback?: (err: AWSError, data: CodePipeline.GetPipelineStateOutput) => void): Request<CodePipeline.GetPipelineStateOutput, AWSError>;
  /**
   * Returns information about the state of a pipeline, including the stages and actions.
   */
  getPipelineState(callback?: (err: AWSError, data: CodePipeline.GetPipelineStateOutput) => void): Request<CodePipeline.GetPipelineStateOutput, AWSError>;
  /**
   * Requests the details of a job for a third party action. Only used for partner actions.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. Additionally, this API returns any secret values defined for the action. 
   */
  getThirdPartyJobDetails(params: CodePipeline.GetThirdPartyJobDetailsInput, callback?: (err: AWSError, data: CodePipeline.GetThirdPartyJobDetailsOutput) => void): Request<CodePipeline.GetThirdPartyJobDetailsOutput, AWSError>;
  /**
   * Requests the details of a job for a third party action. Only used for partner actions.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. Additionally, this API returns any secret values defined for the action. 
   */
  getThirdPartyJobDetails(callback?: (err: AWSError, data: CodePipeline.GetThirdPartyJobDetailsOutput) => void): Request<CodePipeline.GetThirdPartyJobDetailsOutput, AWSError>;
  /**
   * Gets a summary of all AWS CodePipeline action types associated with your account.
   */
  listActionTypes(params: CodePipeline.ListActionTypesInput, callback?: (err: AWSError, data: CodePipeline.ListActionTypesOutput) => void): Request<CodePipeline.ListActionTypesOutput, AWSError>;
  /**
   * Gets a summary of all AWS CodePipeline action types associated with your account.
   */
  listActionTypes(callback?: (err: AWSError, data: CodePipeline.ListActionTypesOutput) => void): Request<CodePipeline.ListActionTypesOutput, AWSError>;
  /**
   * Gets a summary of all of the pipelines associated with your account.
   */
  listPipelines(params: CodePipeline.ListPipelinesInput, callback?: (err: AWSError, data: CodePipeline.ListPipelinesOutput) => void): Request<CodePipeline.ListPipelinesOutput, AWSError>;
  /**
   * Gets a summary of all of the pipelines associated with your account.
   */
  listPipelines(callback?: (err: AWSError, data: CodePipeline.ListPipelinesOutput) => void): Request<CodePipeline.ListPipelinesOutput, AWSError>;
  /**
   * Returns information about any jobs for AWS CodePipeline to act upon.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. Additionally, this API returns any secret values defined for the action. 
   */
  pollForJobs(params: CodePipeline.PollForJobsInput, callback?: (err: AWSError, data: CodePipeline.PollForJobsOutput) => void): Request<CodePipeline.PollForJobsOutput, AWSError>;
  /**
   * Returns information about any jobs for AWS CodePipeline to act upon.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. Additionally, this API returns any secret values defined for the action. 
   */
  pollForJobs(callback?: (err: AWSError, data: CodePipeline.PollForJobsOutput) => void): Request<CodePipeline.PollForJobsOutput, AWSError>;
  /**
   * Determines whether there are any third party jobs for a job worker to act on. Only used for partner actions.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. 
   */
  pollForThirdPartyJobs(params: CodePipeline.PollForThirdPartyJobsInput, callback?: (err: AWSError, data: CodePipeline.PollForThirdPartyJobsOutput) => void): Request<CodePipeline.PollForThirdPartyJobsOutput, AWSError>;
  /**
   * Determines whether there are any third party jobs for a job worker to act on. Only used for partner actions.  When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket for input or output artifacts. 
   */
  pollForThirdPartyJobs(callback?: (err: AWSError, data: CodePipeline.PollForThirdPartyJobsOutput) => void): Request<CodePipeline.PollForThirdPartyJobsOutput, AWSError>;
  /**
   * Provides information to AWS CodePipeline about new revisions to a source.
   */
  putActionRevision(params: CodePipeline.PutActionRevisionInput, callback?: (err: AWSError, data: CodePipeline.PutActionRevisionOutput) => void): Request<CodePipeline.PutActionRevisionOutput, AWSError>;
  /**
   * Provides information to AWS CodePipeline about new revisions to a source.
   */
  putActionRevision(callback?: (err: AWSError, data: CodePipeline.PutActionRevisionOutput) => void): Request<CodePipeline.PutActionRevisionOutput, AWSError>;
  /**
   * Provides the response to a manual approval request to AWS CodePipeline. Valid responses include Approved and Rejected.
   */
  putApprovalResult(params: CodePipeline.PutApprovalResultInput, callback?: (err: AWSError, data: CodePipeline.PutApprovalResultOutput) => void): Request<CodePipeline.PutApprovalResultOutput, AWSError>;
  /**
   * Provides the response to a manual approval request to AWS CodePipeline. Valid responses include Approved and Rejected.
   */
  putApprovalResult(callback?: (err: AWSError, data: CodePipeline.PutApprovalResultOutput) => void): Request<CodePipeline.PutApprovalResultOutput, AWSError>;
  /**
   * Represents the failure of a job as returned to the pipeline by a job worker. Only used for custom actions.
   */
  putJobFailureResult(params: CodePipeline.PutJobFailureResultInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Represents the failure of a job as returned to the pipeline by a job worker. Only used for custom actions.
   */
   ...
   */
  putJobSuccessResult(params: CodePipeline.PutJobSuccessResultInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Represents the success of a job as returned to the pipeline by a job worker. Only used for custom actions.
   */
   ...
   */
  putThirdPartyJobFailureResult(params: CodePipeline.PutThirdPartyJobFailureResultInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Represents the failure of a third party job as returned to the pipeline by a job worker. Only used for partner actions.
   */
   ...
   */
  putThirdPartyJobSuccessResult(params: CodePipeline.PutThirdPartyJobSuccessResultInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Represents the success of a third party job as returned to the pipeline by a job worker. Only used for partner actions.
   */
   ...
   */
  retryStageExecution(params: CodePipeline.RetryStageExecutionInput, callback?: (err: AWSError, data: CodePipeline.RetryStageExecutionOutput) => void): Request<CodePipeline.RetryStageExecutionOutput, AWSError>;
  /**
   * Resumes the pipeline execution by retrying the last failed actions in a stage.
   */
  retryStageExecution(callback?: (err: AWSError, data: CodePipeline.RetryStageExecutionOutput) => void): Request<CodePipeline.RetryStageExecutionOutput, AWSError>;
  /**
   * Starts the specified pipeline. Specifically, it begins processing the latest commit to the source location specified as part of the pipeline.
   */
  startPipelineExecution(params: CodePipeline.StartPipelineExecutionInput, callback?: (err: AWSError, data: CodePipeline.StartPipelineExecutionOutput) => void): Request<CodePipeline.StartPipelineExecutionOutput, AWSError>;
  /**
   * Starts the specified pipeline. Specifically, it begins processing the latest commit to the source location specified as part of the pipeline.
   */
  startPipelineExecution(callback?: (err: AWSError, data: CodePipeline.StartPipelineExecutionOutput) => void): Request<CodePipeline.StartPipelineExecutionOutput, AWSError>;
  /**
   * Updates a specified pipeline with edits or changes to its structure. Use a JSON file with the pipeline structure in conjunction with UpdatePipeline to provide the full structure of the pipeline. Updating the pipeline increases the version number of the pipeline by 1.
   */
  updatePipeline(params: CodePipeline.UpdatePipelineInput, callback?: (err: AWSError, data: CodePipeline.UpdatePipelineOutput) => void): Request<CodePipeline.UpdatePipelineOutput, AWSError>;
  /**
   * Updates a specified pipeline with edits or changes to its structure. Use a JSON file with the pipeline structure in conjunction with UpdatePipeline to provide the full structure of the pipeline. Updating the pipeline increases the version number of the pipeline by 1.
   */
  updatePipeline(callback?: (err: AWSError, data: CodePipeline.UpdatePipelineOutput) => void): Request<CodePipeline.UpdatePipelineOutput, AWSError>;
}
