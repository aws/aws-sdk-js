...
declare class SSM extends Service {
   ...
   */
  addTagsToResource(params: SSM.AddTagsToResourceRequest, callback?: (err: AWSError, data: SSM.AddTagsToResourceResult) => void): Request<SSM.AddTagsToResourceResult, AWSError>;
  /**
   * Adds or overwrites one or more tags for the specified resource. Tags are metadata that you assign to your managed instances. Tags enable you to categorize your managed instances in different ways, for example, by purpose, owner, or environment. Each tag consists of a key and an optional value, both of which you define. For example, you could define a set of tags for your account's managed instances that helps you track each instance's owner and stack level. For example: Key=Owner and Value=DbAdmin, SysAdmin, or Dev. Or Key=Stack and Value=Production, Pre-Production, or Test. Each resource can have a maximum of 10 tags.   We recommend that you devise a set of tag keys that meets your needs for each resource type. Using a consistent set of tag keys makes it easier for you to manage your resources. You can search and filter the resources based on the tags you add. Tags don't have any semantic meaning to Amazon EC2 and are interpreted strictly as a string of characters.  For more information about tags, see Tagging Your Amazon EC2 Resources in the Amazon EC2 User Guide. 
   */
  addTagsToResource(callback?: (err: AWSError, data: SSM.AddTagsToResourceResult) => void): Request<SSM.AddTagsToResourceResult, AWSError>;
  /**
   * Attempts to cancel the command specified by the Command ID. There is no guarantee that the command will be terminated and the underlying process stopped.
   */
  cancelCommand(params: SSM.CancelCommandRequest, callback?: (err: AWSError, data: SSM.CancelCommandResult) => void): Request<SSM.CancelCommandResult, AWSError>;
  /**
   * Attempts to cancel the command specified by the Command ID. There is no guarantee that the command will be terminated and the underlying process stopped.
   */
  cancelCommand(callback?: (err: AWSError, data: SSM.CancelCommandResult) => void): Request<SSM.CancelCommandResult, AWSError>;
  /**
   ...
   */
  createActivation(params: SSM.CreateActivationRequest, callback?: (err: AWSError, data: SSM.CreateActivationResult) => void): Request<SSM.CreateActivationResult, AWSError>;
  /**
   * Registers your on-premises server or virtual machine with Amazon EC2 so that you can manage these resources using Run Command. An on-premises server or virtual machine that has been registered with EC2 is called a managed instance. For more information about activations, see Setting Up Managed Instances (Linux) or Setting Up Managed Instances (Windows) in the Amazon EC2 User Guide. 
   */
  createActivation(callback?: (err: AWSError, data: SSM.CreateActivationResult) => void): Request<SSM.CreateActivationResult, AWSError>;
  /**
   ...
   */
  createAssociation(params: SSM.CreateAssociationRequest, callback?: (err: AWSError, data: SSM.CreateAssociationResult) => void): Request<SSM.CreateAssociationResult, AWSError>;
  /**
   * Associates the specified SSM document with the specified instance. When you associate an SSM document with an instance, the configuration agent on the instance (SSM agent for Linux and EC2Config service for Windows) processes the document and configures the instance as specified. If you associate a document with an instance that already has an associated document, the system throws the AssociationAlreadyExists exception.
   */
  createAssociation(callback?: (err: AWSError, data: SSM.CreateAssociationResult) => void): Request<SSM.CreateAssociationResult, AWSError>;
  /**
   ...
   */
  createAssociationBatch(params: SSM.CreateAssociationBatchRequest, callback?: (err: AWSError, data: SSM.CreateAssociationBatchResult) => void): Request<SSM.CreateAssociationBatchResult, AWSError>;
  /**
   * Associates the specified SSM document with the specified instances. When you associate an SSM document with an instance, the configuration agent on the instance (SSM agent for Linux and EC2Config service for Windows) processes the document and configures the instance as specified. If you associate a document with an instance that already has an associated document, the system throws the AssociationAlreadyExists exception.
   */
  createAssociationBatch(callback?: (err: AWSError, data: SSM.CreateAssociationBatchResult) => void): Request<SSM.CreateAssociationBatchResult, AWSError>;
  /**
   ...
   */
  createDocument(params: SSM.CreateDocumentRequest, callback?: (err: AWSError, data: SSM.CreateDocumentResult) => void): Request<SSM.CreateDocumentResult, AWSError>;
  /**
   * Creates an SSM document. After you create an SSM document, you can use CreateAssociation to associate it with one or more running instances.
   */
  createDocument(callback?: (err: AWSError, data: SSM.CreateDocumentResult) => void): Request<SSM.CreateDocumentResult, AWSError>;
  /**
   * Deletes an activation. You are not required to delete an activation. If you delete an activation, you can no longer use it to register additional managed instances. Deleting an activation does not de-register managed instances. You must manually de-register managed instances.
   */
  deleteActivation(params: SSM.DeleteActivationRequest, callback?: (err: AWSError, data: SSM.DeleteActivationResult) => void): Request<SSM.DeleteActivationResult, AWSError>;
  /**
   * Deletes an activation. You are not required to delete an activation. If you delete an activation, you can no longer use it to register additional managed instances. Deleting an activation does not de-register managed instances. You must manually de-register managed instances.
   */
  deleteActivation(callback?: (err: AWSError, data: SSM.DeleteActivationResult) => void): Request<SSM.DeleteActivationResult, AWSError>;
  /**
   ...
   */
  deleteAssociation(params: SSM.DeleteAssociationRequest, callback?: (err: AWSError, data: SSM.DeleteAssociationResult) => void): Request<SSM.DeleteAssociationResult, AWSError>;
  /**
   * Disassociates the specified SSM document from the specified instance. When you disassociate an SSM document from an instance, it does not change the configuration of the instance. To change the configuration state of an instance after you disassociate a document, you must create a new document with the desired configuration and associate it with the instance.
   */
  deleteAssociation(callback?: (err: AWSError, data: SSM.DeleteAssociationResult) => void): Request<SSM.DeleteAssociationResult, AWSError>;
  /**
   ...
   */
  deleteDocument(params: SSM.DeleteDocumentRequest, callback?: (err: AWSError, data: SSM.DeleteDocumentResult) => void): Request<SSM.DeleteDocumentResult, AWSError>;
  /**
   * Deletes the SSM document and all instance associations to the document. Before you delete the SSM document, we recommend that you use DeleteAssociation to disassociate all instances that are associated with the document.
   */
  deleteDocument(callback?: (err: AWSError, data: SSM.DeleteDocumentResult) => void): Request<SSM.DeleteDocumentResult, AWSError>;
  /**
   * Removes the server or virtual machine from the list of registered servers. You can reregister the instance again at any time. If you don’t plan to use Run Command on the server, we suggest uninstalling the SSM agent first.
   */
  deregisterManagedInstance(params: SSM.DeregisterManagedInstanceRequest, callback?: (err: AWSError, data: SSM.DeregisterManagedInstanceResult) => void): Request<SSM.DeregisterManagedInstanceResult, AWSError>;
  /**
   * Removes the server or virtual machine from the list of registered servers. You can reregister the instance again at any time. If you don’t plan to use Run Command on the server, we suggest uninstalling the SSM agent first.
   */
  deregisterManagedInstance(callback?: (err: AWSError, data: SSM.DeregisterManagedInstanceResult) => void): Request<SSM.DeregisterManagedInstanceResult, AWSError>;
  /**
   * Details about the activation, including: the date and time the activation was created, the expiration date, the IAM role assigned to the instances in the activation, and the number of instances activated by this registration.
   */
  describeActivations(params: SSM.DescribeActivationsRequest, callback?: (err: AWSError, data: SSM.DescribeActivationsResult) => void): Request<SSM.DescribeActivationsResult, AWSError>;
  /**
   * Details about the activation, including: the date and time the activation was created, the expiration date, the IAM role assigned to the instances in the activation, and the number of instances activated by this registration.
   */
  describeActivations(callback?: (err: AWSError, data: SSM.DescribeActivationsResult) => void): Request<SSM.DescribeActivationsResult, AWSError>;
  /**
   * Describes the associations for the specified SSM document or instance.
   */
  describeAssociation(params: SSM.DescribeAssociationRequest, callback?: (err: AWSError, data: SSM.DescribeAssociationResult) => void): Request<SSM.DescribeAssociationResult, AWSError>;
  /**
   * Describes the associations for the specified SSM document or instance.
   */
  describeAssociation(callback?: (err: AWSError, data: SSM.DescribeAssociationResult) => void): Request<SSM.DescribeAssociationResult, AWSError>;
  /**
   * Describes the specified SSM document.
   */
  describeDocument(params: SSM.DescribeDocumentRequest, callback?: (err: AWSError, data: SSM.DescribeDocumentResult) => void): Request<SSM.DescribeDocumentResult, AWSError>;
  /**
   * Describes the specified SSM document.
   */
  describeDocument(callback?: (err: AWSError, data: SSM.DescribeDocumentResult) => void): Request<SSM.DescribeDocumentResult, AWSError>;
  /**
   ...
   */
  describeDocumentPermission(params: SSM.DescribeDocumentPermissionRequest, callback?: (err: AWSError, data: SSM.DescribeDocumentPermissionResponse) => void): Request<SSM.DescribeDocumentPermissionResponse, AWSError>;
  /**
   * Describes the permissions for an SSM document. If you created the document, you are the owner. If a document is shared, it can either be shared privately (by specifying a user’s AWS account ID) or publicly (All). 
   */
  describeDocumentPermission(callback?: (err: AWSError, data: SSM.DescribeDocumentPermissionResponse) => void): Request<SSM.DescribeDocumentPermissionResponse, AWSError>;
  /**
   * Describes one or more of your instances. You can use this to get information about instances like the operating system platform, the SSM agent version (Linux), status etc. If you specify one or more instance IDs, it returns information for those instances. If you do not specify instance IDs, it returns information for all your instances. If you specify an instance ID that is not valid or an instance that you do not own, you receive an error. 
   */
  describeInstanceInformation(params: SSM.DescribeInstanceInformationRequest, callback?: (err: AWSError, data: SSM.DescribeInstanceInformationResult) => void): Request<SSM.DescribeInstanceInformationResult, AWSError>;
  /**
   * Describes one or more of your instances. You can use this to get information about instances like the operating system platform, the SSM agent version (Linux), status etc. If you specify one or more instance IDs, it returns information for those instances. If you do not specify instance IDs, it returns information for all your instances. If you specify an instance ID that is not valid or an instance that you do not own, you receive an error. 
   */
  describeInstanceInformation(callback?: (err: AWSError, data: SSM.DescribeInstanceInformationResult) => void): Request<SSM.DescribeInstanceInformationResult, AWSError>;
  /**
   * Gets the contents of the specified SSM document.
   */
  getDocument(params: SSM.GetDocumentRequest, callback?: (err: AWSError, data: SSM.GetDocumentResult) => void): Request<SSM.GetDocumentResult, AWSError>;
  /**
   * Gets the contents of the specified SSM document.
   */
  getDocument(callback?: (err: AWSError, data: SSM.GetDocumentResult) => void): Request<SSM.GetDocumentResult, AWSError>;
  /**
   * Lists the associations for the specified SSM document or instance.
   */
  listAssociations(params: SSM.ListAssociationsRequest, callback?: (err: AWSError, data: SSM.ListAssociationsResult) => void): Request<SSM.ListAssociationsResult, AWSError>;
  /**
   * Lists the associations for the specified SSM document or instance.
   */
  listAssociations(callback?: (err: AWSError, data: SSM.ListAssociationsResult) => void): Request<SSM.ListAssociationsResult, AWSError>;
  /**
   * An invocation is copy of a command sent to a specific instance. A command can apply to one or more instances. A command invocation applies to one instance. For example, if a user executes SendCommand against three instances, then a command invocation is created for each requested instance ID. ListCommandInvocations provide status about command execution.
   */
  listCommandInvocations(params: SSM.ListCommandInvocationsRequest, callback?: (err: AWSError, data: SSM.ListCommandInvocationsResult) => void): Request<SSM.ListCommandInvocationsResult, AWSError>;
  /**
   * An invocation is copy of a command sent to a specific instance. A command can apply to one or more instances. A command invocation applies to one instance. For example, if a user executes SendCommand against three instances, then a command invocation is created for each requested instance ID. ListCommandInvocations provide status about command execution.
   */
  listCommandInvocations(callback?: (err: AWSError, data: SSM.ListCommandInvocationsResult) => void): Request<SSM.ListCommandInvocationsResult, AWSError>;
  /**
   * Lists the commands requested by users of the AWS account.
   */
  listCommands(params: SSM.ListCommandsRequest, callback?: (err: AWSError, data: SSM.ListCommandsResult) => void): Request<SSM.ListCommandsResult, AWSError>;
  /**
   * Lists the commands requested by users of the AWS account.
   */
  listCommands(callback?: (err: AWSError, data: SSM.ListCommandsResult) => void): Request<SSM.ListCommandsResult, AWSError>;
  /**
   * Describes one or more of your SSM documents.
   */
  listDocuments(params: SSM.ListDocumentsRequest, callback?: (err: AWSError, data: SSM.ListDocumentsResult) => void): Request<SSM.ListDocumentsResult, AWSError>;
  /**
   * Describes one or more of your SSM documents.
   */
  listDocuments(callback?: (err: AWSError, data: SSM.ListDocumentsResult) => void): Request<SSM.ListDocumentsResult, AWSError>;
  /**
   * Returns a list of the tags assigned to the specified resource.
   */
  listTagsForResource(params: SSM.ListTagsForResourceRequest, callback?: (err: AWSError, data: SSM.ListTagsForResourceResult) => void): Request<SSM.ListTagsForResourceResult, AWSError>;
  /**
   * Returns a list of the tags assigned to the specified resource.
   */
  listTagsForResource(callback?: (err: AWSError, data: SSM.ListTagsForResourceResult) => void): Request<SSM.ListTagsForResourceResult, AWSError>;
  /**
   ...
   */
  modifyDocumentPermission(params: SSM.ModifyDocumentPermissionRequest, callback?: (err: AWSError, data: SSM.ModifyDocumentPermissionResponse) => void): Request<SSM.ModifyDocumentPermissionResponse, AWSError>;
  /**
   * Share a document publicly or privately. If you share a document privately, you must specify the AWS user account IDs for those people who can use the document. If you share a document publicly, you must specify All as the account ID.
   */
  modifyDocumentPermission(callback?: (err: AWSError, data: SSM.ModifyDocumentPermissionResponse) => void): Request<SSM.ModifyDocumentPermissionResponse, AWSError>;
  /**
   * Removes all tags from the specified resource.
   */
  removeTagsFromResource(params: SSM.RemoveTagsFromResourceRequest, callback?: (err: AWSError, data: SSM.RemoveTagsFromResourceResult) => void): Request<SSM.RemoveTagsFromResourceResult, AWSError>;
  /**
   * Removes all tags from the specified resource.
   */
  removeTagsFromResource(callback?: (err: AWSError, data: SSM.RemoveTagsFromResourceResult) => void): Request<SSM.RemoveTagsFromResourceResult, AWSError>;
  /**
   * Executes commands on one or more remote instances.
   */
  sendCommand(params: SSM.SendCommandRequest, callback?: (err: AWSError, data: SSM.SendCommandResult) => void): Request<SSM.SendCommandResult, AWSError>;
  /**
   * Executes commands on one or more remote instances.
   */
  sendCommand(callback?: (err: AWSError, data: SSM.SendCommandResult) => void): Request<SSM.SendCommandResult, AWSError>;
  /**
   * Updates the status of the SSM document associated with the specified instance.
   */
  updateAssociationStatus(params: SSM.UpdateAssociationStatusRequest, callback?: (err: AWSError, data: SSM.UpdateAssociationStatusResult) => void): Request<SSM.UpdateAssociationStatusResult, AWSError>;
  /**
   * Updates the status of the SSM document associated with the specified instance.
   */
  updateAssociationStatus(callback?: (err: AWSError, data: SSM.UpdateAssociationStatusResult) => void): Request<SSM.UpdateAssociationStatusResult, AWSError>;
  /**
   * Assigns or changes an Amazon Identity and Access Management (IAM) role to the managed instance.
   */
  updateManagedInstanceRole(params: SSM.UpdateManagedInstanceRoleRequest, callback?: (err: AWSError, data: SSM.UpdateManagedInstanceRoleResult) => void): Request<SSM.UpdateManagedInstanceRoleResult, AWSError>;
  /**
   * Assigns or changes an Amazon Identity and Access Management (IAM) role to the managed instance.
   */
  updateManagedInstanceRole(callback?: (err: AWSError, data: SSM.UpdateManagedInstanceRoleResult) => void): Request<SSM.UpdateManagedInstanceRoleResult, AWSError>;
}
