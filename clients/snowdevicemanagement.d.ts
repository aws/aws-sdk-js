...
declare namespace SnowDeviceManagement {
  ...
  export type ExecutionState = "QUEUED"|"IN_PROGRESS"|"CANCELED"|"FAILED"|"SUCCEEDED"|"REJECTED"|"TIMED_OUT";
  ...
  export type IpAddressAssignment = "DHCP"|"STATIC";
  ...
  export type PhysicalConnectorType = "RJ45"|"SFP_PLUS"|"QSFP"|"RJ45_2"|"WIFI";
  ...
  export type TaskState = "IN_PROGRESS"|"CANCELED"|"COMPLETED";
  ...
  export type UnlockState = "UNLOCKED"|"LOCKED"|"UNLOCKING";
