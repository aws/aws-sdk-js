...
declare class ELB extends Service {
   ...
   */
  addTags(params: ELB.AddTagsInput, callback?: (err: AWSError, data: ELB.AddTagsOutput) => void): Request<ELB.AddTagsOutput, AWSError>;
  /**
   * Adds the specified tags to the specified load balancer. Each load balancer can have a maximum of 10 tags. Each tag consists of a key and an optional value. If a tag with the same key is already associated with the load balancer, AddTags updates its value. For more information, see Tag Your Classic Load Balancer in the Classic Load Balancers Guide.
   */
  addTags(callback?: (err: AWSError, data: ELB.AddTagsOutput) => void): Request<ELB.AddTagsOutput, AWSError>;
  /**
   ...
   */
  applySecurityGroupsToLoadBalancer(params: ELB.ApplySecurityGroupsToLoadBalancerInput, callback?: (err: AWSError, data: ELB.ApplySecurityGroupsToLoadBalancerOutput) => void): Request<ELB.ApplySecurityGroupsToLoadBalancerOutput, AWSError>;
  /**
   * Associates one or more security groups with your load balancer in a virtual private cloud (VPC). The specified security groups override the previously associated security groups. For more information, see Security Groups for Load Balancers in a VPC in the Classic Load Balancers Guide.
   */
  applySecurityGroupsToLoadBalancer(callback?: (err: AWSError, data: ELB.ApplySecurityGroupsToLoadBalancerOutput) => void): Request<ELB.ApplySecurityGroupsToLoadBalancerOutput, AWSError>;
  /**
   ...
   */
  attachLoadBalancerToSubnets(params: ELB.AttachLoadBalancerToSubnetsInput, callback?: (err: AWSError, data: ELB.AttachLoadBalancerToSubnetsOutput) => void): Request<ELB.AttachLoadBalancerToSubnetsOutput, AWSError>;
  /**
   * Adds one or more subnets to the set of configured subnets for the specified load balancer. The load balancer evenly distributes requests across all registered subnets. For more information, see Add or Remove Subnets for Your Load Balancer in a VPC in the Classic Load Balancers Guide.
   */
  attachLoadBalancerToSubnets(callback?: (err: AWSError, data: ELB.AttachLoadBalancerToSubnetsOutput) => void): Request<ELB.AttachLoadBalancerToSubnetsOutput, AWSError>;
  /**
   ...
   */
  configureHealthCheck(params: ELB.ConfigureHealthCheckInput, callback?: (err: AWSError, data: ELB.ConfigureHealthCheckOutput) => void): Request<ELB.ConfigureHealthCheckOutput, AWSError>;
  /**
   * Specifies the health check settings to use when evaluating the health state of your EC2 instances. For more information, see Configure Health Checks for Your Load Balancer in the Classic Load Balancers Guide.
   */
  configureHealthCheck(callback?: (err: AWSError, data: ELB.ConfigureHealthCheckOutput) => void): Request<ELB.ConfigureHealthCheckOutput, AWSError>;
  /**
   ...
   */
  createAppCookieStickinessPolicy(params: ELB.CreateAppCookieStickinessPolicyInput, callback?: (err: AWSError, data: ELB.CreateAppCookieStickinessPolicyOutput) => void): Request<ELB.CreateAppCookieStickinessPolicyOutput, AWSError>;
  /**
   * Generates a stickiness policy with sticky session lifetimes that follow that of an application-generated cookie. This policy can be associated only with HTTP/HTTPS listeners. This policy is similar to the policy created by CreateLBCookieStickinessPolicy, except that the lifetime of the special Elastic Load Balancing cookie, AWSELB, follows the lifetime of the application-generated cookie specified in the policy configuration. The load balancer only inserts a new stickiness cookie when the application response includes a new application cookie. If the application cookie is explicitly removed or expires, the session stops being sticky until a new application cookie is issued. For more information, see Application-Controlled Session Stickiness in the Classic Load Balancers Guide.
   */
  createAppCookieStickinessPolicy(callback?: (err: AWSError, data: ELB.CreateAppCookieStickinessPolicyOutput) => void): Request<ELB.CreateAppCookieStickinessPolicyOutput, AWSError>;
  /**
   ...
   */
  createLBCookieStickinessPolicy(params: ELB.CreateLBCookieStickinessPolicyInput, callback?: (err: AWSError, data: ELB.CreateLBCookieStickinessPolicyOutput) => void): Request<ELB.CreateLBCookieStickinessPolicyOutput, AWSError>;
  /**
   * Generates a stickiness policy with sticky session lifetimes controlled by the lifetime of the browser (user-agent) or a specified expiration period. This policy can be associated only with HTTP/HTTPS listeners. When a load balancer implements this policy, the load balancer uses a special cookie to track the instance for each request. When the load balancer receives a request, it first checks to see if this cookie is present in the request. If so, the load balancer sends the request to the application server specified in the cookie. If not, the load balancer sends the request to a server that is chosen based on the existing load-balancing algorithm. A cookie is inserted into the response for binding subsequent requests from the same user to that server. The validity of the cookie is based on the cookie expiration time, which is specified in the policy configuration. For more information, see Duration-Based Session Stickiness in the Classic Load Balancers Guide.
   */
  createLBCookieStickinessPolicy(callback?: (err: AWSError, data: ELB.CreateLBCookieStickinessPolicyOutput) => void): Request<ELB.CreateLBCookieStickinessPolicyOutput, AWSError>;
  /**
   ...
   */
  createLoadBalancer(params: ELB.CreateAccessPointInput, callback?: (err: AWSError, data: ELB.CreateAccessPointOutput) => void): Request<ELB.CreateAccessPointOutput, AWSError>;
  /**
   * Creates a Classic load balancer. You can add listeners, security groups, subnets, and tags when you create your load balancer, or you can add them later using CreateLoadBalancerListeners, ApplySecurityGroupsToLoadBalancer, AttachLoadBalancerToSubnets, and AddTags. To describe your current load balancers, see DescribeLoadBalancers. When you are finished with a load balancer, you can delete it using DeleteLoadBalancer. You can create up to 20 load balancers per region per account. You can request an increase for the number of load balancers for your account. For more information, see Limits for Your Classic Load Balancer in the Classic Load Balancers Guide.
   */
  createLoadBalancer(callback?: (err: AWSError, data: ELB.CreateAccessPointOutput) => void): Request<ELB.CreateAccessPointOutput, AWSError>;
  /**
   * Creates one or more listeners for the specified load balancer. If a listener with the specified port does not already exist, it is created; otherwise, the properties of the new listener must match the properties of the existing listener. For more information, see Listeners for Your Classic Load Balancer in the Classic Load Balancers Guide.
   */
  createLoadBalancerListeners(params: ELB.CreateLoadBalancerListenerInput, callback?: (err: AWSError, data: ELB.CreateLoadBalancerListenerOutput) => void): Request<ELB.CreateLoadBalancerListenerOutput, AWSError>;
  /**
   * Creates one or more listeners for the specified load balancer. If a listener with the specified port does not already exist, it is created; otherwise, the properties of the new listener must match the properties of the existing listener. For more information, see Listeners for Your Classic Load Balancer in the Classic Load Balancers Guide.
   */
  createLoadBalancerListeners(callback?: (err: AWSError, data: ELB.CreateLoadBalancerListenerOutput) => void): Request<ELB.CreateLoadBalancerListenerOutput, AWSError>;
  /**
   ...
   */
  createLoadBalancerPolicy(params: ELB.CreateLoadBalancerPolicyInput, callback?: (err: AWSError, data: ELB.CreateLoadBalancerPolicyOutput) => void): Request<ELB.CreateLoadBalancerPolicyOutput, AWSError>;
  /**
   * Creates a policy with the specified attributes for the specified load balancer. Policies are settings that are saved for your load balancer and that can be applied to the listener or the application server, depending on the policy type.
   */
  createLoadBalancerPolicy(callback?: (err: AWSError, data: ELB.CreateLoadBalancerPolicyOutput) => void): Request<ELB.CreateLoadBalancerPolicyOutput, AWSError>;
  /**
   ...
   */
  deleteLoadBalancer(params: ELB.DeleteAccessPointInput, callback?: (err: AWSError, data: ELB.DeleteAccessPointOutput) => void): Request<ELB.DeleteAccessPointOutput, AWSError>;
  /**
   * Deletes the specified load balancer. If you are attempting to recreate a load balancer, you must reconfigure all settings. The DNS name associated with a deleted load balancer are no longer usable. The name and associated DNS record of the deleted load balancer no longer exist and traffic sent to any of its IP addresses is no longer delivered to your instances. If the load balancer does not exist or has already been deleted, the call to DeleteLoadBalancer still succeeds.
   */
  deleteLoadBalancer(callback?: (err: AWSError, data: ELB.DeleteAccessPointOutput) => void): Request<ELB.DeleteAccessPointOutput, AWSError>;
  /**
   * Deletes the specified listeners from the specified load balancer.
   */
  deleteLoadBalancerListeners(params: ELB.DeleteLoadBalancerListenerInput, callback?: (err: AWSError, data: ELB.DeleteLoadBalancerListenerOutput) => void): Request<ELB.DeleteLoadBalancerListenerOutput, AWSError>;
  /**
   * Deletes the specified listeners from the specified load balancer.
   */
  deleteLoadBalancerListeners(callback?: (err: AWSError, data: ELB.DeleteLoadBalancerListenerOutput) => void): Request<ELB.DeleteLoadBalancerListenerOutput, AWSError>;
  /**
   * Deletes the specified policy from the specified load balancer. This policy must not be enabled for any listeners.
   */
  deleteLoadBalancerPolicy(params: ELB.DeleteLoadBalancerPolicyInput, callback?: (err: AWSError, data: ELB.DeleteLoadBalancerPolicyOutput) => void): Request<ELB.DeleteLoadBalancerPolicyOutput, AWSError>;
  /**
   * Deletes the specified policy from the specified load balancer. This policy must not be enabled for any listeners.
   */
  deleteLoadBalancerPolicy(callback?: (err: AWSError, data: ELB.DeleteLoadBalancerPolicyOutput) => void): Request<ELB.DeleteLoadBalancerPolicyOutput, AWSError>;
  /**
   ...
   */
  deregisterInstancesFromLoadBalancer(params: ELB.DeregisterEndPointsInput, callback?: (err: AWSError, data: ELB.DeregisterEndPointsOutput) => void): Request<ELB.DeregisterEndPointsOutput, AWSError>;
  /**
   * Deregisters the specified instances from the specified load balancer. After the instance is deregistered, it no longer receives traffic from the load balancer. You can use DescribeLoadBalancers to verify that the instance is deregistered from the load balancer. For more information, see Register or De-Register EC2 Instances in the Classic Load Balancers Guide.
   */
  deregisterInstancesFromLoadBalancer(callback?: (err: AWSError, data: ELB.DeregisterEndPointsOutput) => void): Request<ELB.DeregisterEndPointsOutput, AWSError>;
  /**
   * Describes the state of the specified instances with respect to the specified load balancer. If no instances are specified, the call describes the state of all instances that are currently registered with the load balancer. If instances are specified, their state is returned even if they are no longer registered with the load balancer. The state of terminated instances is not returned.
   */
  describeInstanceHealth(params: ELB.DescribeEndPointStateInput, callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   * Describes the state of the specified instances with respect to the specified load balancer. If no instances are specified, the call describes the state of all instances that are currently registered with the load balancer. If instances are specified, their state is returned even if they are no longer registered with the load balancer. The state of terminated instances is not returned.
   */
  describeInstanceHealth(callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   * Describes the attributes for the specified load balancer.
   */
  describeLoadBalancerAttributes(params: ELB.DescribeLoadBalancerAttributesInput, callback?: (err: AWSError, data: ELB.DescribeLoadBalancerAttributesOutput) => void): Request<ELB.DescribeLoadBalancerAttributesOutput, AWSError>;
  /**
   * Describes the attributes for the specified load balancer.
   */
  describeLoadBalancerAttributes(callback?: (err: AWSError, data: ELB.DescribeLoadBalancerAttributesOutput) => void): Request<ELB.DescribeLoadBalancerAttributesOutput, AWSError>;
  /**
   * Describes the specified policies. If you specify a load balancer name, the action returns the descriptions of all policies created for the load balancer. If you specify a policy name associated with your load balancer, the action returns the description of that policy. If you don't specify a load balancer name, the action returns descriptions of the specified sample policies, or descriptions of all sample policies. The names of the sample policies have the ELBSample- prefix.
   */
  describeLoadBalancerPolicies(params: ELB.DescribeLoadBalancerPoliciesInput, callback?: (err: AWSError, data: ELB.DescribeLoadBalancerPoliciesOutput) => void): Request<ELB.DescribeLoadBalancerPoliciesOutput, AWSError>;
  /**
   * Describes the specified policies. If you specify a load balancer name, the action returns the descriptions of all policies created for the load balancer. If you specify a policy name associated with your load balancer, the action returns the description of that policy. If you don't specify a load balancer name, the action returns descriptions of the specified sample policies, or descriptions of all sample policies. The names of the sample policies have the ELBSample- prefix.
   */
  describeLoadBalancerPolicies(callback?: (err: AWSError, data: ELB.DescribeLoadBalancerPoliciesOutput) => void): Request<ELB.DescribeLoadBalancerPoliciesOutput, AWSError>;
  /**
   ...
   */
  describeLoadBalancerPolicyTypes(params: ELB.DescribeLoadBalancerPolicyTypesInput, callback?: (err: AWSError, data: ELB.DescribeLoadBalancerPolicyTypesOutput) => void): Request<ELB.DescribeLoadBalancerPolicyTypesOutput, AWSError>;
  /**
   * Describes the specified load balancer policy types or all load balancer policy types. The description of each type indicates how it can be used. For example, some policies can be used only with layer 7 listeners, some policies can be used only with layer 4 listeners, and some policies can be used only with your EC2 instances. You can use CreateLoadBalancerPolicy to create a policy configuration for any of these policy types. Then, depending on the policy type, use either SetLoadBalancerPoliciesOfListener or SetLoadBalancerPoliciesForBackendServer to set the policy.
   */
  describeLoadBalancerPolicyTypes(callback?: (err: AWSError, data: ELB.DescribeLoadBalancerPolicyTypesOutput) => void): Request<ELB.DescribeLoadBalancerPolicyTypesOutput, AWSError>;
  /**
   * Describes the specified the load balancers. If no load balancers are specified, the call describes all of your load balancers.
   */
  describeLoadBalancers(params: ELB.DescribeAccessPointsInput, callback?: (err: AWSError, data: ELB.DescribeAccessPointsOutput) => void): Request<ELB.DescribeAccessPointsOutput, AWSError>;
  /**
   * Describes the specified the load balancers. If no load balancers are specified, the call describes all of your load balancers.
   */
  describeLoadBalancers(callback?: (err: AWSError, data: ELB.DescribeAccessPointsOutput) => void): Request<ELB.DescribeAccessPointsOutput, AWSError>;
  /**
   * Describes the tags associated with the specified load balancers.
   */
  describeTags(params: ELB.DescribeTagsInput, callback?: (err: AWSError, data: ELB.DescribeTagsOutput) => void): Request<ELB.DescribeTagsOutput, AWSError>;
  /**
   * Describes the tags associated with the specified load balancers.
   */
  describeTags(callback?: (err: AWSError, data: ELB.DescribeTagsOutput) => void): Request<ELB.DescribeTagsOutput, AWSError>;
  /**
   ...
   */
  detachLoadBalancerFromSubnets(params: ELB.DetachLoadBalancerFromSubnetsInput, callback?: (err: AWSError, data: ELB.DetachLoadBalancerFromSubnetsOutput) => void): Request<ELB.DetachLoadBalancerFromSubnetsOutput, AWSError>;
  /**
   * Removes the specified subnets from the set of configured subnets for the load balancer. After a subnet is removed, all EC2 instances registered with the load balancer in the removed subnet go into the OutOfService state. Then, the load balancer balances the traffic among the remaining routable subnets.
   */
  detachLoadBalancerFromSubnets(callback?: (err: AWSError, data: ELB.DetachLoadBalancerFromSubnetsOutput) => void): Request<ELB.DetachLoadBalancerFromSubnetsOutput, AWSError>;
  /**
   ...
   */
  disableAvailabilityZonesForLoadBalancer(params: ELB.RemoveAvailabilityZonesInput, callback?: (err: AWSError, data: ELB.RemoveAvailabilityZonesOutput) => void): Request<ELB.RemoveAvailabilityZonesOutput, AWSError>;
  /**
   * Removes the specified Availability Zones from the set of Availability Zones for the specified load balancer. There must be at least one Availability Zone registered with a load balancer at all times. After an Availability Zone is removed, all instances registered with the load balancer that are in the removed Availability Zone go into the OutOfService state. Then, the load balancer attempts to equally balance the traffic among its remaining Availability Zones. For more information, see Add or Remove Availability Zones in the Classic Load Balancers Guide.
   */
  disableAvailabilityZonesForLoadBalancer(callback?: (err: AWSError, data: ELB.RemoveAvailabilityZonesOutput) => void): Request<ELB.RemoveAvailabilityZonesOutput, AWSError>;
  /**
   ...
   */
  enableAvailabilityZonesForLoadBalancer(params: ELB.AddAvailabilityZonesInput, callback?: (err: AWSError, data: ELB.AddAvailabilityZonesOutput) => void): Request<ELB.AddAvailabilityZonesOutput, AWSError>;
  /**
   * Adds the specified Availability Zones to the set of Availability Zones for the specified load balancer. The load balancer evenly distributes requests across all its registered Availability Zones that contain instances. For more information, see Add or Remove Availability Zones in the Classic Load Balancers Guide.
   */
  enableAvailabilityZonesForLoadBalancer(callback?: (err: AWSError, data: ELB.AddAvailabilityZonesOutput) => void): Request<ELB.AddAvailabilityZonesOutput, AWSError>;
  /**
   ...
   */
  modifyLoadBalancerAttributes(params: ELB.ModifyLoadBalancerAttributesInput, callback?: (err: AWSError, data: ELB.ModifyLoadBalancerAttributesOutput) => void): Request<ELB.ModifyLoadBalancerAttributesOutput, AWSError>;
  /**
   * Modifies the attributes of the specified load balancer. You can modify the load balancer attributes, such as AccessLogs, ConnectionDraining, and CrossZoneLoadBalancing by either enabling or disabling them. Or, you can modify the load balancer attribute ConnectionSettings by specifying an idle connection timeout value for your load balancer. For more information, see the following in the Classic Load Balancers Guide:    Cross-Zone Load Balancing     Connection Draining     Access Logs     Idle Connection Timeout   
   */
  modifyLoadBalancerAttributes(callback?: (err: AWSError, data: ELB.ModifyLoadBalancerAttributesOutput) => void): Request<ELB.ModifyLoadBalancerAttributesOutput, AWSError>;
  /**
   ...
   */
  registerInstancesWithLoadBalancer(params: ELB.RegisterEndPointsInput, callback?: (err: AWSError, data: ELB.RegisterEndPointsOutput) => void): Request<ELB.RegisterEndPointsOutput, AWSError>;
  /**
   * Adds the specified instances to the specified load balancer. The instance must be a running instance in the same network as the load balancer (EC2-Classic or the same VPC). If you have EC2-Classic instances and a load balancer in a VPC with ClassicLink enabled, you can link the EC2-Classic instances to that VPC and then register the linked EC2-Classic instances with the load balancer in the VPC. Note that RegisterInstanceWithLoadBalancer completes when the request has been registered. Instance registration takes a little time to complete. To check the state of the registered instances, use DescribeLoadBalancers or DescribeInstanceHealth. After the instance is registered, it starts receiving traffic and requests from the load balancer. Any instance that is not in one of the Availability Zones registered for the load balancer is moved to the OutOfService state. If an Availability Zone is added to the load balancer later, any instances registered with the load balancer move to the InService state. To deregister instances from a load balancer, use DeregisterInstancesFromLoadBalancer. For more information, see Register or De-Register EC2 Instances in the Classic Load Balancers Guide.
   */
  registerInstancesWithLoadBalancer(callback?: (err: AWSError, data: ELB.RegisterEndPointsOutput) => void): Request<ELB.RegisterEndPointsOutput, AWSError>;
  /**
   * Removes one or more tags from the specified load balancer.
   */
  removeTags(params: ELB.RemoveTagsInput, callback?: (err: AWSError, data: ELB.RemoveTagsOutput) => void): Request<ELB.RemoveTagsOutput, AWSError>;
  /**
   * Removes one or more tags from the specified load balancer.
   */
  removeTags(callback?: (err: AWSError, data: ELB.RemoveTagsOutput) => void): Request<ELB.RemoveTagsOutput, AWSError>;
  /**
   ...
   */
  setLoadBalancerListenerSSLCertificate(params: ELB.SetLoadBalancerListenerSSLCertificateInput, callback?: (err: AWSError, data: ELB.SetLoadBalancerListenerSSLCertificateOutput) => void): Request<ELB.SetLoadBalancerListenerSSLCertificateOutput, AWSError>;
  /**
   * Sets the certificate that terminates the specified listener's SSL connections. The specified certificate replaces any prior certificate that was used on the same load balancer and port. For more information about updating your SSL certificate, see Replace the SSL Certificate for Your Load Balancer in the Classic Load Balancers Guide.
   */
  setLoadBalancerListenerSSLCertificate(callback?: (err: AWSError, data: ELB.SetLoadBalancerListenerSSLCertificateOutput) => void): Request<ELB.SetLoadBalancerListenerSSLCertificateOutput, AWSError>;
  /**
   ...
   */
  setLoadBalancerPoliciesForBackendServer(params: ELB.SetLoadBalancerPoliciesForBackendServerInput, callback?: (err: AWSError, data: ELB.SetLoadBalancerPoliciesForBackendServerOutput) => void): Request<ELB.SetLoadBalancerPoliciesForBackendServerOutput, AWSError>;
  /**
   * Replaces the set of policies associated with the specified port on which the EC2 instance is listening with a new set of policies. At this time, only the back-end server authentication policy type can be applied to the instance ports; this policy type is composed of multiple public key policies. Each time you use SetLoadBalancerPoliciesForBackendServer to enable the policies, use the PolicyNames parameter to list the policies that you want to enable. You can use DescribeLoadBalancers or DescribeLoadBalancerPolicies to verify that the policy is associated with the EC2 instance. For more information about enabling back-end instance authentication, see Configure Back-end Instance Authentication in the Classic Load Balancers Guide. For more information about Proxy Protocol, see Configure Proxy Protocol Support in the Classic Load Balancers Guide.
   */
  setLoadBalancerPoliciesForBackendServer(callback?: (err: AWSError, data: ELB.SetLoadBalancerPoliciesForBackendServerOutput) => void): Request<ELB.SetLoadBalancerPoliciesForBackendServerOutput, AWSError>;
  /**
   ...
   */
  setLoadBalancerPoliciesOfListener(params: ELB.SetLoadBalancerPoliciesOfListenerInput, callback?: (err: AWSError, data: ELB.SetLoadBalancerPoliciesOfListenerOutput) => void): Request<ELB.SetLoadBalancerPoliciesOfListenerOutput, AWSError>;
  /**
   * Replaces the current set of policies for the specified load balancer port with the specified set of policies. To enable back-end server authentication, use SetLoadBalancerPoliciesForBackendServer. For more information about setting policies, see Update the SSL Negotiation Configuration, Duration-Based Session Stickiness, and Application-Controlled Session Stickiness in the Classic Load Balancers Guide.
   */
  setLoadBalancerPoliciesOfListener(callback?: (err: AWSError, data: ELB.SetLoadBalancerPoliciesOfListenerOutput) => void): Request<ELB.SetLoadBalancerPoliciesOfListenerOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceDeregistered", params: ELB.DescribeEndPointStateInput, callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   * Waits for the InstanceDeregistered state by periodically calling the underlying ELB.describeInstanceHealthoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "InstanceDeregistered", callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "AnyInstanceInService", params: ELB.DescribeEndPointStateInput, callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   * Waits for the AnyInstanceInService state by periodically calling the underlying ELB.describeInstanceHealthoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "AnyInstanceInService", callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "InstanceInService", params: ELB.DescribeEndPointStateInput, callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
  /**
   * Waits for the InstanceInService state by periodically calling the underlying ELB.describeInstanceHealthoperation every 15 seconds (at most 40 times).
   */
  waitFor(state: "InstanceInService", callback?: (err: AWSError, data: ELB.DescribeEndPointStateOutput) => void): Request<ELB.DescribeEndPointStateOutput, AWSError>;
}
