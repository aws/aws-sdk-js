...
interface Blob {}
declare class Inspector<Params extends Inspector.Types.ClientParams = {}> extends Service {
  /**
   * Constructs a service object. This object has one method for each API operation.
   */
  constructor(options?: Inspector.Types.ClientConfiguration<Params>)
  config: Config & Inspector.Types.ClientConfiguration<Params>;
  /**
   * Assigns attributes (key and value pairs) to the findings that are specified by the ARNs of the findings.
   */
  addAttributesToFindings(params: BoundInput<Inspector.Types.AddAttributesToFindingsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.AddAttributesToFindingsResponse) => void): Request<Inspector.Types.AddAttributesToFindingsResponse, AWSError>;
  /**
   * Assigns attributes (key and value pairs) to the findings that are specified by the ARNs of the findings.
   */
   ...
   */
  createAssessmentTarget(params: BoundInput<Inspector.Types.CreateAssessmentTargetRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.CreateAssessmentTargetResponse) => void): Request<Inspector.Types.CreateAssessmentTargetResponse, AWSError>;
  /**
   * Creates a new assessment target using the ARN of the resource group that is generated by CreateResourceGroup. If resourceGroupArn is not specified, all EC2 instances in the current AWS account and region are included in the assessment target. If the service-linked role isn’t already registered, this action also creates and registers a service-linked role to grant Amazon Inspector access to AWS Services needed to perform security assessments. You can create up to 50 assessment targets per AWS account. You can run up to 500 concurrent agents per AWS account. For more information, see  Amazon Inspector Assessment Targets.
   */
   ...
   */
  createAssessmentTemplate(params: BoundInput<Inspector.Types.CreateAssessmentTemplateRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.CreateAssessmentTemplateResponse) => void): Request<Inspector.Types.CreateAssessmentTemplateResponse, AWSError>;
  /**
   * Creates an assessment template for the assessment target that is specified by the ARN of the assessment target. If the service-linked role isn’t already registered, this action also creates and registers a service-linked role to grant Amazon Inspector access to AWS Services needed to perform security assessments.
   */
   ...
   */
  createExclusionsPreview(params: BoundInput<Inspector.Types.CreateExclusionsPreviewRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.CreateExclusionsPreviewResponse) => void): Request<Inspector.Types.CreateExclusionsPreviewResponse, AWSError>;
  /**
   * Starts the generation of an exclusions preview for the specified assessment template. The exclusions preview lists the potential exclusions (ExclusionPreview) that Inspector can detect before it runs the assessment. 
   */
   ...
   */
  createResourceGroup(params: BoundInput<Inspector.Types.CreateResourceGroupRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.CreateResourceGroupResponse) => void): Request<Inspector.Types.CreateResourceGroupResponse, AWSError>;
  /**
   * Creates a resource group using the specified set of tags (key and value pairs) that are used to select the EC2 instances to be included in an Amazon Inspector assessment target. The created resource group is then used to create an Amazon Inspector assessment target. For more information, see CreateAssessmentTarget.
   */
   ...
   */
  deleteAssessmentRun(params: BoundInput<Inspector.Types.DeleteAssessmentRunRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the assessment run that is specified by the ARN of the assessment run.
   */
   ...
   */
  deleteAssessmentTarget(params: BoundInput<Inspector.Types.DeleteAssessmentTargetRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the assessment target that is specified by the ARN of the assessment target.
   */
   ...
   */
  deleteAssessmentTemplate(params: BoundInput<Inspector.Types.DeleteAssessmentTemplateRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the assessment template that is specified by the ARN of the assessment template.
   */
   ...
   */
  describeAssessmentRuns(params: BoundInput<Inspector.Types.DescribeAssessmentRunsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeAssessmentRunsResponse) => void): Request<Inspector.Types.DescribeAssessmentRunsResponse, AWSError>;
  /**
   * Describes the assessment runs that are specified by the ARNs of the assessment runs.
   */
   ...
   */
  describeAssessmentTargets(params: BoundInput<Inspector.Types.DescribeAssessmentTargetsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeAssessmentTargetsResponse) => void): Request<Inspector.Types.DescribeAssessmentTargetsResponse, AWSError>;
  /**
   * Describes the assessment targets that are specified by the ARNs of the assessment targets.
   */
   ...
   */
  describeAssessmentTemplates(params: BoundInput<Inspector.Types.DescribeAssessmentTemplatesRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeAssessmentTemplatesResponse) => void): Request<Inspector.Types.DescribeAssessmentTemplatesResponse, AWSError>;
  /**
   * Describes the assessment templates that are specified by the ARNs of the assessment templates.
   */
   ...
   */
  describeExclusions(params: BoundInput<Inspector.Types.DescribeExclusionsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeExclusionsResponse) => void): Request<Inspector.Types.DescribeExclusionsResponse, AWSError>;
  /**
   * Describes the exclusions that are specified by the exclusions' ARNs.
   */
   ...
   */
  describeFindings(params: BoundInput<Inspector.Types.DescribeFindingsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeFindingsResponse) => void): Request<Inspector.Types.DescribeFindingsResponse, AWSError>;
  /**
   * Describes the findings that are specified by the ARNs of the findings.
   */
   ...
   */
  describeResourceGroups(params: BoundInput<Inspector.Types.DescribeResourceGroupsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeResourceGroupsResponse) => void): Request<Inspector.Types.DescribeResourceGroupsResponse, AWSError>;
  /**
   * Describes the resource groups that are specified by the ARNs of the resource groups.
   */
   ...
   */
  describeRulesPackages(params: BoundInput<Inspector.Types.DescribeRulesPackagesRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.DescribeRulesPackagesResponse) => void): Request<Inspector.Types.DescribeRulesPackagesResponse, AWSError>;
  /**
   * Describes the rules packages that are specified by the ARNs of the rules packages.
   */
   ...
   */
  getAssessmentReport(params: BoundInput<Inspector.Types.GetAssessmentReportRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.GetAssessmentReportResponse) => void): Request<Inspector.Types.GetAssessmentReportResponse, AWSError>;
  /**
   * Produces an assessment report that includes detailed and comprehensive results of a specified assessment run. 
   */
   ...
   */
  getExclusionsPreview(params: BoundInput<Inspector.Types.GetExclusionsPreviewRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.GetExclusionsPreviewResponse) => void): Request<Inspector.Types.GetExclusionsPreviewResponse, AWSError>;
  /**
   * Retrieves the exclusions preview (a list of ExclusionPreview objects) specified by the preview token. You can obtain the preview token by running the CreateExclusionsPreview API.
   */
   ...
   */
  getTelemetryMetadata(params: BoundInput<Inspector.Types.GetTelemetryMetadataRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.GetTelemetryMetadataResponse) => void): Request<Inspector.Types.GetTelemetryMetadataResponse, AWSError>;
  /**
   * Information about the data that is collected for the specified assessment run.
   */
   ...
   */
  listAssessmentRunAgents(params: BoundInput<Inspector.Types.ListAssessmentRunAgentsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListAssessmentRunAgentsResponse) => void): Request<Inspector.Types.ListAssessmentRunAgentsResponse, AWSError>;
  /**
   * Lists the agents of the assessment runs that are specified by the ARNs of the assessment runs.
   */
   ...
   */
  listAssessmentRuns(params: BoundInput<Inspector.Types.ListAssessmentRunsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListAssessmentRunsResponse) => void): Request<Inspector.Types.ListAssessmentRunsResponse, AWSError>;
  /**
   * Lists the assessment runs that correspond to the assessment templates that are specified by the ARNs of the assessment templates.
   */
   ...
   */
  listAssessmentTargets(params: BoundInput<Inspector.Types.ListAssessmentTargetsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListAssessmentTargetsResponse) => void): Request<Inspector.Types.ListAssessmentTargetsResponse, AWSError>;
  /**
   * Lists the ARNs of the assessment targets within this AWS account. For more information about assessment targets, see Amazon Inspector Assessment Targets.
   */
   ...
   */
  listAssessmentTemplates(params: BoundInput<Inspector.Types.ListAssessmentTemplatesRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListAssessmentTemplatesResponse) => void): Request<Inspector.Types.ListAssessmentTemplatesResponse, AWSError>;
  /**
   * Lists the assessment templates that correspond to the assessment targets that are specified by the ARNs of the assessment targets.
   */
   ...
   */
  listEventSubscriptions(params: BoundInput<Inspector.Types.ListEventSubscriptionsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListEventSubscriptionsResponse) => void): Request<Inspector.Types.ListEventSubscriptionsResponse, AWSError>;
  /**
   * Lists all the event subscriptions for the assessment template that is specified by the ARN of the assessment template. For more information, see SubscribeToEvent and UnsubscribeFromEvent.
   */
   ...
   */
  listExclusions(params: BoundInput<Inspector.Types.ListExclusionsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListExclusionsResponse) => void): Request<Inspector.Types.ListExclusionsResponse, AWSError>;
  /**
   * List exclusions that are generated by the assessment run.
   */
   ...
   */
  listFindings(params: BoundInput<Inspector.Types.ListFindingsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListFindingsResponse) => void): Request<Inspector.Types.ListFindingsResponse, AWSError>;
  /**
   * Lists findings that are generated by the assessment runs that are specified by the ARNs of the assessment runs.
   */
   ...
   */
  listRulesPackages(params: BoundInput<Inspector.Types.ListRulesPackagesRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListRulesPackagesResponse) => void): Request<Inspector.Types.ListRulesPackagesResponse, AWSError>;
  /**
   * Lists all available Amazon Inspector rules packages.
   */
   ...
   */
  listTagsForResource(params: BoundInput<Inspector.Types.ListTagsForResourceRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.ListTagsForResourceResponse) => void): Request<Inspector.Types.ListTagsForResourceResponse, AWSError>;
  /**
   * Lists all tags associated with an assessment template.
   */
   ...
   */
  previewAgents(params: BoundInput<Inspector.Types.PreviewAgentsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.PreviewAgentsResponse) => void): Request<Inspector.Types.PreviewAgentsResponse, AWSError>;
  /**
   * Previews the agents installed on the EC2 instances that are part of the specified assessment target.
   */
   ...
   */
  registerCrossAccountAccessRole(params: BoundInput<Inspector.Types.RegisterCrossAccountAccessRoleRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Registers the IAM role that grants Amazon Inspector access to AWS Services needed to perform security assessments.
   */
   ...
   */
  removeAttributesFromFindings(params: BoundInput<Inspector.Types.RemoveAttributesFromFindingsRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.RemoveAttributesFromFindingsResponse) => void): Request<Inspector.Types.RemoveAttributesFromFindingsResponse, AWSError>;
  /**
   * Removes entire attributes (key and value pairs) from the findings that are specified by the ARNs of the findings where an attribute with the specified key exists.
   */
   ...
   */
  setTagsForResource(params: BoundInput<Inspector.Types.SetTagsForResourceRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Sets tags (key and value pairs) to the assessment template that is specified by the ARN of the assessment template.
   */
   ...
   */
  startAssessmentRun(params: BoundInput<Inspector.Types.StartAssessmentRunRequest, keyof Params>, callback?: (err: AWSError, data: Inspector.Types.StartAssessmentRunResponse) => void): Request<Inspector.Types.StartAssessmentRunResponse, AWSError>;
  /**
   * Starts the assessment run specified by the ARN of the assessment template. For this API to function properly, you must not exceed the limit of running up to 500 concurrent agents per AWS account.
   */
   ...
   */
  stopAssessmentRun(params: BoundInput<Inspector.Types.StopAssessmentRunRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Stops the assessment run that is specified by the ARN of the assessment run.
   */
   ...
   */
  subscribeToEvent(params: BoundInput<Inspector.Types.SubscribeToEventRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Enables the process of sending Amazon Simple Notification Service (SNS) notifications about a specified event to a specified SNS topic.
   */
   ...
   */
  unsubscribeFromEvent(params: BoundInput<Inspector.Types.UnsubscribeFromEventRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Disables the process of sending Amazon Simple Notification Service (SNS) notifications about a specified event to a specified SNS topic.
   */
   ...
   */
  updateAssessmentTarget(params: BoundInput<Inspector.Types.UpdateAssessmentTargetRequest, keyof Params>, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Updates the assessment target that is specified by the ARN of the assessment target. If resourceGroupArn is not specified, all EC2 instances in the current AWS account and region are included in the assessment target.
   */
...
declare namespace Inspector {
  ...
  export type ClientParams = InputParams<AddAttributesToFindingsRequest & CreateAssessmentTargetRequest & CreateAssessmentTemplateRequest & CreateExclusionsPreviewRequest & CreateResourceGroupRequest & DeleteAssessmentRunRequest & DeleteAssessmentTargetRequest & DeleteAssessmentTemplateRequest & DescribeAssessmentRunsRequest & DescribeAssessmentTargetsRequest & DescribeAssessmentTemplatesRequest & DescribeExclusionsRequest & DescribeFindingsRequest & DescribeResourceGroupsRequest & DescribeRulesPackagesRequest & GetAssessmentReportRequest & GetExclusionsPreviewRequest & GetTelemetryMetadataRequest & ListAssessmentRunAgentsRequest & ListAssessmentRunsRequest & ListAssessmentTargetsRequest & ListAssessmentTemplatesRequest & ListEventSubscriptionsRequest & ListExclusionsRequest & ListFindingsRequest & ListRulesPackagesRequest & ListTagsForResourceRequest & PreviewAgentsRequest & RegisterCrossAccountAccessRoleRequest & RemoveAttributesFromFindingsRequest & SetTagsForResourceRequest & StartAssessmentRunRequest & StopAssessmentRunRequest & SubscribeToEventRequest & UnsubscribeFromEventRequest & UpdateAssessmentTargetRequest>;
