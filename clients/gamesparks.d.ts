...
declare namespace GameSparks {
  ...
  export type DeploymentAction = "DEPLOY"|"UNDEPLOY";
  ...
  export type DeploymentState = "PENDING"|"IN_PROGRESS"|"COMPLETED"|"FAILED";
  ...
  export type GameState = "ACTIVE"|"DELETING";
  ...
  export type GeneratedCodeJobState = "IN_PROGRESS"|"COMPLETED"|"FAILED"|"PENDING";
  ...
  export type ResultCode = "SUCCESS"|"INVALID_ROLE_FAILURE"|"UNSPECIFIED_FAILURE";
  ...
  export type StageState = "ACTIVE"|"DELETING";
