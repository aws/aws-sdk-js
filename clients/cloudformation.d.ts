...
declare class CloudFormation extends Service {
   ...
   */
  cancelUpdateStack(params: CloudFormation.CancelUpdateStackInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Cancels an update on the specified stack. If the call completes successfully, the stack rolls back the update and reverts to the previous stack configuration.  You can cancel only stacks that are in the UPDATE_IN_PROGRESS state. 
   */
   ...
   */
  continueUpdateRollback(params: CloudFormation.ContinueUpdateRollbackInput, callback?: (err: AWSError, data: CloudFormation.ContinueUpdateRollbackOutput) => void): Request<CloudFormation.ContinueUpdateRollbackOutput, AWSError>;
  /**
   * For a specified stack that is in the UPDATE_ROLLBACK_FAILED state, continues rolling it back to the UPDATE_ROLLBACK_COMPLETE state. Depending on the cause of the failure, you can manually  fix the error and continue the rollback. By continuing the rollback, you can return your stack to a working state (the UPDATE_ROLLBACK_COMPLETE state), and then try to update the stack again. A stack goes into the UPDATE_ROLLBACK_FAILED state when AWS CloudFormation cannot roll back all changes after a failed stack update. For example, you might have a stack that is rolling back to an old database instance that was deleted outside of AWS CloudFormation. Because AWS CloudFormation doesn't know the database was deleted, it assumes that the database instance still exists and attempts to roll back to it, causing the update rollback to fail.
   */
  continueUpdateRollback(callback?: (err: AWSError, data: CloudFormation.ContinueUpdateRollbackOutput) => void): Request<CloudFormation.ContinueUpdateRollbackOutput, AWSError>;
  /**
   ...
   */
  createChangeSet(params: CloudFormation.CreateChangeSetInput, callback?: (err: AWSError, data: CloudFormation.CreateChangeSetOutput) => void): Request<CloudFormation.CreateChangeSetOutput, AWSError>;
  /**
   * Creates a list of changes for a stack. AWS CloudFormation generates the change set by comparing the stack's information with the information that you submit. A change set can help you understand which resources AWS CloudFormation will change and how it will change them before you update your stack. Change sets allow you to check before you make a change so that you don't delete or replace critical resources. AWS CloudFormation doesn't make any changes to the stack when you create a change set. To make the specified changes, you must execute the change set by using the ExecuteChangeSet action. After the call successfully completes, AWS CloudFormation starts creating the change set. To check the status of the change set, use the DescribeChangeSet action.
   */
  createChangeSet(callback?: (err: AWSError, data: CloudFormation.CreateChangeSetOutput) => void): Request<CloudFormation.CreateChangeSetOutput, AWSError>;
  /**
   * Creates a stack as specified in the template. After the call completes successfully, the stack creation starts. You can check the status of the stack via the DescribeStacks API.
   */
  createStack(params: CloudFormation.CreateStackInput, callback?: (err: AWSError, data: CloudFormation.CreateStackOutput) => void): Request<CloudFormation.CreateStackOutput, AWSError>;
  /**
   * Creates a stack as specified in the template. After the call completes successfully, the stack creation starts. You can check the status of the stack via the DescribeStacks API.
   */
  createStack(callback?: (err: AWSError, data: CloudFormation.CreateStackOutput) => void): Request<CloudFormation.CreateStackOutput, AWSError>;
  /**
   ...
   */
  deleteChangeSet(params: CloudFormation.DeleteChangeSetInput, callback?: (err: AWSError, data: CloudFormation.DeleteChangeSetOutput) => void): Request<CloudFormation.DeleteChangeSetOutput, AWSError>;
  /**
   * Deletes the specified change set. Deleting change sets ensures that no one executes the wrong change set. If the call successfully completes, AWS CloudFormation successfully deleted the change set.
   */
  deleteChangeSet(callback?: (err: AWSError, data: CloudFormation.DeleteChangeSetOutput) => void): Request<CloudFormation.DeleteChangeSetOutput, AWSError>;
  /**
   * Deletes a specified stack. Once the call completes successfully, stack deletion starts. Deleted stacks do not show up in the DescribeStacks API if the deletion has been completed successfully.
   */
  deleteStack(params: CloudFormation.DeleteStackInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes a specified stack. Once the call completes successfully, stack deletion starts. Deleted stacks do not show up in the DescribeStacks API if the deletion has been completed successfully.
   */
   ...
   */
  describeAccountLimits(params: CloudFormation.DescribeAccountLimitsInput, callback?: (err: AWSError, data: CloudFormation.DescribeAccountLimitsOutput) => void): Request<CloudFormation.DescribeAccountLimitsOutput, AWSError>;
  /**
   * Retrieves your account's AWS CloudFormation limits, such as the maximum number of stacks that you can create in your account.
   */
  describeAccountLimits(callback?: (err: AWSError, data: CloudFormation.DescribeAccountLimitsOutput) => void): Request<CloudFormation.DescribeAccountLimitsOutput, AWSError>;
  /**
   * Returns the inputs for the change set and a list of changes that AWS CloudFormation will make if you execute the change set. For more information, see Updating Stacks Using Change Sets in the AWS CloudFormation User Guide.
   */
  describeChangeSet(params: CloudFormation.DescribeChangeSetInput, callback?: (err: AWSError, data: CloudFormation.DescribeChangeSetOutput) => void): Request<CloudFormation.DescribeChangeSetOutput, AWSError>;
  /**
   * Returns the inputs for the change set and a list of changes that AWS CloudFormation will make if you execute the change set. For more information, see Updating Stacks Using Change Sets in the AWS CloudFormation User Guide.
   */
  describeChangeSet(callback?: (err: AWSError, data: CloudFormation.DescribeChangeSetOutput) => void): Request<CloudFormation.DescribeChangeSetOutput, AWSError>;
  /**
   ...
   */
  describeStackEvents(params: CloudFormation.DescribeStackEventsInput, callback?: (err: AWSError, data: CloudFormation.DescribeStackEventsOutput) => void): Request<CloudFormation.DescribeStackEventsOutput, AWSError>;
  /**
   * Returns all stack related events for a specified stack in reverse chronological order. For more information about a stack's event history, go to Stacks in the AWS CloudFormation User Guide.  You can list events for stacks that have failed to create or have been deleted by specifying the unique stack identifier (stack ID). 
   */
  describeStackEvents(callback?: (err: AWSError, data: CloudFormation.DescribeStackEventsOutput) => void): Request<CloudFormation.DescribeStackEventsOutput, AWSError>;
  /**
   ...
   */
  describeStackResource(params: CloudFormation.DescribeStackResourceInput, callback?: (err: AWSError, data: CloudFormation.DescribeStackResourceOutput) => void): Request<CloudFormation.DescribeStackResourceOutput, AWSError>;
  /**
   * Returns a description of the specified resource in the specified stack. For deleted stacks, DescribeStackResource returns resource information for up to 90 days after the stack has been deleted.
   */
  describeStackResource(callback?: (err: AWSError, data: CloudFormation.DescribeStackResourceOutput) => void): Request<CloudFormation.DescribeStackResourceOutput, AWSError>;
  /**
   ...
   */
  describeStackResources(params: CloudFormation.DescribeStackResourcesInput, callback?: (err: AWSError, data: CloudFormation.DescribeStackResourcesOutput) => void): Request<CloudFormation.DescribeStackResourcesOutput, AWSError>;
  /**
   * Returns AWS resource descriptions for running and deleted stacks. If StackName is specified, all the associated resources that are part of the stack are returned. If PhysicalResourceId is specified, the associated resources of the stack that the resource belongs to are returned.  Only the first 100 resources will be returned. If your stack has more resources than this, you should use ListStackResources instead.  For deleted stacks, DescribeStackResources returns resource information for up to 90 days after the stack has been deleted. You must specify either StackName or PhysicalResourceId, but not both. In addition, you can specify LogicalResourceId to filter the returned result. For more information about resources, the LogicalResourceId and PhysicalResourceId, go to the AWS CloudFormation User Guide.  A ValidationError is returned if you specify both StackName and PhysicalResourceId in the same request. 
   */
  describeStackResources(callback?: (err: AWSError, data: CloudFormation.DescribeStackResourcesOutput) => void): Request<CloudFormation.DescribeStackResourcesOutput, AWSError>;
  /**
   ...
   */
  describeStacks(params: CloudFormation.DescribeStacksInput, callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   * Returns the description for the specified stack; if no stack name was specified, then it returns the description for all the stacks created.  If the stack does not exist, an AmazonCloudFormationException is returned. 
   */
  describeStacks(callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   * Returns the estimated monthly cost of a template. The return value is an AWS Simple Monthly Calculator URL with a query string that describes the resources required to run the template.
   */
  estimateTemplateCost(params: CloudFormation.EstimateTemplateCostInput, callback?: (err: AWSError, data: CloudFormation.EstimateTemplateCostOutput) => void): Request<CloudFormation.EstimateTemplateCostOutput, AWSError>;
  /**
   * Returns the estimated monthly cost of a template. The return value is an AWS Simple Monthly Calculator URL with a query string that describes the resources required to run the template.
   */
  estimateTemplateCost(callback?: (err: AWSError, data: CloudFormation.EstimateTemplateCostOutput) => void): Request<CloudFormation.EstimateTemplateCostOutput, AWSError>;
  /**
   ...
   */
  executeChangeSet(params: CloudFormation.ExecuteChangeSetInput, callback?: (err: AWSError, data: CloudFormation.ExecuteChangeSetOutput) => void): Request<CloudFormation.ExecuteChangeSetOutput, AWSError>;
  /**
   * Updates a stack using the input information that was provided when the specified change set was created. After the call successfully completes, AWS CloudFormation starts updating the stack. Use the DescribeStacks action to view the status of the update. When you execute a change set, AWS CloudFormation deletes all other change sets associated with the stack because they aren't valid for the updated stack. If a stack policy is associated with the stack, AWS CloudFormation enforces the policy during the update. You can't specify a temporary stack policy that overrides the current policy.
   */
  executeChangeSet(callback?: (err: AWSError, data: CloudFormation.ExecuteChangeSetOutput) => void): Request<CloudFormation.ExecuteChangeSetOutput, AWSError>;
  /**
   * Returns the stack policy for a specified stack. If a stack doesn't have a policy, a null value is returned.
   */
  getStackPolicy(params: CloudFormation.GetStackPolicyInput, callback?: (err: AWSError, data: CloudFormation.GetStackPolicyOutput) => void): Request<CloudFormation.GetStackPolicyOutput, AWSError>;
  /**
   * Returns the stack policy for a specified stack. If a stack doesn't have a policy, a null value is returned.
   */
  getStackPolicy(callback?: (err: AWSError, data: CloudFormation.GetStackPolicyOutput) => void): Request<CloudFormation.GetStackPolicyOutput, AWSError>;
  /**
   ...
   */
  getTemplate(params: CloudFormation.GetTemplateInput, callback?: (err: AWSError, data: CloudFormation.GetTemplateOutput) => void): Request<CloudFormation.GetTemplateOutput, AWSError>;
  /**
   * Returns the template body for a specified stack. You can get the template for running or deleted stacks. For deleted stacks, GetTemplate returns the template for up to 90 days after the stack has been deleted.   If the template does not exist, a ValidationError is returned.  
   */
  getTemplate(callback?: (err: AWSError, data: CloudFormation.GetTemplateOutput) => void): Request<CloudFormation.GetTemplateOutput, AWSError>;
  /**
   ...
   */
  getTemplateSummary(params: CloudFormation.GetTemplateSummaryInput, callback?: (err: AWSError, data: CloudFormation.GetTemplateSummaryOutput) => void): Request<CloudFormation.GetTemplateSummaryOutput, AWSError>;
  /**
   * Returns information about a new or existing template. The GetTemplateSummary action is useful for viewing parameter information, such as default parameter values and parameter types, before you create or update a stack. You can use the GetTemplateSummary action when you submit a template, or you can get template information for a running or deleted stack. For deleted stacks, GetTemplateSummary returns the template information for up to 90 days after the stack has been deleted. If the template does not exist, a ValidationError is returned.
   */
  getTemplateSummary(callback?: (err: AWSError, data: CloudFormation.GetTemplateSummaryOutput) => void): Request<CloudFormation.GetTemplateSummaryOutput, AWSError>;
  /**
   * Returns the ID and status of each active change set for a stack. For example, AWS CloudFormation lists change sets that are in the CREATE_IN_PROGRESS or CREATE_PENDING state.
   */
  listChangeSets(params: CloudFormation.ListChangeSetsInput, callback?: (err: AWSError, data: CloudFormation.ListChangeSetsOutput) => void): Request<CloudFormation.ListChangeSetsOutput, AWSError>;
  /**
   * Returns the ID and status of each active change set for a stack. For example, AWS CloudFormation lists change sets that are in the CREATE_IN_PROGRESS or CREATE_PENDING state.
   */
  listChangeSets(callback?: (err: AWSError, data: CloudFormation.ListChangeSetsOutput) => void): Request<CloudFormation.ListChangeSetsOutput, AWSError>;
  /**
   ...
   */
  listStackResources(params: CloudFormation.ListStackResourcesInput, callback?: (err: AWSError, data: CloudFormation.ListStackResourcesOutput) => void): Request<CloudFormation.ListStackResourcesOutput, AWSError>;
  /**
   * Returns descriptions of all resources of the specified stack. For deleted stacks, ListStackResources returns resource information for up to 90 days after the stack has been deleted.
   */
  listStackResources(callback?: (err: AWSError, data: CloudFormation.ListStackResourcesOutput) => void): Request<CloudFormation.ListStackResourcesOutput, AWSError>;
  /**
   * Returns the summary information for stacks whose status matches the specified StackStatusFilter. Summary information for stacks that have been deleted is kept for 90 days after the stack is deleted. If no StackStatusFilter is specified, summary information for all stacks is returned (including existing stacks and stacks that have been deleted).
   */
  listStacks(params: CloudFormation.ListStacksInput, callback?: (err: AWSError, data: CloudFormation.ListStacksOutput) => void): Request<CloudFormation.ListStacksOutput, AWSError>;
  /**
   * Returns the summary information for stacks whose status matches the specified StackStatusFilter. Summary information for stacks that have been deleted is kept for 90 days after the stack is deleted. If no StackStatusFilter is specified, summary information for all stacks is returned (including existing stacks and stacks that have been deleted).
   */
  listStacks(callback?: (err: AWSError, data: CloudFormation.ListStacksOutput) => void): Request<CloudFormation.ListStacksOutput, AWSError>;
  /**
   * Sets a stack policy for a specified stack.
   */
  setStackPolicy(params: CloudFormation.SetStackPolicyInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Sets a stack policy for a specified stack.
   */
   ...
   */
  signalResource(params: CloudFormation.SignalResourceInput, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Sends a signal to the specified resource with a success or failure status. You can use the SignalResource API in conjunction with a creation policy or update policy. AWS CloudFormation doesn't proceed with a stack creation or update until resources receive the required number of signals or the timeout period is exceeded. The SignalResource API is useful in cases where you want to send signals from anywhere other than an Amazon EC2 instance.
   */
   ...
   */
  updateStack(params: CloudFormation.UpdateStackInput, callback?: (err: AWSError, data: CloudFormation.UpdateStackOutput) => void): Request<CloudFormation.UpdateStackOutput, AWSError>;
  /**
   * Updates a stack as specified in the template. After the call completes successfully, the stack update starts. You can check the status of the stack via the DescribeStacks action. To get a copy of the template for an existing stack, you can use the GetTemplate action. For more information about creating an update template, updating a stack, and monitoring the progress of the update, see Updating a Stack.
   */
  updateStack(callback?: (err: AWSError, data: CloudFormation.UpdateStackOutput) => void): Request<CloudFormation.UpdateStackOutput, AWSError>;
  /**
   * Validates a specified template. AWS CloudFormation first checks if the template is valid JSON. If it isn't, AWS CloudFormation checks if the template is valid YAML. If both these checks fail, AWS CloudFormation returns a template validation error.
   */
  validateTemplate(params: CloudFormation.ValidateTemplateInput, callback?: (err: AWSError, data: CloudFormation.ValidateTemplateOutput) => void): Request<CloudFormation.ValidateTemplateOutput, AWSError>;
  /**
   * Validates a specified template. AWS CloudFormation first checks if the template is valid JSON. If it isn't, AWS CloudFormation checks if the template is valid YAML. If both these checks fail, AWS CloudFormation returns a template validation error.
   */
  validateTemplate(callback?: (err: AWSError, data: CloudFormation.ValidateTemplateOutput) => void): Request<CloudFormation.ValidateTemplateOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "StackExists", params: CloudFormation.DescribeStacksInput, callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   * Waits for the StackExists state by periodically calling the underlying CloudFormation.describeStacksoperation every 5 seconds (at most 20 times).
   */
  waitFor(state: "StackExists", callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "StackCreateComplete", params: CloudFormation.DescribeStacksInput, callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   * Waits for the StackCreateComplete state by periodically calling the underlying CloudFormation.describeStacksoperation every 30 seconds (at most 120 times). Wait until stack status is CREATE_COMPLETE.
   */
  waitFor(state: "StackCreateComplete", callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "StackDeleteComplete", params: CloudFormation.DescribeStacksInput, callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   * Waits for the StackDeleteComplete state by periodically calling the underlying CloudFormation.describeStacksoperation every 30 seconds (at most 120 times). Wait until stack status is DELETE_COMPLETE.
   */
  waitFor(state: "StackDeleteComplete", callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   ...
   */
  waitFor(state: "StackUpdateComplete", params: CloudFormation.DescribeStacksInput, callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
  /**
   * Waits for the StackUpdateComplete state by periodically calling the underlying CloudFormation.describeStacksoperation every 30 seconds (at most 120 times). Wait until stack status is UPDATE_COMPLETE.
   */
  waitFor(state: "StackUpdateComplete", callback?: (err: AWSError, data: CloudFormation.DescribeStacksOutput) => void): Request<CloudFormation.DescribeStacksOutput, AWSError>;
}
