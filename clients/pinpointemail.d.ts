...
interface Blob {}
declare class PinpointEmail<Params extends PinpointEmail.Types.ClientParams = {}> extends Service {
  /**
   * Constructs a service object. This object has one method for each API operation.
   */
  constructor(options?: PinpointEmail.Types.ClientConfiguration<Params>)
  config: Config & PinpointEmail.Types.ClientConfiguration<Params>;
  /**
   * Create a configuration set. Configuration sets are groups of rules that you can apply to the emails you send using Amazon Pinpoint. You apply a configuration set to an email by including a reference to the configuration set in the headers of the email. When you apply a configuration set to an email, all of the rules in that configuration set are applied to the email. 
   */
  createConfigurationSet(params: BoundInput<PinpointEmail.Types.CreateConfigurationSetRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.CreateConfigurationSetResponse) => void): Request<PinpointEmail.Types.CreateConfigurationSetResponse, AWSError>;
  /**
   * Create a configuration set. Configuration sets are groups of rules that you can apply to the emails you send using Amazon Pinpoint. You apply a configuration set to an email by including a reference to the configuration set in the headers of the email. When you apply a configuration set to an email, all of the rules in that configuration set are applied to the email. 
   */
   ...
   */
  createConfigurationSetEventDestination(params: BoundInput<PinpointEmail.Types.CreateConfigurationSetEventDestinationRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.CreateConfigurationSetEventDestinationResponse) => void): Request<PinpointEmail.Types.CreateConfigurationSetEventDestinationResponse, AWSError>;
  /**
   * Create an event destination. In Amazon Pinpoint, events include message sends, deliveries, opens, clicks, bounces, and complaints. Event destinations are places that you can send information about these events to. For example, you can send event data to Amazon SNS to receive notifications when you receive bounces or complaints, or you can use Amazon Kinesis Data Firehose to stream data to Amazon S3 for long-term storage. A single configuration set can include more than one event destination.
   */
   ...
   */
  createDedicatedIpPool(params: BoundInput<PinpointEmail.Types.CreateDedicatedIpPoolRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.CreateDedicatedIpPoolResponse) => void): Request<PinpointEmail.Types.CreateDedicatedIpPoolResponse, AWSError>;
  /**
   * Create a new pool of dedicated IP addresses. A pool can include one or more dedicated IP addresses that are associated with your Amazon Pinpoint account. You can associate a pool with a configuration set. When you send an email that uses that configuration set, Amazon Pinpoint sends it using only the IP addresses in the associated pool.
   */
   ...
   */
  createDeliverabilityTestReport(params: BoundInput<PinpointEmail.Types.CreateDeliverabilityTestReportRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.CreateDeliverabilityTestReportResponse) => void): Request<PinpointEmail.Types.CreateDeliverabilityTestReportResponse, AWSError>;
  /**
   * Create a new predictive inbox placement test. Predictive inbox placement tests can help you predict how your messages will be handled by various email providers around the world. When you perform a predictive inbox placement test, you provide a sample message that contains the content that you plan to send to your customers. Amazon Pinpoint then sends that message to special email addresses spread across several major email providers. After about 24 hours, the test is complete, and you can use the GetDeliverabilityTestReport operation to view the results of the test.
   */
   ...
   */
  createEmailIdentity(params: BoundInput<PinpointEmail.Types.CreateEmailIdentityRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.CreateEmailIdentityResponse) => void): Request<PinpointEmail.Types.CreateEmailIdentityResponse, AWSError>;
  /**
   * Verifies an email identity for use with Amazon Pinpoint. In Amazon Pinpoint, an identity is an email address or domain that you use when you send email. Before you can use an identity to send email with Amazon Pinpoint, you first have to verify it. By verifying an address, you demonstrate that you're the owner of the address, and that you've given Amazon Pinpoint permission to send email from the address. When you verify an email address, Amazon Pinpoint sends an email to the address. Your email address is verified as soon as you follow the link in the verification email.  When you verify a domain, this operation provides a set of DKIM tokens, which you can convert into CNAME tokens. You add these CNAME tokens to the DNS configuration for your domain. Your domain is verified when Amazon Pinpoint detects these records in the DNS configuration for your domain. It usually takes around 72 hours to complete the domain verification process.
   */
   ...
   */
  deleteConfigurationSet(params: BoundInput<PinpointEmail.Types.DeleteConfigurationSetRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.DeleteConfigurationSetResponse) => void): Request<PinpointEmail.Types.DeleteConfigurationSetResponse, AWSError>;
  /**
   * Delete an existing configuration set. In Amazon Pinpoint, configuration sets are groups of rules that you can apply to the emails you send. You apply a configuration set to an email by including a reference to the configuration set in the headers of the email. When you apply a configuration set to an email, all of the rules in that configuration set are applied to the email.
   */
   ...
   */
  deleteConfigurationSetEventDestination(params: BoundInput<PinpointEmail.Types.DeleteConfigurationSetEventDestinationRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.DeleteConfigurationSetEventDestinationResponse) => void): Request<PinpointEmail.Types.DeleteConfigurationSetEventDestinationResponse, AWSError>;
  /**
   * Delete an event destination. In Amazon Pinpoint, events include message sends, deliveries, opens, clicks, bounces, and complaints. Event destinations are places that you can send information about these events to. For example, you can send event data to Amazon SNS to receive notifications when you receive bounces or complaints, or you can use Amazon Kinesis Data Firehose to stream data to Amazon S3 for long-term storage.
   */
   ...
   */
  deleteDedicatedIpPool(params: BoundInput<PinpointEmail.Types.DeleteDedicatedIpPoolRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.DeleteDedicatedIpPoolResponse) => void): Request<PinpointEmail.Types.DeleteDedicatedIpPoolResponse, AWSError>;
  /**
   * Delete a dedicated IP pool.
   */
   ...
   */
  deleteEmailIdentity(params: BoundInput<PinpointEmail.Types.DeleteEmailIdentityRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.DeleteEmailIdentityResponse) => void): Request<PinpointEmail.Types.DeleteEmailIdentityResponse, AWSError>;
  /**
   * Deletes an email identity that you previously verified for use with Amazon Pinpoint. An identity can be either an email address or a domain name.
   */
   ...
   */
  getAccount(params: BoundInput<PinpointEmail.Types.GetAccountRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetAccountResponse) => void): Request<PinpointEmail.Types.GetAccountResponse, AWSError>;
  /**
   * Obtain information about the email-sending status and capabilities of your Amazon Pinpoint account in the current AWS Region.
   */
   ...
   */
  getBlacklistReports(params: BoundInput<PinpointEmail.Types.GetBlacklistReportsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetBlacklistReportsResponse) => void): Request<PinpointEmail.Types.GetBlacklistReportsResponse, AWSError>;
  /**
   * Retrieve a list of the blacklists that your dedicated IP addresses appear on.
   */
   ...
   */
  getConfigurationSet(params: BoundInput<PinpointEmail.Types.GetConfigurationSetRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetConfigurationSetResponse) => void): Request<PinpointEmail.Types.GetConfigurationSetResponse, AWSError>;
  /**
   * Get information about an existing configuration set, including the dedicated IP pool that it's associated with, whether or not it's enabled for sending email, and more. In Amazon Pinpoint, configuration sets are groups of rules that you can apply to the emails you send. You apply a configuration set to an email by including a reference to the configuration set in the headers of the email. When you apply a configuration set to an email, all of the rules in that configuration set are applied to the email.
   */
   ...
   */
  getConfigurationSetEventDestinations(params: BoundInput<PinpointEmail.Types.GetConfigurationSetEventDestinationsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetConfigurationSetEventDestinationsResponse) => void): Request<PinpointEmail.Types.GetConfigurationSetEventDestinationsResponse, AWSError>;
  /**
   * Retrieve a list of event destinations that are associated with a configuration set. In Amazon Pinpoint, events include message sends, deliveries, opens, clicks, bounces, and complaints. Event destinations are places that you can send information about these events to. For example, you can send event data to Amazon SNS to receive notifications when you receive bounces or complaints, or you can use Amazon Kinesis Data Firehose to stream data to Amazon S3 for long-term storage.
   */
   ...
   */
  getDedicatedIp(params: BoundInput<PinpointEmail.Types.GetDedicatedIpRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetDedicatedIpResponse) => void): Request<PinpointEmail.Types.GetDedicatedIpResponse, AWSError>;
  /**
   * Get information about a dedicated IP address, including the name of the dedicated IP pool that it's associated with, as well information about the automatic warm-up process for the address.
   */
   ...
   */
  getDedicatedIps(params: BoundInput<PinpointEmail.Types.GetDedicatedIpsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetDedicatedIpsResponse) => void): Request<PinpointEmail.Types.GetDedicatedIpsResponse, AWSError>;
  /**
   * List the dedicated IP addresses that are associated with your Amazon Pinpoint account.
   */
   ...
   */
  getDeliverabilityDashboardOptions(params: BoundInput<PinpointEmail.Types.GetDeliverabilityDashboardOptionsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetDeliverabilityDashboardOptionsResponse) => void): Request<PinpointEmail.Types.GetDeliverabilityDashboardOptionsResponse, AWSError>;
  /**
   * Show the status of the Deliverability dashboard. When the Deliverability dashboard is enabled, you gain access to reputation metrics for the domains that you use to send email using Amazon Pinpoint. You also gain the ability to perform predictive inbox placement tests. When you use the Deliverability dashboard, you pay a monthly charge of USD$1,250.00, in addition to any other fees that you accrue by using Amazon Pinpoint. If you enable the Deliverability dashboard after the first day of a calendar month, AWS prorates the monthly charge based on how many days have elapsed in the current calendar month.
   */
   ...
   */
  getDeliverabilityTestReport(params: BoundInput<PinpointEmail.Types.GetDeliverabilityTestReportRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetDeliverabilityTestReportResponse) => void): Request<PinpointEmail.Types.GetDeliverabilityTestReportResponse, AWSError>;
  /**
   * Retrieve the results of a predictive inbox placement test.
   */
   ...
   */
  getDomainStatisticsReport(params: BoundInput<PinpointEmail.Types.GetDomainStatisticsReportRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetDomainStatisticsReportResponse) => void): Request<PinpointEmail.Types.GetDomainStatisticsReportResponse, AWSError>;
  /**
   * Retrieve inbox placement and engagement rates for the domains that you use to send email.
   */
   ...
   */
  getEmailIdentity(params: BoundInput<PinpointEmail.Types.GetEmailIdentityRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.GetEmailIdentityResponse) => void): Request<PinpointEmail.Types.GetEmailIdentityResponse, AWSError>;
  /**
   * Provides information about a specific identity associated with your Amazon Pinpoint account, including the identity's verification status, its DKIM authentication status, and its custom Mail-From settings.
   */
   ...
   */
  listConfigurationSets(params: BoundInput<PinpointEmail.Types.ListConfigurationSetsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.ListConfigurationSetsResponse) => void): Request<PinpointEmail.Types.ListConfigurationSetsResponse, AWSError>;
  /**
   * List all of the configuration sets associated with your Amazon Pinpoint account in the current region. In Amazon Pinpoint, configuration sets are groups of rules that you can apply to the emails you send. You apply a configuration set to an email by including a reference to the configuration set in the headers of the email. When you apply a configuration set to an email, all of the rules in that configuration set are applied to the email.
   */
   ...
   */
  listDedicatedIpPools(params: BoundInput<PinpointEmail.Types.ListDedicatedIpPoolsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.ListDedicatedIpPoolsResponse) => void): Request<PinpointEmail.Types.ListDedicatedIpPoolsResponse, AWSError>;
  /**
   * List all of the dedicated IP pools that exist in your Amazon Pinpoint account in the current AWS Region.
   */
   ...
   */
  listDeliverabilityTestReports(params: BoundInput<PinpointEmail.Types.ListDeliverabilityTestReportsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.ListDeliverabilityTestReportsResponse) => void): Request<PinpointEmail.Types.ListDeliverabilityTestReportsResponse, AWSError>;
  /**
   * Show a list of the predictive inbox placement tests that you've performed, regardless of their statuses. For predictive inbox placement tests that are complete, you can use the GetDeliverabilityTestReport operation to view the results.
   */
   ...
   */
  listEmailIdentities(params: BoundInput<PinpointEmail.Types.ListEmailIdentitiesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.ListEmailIdentitiesResponse) => void): Request<PinpointEmail.Types.ListEmailIdentitiesResponse, AWSError>;
  /**
   * Returns a list of all of the email identities that are associated with your Amazon Pinpoint account. An identity can be either an email address or a domain. This operation returns identities that are verified as well as those that aren't.
   */
   ...
   */
  putAccountDedicatedIpWarmupAttributes(params: BoundInput<PinpointEmail.Types.PutAccountDedicatedIpWarmupAttributesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutAccountDedicatedIpWarmupAttributesResponse) => void): Request<PinpointEmail.Types.PutAccountDedicatedIpWarmupAttributesResponse, AWSError>;
  /**
   * Enable or disable the automatic warm-up feature for dedicated IP addresses.
   */
   ...
   */
  putAccountSendingAttributes(params: BoundInput<PinpointEmail.Types.PutAccountSendingAttributesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutAccountSendingAttributesResponse) => void): Request<PinpointEmail.Types.PutAccountSendingAttributesResponse, AWSError>;
  /**
   * Enable or disable the ability of your account to send email.
   */
   ...
   */
  putConfigurationSetDeliveryOptions(params: BoundInput<PinpointEmail.Types.PutConfigurationSetDeliveryOptionsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutConfigurationSetDeliveryOptionsResponse) => void): Request<PinpointEmail.Types.PutConfigurationSetDeliveryOptionsResponse, AWSError>;
  /**
   * Associate a configuration set with a dedicated IP pool. You can use dedicated IP pools to create groups of dedicated IP addresses for sending specific types of email.
   */
   ...
   */
  putConfigurationSetReputationOptions(params: BoundInput<PinpointEmail.Types.PutConfigurationSetReputationOptionsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutConfigurationSetReputationOptionsResponse) => void): Request<PinpointEmail.Types.PutConfigurationSetReputationOptionsResponse, AWSError>;
  /**
   * Enable or disable collection of reputation metrics for emails that you send using a particular configuration set in a specific AWS Region.
   */
   ...
   */
  putConfigurationSetSendingOptions(params: BoundInput<PinpointEmail.Types.PutConfigurationSetSendingOptionsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutConfigurationSetSendingOptionsResponse) => void): Request<PinpointEmail.Types.PutConfigurationSetSendingOptionsResponse, AWSError>;
  /**
   * Enable or disable email sending for messages that use a particular configuration set in a specific AWS Region.
   */
   ...
   */
  putConfigurationSetTrackingOptions(params: BoundInput<PinpointEmail.Types.PutConfigurationSetTrackingOptionsRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutConfigurationSetTrackingOptionsResponse) => void): Request<PinpointEmail.Types.PutConfigurationSetTrackingOptionsResponse, AWSError>;
  /**
   * Specify a custom domain to use for open and click tracking elements in email that you send using Amazon Pinpoint.
   */
   ...
   */
  putDedicatedIpInPool(params: BoundInput<PinpointEmail.Types.PutDedicatedIpInPoolRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutDedicatedIpInPoolResponse) => void): Request<PinpointEmail.Types.PutDedicatedIpInPoolResponse, AWSError>;
  /**
   * Move a dedicated IP address to an existing dedicated IP pool.  The dedicated IP address that you specify must already exist, and must be associated with your Amazon Pinpoint account.  The dedicated IP pool you specify must already exist. You can create a new pool by using the CreateDedicatedIpPool operation. 
   */
   ...
   * 
   */
  putDedicatedIpWarmupAttributes(params: BoundInput<PinpointEmail.Types.PutDedicatedIpWarmupAttributesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutDedicatedIpWarmupAttributesResponse) => void): Request<PinpointEmail.Types.PutDedicatedIpWarmupAttributesResponse, AWSError>;
  /**
   * 
   */
   ...
   */
  putDeliverabilityDashboardOption(params: BoundInput<PinpointEmail.Types.PutDeliverabilityDashboardOptionRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutDeliverabilityDashboardOptionResponse) => void): Request<PinpointEmail.Types.PutDeliverabilityDashboardOptionResponse, AWSError>;
  /**
   * Enable or disable the Deliverability dashboard. When you enable the Deliverability dashboard, you gain access to reputation metrics for the domains that you use to send email using Amazon Pinpoint. You also gain the ability to perform predictive inbox placement tests. When you use the Deliverability dashboard, you pay a monthly charge of USD$1,250.00, in addition to any other fees that you accrue by using Amazon Pinpoint. If you enable the Deliverability dashboard after the first day of a calendar month, we prorate the monthly charge based on how many days have elapsed in the current calendar month.
   */
   ...
   */
  putEmailIdentityDkimAttributes(params: BoundInput<PinpointEmail.Types.PutEmailIdentityDkimAttributesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutEmailIdentityDkimAttributesResponse) => void): Request<PinpointEmail.Types.PutEmailIdentityDkimAttributesResponse, AWSError>;
  /**
   * Used to enable or disable DKIM authentication for an email identity.
   */
   ...
   */
  putEmailIdentityFeedbackAttributes(params: BoundInput<PinpointEmail.Types.PutEmailIdentityFeedbackAttributesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutEmailIdentityFeedbackAttributesResponse) => void): Request<PinpointEmail.Types.PutEmailIdentityFeedbackAttributesResponse, AWSError>;
  /**
   * Used to enable or disable feedback forwarding for an identity. This setting determines what happens when an identity is used to send an email that results in a bounce or complaint event. When you enable feedback forwarding, Amazon Pinpoint sends you email notifications when bounce or complaint events occur. Amazon Pinpoint sends this notification to the address that you specified in the Return-Path header of the original email. When you disable feedback forwarding, Amazon Pinpoint sends notifications through other mechanisms, such as by notifying an Amazon SNS topic. You're required to have a method of tracking bounces and complaints. If you haven't set up another mechanism for receiving bounce or complaint notifications, Amazon Pinpoint sends an email notification when these events occur (even if this setting is disabled).
   */
   ...
   */
  putEmailIdentityMailFromAttributes(params: BoundInput<PinpointEmail.Types.PutEmailIdentityMailFromAttributesRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.PutEmailIdentityMailFromAttributesResponse) => void): Request<PinpointEmail.Types.PutEmailIdentityMailFromAttributesResponse, AWSError>;
  /**
   * Used to enable or disable the custom Mail-From domain configuration for an email identity.
   */
   ...
   */
  sendEmail(params: BoundInput<PinpointEmail.Types.SendEmailRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.SendEmailResponse) => void): Request<PinpointEmail.Types.SendEmailResponse, AWSError>;
  /**
   * Sends an email message. You can use the Amazon Pinpoint Email API to send two types of messages:    Simple – A standard email message. When you create this type of message, you specify the sender, the recipient, and the message body, and Amazon Pinpoint assembles the message for you.    Raw – A raw, MIME-formatted email message. When you send this type of email, you have to specify all of the message headers, as well as the message body. You can use this message type to send messages that contain attachments. The message that you specify has to be a valid MIME message.  
   */
   ...
   */
  updateConfigurationSetEventDestination(params: BoundInput<PinpointEmail.Types.UpdateConfigurationSetEventDestinationRequest, keyof Params>, callback?: (err: AWSError, data: PinpointEmail.Types.UpdateConfigurationSetEventDestinationResponse) => void): Request<PinpointEmail.Types.UpdateConfigurationSetEventDestinationResponse, AWSError>;
  /**
   * Update the configuration of an event destination for a configuration set. In Amazon Pinpoint, events include message sends, deliveries, opens, clicks, bounces, and complaints. Event destinations are places that you can send information about these events to. For example, you can send event data to Amazon SNS to receive notifications when you receive bounces or complaints, or you can use Amazon Kinesis Data Firehose to stream data to Amazon S3 for long-term storage.
   */
...
declare namespace PinpointEmail {
  ...
  export type ClientParams = InputParams<CreateConfigurationSetRequest & CreateConfigurationSetEventDestinationRequest & CreateDedicatedIpPoolRequest & CreateDeliverabilityTestReportRequest & CreateEmailIdentityRequest & DeleteConfigurationSetRequest & DeleteConfigurationSetEventDestinationRequest & DeleteDedicatedIpPoolRequest & DeleteEmailIdentityRequest & GetAccountRequest & GetBlacklistReportsRequest & GetConfigurationSetRequest & GetConfigurationSetEventDestinationsRequest & GetDedicatedIpRequest & GetDedicatedIpsRequest & GetDeliverabilityDashboardOptionsRequest & GetDeliverabilityTestReportRequest & GetDomainStatisticsReportRequest & GetEmailIdentityRequest & ListConfigurationSetsRequest & ListDedicatedIpPoolsRequest & ListDeliverabilityTestReportsRequest & ListEmailIdentitiesRequest & PutAccountDedicatedIpWarmupAttributesRequest & PutAccountSendingAttributesRequest & PutConfigurationSetDeliveryOptionsRequest & PutConfigurationSetReputationOptionsRequest & PutConfigurationSetSendingOptionsRequest & PutConfigurationSetTrackingOptionsRequest & PutDedicatedIpInPoolRequest & PutDedicatedIpWarmupAttributesRequest & PutDeliverabilityDashboardOptionRequest & PutEmailIdentityDkimAttributesRequest & PutEmailIdentityFeedbackAttributesRequest & PutEmailIdentityMailFromAttributesRequest & SendEmailRequest & UpdateConfigurationSetEventDestinationRequest>;
