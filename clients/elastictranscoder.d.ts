...
interface Blob {}
declare class ElasticTranscoder<Params extends ElasticTranscoder.Types.ClientParams = {}> extends Service {
  /**
   * Constructs a service object. This object has one method for each API operation.
   */
  constructor(options?: ElasticTranscoder.Types.ClientConfiguration<Params>)
  config: Config & ElasticTranscoder.Types.ClientConfiguration<Params>;
  /**
   ...
   */
  cancelJob(params: BoundInput<ElasticTranscoder.Types.CancelJobRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.CancelJobResponse) => void): Request<ElasticTranscoder.Types.CancelJobResponse, AWSError>;
  /**
   * The CancelJob operation cancels an unfinished job.  You can only cancel a job that has a status of Submitted. To prevent a pipeline from starting to process a job while you're getting the job identifier, use UpdatePipelineStatus to temporarily pause the pipeline. 
   */
   ...
   */
  createJob(params: BoundInput<ElasticTranscoder.Types.CreateJobRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.CreateJobResponse) => void): Request<ElasticTranscoder.Types.CreateJobResponse, AWSError>;
  /**
   * When you create a job, Elastic Transcoder returns JSON data that includes the values that you specified plus information about the job that is created. If you have specified more than one output for your jobs (for example, one output for the Kindle Fire and another output for the Apple iPhone 4s), you currently must use the Elastic Transcoder API to list the jobs (as opposed to the AWS Console).
   */
   ...
   */
  createPipeline(params: BoundInput<ElasticTranscoder.Types.CreatePipelineRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.CreatePipelineResponse) => void): Request<ElasticTranscoder.Types.CreatePipelineResponse, AWSError>;
  /**
   * The CreatePipeline operation creates a pipeline with settings that you specify.
   */
   ...
   */
  createPreset(params: BoundInput<ElasticTranscoder.Types.CreatePresetRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.CreatePresetResponse) => void): Request<ElasticTranscoder.Types.CreatePresetResponse, AWSError>;
  /**
   * The CreatePreset operation creates a preset with settings that you specify.  Elastic Transcoder checks the CreatePreset settings to ensure that they meet Elastic Transcoder requirements and to determine whether they comply with H.264 standards. If your settings are not valid for Elastic Transcoder, Elastic Transcoder returns an HTTP 400 response (ValidationException) and does not create the preset. If the settings are valid for Elastic Transcoder but aren't strictly compliant with the H.264 standard, Elastic Transcoder creates the preset and returns a warning message in the response. This helps you determine whether your settings comply with the H.264 standard while giving you greater flexibility with respect to the video that Elastic Transcoder produces.  Elastic Transcoder uses the H.264 video-compression format. For more information, see the International Telecommunication Union publication Recommendation ITU-T H.264: Advanced video coding for generic audiovisual services.
   */
   ...
   */
  deletePipeline(params: BoundInput<ElasticTranscoder.Types.DeletePipelineRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.DeletePipelineResponse) => void): Request<ElasticTranscoder.Types.DeletePipelineResponse, AWSError>;
  /**
   * The DeletePipeline operation removes a pipeline.  You can only delete a pipeline that has never been used or that is not currently in use (doesn't contain any active jobs). If the pipeline is currently in use, DeletePipeline returns an error. 
   */
   ...
   */
  deletePreset(params: BoundInput<ElasticTranscoder.Types.DeletePresetRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.DeletePresetResponse) => void): Request<ElasticTranscoder.Types.DeletePresetResponse, AWSError>;
  /**
   * The DeletePreset operation removes a preset that you've added in an AWS region.  You can't delete the default presets that are included with Elastic Transcoder. 
   */
   ...
   */
  listJobsByPipeline(params: BoundInput<ElasticTranscoder.Types.ListJobsByPipelineRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ListJobsByPipelineResponse) => void): Request<ElasticTranscoder.Types.ListJobsByPipelineResponse, AWSError>;
  /**
   * The ListJobsByPipeline operation gets a list of the jobs currently in a pipeline. Elastic Transcoder returns all of the jobs currently in the specified pipeline. The response body contains one element for each job that satisfies the search criteria.
   */
   ...
   */
  listJobsByStatus(params: BoundInput<ElasticTranscoder.Types.ListJobsByStatusRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ListJobsByStatusResponse) => void): Request<ElasticTranscoder.Types.ListJobsByStatusResponse, AWSError>;
  /**
   * The ListJobsByStatus operation gets a list of jobs that have a specified status. The response body contains one element for each job that satisfies the search criteria.
   */
   ...
   */
  listPipelines(params: BoundInput<ElasticTranscoder.Types.ListPipelinesRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ListPipelinesResponse) => void): Request<ElasticTranscoder.Types.ListPipelinesResponse, AWSError>;
  /**
   * The ListPipelines operation gets a list of the pipelines associated with the current AWS account.
   */
   ...
   */
  listPresets(params: BoundInput<ElasticTranscoder.Types.ListPresetsRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ListPresetsResponse) => void): Request<ElasticTranscoder.Types.ListPresetsResponse, AWSError>;
  /**
   * The ListPresets operation gets a list of the default presets included with Elastic Transcoder and the presets that you've added in an AWS region.
   */
   ...
   */
  readJob(params: BoundInput<ElasticTranscoder.Types.ReadJobRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ReadJobResponse) => void): Request<ElasticTranscoder.Types.ReadJobResponse, AWSError>;
  /**
   * The ReadJob operation returns detailed information about a job.
   */
   ...
   */
  readPipeline(params: BoundInput<ElasticTranscoder.Types.ReadPipelineRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ReadPipelineResponse) => void): Request<ElasticTranscoder.Types.ReadPipelineResponse, AWSError>;
  /**
   * The ReadPipeline operation gets detailed information about a pipeline.
   */
   ...
   */
  readPreset(params: BoundInput<ElasticTranscoder.Types.ReadPresetRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.ReadPresetResponse) => void): Request<ElasticTranscoder.Types.ReadPresetResponse, AWSError>;
  /**
   * The ReadPreset operation gets detailed information about a preset.
   */
   ...
   */
  testRole(params: BoundInput<ElasticTranscoder.Types.TestRoleRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.TestRoleResponse) => void): Request<ElasticTranscoder.Types.TestRoleResponse, AWSError>;
  /**
   * The TestRole operation tests the IAM role used to create the pipeline. The TestRole action lets you determine whether the IAM role you are using has sufficient permissions to let Elastic Transcoder perform tasks associated with the transcoding process. The action attempts to assume the specified IAM role, checks read access to the input and output buckets, and tries to send a test notification to Amazon SNS topics that you specify.
   */
   ...
   */
  updatePipeline(params: BoundInput<ElasticTranscoder.Types.UpdatePipelineRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.UpdatePipelineResponse) => void): Request<ElasticTranscoder.Types.UpdatePipelineResponse, AWSError>;
  /**
   *  Use the UpdatePipeline operation to update settings for a pipeline.  When you change pipeline settings, your changes take effect immediately. Jobs that you have already submitted and that Elastic Transcoder has not started to process are affected in addition to jobs that you submit after you change settings.  
   */
   ...
   */
  updatePipelineNotifications(params: BoundInput<ElasticTranscoder.Types.UpdatePipelineNotificationsRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.UpdatePipelineNotificationsResponse) => void): Request<ElasticTranscoder.Types.UpdatePipelineNotificationsResponse, AWSError>;
  /**
   * With the UpdatePipelineNotifications operation, you can update Amazon Simple Notification Service (Amazon SNS) notifications for a pipeline. When you update notifications for a pipeline, Elastic Transcoder returns the values that you specified in the request.
   */
   ...
   */
  updatePipelineStatus(params: BoundInput<ElasticTranscoder.Types.UpdatePipelineStatusRequest, keyof Params>, callback?: (err: AWSError, data: ElasticTranscoder.Types.UpdatePipelineStatusResponse) => void): Request<ElasticTranscoder.Types.UpdatePipelineStatusResponse, AWSError>;
  /**
   * The UpdatePipelineStatus operation pauses or reactivates a pipeline, so that the pipeline stops or restarts the processing of jobs. Changing the pipeline status is useful if you want to cancel one or more jobs. You can't cancel jobs after Elastic Transcoder has started processing them; if you pause the pipeline to which you submitted the jobs, you have more time to get the job IDs for the jobs that you want to cancel, and to send a CancelJob request. 
   */
...
declare namespace ElasticTranscoder {
  ...
  export type ClientParams = InputParams<CancelJobRequest & CreateJobRequest & CreatePipelineRequest & CreatePresetRequest & DeletePipelineRequest & DeletePresetRequest & ListJobsByPipelineRequest & ListJobsByStatusRequest & ListPipelinesRequest & ListPresetsRequest & ReadJobRequest & ReadPipelineRequest & ReadPresetRequest & TestRoleRequest & UpdatePipelineRequest & UpdatePipelineNotificationsRequest & UpdatePipelineStatusRequest>;
