...
declare class ElasticTranscoder extends Service {
   ...
   */
  cancelJob(params: ElasticTranscoder.CancelJobRequest, callback?: (err: AWSError, data: ElasticTranscoder.CancelJobResponse) => void): Request<ElasticTranscoder.CancelJobResponse, AWSError>;
  /**
   * The CancelJob operation cancels an unfinished job. You can only cancel a job that has a status of Submitted. To prevent a pipeline from starting to process a job while you're getting the job identifier, use UpdatePipelineStatus to temporarily pause the pipeline.
   */
  cancelJob(callback?: (err: AWSError, data: ElasticTranscoder.CancelJobResponse) => void): Request<ElasticTranscoder.CancelJobResponse, AWSError>;
  /**
   ...
   */
  createJob(params: ElasticTranscoder.CreateJobRequest, callback?: (err: AWSError, data: ElasticTranscoder.CreateJobResponse) => void): Request<ElasticTranscoder.CreateJobResponse, AWSError>;
  /**
   *  When you create a job, Elastic Transcoder returns JSON data that includes the values that you specified plus information about the job that is created.  If you have specified more than one output for your jobs (for example, one output for the Kindle Fire and another output for the Apple iPhone 4s), you currently must use the Elastic Transcoder API to list the jobs (as opposed to the AWS Console).
   */
  createJob(callback?: (err: AWSError, data: ElasticTranscoder.CreateJobResponse) => void): Request<ElasticTranscoder.CreateJobResponse, AWSError>;
  /**
   * The CreatePipeline operation creates a pipeline with settings that you specify.
   */
  createPipeline(params: ElasticTranscoder.CreatePipelineRequest, callback?: (err: AWSError, data: ElasticTranscoder.CreatePipelineResponse) => void): Request<ElasticTranscoder.CreatePipelineResponse, AWSError>;
  /**
   * The CreatePipeline operation creates a pipeline with settings that you specify.
   */
  createPipeline(callback?: (err: AWSError, data: ElasticTranscoder.CreatePipelineResponse) => void): Request<ElasticTranscoder.CreatePipelineResponse, AWSError>;
  /**
   ...
   */
  createPreset(params: ElasticTranscoder.CreatePresetRequest, callback?: (err: AWSError, data: ElasticTranscoder.CreatePresetResponse) => void): Request<ElasticTranscoder.CreatePresetResponse, AWSError>;
  /**
   * The CreatePreset operation creates a preset with settings that you specify. Elastic Transcoder checks the CreatePreset settings to ensure that they meet Elastic Transcoder requirements and to determine whether they comply with H.264 standards. If your settings are not valid for Elastic Transcoder, Elastic Transcoder returns an HTTP 400 response (ValidationException) and does not create the preset. If the settings are valid for Elastic Transcoder but aren't strictly compliant with the H.264 standard, Elastic Transcoder creates the preset and returns a warning message in the response. This helps you determine whether your settings comply with the H.264 standard while giving you greater flexibility with respect to the video that Elastic Transcoder produces. Elastic Transcoder uses the H.264 video-compression format. For more information, see the International Telecommunication Union publication Recommendation ITU-T H.264: Advanced video coding for generic audiovisual services.
   */
  createPreset(callback?: (err: AWSError, data: ElasticTranscoder.CreatePresetResponse) => void): Request<ElasticTranscoder.CreatePresetResponse, AWSError>;
  /**
   ...
   */
  deletePipeline(params: ElasticTranscoder.DeletePipelineRequest, callback?: (err: AWSError, data: ElasticTranscoder.DeletePipelineResponse) => void): Request<ElasticTranscoder.DeletePipelineResponse, AWSError>;
  /**
   * The DeletePipeline operation removes a pipeline.  You can only delete a pipeline that has never been used or that is not currently in use (doesn't contain any active jobs). If the pipeline is currently in use, DeletePipeline returns an error. 
   */
  deletePipeline(callback?: (err: AWSError, data: ElasticTranscoder.DeletePipelineResponse) => void): Request<ElasticTranscoder.DeletePipelineResponse, AWSError>;
  /**
   ...
   */
  deletePreset(params: ElasticTranscoder.DeletePresetRequest, callback?: (err: AWSError, data: ElasticTranscoder.DeletePresetResponse) => void): Request<ElasticTranscoder.DeletePresetResponse, AWSError>;
  /**
   * The DeletePreset operation removes a preset that you've added in an AWS region.  You can't delete the default presets that are included with Elastic Transcoder. 
   */
  deletePreset(callback?: (err: AWSError, data: ElasticTranscoder.DeletePresetResponse) => void): Request<ElasticTranscoder.DeletePresetResponse, AWSError>;
  /**
   ...
   */
  listJobsByPipeline(params: ElasticTranscoder.ListJobsByPipelineRequest, callback?: (err: AWSError, data: ElasticTranscoder.ListJobsByPipelineResponse) => void): Request<ElasticTranscoder.ListJobsByPipelineResponse, AWSError>;
  /**
   * The ListJobsByPipeline operation gets a list of the jobs currently in a pipeline. Elastic Transcoder returns all of the jobs currently in the specified pipeline. The response body contains one element for each job that satisfies the search criteria.
   */
  listJobsByPipeline(callback?: (err: AWSError, data: ElasticTranscoder.ListJobsByPipelineResponse) => void): Request<ElasticTranscoder.ListJobsByPipelineResponse, AWSError>;
  /**
   * The ListJobsByStatus operation gets a list of jobs that have a specified status. The response body contains one element for each job that satisfies the search criteria.
   */
  listJobsByStatus(params: ElasticTranscoder.ListJobsByStatusRequest, callback?: (err: AWSError, data: ElasticTranscoder.ListJobsByStatusResponse) => void): Request<ElasticTranscoder.ListJobsByStatusResponse, AWSError>;
  /**
   * The ListJobsByStatus operation gets a list of jobs that have a specified status. The response body contains one element for each job that satisfies the search criteria.
   */
  listJobsByStatus(callback?: (err: AWSError, data: ElasticTranscoder.ListJobsByStatusResponse) => void): Request<ElasticTranscoder.ListJobsByStatusResponse, AWSError>;
  /**
   * The ListPipelines operation gets a list of the pipelines associated with the current AWS account.
   */
  listPipelines(params: ElasticTranscoder.ListPipelinesRequest, callback?: (err: AWSError, data: ElasticTranscoder.ListPipelinesResponse) => void): Request<ElasticTranscoder.ListPipelinesResponse, AWSError>;
  /**
   * The ListPipelines operation gets a list of the pipelines associated with the current AWS account.
   */
  listPipelines(callback?: (err: AWSError, data: ElasticTranscoder.ListPipelinesResponse) => void): Request<ElasticTranscoder.ListPipelinesResponse, AWSError>;
  /**
   * The ListPresets operation gets a list of the default presets included with Elastic Transcoder and the presets that you've added in an AWS region.
   */
  listPresets(params: ElasticTranscoder.ListPresetsRequest, callback?: (err: AWSError, data: ElasticTranscoder.ListPresetsResponse) => void): Request<ElasticTranscoder.ListPresetsResponse, AWSError>;
  /**
   * The ListPresets operation gets a list of the default presets included with Elastic Transcoder and the presets that you've added in an AWS region.
   */
  listPresets(callback?: (err: AWSError, data: ElasticTranscoder.ListPresetsResponse) => void): Request<ElasticTranscoder.ListPresetsResponse, AWSError>;
  /**
   * The ReadJob operation returns detailed information about a job.
   */
  readJob(params: ElasticTranscoder.ReadJobRequest, callback?: (err: AWSError, data: ElasticTranscoder.ReadJobResponse) => void): Request<ElasticTranscoder.ReadJobResponse, AWSError>;
  /**
   * The ReadJob operation returns detailed information about a job.
   */
  readJob(callback?: (err: AWSError, data: ElasticTranscoder.ReadJobResponse) => void): Request<ElasticTranscoder.ReadJobResponse, AWSError>;
  /**
   * The ReadPipeline operation gets detailed information about a pipeline.
   */
  readPipeline(params: ElasticTranscoder.ReadPipelineRequest, callback?: (err: AWSError, data: ElasticTranscoder.ReadPipelineResponse) => void): Request<ElasticTranscoder.ReadPipelineResponse, AWSError>;
  /**
   * The ReadPipeline operation gets detailed information about a pipeline.
   */
  readPipeline(callback?: (err: AWSError, data: ElasticTranscoder.ReadPipelineResponse) => void): Request<ElasticTranscoder.ReadPipelineResponse, AWSError>;
  /**
   * The ReadPreset operation gets detailed information about a preset.
   */
  readPreset(params: ElasticTranscoder.ReadPresetRequest, callback?: (err: AWSError, data: ElasticTranscoder.ReadPresetResponse) => void): Request<ElasticTranscoder.ReadPresetResponse, AWSError>;
  /**
   * The ReadPreset operation gets detailed information about a preset.
   */
  readPreset(callback?: (err: AWSError, data: ElasticTranscoder.ReadPresetResponse) => void): Request<ElasticTranscoder.ReadPresetResponse, AWSError>;
  /**
   * The TestRole operation tests the IAM role used to create the pipeline. The TestRole action lets you determine whether the IAM role you are using has sufficient permissions to let Elastic Transcoder perform tasks associated with the transcoding process. The action attempts to assume the specified IAM role, checks read access to the input and output buckets, and tries to send a test notification to Amazon SNS topics that you specify.
   */
  testRole(params: ElasticTranscoder.TestRoleRequest, callback?: (err: AWSError, data: ElasticTranscoder.TestRoleResponse) => void): Request<ElasticTranscoder.TestRoleResponse, AWSError>;
  /**
   * The TestRole operation tests the IAM role used to create the pipeline. The TestRole action lets you determine whether the IAM role you are using has sufficient permissions to let Elastic Transcoder perform tasks associated with the transcoding process. The action attempts to assume the specified IAM role, checks read access to the input and output buckets, and tries to send a test notification to Amazon SNS topics that you specify.
   */
  testRole(callback?: (err: AWSError, data: ElasticTranscoder.TestRoleResponse) => void): Request<ElasticTranscoder.TestRoleResponse, AWSError>;
  /**
   ...
   */
  updatePipeline(params: ElasticTranscoder.UpdatePipelineRequest, callback?: (err: AWSError, data: ElasticTranscoder.UpdatePipelineResponse) => void): Request<ElasticTranscoder.UpdatePipelineResponse, AWSError>;
  /**
   *  Use the UpdatePipeline operation to update settings for a pipeline. When you change pipeline settings, your changes take effect immediately. Jobs that you have already submitted and that Elastic Transcoder has not started to process are affected in addition to jobs that you submit after you change settings.  
   */
  updatePipeline(callback?: (err: AWSError, data: ElasticTranscoder.UpdatePipelineResponse) => void): Request<ElasticTranscoder.UpdatePipelineResponse, AWSError>;
  /**
   ...
   */
  updatePipelineNotifications(params: ElasticTranscoder.UpdatePipelineNotificationsRequest, callback?: (err: AWSError, data: ElasticTranscoder.UpdatePipelineNotificationsResponse) => void): Request<ElasticTranscoder.UpdatePipelineNotificationsResponse, AWSError>;
  /**
   * With the UpdatePipelineNotifications operation, you can update Amazon Simple Notification Service (Amazon SNS) notifications for a pipeline. When you update notifications for a pipeline, Elastic Transcoder returns the values that you specified in the request.
   */
  updatePipelineNotifications(callback?: (err: AWSError, data: ElasticTranscoder.UpdatePipelineNotificationsResponse) => void): Request<ElasticTranscoder.UpdatePipelineNotificationsResponse, AWSError>;
  /**
   * The UpdatePipelineStatus operation pauses or reactivates a pipeline, so that the pipeline stops or restarts the processing of jobs. Changing the pipeline status is useful if you want to cancel one or more jobs. You can't cancel jobs after Elastic Transcoder has started processing them; if you pause the pipeline to which you submitted the jobs, you have more time to get the job IDs for the jobs that you want to cancel, and to send a CancelJob request. 
   */
  updatePipelineStatus(params: ElasticTranscoder.UpdatePipelineStatusRequest, callback?: (err: AWSError, data: ElasticTranscoder.UpdatePipelineStatusResponse) => void): Request<ElasticTranscoder.UpdatePipelineStatusResponse, AWSError>;
  /**
   * The UpdatePipelineStatus operation pauses or reactivates a pipeline, so that the pipeline stops or restarts the processing of jobs. Changing the pipeline status is useful if you want to cancel one or more jobs. You can't cancel jobs after Elastic Transcoder has started processing them; if you pause the pipeline to which you submitted the jobs, you have more time to get the job IDs for the jobs that you want to cancel, and to send a CancelJob request. 
   */
  updatePipelineStatus(callback?: (err: AWSError, data: ElasticTranscoder.UpdatePipelineStatusResponse) => void): Request<ElasticTranscoder.UpdatePipelineStatusResponse, AWSError>;
  /**
   ...
   */
  waitFor(state: "JobComplete", params: ElasticTranscoder.ReadJobRequest, callback?: (err: AWSError, data: ElasticTranscoder.ReadJobResponse) => void): Request<ElasticTranscoder.ReadJobResponse, AWSError>;
  /**
   * Waits for the JobComplete state by periodically calling the underlying ElasticTranscoder.readJoboperation every 30 seconds (at most 120 times).
   */
  waitFor(state: "JobComplete", callback?: (err: AWSError, data: ElasticTranscoder.ReadJobResponse) => void): Request<ElasticTranscoder.ReadJobResponse, AWSError>;
}
declare namespace ElasticTranscoder {
  ...
  export interface CaptionSource {
    ...
    Key?: LongKey;
    /**
     * A string that specifies the language of the caption. Specify this as one of:  2-character ISO 639-1 code 3-character ISO 639-2 code  For more information on ISO language codes and language names, see the List of ISO 639-1 codes.
     */
    Language?: Key;
    /**
  ...
  export interface HlsContentProtection {
    /**
     * The content protection method for your output. The only valid value is: aes-128. This value will be written into the method attribute of the EXT-X-KEY metadata tag in the output playlist.
     */
  ...
  export interface JobAlbumArt {
    /**
     * A policy that determines how Elastic Transcoder will handle the existence of multiple album artwork files.   Replace: The specified album art will replace any existing album art. Prepend: The specified album art will be placed in front of any existing album art. Append: The specified album art will be placed after any existing album art. Fallback: If the original input file contains artwork, Elastic Transcoder will use that artwork for the output. If the original input does not contain artwork, Elastic Transcoder will use the specified album art file.  
     */
  ...
  export interface PlayReadyDrm {
    ...
    /**
     * The ID for your DRM key, so that your DRM license provider knows which key to provide. The key ID must be provided in big endian, and Elastic Transcoder will convert it to little endian before inserting it into the PlayReady DRM headers. If you are unsure whether your license server provides your key ID in big or little endian, check with your DRM provider.
     */
    KeyId?: KeyIdGuid;
    /**
