...
declare class AutoScaling extends Service {
   ...
   */
  attachInstances(params: AutoScaling.AttachInstancesQuery, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Attaches one or more EC2 instances to the specified Auto Scaling group. When you attach instances, Auto Scaling increases the desired capacity of the group by the number of instances being attached. If the number of instances being attached plus the desired capacity of the group exceeds the maximum size of the group, the operation fails. If there is a Classic load balancer attached to your Auto Scaling group, the instances are also registered with the load balancer. If there are target groups attached to your Auto Scaling group, the instances are also registered with the target groups. For more information, see Attach EC2 Instances to Your Auto Scaling Group in the Auto Scaling User Guide.
   */
   ...
   */
  attachLoadBalancerTargetGroups(params: AutoScaling.AttachLoadBalancerTargetGroupsType, callback?: (err: AWSError, data: AutoScaling.AttachLoadBalancerTargetGroupsResultType) => void): Request<AutoScaling.AttachLoadBalancerTargetGroupsResultType, AWSError>;
  /**
   * Attaches one or more target groups to the specified Auto Scaling group. To describe the target groups for an Auto Scaling group, use DescribeLoadBalancerTargetGroups. To detach the target group from the Auto Scaling group, use DetachLoadBalancerTargetGroups. For more information, see Attach a Load Balancer to Your Auto Scaling Group in the Auto Scaling User Guide.
   */
  attachLoadBalancerTargetGroups(callback?: (err: AWSError, data: AutoScaling.AttachLoadBalancerTargetGroupsResultType) => void): Request<AutoScaling.AttachLoadBalancerTargetGroupsResultType, AWSError>;
  /**
   ...
   */
  attachLoadBalancers(params: AutoScaling.AttachLoadBalancersType, callback?: (err: AWSError, data: AutoScaling.AttachLoadBalancersResultType) => void): Request<AutoScaling.AttachLoadBalancersResultType, AWSError>;
  /**
   * Attaches one or more Classic load balancers to the specified Auto Scaling group. To attach an Application load balancer instead, see AttachLoadBalancerTargetGroups. To describe the load balancers for an Auto Scaling group, use DescribeLoadBalancers. To detach the load balancer from the Auto Scaling group, use DetachLoadBalancers. For more information, see Attach a Load Balancer to Your Auto Scaling Group in the Auto Scaling User Guide.
   */
  attachLoadBalancers(callback?: (err: AWSError, data: AutoScaling.AttachLoadBalancersResultType) => void): Request<AutoScaling.AttachLoadBalancersResultType, AWSError>;
  /**
   ...
   */
  completeLifecycleAction(params: AutoScaling.CompleteLifecycleActionType, callback?: (err: AWSError, data: AutoScaling.CompleteLifecycleActionAnswer) => void): Request<AutoScaling.CompleteLifecycleActionAnswer, AWSError>;
  /**
   * Completes the lifecycle action for the specified token or instance with the specified result. This step is a part of the procedure for adding a lifecycle hook to an Auto Scaling group:   (Optional) Create a Lambda function and a rule that allows CloudWatch Events to invoke your Lambda function when Auto Scaling launches or terminates instances.   (Optional) Create a notification target and an IAM role. The target can be either an Amazon SQS queue or an Amazon SNS topic. The role allows Auto Scaling to publish lifecycle notifications to the target.   Create the lifecycle hook. Specify whether the hook is used when the instances launch or terminate.   If you need more time, record the lifecycle action heartbeat to keep the instance in a pending state.    If you finish before the timeout period ends, complete the lifecycle action.    For more information, see Auto Scaling Lifecycle in the Auto Scaling User Guide.
   */
  completeLifecycleAction(callback?: (err: AWSError, data: AutoScaling.CompleteLifecycleActionAnswer) => void): Request<AutoScaling.CompleteLifecycleActionAnswer, AWSError>;
  /**
   ...
   */
  createAutoScalingGroup(params: AutoScaling.CreateAutoScalingGroupType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates an Auto Scaling group with the specified name and attributes. If you exceed your maximum limit of Auto Scaling groups, which by default is 20 per region, the call fails. For information about viewing and updating this limit, see DescribeAccountLimits. For more information, see Auto Scaling Groups in the Auto Scaling User Guide.
   */
   ...
   */
  createLaunchConfiguration(params: AutoScaling.CreateLaunchConfigurationType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates a launch configuration. If you exceed your maximum limit of launch configurations, which by default is 100 per region, the call fails. For information about viewing and updating this limit, see DescribeAccountLimits. For more information, see Launch Configurations in the Auto Scaling User Guide.
   */
   ...
   */
  createOrUpdateTags(params: AutoScaling.CreateOrUpdateTagsType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates or updates tags for the specified Auto Scaling group. When you specify a tag with a key that already exists, the operation overwrites the previous tag definition, and you do not get an error message. For more information, see Tagging Auto Scaling Groups and Instances in the Auto Scaling User Guide.
   */
   ...
   */
  deleteAutoScalingGroup(params: AutoScaling.DeleteAutoScalingGroupType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified Auto Scaling group. If the group has instances or scaling activities in progress, you must specify the option to force the deletion in order for it to succeed. If the group has policies, deleting the group deletes the policies, the underlying alarm actions, and any alarm that no longer has an associated action. To remove instances from the Auto Scaling group before deleting it, call DetachInstances with the list of instances and the option to decrement the desired capacity so that Auto Scaling does not launch replacement instances. To terminate all instances before deleting the Auto Scaling group, call UpdateAutoScalingGroup and set the minimum size and desired capacity of the Auto Scaling group to zero.
   */
   ...
   */
  deleteLaunchConfiguration(params: AutoScaling.LaunchConfigurationNameType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified launch configuration. The launch configuration must not be attached to an Auto Scaling group. When this call completes, the launch configuration is no longer available for use.
   */
   ...
   */
  deleteLifecycleHook(params: AutoScaling.DeleteLifecycleHookType, callback?: (err: AWSError, data: AutoScaling.DeleteLifecycleHookAnswer) => void): Request<AutoScaling.DeleteLifecycleHookAnswer, AWSError>;
  /**
   * Deletes the specified lifecycle hook. If there are any outstanding lifecycle actions, they are completed first (ABANDON for launching instances, CONTINUE for terminating instances).
   */
  deleteLifecycleHook(callback?: (err: AWSError, data: AutoScaling.DeleteLifecycleHookAnswer) => void): Request<AutoScaling.DeleteLifecycleHookAnswer, AWSError>;
  /**
   * Deletes the specified notification.
   */
  deleteNotificationConfiguration(params: AutoScaling.DeleteNotificationConfigurationType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified notification.
   */
   ...
   */
  deletePolicy(params: AutoScaling.DeletePolicyType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified Auto Scaling policy. Deleting a policy deletes the underlying alarm action, but does not delete the alarm, even if it no longer has an associated action.
   */
   ...
   */
  deleteScheduledAction(params: AutoScaling.DeleteScheduledActionType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified scheduled action.
   */
   ...
   */
  deleteTags(params: AutoScaling.DeleteTagsType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified tags.
   */
   ...
   */
  describeAccountLimits(params: {}, callback?: (err: AWSError, data: AutoScaling.DescribeAccountLimitsAnswer) => void): Request<AutoScaling.DescribeAccountLimitsAnswer, AWSError>;
  /**
   * Describes the current Auto Scaling resource limits for your AWS account. For information about requesting an increase in these limits, see AWS Service Limits in the Amazon Web Services General Reference.
   */
  describeAccountLimits(callback?: (err: AWSError, data: AutoScaling.DescribeAccountLimitsAnswer) => void): Request<AutoScaling.DescribeAccountLimitsAnswer, AWSError>;
  /**
   * Describes the policy adjustment types for use with PutScalingPolicy.
   */
  describeAdjustmentTypes(params: {}, callback?: (err: AWSError, data: AutoScaling.DescribeAdjustmentTypesAnswer) => void): Request<AutoScaling.DescribeAdjustmentTypesAnswer, AWSError>;
  /**
   * Describes the policy adjustment types for use with PutScalingPolicy.
   */
  describeAdjustmentTypes(callback?: (err: AWSError, data: AutoScaling.DescribeAdjustmentTypesAnswer) => void): Request<AutoScaling.DescribeAdjustmentTypesAnswer, AWSError>;
  /**
   * Describes one or more Auto Scaling groups.
   */
  describeAutoScalingGroups(params: AutoScaling.AutoScalingGroupNamesType, callback?: (err: AWSError, data: AutoScaling.AutoScalingGroupsType) => void): Request<AutoScaling.AutoScalingGroupsType, AWSError>;
  /**
   * Describes one or more Auto Scaling groups.
   */
  describeAutoScalingGroups(callback?: (err: AWSError, data: AutoScaling.AutoScalingGroupsType) => void): Request<AutoScaling.AutoScalingGroupsType, AWSError>;
  /**
   * Describes one or more Auto Scaling instances.
   */
  describeAutoScalingInstances(params: AutoScaling.DescribeAutoScalingInstancesType, callback?: (err: AWSError, data: AutoScaling.AutoScalingInstancesType) => void): Request<AutoScaling.AutoScalingInstancesType, AWSError>;
  /**
   * Describes one or more Auto Scaling instances.
   */
  describeAutoScalingInstances(callback?: (err: AWSError, data: AutoScaling.AutoScalingInstancesType) => void): Request<AutoScaling.AutoScalingInstancesType, AWSError>;
  /**
   * Describes the notification types that are supported by Auto Scaling.
   */
  describeAutoScalingNotificationTypes(params: {}, callback?: (err: AWSError, data: AutoScaling.DescribeAutoScalingNotificationTypesAnswer) => void): Request<AutoScaling.DescribeAutoScalingNotificationTypesAnswer, AWSError>;
  /**
   * Describes the notification types that are supported by Auto Scaling.
   */
  describeAutoScalingNotificationTypes(callback?: (err: AWSError, data: AutoScaling.DescribeAutoScalingNotificationTypesAnswer) => void): Request<AutoScaling.DescribeAutoScalingNotificationTypesAnswer, AWSError>;
  /**
   * Describes one or more launch configurations.
   */
  describeLaunchConfigurations(params: AutoScaling.LaunchConfigurationNamesType, callback?: (err: AWSError, data: AutoScaling.LaunchConfigurationsType) => void): Request<AutoScaling.LaunchConfigurationsType, AWSError>;
  /**
   * Describes one or more launch configurations.
   */
  describeLaunchConfigurations(callback?: (err: AWSError, data: AutoScaling.LaunchConfigurationsType) => void): Request<AutoScaling.LaunchConfigurationsType, AWSError>;
  /**
   * Describes the available types of lifecycle hooks.
   */
  describeLifecycleHookTypes(params: {}, callback?: (err: AWSError, data: AutoScaling.DescribeLifecycleHookTypesAnswer) => void): Request<AutoScaling.DescribeLifecycleHookTypesAnswer, AWSError>;
  /**
   * Describes the available types of lifecycle hooks.
   */
  describeLifecycleHookTypes(callback?: (err: AWSError, data: AutoScaling.DescribeLifecycleHookTypesAnswer) => void): Request<AutoScaling.DescribeLifecycleHookTypesAnswer, AWSError>;
  /**
   * Describes the lifecycle hooks for the specified Auto Scaling group.
   */
  describeLifecycleHooks(params: AutoScaling.DescribeLifecycleHooksType, callback?: (err: AWSError, data: AutoScaling.DescribeLifecycleHooksAnswer) => void): Request<AutoScaling.DescribeLifecycleHooksAnswer, AWSError>;
  /**
   * Describes the lifecycle hooks for the specified Auto Scaling group.
   */
  describeLifecycleHooks(callback?: (err: AWSError, data: AutoScaling.DescribeLifecycleHooksAnswer) => void): Request<AutoScaling.DescribeLifecycleHooksAnswer, AWSError>;
  /**
   * Describes the target groups for the specified Auto Scaling group.
   */
  describeLoadBalancerTargetGroups(params: AutoScaling.DescribeLoadBalancerTargetGroupsRequest, callback?: (err: AWSError, data: AutoScaling.DescribeLoadBalancerTargetGroupsResponse) => void): Request<AutoScaling.DescribeLoadBalancerTargetGroupsResponse, AWSError>;
  /**
   * Describes the target groups for the specified Auto Scaling group.
   */
  describeLoadBalancerTargetGroups(callback?: (err: AWSError, data: AutoScaling.DescribeLoadBalancerTargetGroupsResponse) => void): Request<AutoScaling.DescribeLoadBalancerTargetGroupsResponse, AWSError>;
  /**
   ...
   */
  describeLoadBalancers(params: AutoScaling.DescribeLoadBalancersRequest, callback?: (err: AWSError, data: AutoScaling.DescribeLoadBalancersResponse) => void): Request<AutoScaling.DescribeLoadBalancersResponse, AWSError>;
  /**
   * Describes the load balancers for the specified Auto Scaling group. Note that this operation describes only Classic load balancers. If you have Application load balancers, use DescribeLoadBalancerTargetGroups instead.
   */
  describeLoadBalancers(callback?: (err: AWSError, data: AutoScaling.DescribeLoadBalancersResponse) => void): Request<AutoScaling.DescribeLoadBalancersResponse, AWSError>;
  /**
   ...
   */
  describeMetricCollectionTypes(params: {}, callback?: (err: AWSError, data: AutoScaling.DescribeMetricCollectionTypesAnswer) => void): Request<AutoScaling.DescribeMetricCollectionTypesAnswer, AWSError>;
  /**
   * Describes the available CloudWatch metrics for Auto Scaling. Note that the GroupStandbyInstances metric is not returned by default. You must explicitly request this metric when calling EnableMetricsCollection.
   */
  describeMetricCollectionTypes(callback?: (err: AWSError, data: AutoScaling.DescribeMetricCollectionTypesAnswer) => void): Request<AutoScaling.DescribeMetricCollectionTypesAnswer, AWSError>;
  /**
   * Describes the notification actions associated with the specified Auto Scaling group.
   */
  describeNotificationConfigurations(params: AutoScaling.DescribeNotificationConfigurationsType, callback?: (err: AWSError, data: AutoScaling.DescribeNotificationConfigurationsAnswer) => void): Request<AutoScaling.DescribeNotificationConfigurationsAnswer, AWSError>;
  /**
   * Describes the notification actions associated with the specified Auto Scaling group.
   */
  describeNotificationConfigurations(callback?: (err: AWSError, data: AutoScaling.DescribeNotificationConfigurationsAnswer) => void): Request<AutoScaling.DescribeNotificationConfigurationsAnswer, AWSError>;
  /**
   * Describes the policies for the specified Auto Scaling group.
   */
  describePolicies(params: AutoScaling.DescribePoliciesType, callback?: (err: AWSError, data: AutoScaling.PoliciesType) => void): Request<AutoScaling.PoliciesType, AWSError>;
  /**
   * Describes the policies for the specified Auto Scaling group.
   */
  describePolicies(callback?: (err: AWSError, data: AutoScaling.PoliciesType) => void): Request<AutoScaling.PoliciesType, AWSError>;
  /**
   * Describes one or more scaling activities for the specified Auto Scaling group.
   */
  describeScalingActivities(params: AutoScaling.DescribeScalingActivitiesType, callback?: (err: AWSError, data: AutoScaling.ActivitiesType) => void): Request<AutoScaling.ActivitiesType, AWSError>;
  /**
   * Describes one or more scaling activities for the specified Auto Scaling group.
   */
  describeScalingActivities(callback?: (err: AWSError, data: AutoScaling.ActivitiesType) => void): Request<AutoScaling.ActivitiesType, AWSError>;
  /**
   * Describes the scaling process types for use with ResumeProcesses and SuspendProcesses.
   */
  describeScalingProcessTypes(params: {}, callback?: (err: AWSError, data: AutoScaling.ProcessesType) => void): Request<AutoScaling.ProcessesType, AWSError>;
  /**
   * Describes the scaling process types for use with ResumeProcesses and SuspendProcesses.
   */
  describeScalingProcessTypes(callback?: (err: AWSError, data: AutoScaling.ProcessesType) => void): Request<AutoScaling.ProcessesType, AWSError>;
  /**
   * Describes the actions scheduled for your Auto Scaling group that haven't run. To describe the actions that have already run, use DescribeScalingActivities.
   */
  describeScheduledActions(params: AutoScaling.DescribeScheduledActionsType, callback?: (err: AWSError, data: AutoScaling.ScheduledActionsType) => void): Request<AutoScaling.ScheduledActionsType, AWSError>;
  /**
   * Describes the actions scheduled for your Auto Scaling group that haven't run. To describe the actions that have already run, use DescribeScalingActivities.
   */
  describeScheduledActions(callback?: (err: AWSError, data: AutoScaling.ScheduledActionsType) => void): Request<AutoScaling.ScheduledActionsType, AWSError>;
  /**
   ...
   */
  describeTags(params: AutoScaling.DescribeTagsType, callback?: (err: AWSError, data: AutoScaling.TagsType) => void): Request<AutoScaling.TagsType, AWSError>;
  /**
   * Describes the specified tags. You can use filters to limit the results. For example, you can query for the tags for a specific Auto Scaling group. You can specify multiple values for a filter. A tag must match at least one of the specified values for it to be included in the results. You can also specify multiple filters. The result includes information for a particular tag only if it matches all the filters. If there's no match, no special message is returned.
   */
  describeTags(callback?: (err: AWSError, data: AutoScaling.TagsType) => void): Request<AutoScaling.TagsType, AWSError>;
  /**
   * Describes the termination policies supported by Auto Scaling.
   */
  describeTerminationPolicyTypes(params: {}, callback?: (err: AWSError, data: AutoScaling.DescribeTerminationPolicyTypesAnswer) => void): Request<AutoScaling.DescribeTerminationPolicyTypesAnswer, AWSError>;
  /**
   * Describes the termination policies supported by Auto Scaling.
   */
  describeTerminationPolicyTypes(callback?: (err: AWSError, data: AutoScaling.DescribeTerminationPolicyTypesAnswer) => void): Request<AutoScaling.DescribeTerminationPolicyTypesAnswer, AWSError>;
  /**
   ...
   */
  detachInstances(params: AutoScaling.DetachInstancesQuery, callback?: (err: AWSError, data: AutoScaling.DetachInstancesAnswer) => void): Request<AutoScaling.DetachInstancesAnswer, AWSError>;
  /**
   * Removes one or more instances from the specified Auto Scaling group. After the instances are detached, you can manage them independently from the rest of the Auto Scaling group. If you do not specify the option to decrement the desired capacity, Auto Scaling launches instances to replace the ones that are detached. If there is a Classic load balancer attached to the Auto Scaling group, the instances are deregistered from the load balancer. If there are target groups attached to the Auto Scaling group, the instances are deregistered from the target groups. For more information, see Detach EC2 Instances from Your Auto Scaling Group in the Auto Scaling User Guide.
   */
  detachInstances(callback?: (err: AWSError, data: AutoScaling.DetachInstancesAnswer) => void): Request<AutoScaling.DetachInstancesAnswer, AWSError>;
  /**
   * Detaches one or more target groups from the specified Auto Scaling group.
   */
  detachLoadBalancerTargetGroups(params: AutoScaling.DetachLoadBalancerTargetGroupsType, callback?: (err: AWSError, data: AutoScaling.DetachLoadBalancerTargetGroupsResultType) => void): Request<AutoScaling.DetachLoadBalancerTargetGroupsResultType, AWSError>;
  /**
   * Detaches one or more target groups from the specified Auto Scaling group.
   */
  detachLoadBalancerTargetGroups(callback?: (err: AWSError, data: AutoScaling.DetachLoadBalancerTargetGroupsResultType) => void): Request<AutoScaling.DetachLoadBalancerTargetGroupsResultType, AWSError>;
  /**
   ...
   */
  detachLoadBalancers(params: AutoScaling.DetachLoadBalancersType, callback?: (err: AWSError, data: AutoScaling.DetachLoadBalancersResultType) => void): Request<AutoScaling.DetachLoadBalancersResultType, AWSError>;
  /**
   * Detaches one or more Classic load balancers from the specified Auto Scaling group. Note that this operation detaches only Classic load balancers. If you have Application load balancers, use DetachLoadBalancerTargetGroups instead. When you detach a load balancer, it enters the Removing state while deregistering the instances in the group. When all instances are deregistered, then you can no longer describe the load balancer using DescribeLoadBalancers. Note that the instances remain running.
   */
  detachLoadBalancers(callback?: (err: AWSError, data: AutoScaling.DetachLoadBalancersResultType) => void): Request<AutoScaling.DetachLoadBalancersResultType, AWSError>;
  /**
   * Disables group metrics for the specified Auto Scaling group.
   */
  disableMetricsCollection(params: AutoScaling.DisableMetricsCollectionQuery, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Disables group metrics for the specified Auto Scaling group.
   */
   ...
   */
  enableMetricsCollection(params: AutoScaling.EnableMetricsCollectionQuery, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Enables group metrics for the specified Auto Scaling group. For more information, see Monitoring Your Auto Scaling Groups and Instances in the Auto Scaling User Guide.
   */
   ...
   */
  enterStandby(params: AutoScaling.EnterStandbyQuery, callback?: (err: AWSError, data: AutoScaling.EnterStandbyAnswer) => void): Request<AutoScaling.EnterStandbyAnswer, AWSError>;
  /**
   * Moves the specified instances into Standby mode. For more information, see Auto Scaling Lifecycle in the Auto Scaling User Guide.
   */
  enterStandby(callback?: (err: AWSError, data: AutoScaling.EnterStandbyAnswer) => void): Request<AutoScaling.EnterStandbyAnswer, AWSError>;
  /**
   * Executes the specified policy.
   */
  executePolicy(params: AutoScaling.ExecutePolicyType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Executes the specified policy.
   */
   ...
   */
  exitStandby(params: AutoScaling.ExitStandbyQuery, callback?: (err: AWSError, data: AutoScaling.ExitStandbyAnswer) => void): Request<AutoScaling.ExitStandbyAnswer, AWSError>;
  /**
   * Moves the specified instances out of Standby mode. For more information, see Auto Scaling Lifecycle in the Auto Scaling User Guide.
   */
  exitStandby(callback?: (err: AWSError, data: AutoScaling.ExitStandbyAnswer) => void): Request<AutoScaling.ExitStandbyAnswer, AWSError>;
  /**
   * Creates or updates a lifecycle hook for the specified Auto Scaling Group. A lifecycle hook tells Auto Scaling that you want to perform an action on an instance that is not actively in service; for example, either when the instance launches or before the instance terminates. This step is a part of the procedure for adding a lifecycle hook to an Auto Scaling group:   (Optional) Create a Lambda function and a rule that allows CloudWatch Events to invoke your Lambda function when Auto Scaling launches or terminates instances.   (Optional) Create a notification target and an IAM role. The target can be either an Amazon SQS queue or an Amazon SNS topic. The role allows Auto Scaling to publish lifecycle notifications to the target.    Create the lifecycle hook. Specify whether the hook is used when the instances launch or terminate.    If you need more time, record the lifecycle action heartbeat to keep the instance in a pending state.   If you finish before the timeout period ends, complete the lifecycle action.   For more information, see Auto Scaling Lifecycle in the Auto Scaling User Guide. If you exceed your maximum limit of lifecycle hooks, which by default is 50 per Auto Scaling group, the call fails. For information about updating this limit, see AWS Service Limits in the Amazon Web Services General Reference.
   */
  putLifecycleHook(params: AutoScaling.PutLifecycleHookType, callback?: (err: AWSError, data: AutoScaling.PutLifecycleHookAnswer) => void): Request<AutoScaling.PutLifecycleHookAnswer, AWSError>;
  /**
   * Creates or updates a lifecycle hook for the specified Auto Scaling Group. A lifecycle hook tells Auto Scaling that you want to perform an action on an instance that is not actively in service; for example, either when the instance launches or before the instance terminates. This step is a part of the procedure for adding a lifecycle hook to an Auto Scaling group:   (Optional) Create a Lambda function and a rule that allows CloudWatch Events to invoke your Lambda function when Auto Scaling launches or terminates instances.   (Optional) Create a notification target and an IAM role. The target can be either an Amazon SQS queue or an Amazon SNS topic. The role allows Auto Scaling to publish lifecycle notifications to the target.    Create the lifecycle hook. Specify whether the hook is used when the instances launch or terminate.    If you need more time, record the lifecycle action heartbeat to keep the instance in a pending state.   If you finish before the timeout period ends, complete the lifecycle action.   For more information, see Auto Scaling Lifecycle in the Auto Scaling User Guide. If you exceed your maximum limit of lifecycle hooks, which by default is 50 per Auto Scaling group, the call fails. For information about updating this limit, see AWS Service Limits in the Amazon Web Services General Reference.
   */
  putLifecycleHook(callback?: (err: AWSError, data: AutoScaling.PutLifecycleHookAnswer) => void): Request<AutoScaling.PutLifecycleHookAnswer, AWSError>;
  /**
   ...
   */
  putNotificationConfiguration(params: AutoScaling.PutNotificationConfigurationType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Configures an Auto Scaling group to send notifications when specified events take place. Subscribers to the specified topic can have messages delivered to an endpoint such as a web server or an email address. This configuration overwrites any existing configuration. For more information see Getting SNS Notifications When Your Auto Scaling Group Scales in the Auto Scaling User Guide.
   */
   ...
   */
  putScalingPolicy(params: AutoScaling.PutScalingPolicyType, callback?: (err: AWSError, data: AutoScaling.PolicyARNType) => void): Request<AutoScaling.PolicyARNType, AWSError>;
  /**
   * Creates or updates a policy for an Auto Scaling group. To update an existing policy, use the existing policy name and set the parameters you want to change. Any existing parameter not changed in an update to an existing policy is not changed in this update request. If you exceed your maximum limit of step adjustments, which by default is 20 per region, the call fails. For information about updating this limit, see AWS Service Limits in the Amazon Web Services General Reference.
   */
  putScalingPolicy(callback?: (err: AWSError, data: AutoScaling.PolicyARNType) => void): Request<AutoScaling.PolicyARNType, AWSError>;
  /**
   * Creates or updates a scheduled scaling action for an Auto Scaling group. When updating a scheduled scaling action, if you leave a parameter unspecified, the corresponding value remains unchanged in the affected Auto Scaling group. For more information, see Scheduled Scaling in the Auto Scaling User Guide.
   */
  putScheduledUpdateGroupAction(params: AutoScaling.PutScheduledUpdateGroupActionType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Creates or updates a scheduled scaling action for an Auto Scaling group. When updating a scheduled scaling action, if you leave a parameter unspecified, the corresponding value remains unchanged in the affected Auto Scaling group. For more information, see Scheduled Scaling in the Auto Scaling User Guide.
   */
   ...
   */
  recordLifecycleActionHeartbeat(params: AutoScaling.RecordLifecycleActionHeartbeatType, callback?: (err: AWSError, data: AutoScaling.RecordLifecycleActionHeartbeatAnswer) => void): Request<AutoScaling.RecordLifecycleActionHeartbeatAnswer, AWSError>;
  /**
   * Records a heartbeat for the lifecycle action associated with the specified token or instance. This extends the timeout by the length of time defined using PutLifecycleHook. This step is a part of the procedure for adding a lifecycle hook to an Auto Scaling group:   (Optional) Create a Lambda function and a rule that allows CloudWatch Events to invoke your Lambda function when Auto Scaling launches or terminates instances.   (Optional) Create a notification target and an IAM role. The target can be either an Amazon SQS queue or an Amazon SNS topic. The role allows Auto Scaling to publish lifecycle notifications to the target.   Create the lifecycle hook. Specify whether the hook is used when the instances launch or terminate.    If you need more time, record the lifecycle action heartbeat to keep the instance in a pending state.    If you finish before the timeout period ends, complete the lifecycle action.   For more information, see Auto Scaling Lifecycle in the Auto Scaling User Guide.
   */
  recordLifecycleActionHeartbeat(callback?: (err: AWSError, data: AutoScaling.RecordLifecycleActionHeartbeatAnswer) => void): Request<AutoScaling.RecordLifecycleActionHeartbeatAnswer, AWSError>;
  /**
   ...
   */
  resumeProcesses(params: AutoScaling.ScalingProcessQuery, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Resumes the specified suspended Auto Scaling processes, or all suspended process, for the specified Auto Scaling group. For more information, see Suspending and Resuming Auto Scaling Processes in the Auto Scaling User Guide.
   */
   ...
   */
  setDesiredCapacity(params: AutoScaling.SetDesiredCapacityType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Sets the size of the specified Auto Scaling group. For more information about desired capacity, see What Is Auto Scaling? in the Auto Scaling User Guide.
   */
   ...
   */
  setInstanceHealth(params: AutoScaling.SetInstanceHealthQuery, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Sets the health status of the specified instance. For more information, see Health Checks in the Auto Scaling User Guide.
   */
   ...
   */
  setInstanceProtection(params: AutoScaling.SetInstanceProtectionQuery, callback?: (err: AWSError, data: AutoScaling.SetInstanceProtectionAnswer) => void): Request<AutoScaling.SetInstanceProtectionAnswer, AWSError>;
  /**
   * Updates the instance protection settings of the specified instances. For more information, see Instance Protection in the Auto Scaling User Guide.
   */
  setInstanceProtection(callback?: (err: AWSError, data: AutoScaling.SetInstanceProtectionAnswer) => void): Request<AutoScaling.SetInstanceProtectionAnswer, AWSError>;
  /**
   ...
   */
  suspendProcesses(params: AutoScaling.ScalingProcessQuery, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Suspends the specified Auto Scaling processes, or all processes, for the specified Auto Scaling group. Note that if you suspend either the Launch or Terminate process types, it can prevent other process types from functioning properly. To resume processes that have been suspended, use ResumeProcesses. For more information, see Suspending and Resuming Auto Scaling Processes in the Auto Scaling User Guide.
   */
   ...
   */
  terminateInstanceInAutoScalingGroup(params: AutoScaling.TerminateInstanceInAutoScalingGroupType, callback?: (err: AWSError, data: AutoScaling.ActivityType) => void): Request<AutoScaling.ActivityType, AWSError>;
  /**
   * Terminates the specified instance and optionally adjusts the desired group size. This call simply makes a termination request. The instance is not terminated immediately.
   */
  terminateInstanceInAutoScalingGroup(callback?: (err: AWSError, data: AutoScaling.ActivityType) => void): Request<AutoScaling.ActivityType, AWSError>;
  /**
   ...
   */
  updateAutoScalingGroup(params: AutoScaling.UpdateAutoScalingGroupType, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Updates the configuration for the specified Auto Scaling group. To update an Auto Scaling group with a launch configuration with InstanceMonitoring set to False, you must first disable the collection of group metrics. Otherwise, you will get an error. If you have previously enabled the collection of group metrics, you can disable it using DisableMetricsCollection. The new settings are registered upon the completion of this call. Any launch configuration settings take effect on any triggers after this call returns. Scaling activities that are currently in progress aren't affected. Note the following:   If you specify a new value for MinSize without specifying a value for DesiredCapacity, and the new MinSize is larger than the current size of the group, we implicitly call SetDesiredCapacity to set the size of the group to the new value of MinSize.   If you specify a new value for MaxSize without specifying a value for DesiredCapacity, and the new MaxSize is smaller than the current size of the group, we implicitly call SetDesiredCapacity to set the size of the group to the new value of MaxSize.   All other optional parameters are left unchanged if not specified.  
   */
...
declare namespace AutoScaling {
  ...
  export interface PutScheduledUpdateGroupActionType {
    ...
    Time?: TimestampType;
    /**
     * The time for this action to start, in "YYYY-MM-DDThh:mm:ssZ" format in UTC/GMT only (for example, 2014-06-01T00:00:00Z). If you try to schedule your action in the past, Auto Scaling returns an error message. When StartTime and EndTime are specified with Recurrence, they form the boundaries of when the recurring action starts and stops.
     */
    StartTime?: TimestampType;
    /**
    ...
    EndTime?: TimestampType;
    /**
     * The time when recurring future actions will start. Start time is specified by the user following the Unix cron syntax format. For more information, see Cron in Wikipedia. When StartTime and EndTime are specified with Recurrence, they form the boundaries of when the recurring action will start and stop.
     */
