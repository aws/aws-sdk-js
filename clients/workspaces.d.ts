...
declare class WorkSpaces extends Service {
   ...
   */
  createTags(params: WorkSpaces.CreateTagsRequest, callback?: (err: AWSError, data: WorkSpaces.CreateTagsResult) => void): Request<WorkSpaces.CreateTagsResult, AWSError>;
  /**
   * Creates tags for a WorkSpace.
   */
  createTags(callback?: (err: AWSError, data: WorkSpaces.CreateTagsResult) => void): Request<WorkSpaces.CreateTagsResult, AWSError>;
  /**
   * Creates one or more WorkSpaces.  This operation is asynchronous and returns before the WorkSpaces are created. 
   */
  createWorkspaces(params: WorkSpaces.CreateWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.CreateWorkspacesResult) => void): Request<WorkSpaces.CreateWorkspacesResult, AWSError>;
  /**
   * Creates one or more WorkSpaces.  This operation is asynchronous and returns before the WorkSpaces are created. 
   */
  createWorkspaces(callback?: (err: AWSError, data: WorkSpaces.CreateWorkspacesResult) => void): Request<WorkSpaces.CreateWorkspacesResult, AWSError>;
  /**
   * Deletes tags from a WorkSpace.
   */
  deleteTags(params: WorkSpaces.DeleteTagsRequest, callback?: (err: AWSError, data: WorkSpaces.DeleteTagsResult) => void): Request<WorkSpaces.DeleteTagsResult, AWSError>;
  /**
   * Deletes tags from a WorkSpace.
   */
  deleteTags(callback?: (err: AWSError, data: WorkSpaces.DeleteTagsResult) => void): Request<WorkSpaces.DeleteTagsResult, AWSError>;
  /**
   * Describes tags for a WorkSpace.
   */
  describeTags(params: WorkSpaces.DescribeTagsRequest, callback?: (err: AWSError, data: WorkSpaces.DescribeTagsResult) => void): Request<WorkSpaces.DescribeTagsResult, AWSError>;
  /**
   * Describes tags for a WorkSpace.
   */
  describeTags(callback?: (err: AWSError, data: WorkSpaces.DescribeTagsResult) => void): Request<WorkSpaces.DescribeTagsResult, AWSError>;
  /**
   ...
   */
  describeWorkspaceBundles(params: WorkSpaces.DescribeWorkspaceBundlesRequest, callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspaceBundlesResult) => void): Request<WorkSpaces.DescribeWorkspaceBundlesResult, AWSError>;
  /**
   * Obtains information about the WorkSpace bundles that are available to your account in the specified region. You can filter the results with either the BundleIds parameter, or the Owner parameter, but not both. This operation supports pagination with the use of the NextToken request and response parameters. If more results are available, the NextToken response member contains a token that you pass in the next call to this operation to retrieve the next set of items.
   */
  describeWorkspaceBundles(callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspaceBundlesResult) => void): Request<WorkSpaces.DescribeWorkspaceBundlesResult, AWSError>;
  /**
   ...
   */
  describeWorkspaceDirectories(params: WorkSpaces.DescribeWorkspaceDirectoriesRequest, callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspaceDirectoriesResult) => void): Request<WorkSpaces.DescribeWorkspaceDirectoriesResult, AWSError>;
  /**
   * Retrieves information about the AWS Directory Service directories in the region that are registered with Amazon WorkSpaces and are available to your account. This operation supports pagination with the use of the NextToken request and response parameters. If more results are available, the NextToken response member contains a token that you pass in the next call to this operation to retrieve the next set of items.
   */
  describeWorkspaceDirectories(callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspaceDirectoriesResult) => void): Request<WorkSpaces.DescribeWorkspaceDirectoriesResult, AWSError>;
  /**
   ...
   */
  describeWorkspaces(params: WorkSpaces.DescribeWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspacesResult) => void): Request<WorkSpaces.DescribeWorkspacesResult, AWSError>;
  /**
   * Obtains information about the specified WorkSpaces. Only one of the filter parameters, such as BundleId, DirectoryId, or WorkspaceIds, can be specified at a time. This operation supports pagination with the use of the NextToken request and response parameters. If more results are available, the NextToken response member contains a token that you pass in the next call to this operation to retrieve the next set of items.
   */
  describeWorkspaces(callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspacesResult) => void): Request<WorkSpaces.DescribeWorkspacesResult, AWSError>;
  /**
   * Describes the connection status of a specified WorkSpace.
   */
  describeWorkspacesConnectionStatus(params: WorkSpaces.DescribeWorkspacesConnectionStatusRequest, callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspacesConnectionStatusResult) => void): Request<WorkSpaces.DescribeWorkspacesConnectionStatusResult, AWSError>;
  /**
   * Describes the connection status of a specified WorkSpace.
   */
  describeWorkspacesConnectionStatus(callback?: (err: AWSError, data: WorkSpaces.DescribeWorkspacesConnectionStatusResult) => void): Request<WorkSpaces.DescribeWorkspacesConnectionStatusResult, AWSError>;
  /**
   * Modifies the WorkSpace properties, including the RunningMode and AutoStop time.
   */
  modifyWorkspaceProperties(params: WorkSpaces.ModifyWorkspacePropertiesRequest, callback?: (err: AWSError, data: WorkSpaces.ModifyWorkspacePropertiesResult) => void): Request<WorkSpaces.ModifyWorkspacePropertiesResult, AWSError>;
  /**
   * Modifies the WorkSpace properties, including the RunningMode and AutoStop time.
   */
  modifyWorkspaceProperties(callback?: (err: AWSError, data: WorkSpaces.ModifyWorkspacePropertiesResult) => void): Request<WorkSpaces.ModifyWorkspacePropertiesResult, AWSError>;
  /**
   ...
   */
  rebootWorkspaces(params: WorkSpaces.RebootWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.RebootWorkspacesResult) => void): Request<WorkSpaces.RebootWorkspacesResult, AWSError>;
  /**
   * Reboots the specified WorkSpaces. To be able to reboot a WorkSpace, the WorkSpace must have a State of AVAILABLE, IMPAIRED, or INOPERABLE.  This operation is asynchronous and returns before the WorkSpaces have rebooted. 
   */
  rebootWorkspaces(callback?: (err: AWSError, data: WorkSpaces.RebootWorkspacesResult) => void): Request<WorkSpaces.RebootWorkspacesResult, AWSError>;
  /**
   ...
   */
  rebuildWorkspaces(params: WorkSpaces.RebuildWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.RebuildWorkspacesResult) => void): Request<WorkSpaces.RebuildWorkspacesResult, AWSError>;
  /**
   * Rebuilds the specified WorkSpaces. Rebuilding a WorkSpace is a potentially destructive action that can result in the loss of data. Rebuilding a WorkSpace causes the following to occur:   The system is restored to the image of the bundle that the WorkSpace is created from. Any applications that have been installed, or system settings that have been made since the WorkSpace was created will be lost.   The data drive (D drive) is re-created from the last automatic snapshot taken of the data drive. The current contents of the data drive are overwritten. Automatic snapshots of the data drive are taken every 12 hours, so the snapshot can be as much as 12 hours old.   To be able to rebuild a WorkSpace, the WorkSpace must have a State of AVAILABLE or ERROR.  This operation is asynchronous and returns before the WorkSpaces have been completely rebuilt. 
   */
  rebuildWorkspaces(callback?: (err: AWSError, data: WorkSpaces.RebuildWorkspacesResult) => void): Request<WorkSpaces.RebuildWorkspacesResult, AWSError>;
  /**
   ...
   */
  startWorkspaces(params: WorkSpaces.StartWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.StartWorkspacesResult) => void): Request<WorkSpaces.StartWorkspacesResult, AWSError>;
  /**
   * Starts the specified WorkSpaces. The API only works with WorkSpaces that have RunningMode configured as AutoStop and the State set to “STOPPED.”
   */
  startWorkspaces(callback?: (err: AWSError, data: WorkSpaces.StartWorkspacesResult) => void): Request<WorkSpaces.StartWorkspacesResult, AWSError>;
  /**
   ...
   */
  stopWorkspaces(params: WorkSpaces.StopWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.StopWorkspacesResult) => void): Request<WorkSpaces.StopWorkspacesResult, AWSError>;
  /**
   *  Stops the specified WorkSpaces. The API only works with WorkSpaces that have RunningMode configured as AutoStop and the State set to AVAILABLE, IMPAIRED, UNHEALTHY, or ERROR.
   */
  stopWorkspaces(callback?: (err: AWSError, data: WorkSpaces.StopWorkspacesResult) => void): Request<WorkSpaces.StopWorkspacesResult, AWSError>;
  /**
   ...
   */
  terminateWorkspaces(params: WorkSpaces.TerminateWorkspacesRequest, callback?: (err: AWSError, data: WorkSpaces.TerminateWorkspacesResult) => void): Request<WorkSpaces.TerminateWorkspacesResult, AWSError>;
  /**
   * Terminates the specified WorkSpaces. Terminating a WorkSpace is a permanent action and cannot be undone. The user's data is not maintained and will be destroyed. If you need to archive any user data, contact Amazon Web Services before terminating the WorkSpace. You can terminate a WorkSpace that is in any state except SUSPENDED.  This operation is asynchronous and returns before the WorkSpaces have been completely terminated. 
   */
  terminateWorkspaces(callback?: (err: AWSError, data: WorkSpaces.TerminateWorkspacesResult) => void): Request<WorkSpaces.TerminateWorkspacesResult, AWSError>;
}
