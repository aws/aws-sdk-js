...
declare class ElasticBeanstalk extends Service {
   ...
   */
  abortEnvironmentUpdate(params: ElasticBeanstalk.AbortEnvironmentUpdateMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Cancels in-progress environment configuration update or application version deployment.
   */
   ...
   */
  applyEnvironmentManagedAction(params: ElasticBeanstalk.ApplyEnvironmentManagedActionRequest, callback?: (err: AWSError, data: ElasticBeanstalk.ApplyEnvironmentManagedActionResult) => void): Request<ElasticBeanstalk.ApplyEnvironmentManagedActionResult, AWSError>;
  /**
   * Applies a scheduled managed action immediately. A managed action can be applied only if its status is Scheduled. Get the status and action ID of a managed action with DescribeEnvironmentManagedActions.
   */
  applyEnvironmentManagedAction(callback?: (err: AWSError, data: ElasticBeanstalk.ApplyEnvironmentManagedActionResult) => void): Request<ElasticBeanstalk.ApplyEnvironmentManagedActionResult, AWSError>;
  /**
   *  Checks if the specified CNAME is available. 
   */
  checkDNSAvailability(params: ElasticBeanstalk.CheckDNSAvailabilityMessage, callback?: (err: AWSError, data: ElasticBeanstalk.CheckDNSAvailabilityResultMessage) => void): Request<ElasticBeanstalk.CheckDNSAvailabilityResultMessage, AWSError>;
  /**
   *  Checks if the specified CNAME is available. 
   */
  checkDNSAvailability(callback?: (err: AWSError, data: ElasticBeanstalk.CheckDNSAvailabilityResultMessage) => void): Request<ElasticBeanstalk.CheckDNSAvailabilityResultMessage, AWSError>;
  /**
   * Create or update a group of environments that each run a separate component of a single application. Takes a list of version labels that specify application source bundles for each of the environments to create or update. The name of each environment and other required information must be included in the source bundles in an environment manifest named env.yaml. See Compose Environments for details.
   */
  composeEnvironments(params: ElasticBeanstalk.ComposeEnvironmentsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescriptionsMessage) => void): Request<ElasticBeanstalk.EnvironmentDescriptionsMessage, AWSError>;
  /**
   * Create or update a group of environments that each run a separate component of a single application. Takes a list of version labels that specify application source bundles for each of the environments to create or update. The name of each environment and other required information must be included in the source bundles in an environment manifest named env.yaml. See Compose Environments for details.
   */
  composeEnvironments(callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescriptionsMessage) => void): Request<ElasticBeanstalk.EnvironmentDescriptionsMessage, AWSError>;
  /**
   *  Creates an application that has one configuration template named default and no application versions. 
   */
  createApplication(params: ElasticBeanstalk.CreateApplicationMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationDescriptionMessage, AWSError>;
  /**
   *  Creates an application that has one configuration template named default and no application versions. 
   */
  createApplication(callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationDescriptionMessage, AWSError>;
  /**
   ...
   */
  createApplicationVersion(params: ElasticBeanstalk.CreateApplicationVersionMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationVersionDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationVersionDescriptionMessage, AWSError>;
  /**
   * Creates an application version for the specified application. Once you create an application version with a specified Amazon S3 bucket and key location, you cannot change that Amazon S3 location. If you change the Amazon S3 location, you receive an exception when you attempt to launch an environment from the application version. 
   */
  createApplicationVersion(callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationVersionDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationVersionDescriptionMessage, AWSError>;
  /**
   ...
   */
  createConfigurationTemplate(params: ElasticBeanstalk.CreateConfigurationTemplateMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsDescription) => void): Request<ElasticBeanstalk.ConfigurationSettingsDescription, AWSError>;
  /**
   * Creates a configuration template. Templates are associated with a specific application and are used to deploy different versions of the application with the same configuration settings. Related Topics   DescribeConfigurationOptions   DescribeConfigurationSettings   ListAvailableSolutionStacks  
   */
  createConfigurationTemplate(callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsDescription) => void): Request<ElasticBeanstalk.ConfigurationSettingsDescription, AWSError>;
  /**
   * Launches an environment for the specified application using the specified configuration.
   */
  createEnvironment(params: ElasticBeanstalk.CreateEnvironmentMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescription) => void): Request<ElasticBeanstalk.EnvironmentDescription, AWSError>;
  /**
   * Launches an environment for the specified application using the specified configuration.
   */
  createEnvironment(callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescription) => void): Request<ElasticBeanstalk.EnvironmentDescription, AWSError>;
  /**
   *  Creates the Amazon S3 storage location for the account.   This location is used to store user log files. 
   */
  createStorageLocation(params: {}, callback?: (err: AWSError, data: ElasticBeanstalk.CreateStorageLocationResultMessage) => void): Request<ElasticBeanstalk.CreateStorageLocationResultMessage, AWSError>;
  /**
   *  Creates the Amazon S3 storage location for the account.   This location is used to store user log files. 
   */
  createStorageLocation(callback?: (err: AWSError, data: ElasticBeanstalk.CreateStorageLocationResultMessage) => void): Request<ElasticBeanstalk.CreateStorageLocationResultMessage, AWSError>;
  /**
   ...
   */
  deleteApplication(params: ElasticBeanstalk.DeleteApplicationMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   *  Deletes the specified application along with all associated versions and configurations. The application versions will not be deleted from your Amazon S3 bucket.  You cannot delete an application that has a running environment. 
   */
   ...
   */
  deleteApplicationVersion(params: ElasticBeanstalk.DeleteApplicationVersionMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   *  Deletes the specified version from the specified application.  You cannot delete an application version that is associated with a running environment.
   */
   ...
   */
  deleteConfigurationTemplate(params: ElasticBeanstalk.DeleteConfigurationTemplateMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the specified configuration template. When you launch an environment using a configuration template, the environment gets a copy of the template. You can delete or modify the environment's copy of the template without affecting the running environment.
   */
   ...
   */
  deleteEnvironmentConfiguration(params: ElasticBeanstalk.DeleteEnvironmentConfigurationMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Deletes the draft configuration associated with the running environment. Updating a running environment with any configuration changes creates a draft configuration set. You can get the draft configuration using DescribeConfigurationSettings while the update is in progress or if the update fails. The DeploymentStatus for the draft configuration indicates whether the deployment is in process or has failed. The draft configuration remains in existence until it is deleted with this action.
   */
   ...
   */
  describeApplicationVersions(params: ElasticBeanstalk.DescribeApplicationVersionsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationVersionDescriptionsMessage) => void): Request<ElasticBeanstalk.ApplicationVersionDescriptionsMessage, AWSError>;
  /**
   * Retrieve a list of application versions stored in your AWS Elastic Beanstalk storage bucket.
   */
  describeApplicationVersions(callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationVersionDescriptionsMessage) => void): Request<ElasticBeanstalk.ApplicationVersionDescriptionsMessage, AWSError>;
  /**
   * Returns the descriptions of existing applications.
   */
  describeApplications(params: ElasticBeanstalk.DescribeApplicationsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationDescriptionsMessage) => void): Request<ElasticBeanstalk.ApplicationDescriptionsMessage, AWSError>;
  /**
   * Returns the descriptions of existing applications.
   */
  describeApplications(callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationDescriptionsMessage) => void): Request<ElasticBeanstalk.ApplicationDescriptionsMessage, AWSError>;
  /**
   *  Describes the configuration options that are used in a particular configuration template or environment, or that a specified solution stack defines. The description includes the values the options, their default values, and an indication of the required action on a running environment if an option value is changed. 
   */
  describeConfigurationOptions(params: ElasticBeanstalk.DescribeConfigurationOptionsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationOptionsDescription) => void): Request<ElasticBeanstalk.ConfigurationOptionsDescription, AWSError>;
  /**
   *  Describes the configuration options that are used in a particular configuration template or environment, or that a specified solution stack defines. The description includes the values the options, their default values, and an indication of the required action on a running environment if an option value is changed. 
   */
  describeConfigurationOptions(callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationOptionsDescription) => void): Request<ElasticBeanstalk.ConfigurationOptionsDescription, AWSError>;
  /**
   ...
   */
  describeConfigurationSettings(params: ElasticBeanstalk.DescribeConfigurationSettingsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsDescriptions) => void): Request<ElasticBeanstalk.ConfigurationSettingsDescriptions, AWSError>;
  /**
   *  Returns a description of the settings for the specified configuration set, that is, either a configuration template or the configuration set associated with a running environment.   When describing the settings for the configuration set associated with a running environment, it is possible to receive two sets of setting descriptions. One is the deployed configuration set, and the other is a draft configuration of an environment that is either in the process of deployment or that failed to deploy.  Related Topics   DeleteEnvironmentConfiguration  
   */
  describeConfigurationSettings(callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsDescriptions) => void): Request<ElasticBeanstalk.ConfigurationSettingsDescriptions, AWSError>;
  /**
   * Returns information about the overall health of the specified environment. The DescribeEnvironmentHealth operation is only available with AWS Elastic Beanstalk Enhanced Health.
   */
  describeEnvironmentHealth(params: ElasticBeanstalk.DescribeEnvironmentHealthRequest, callback?: (err: AWSError, data: ElasticBeanstalk.DescribeEnvironmentHealthResult) => void): Request<ElasticBeanstalk.DescribeEnvironmentHealthResult, AWSError>;
  /**
   * Returns information about the overall health of the specified environment. The DescribeEnvironmentHealth operation is only available with AWS Elastic Beanstalk Enhanced Health.
   */
  describeEnvironmentHealth(callback?: (err: AWSError, data: ElasticBeanstalk.DescribeEnvironmentHealthResult) => void): Request<ElasticBeanstalk.DescribeEnvironmentHealthResult, AWSError>;
  /**
   * Lists an environment's completed and failed managed actions.
   */
  describeEnvironmentManagedActionHistory(params: ElasticBeanstalk.DescribeEnvironmentManagedActionHistoryRequest, callback?: (err: AWSError, data: ElasticBeanstalk.DescribeEnvironmentManagedActionHistoryResult) => void): Request<ElasticBeanstalk.DescribeEnvironmentManagedActionHistoryResult, AWSError>;
  /**
   * Lists an environment's completed and failed managed actions.
   */
  describeEnvironmentManagedActionHistory(callback?: (err: AWSError, data: ElasticBeanstalk.DescribeEnvironmentManagedActionHistoryResult) => void): Request<ElasticBeanstalk.DescribeEnvironmentManagedActionHistoryResult, AWSError>;
  /**
   * Lists an environment's upcoming and in-progress managed actions.
   */
  describeEnvironmentManagedActions(params: ElasticBeanstalk.DescribeEnvironmentManagedActionsRequest, callback?: (err: AWSError, data: ElasticBeanstalk.DescribeEnvironmentManagedActionsResult) => void): Request<ElasticBeanstalk.DescribeEnvironmentManagedActionsResult, AWSError>;
  /**
   * Lists an environment's upcoming and in-progress managed actions.
   */
  describeEnvironmentManagedActions(callback?: (err: AWSError, data: ElasticBeanstalk.DescribeEnvironmentManagedActionsResult) => void): Request<ElasticBeanstalk.DescribeEnvironmentManagedActionsResult, AWSError>;
  /**
   * Returns AWS resources for this environment.
   */
  describeEnvironmentResources(params: ElasticBeanstalk.DescribeEnvironmentResourcesMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentResourceDescriptionsMessage) => void): Request<ElasticBeanstalk.EnvironmentResourceDescriptionsMessage, AWSError>;
  /**
   * Returns AWS resources for this environment.
   */
  describeEnvironmentResources(callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentResourceDescriptionsMessage) => void): Request<ElasticBeanstalk.EnvironmentResourceDescriptionsMessage, AWSError>;
  /**
   * Returns descriptions for existing environments.
   */
  describeEnvironments(params: ElasticBeanstalk.DescribeEnvironmentsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescriptionsMessage) => void): Request<ElasticBeanstalk.EnvironmentDescriptionsMessage, AWSError>;
  /**
   * Returns descriptions for existing environments.
   */
  describeEnvironments(callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescriptionsMessage) => void): Request<ElasticBeanstalk.EnvironmentDescriptionsMessage, AWSError>;
  /**
   * Returns list of event descriptions matching criteria up to the last 6 weeks. This action returns the most recent 1,000 events from the specified NextToken.
   */
  describeEvents(params: ElasticBeanstalk.DescribeEventsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EventDescriptionsMessage) => void): Request<ElasticBeanstalk.EventDescriptionsMessage, AWSError>;
  /**
   * Returns list of event descriptions matching criteria up to the last 6 weeks. This action returns the most recent 1,000 events from the specified NextToken.
   */
  describeEvents(callback?: (err: AWSError, data: ElasticBeanstalk.EventDescriptionsMessage) => void): Request<ElasticBeanstalk.EventDescriptionsMessage, AWSError>;
  /**
   ...
   */
  describeInstancesHealth(params: ElasticBeanstalk.DescribeInstancesHealthRequest, callback?: (err: AWSError, data: ElasticBeanstalk.DescribeInstancesHealthResult) => void): Request<ElasticBeanstalk.DescribeInstancesHealthResult, AWSError>;
  /**
   * Returns more detailed information about the health of the specified instances (for example, CPU utilization, load average, and causes). The DescribeInstancesHealth operation is only available with AWS Elastic Beanstalk Enhanced Health.
   */
  describeInstancesHealth(callback?: (err: AWSError, data: ElasticBeanstalk.DescribeInstancesHealthResult) => void): Request<ElasticBeanstalk.DescribeInstancesHealthResult, AWSError>;
  /**
   *  Returns a list of the available solution stack names. 
   */
  listAvailableSolutionStacks(params: {}, callback?: (err: AWSError, data: ElasticBeanstalk.ListAvailableSolutionStacksResultMessage) => void): Request<ElasticBeanstalk.ListAvailableSolutionStacksResultMessage, AWSError>;
  /**
   *  Returns a list of the available solution stack names. 
   */
  listAvailableSolutionStacks(callback?: (err: AWSError, data: ElasticBeanstalk.ListAvailableSolutionStacksResultMessage) => void): Request<ElasticBeanstalk.ListAvailableSolutionStacksResultMessage, AWSError>;
  /**
   *  Deletes and recreates all of the AWS resources (for example: the Auto Scaling group, load balancer, etc.) for a specified environment and forces a restart. 
   */
  rebuildEnvironment(params: ElasticBeanstalk.RebuildEnvironmentMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   *  Deletes and recreates all of the AWS resources (for example: the Auto Scaling group, load balancer, etc.) for a specified environment and forces a restart. 
   */
   ...
   */
  requestEnvironmentInfo(params: ElasticBeanstalk.RequestEnvironmentInfoMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   *  Initiates a request to compile the specified type of information of the deployed environment.   Setting the InfoType to tail compiles the last lines from the application server log files of every Amazon EC2 instance in your environment.   Setting the InfoType to bundle compresses the application server log files for every Amazon EC2 instance into a .zip file. Legacy and .NET containers do not support bundle logs.   Use RetrieveEnvironmentInfo to obtain the set of logs.  Related Topics   RetrieveEnvironmentInfo  
   */
   ...
   */
  restartAppServer(params: ElasticBeanstalk.RestartAppServerMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   * Causes the environment to restart the application container server running on each Amazon EC2 instance.
   */
   ...
   */
  retrieveEnvironmentInfo(params: ElasticBeanstalk.RetrieveEnvironmentInfoMessage, callback?: (err: AWSError, data: ElasticBeanstalk.RetrieveEnvironmentInfoResultMessage) => void): Request<ElasticBeanstalk.RetrieveEnvironmentInfoResultMessage, AWSError>;
  /**
   * Retrieves the compiled information from a RequestEnvironmentInfo request. Related Topics   RequestEnvironmentInfo  
   */
  retrieveEnvironmentInfo(callback?: (err: AWSError, data: ElasticBeanstalk.RetrieveEnvironmentInfoResultMessage) => void): Request<ElasticBeanstalk.RetrieveEnvironmentInfoResultMessage, AWSError>;
  /**
   *  Swaps the CNAMEs of two environments. 
   */
  swapEnvironmentCNAMEs(params: ElasticBeanstalk.SwapEnvironmentCNAMEsMessage, callback?: (err: AWSError, data: {}) => void): Request<{}, AWSError>;
  /**
   *  Swaps the CNAMEs of two environments. 
   */
   ...
   */
  terminateEnvironment(params: ElasticBeanstalk.TerminateEnvironmentMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescription) => void): Request<ElasticBeanstalk.EnvironmentDescription, AWSError>;
  /**
   *  Terminates the specified environment. 
   */
  terminateEnvironment(callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescription) => void): Request<ElasticBeanstalk.EnvironmentDescription, AWSError>;
  /**
   ...
   */
  updateApplication(params: ElasticBeanstalk.UpdateApplicationMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationDescriptionMessage, AWSError>;
  /**
   * Updates the specified application to have the specified properties.   If a property (for example, description) is not provided, the value remains unchanged. To clear these properties, specify an empty string. 
   */
  updateApplication(callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationDescriptionMessage, AWSError>;
  /**
   ...
   */
  updateApplicationVersion(params: ElasticBeanstalk.UpdateApplicationVersionMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationVersionDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationVersionDescriptionMessage, AWSError>;
  /**
   *  Updates the specified application version to have the specified properties.   If a property (for example, description) is not provided, the value remains unchanged. To clear properties, specify an empty string. 
   */
  updateApplicationVersion(callback?: (err: AWSError, data: ElasticBeanstalk.ApplicationVersionDescriptionMessage) => void): Request<ElasticBeanstalk.ApplicationVersionDescriptionMessage, AWSError>;
  /**
   ...
   */
  updateConfigurationTemplate(params: ElasticBeanstalk.UpdateConfigurationTemplateMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsDescription) => void): Request<ElasticBeanstalk.ConfigurationSettingsDescription, AWSError>;
  /**
   *  Updates the specified configuration template to have the specified properties or configuration option values.   If a property (for example, ApplicationName) is not provided, its value remains unchanged. To clear such properties, specify an empty string.  Related Topics   DescribeConfigurationOptions  
   */
  updateConfigurationTemplate(callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsDescription) => void): Request<ElasticBeanstalk.ConfigurationSettingsDescription, AWSError>;
  /**
   ...
   */
  updateEnvironment(params: ElasticBeanstalk.UpdateEnvironmentMessage, callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescription) => void): Request<ElasticBeanstalk.EnvironmentDescription, AWSError>;
  /**
   *  Updates the environment description, deploys a new application version, updates the configuration settings to an entirely new configuration template, or updates select configuration option values in the running environment.   Attempting to update both the release and configuration is not allowed and AWS Elastic Beanstalk returns an InvalidParameterCombination error.   When updating the configuration settings to a new template or individual settings, a draft configuration is created and DescribeConfigurationSettings for this environment returns two setting descriptions with different DeploymentStatus values. 
   */
  updateEnvironment(callback?: (err: AWSError, data: ElasticBeanstalk.EnvironmentDescription) => void): Request<ElasticBeanstalk.EnvironmentDescription, AWSError>;
  /**
   ...
   */
  validateConfigurationSettings(params: ElasticBeanstalk.ValidateConfigurationSettingsMessage, callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsValidationMessages) => void): Request<ElasticBeanstalk.ConfigurationSettingsValidationMessages, AWSError>;
  /**
   *  Takes a set of configuration settings and either a configuration template or environment, and determines whether those values are valid.   This action returns a list of messages indicating any errors or warnings associated with the selection of option values. 
   */
  validateConfigurationSettings(callback?: (err: AWSError, data: ElasticBeanstalk.ConfigurationSettingsValidationMessages) => void): Request<ElasticBeanstalk.ConfigurationSettingsValidationMessages, AWSError>;
}
