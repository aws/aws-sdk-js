...
AWS.ServiceInterface.RestXml = {
  buildRequest: function buildRequest(resp, req) {
    AWS.ServiceInterface.Rest.buildRequest(resp, req);
    AWS.ServiceInterface.RestXml.populateBody(resp, req);
  },

  extractError: function extractError(resp, req) {
    AWS.ServiceInterface.Rest.extractError(resp, req);
  ...
  extractData: function extractData(resp, req) {
    AWS.ServiceInterface.Rest.extractData(resp, req);
  ...
  populateBody: function populateBody(resp, req) {
    var operation = req.client.api.operations[req.operation];
