...
AWS.ServiceInterface.RestXml = {
  ...
  populateBody: function populateBody(req) {
    ...
    if (typeof payload === 'string') {
      ...
      var params = req.params[payload]

      if (params === undefined) return;

      if (rules.type === 'structure') {
        var builder = new AWS.XML.Builder(payload, rules.members, req.client.api);
      ...
      var builder = new AWS.XML.Builder(input.wrapper, rules, req.client.api);
