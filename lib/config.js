 ...
 */
AWS.WebIdentityCredentials = inherit(AWS.Credentials, {
  /**
   * Creates a new credentials object.
   * @param params [map] a map of options that are passed to the
   *   {AWS.STS.assumeRoleWithWebIdentity} operation.
  ...
  /**
   * @return [Boolean] whether the credentials have expired. Checks the expiry
   *   time from STS credentials.
   */
  needsRefresh: function needsRefresh() {
    if (this.expireTime && AWS.util.date.getDate() > this.expireTime) {
      return true;
    } else {
      return AWS.Credentials.prototype.needsRefresh.call(this);
    }
  },
