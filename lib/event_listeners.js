...
AWS.EventListeners = {
  Core: new AWS.SequentialExecutor().addNamedListeners(function(add, addAsync) {
    ...
    addAsync('SEND', 'send', function SEND(resp, done) {
      ...
      var signDateHeader = this.httpRequest.headers['X-Amz-Date'];
      var signDate = AWS.util.date.parseTimestamp(signDateHeader);
      var timeDiff = (AWS.util.date.getDate() - signDate) / 1000;
