...
/**
 * Represents credentials loaded from shared credentials file. By default this
 * reads from `~/.aws/credentials` but this can be overridden by setting the
 * `AWS_SDK_LOAD_CONFIG` environment variable (e.g. to `true`) and by providing
 * a file path in the `AWS_SHARED_CREDENTIALS_FILE` environment variable.
 *
