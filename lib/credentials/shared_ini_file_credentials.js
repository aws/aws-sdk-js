...
AWS.SharedIniFileCredentials = AWS.util.inherit(AWS.Credentials, {
   ...
   * @option options useCredentialProcess [Boolean] (false) True to enable
   *   usage of the credential_process as the source for credentials
   */
  constructor: function SharedIniFileCredentials(options) {
    ...
    this.useCredentialProcess = Boolean(options.useCredentialProcess);
    this.get(function() {});
  },
  ...
  refresh: function refresh(callback) {
    ...
    try {
      ...
      if (this.useCredentialProcess) {
        this.loadViaCredentialProcess(profile);
      } else {
  ...
  */
    loadViaCredentialProcess: function loadCredentialProcess(profile) {
