...
AWS.EC2MetadataCredentials = AWS.util.inherit(AWS.Credentials, {
  ...
  extendExpirationIfExpired: function extendExpirationIfExpired() {
    if (this.needsRefresh()) {
      ...
      // TODO: add doc link;
      this.logger.warn('SDK cannot renew the credential from IMDS service, extending the expiration of existing '
          + 'credentials to ' + this.expireTime + '\nFor more information, please visit: TBD');
    }
  },
