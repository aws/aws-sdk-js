...
AWS.util.update(AWS.Service, {
  ...
  defineService: function defineService(serviceIdentifier, versions, features) {
    ...
    if (typeof serviceIdentifier === 'string') {
      ...
      svc.serviceName = svc.serviceName || apis.serviceName(identifier);
  ...
  defineServiceApi: function defineServiceApi(superclass, version, apiConfig) {
    var svc = inherit(superclass, {
      serviceName: superclass.serviceName,
    ...
    if (typeof version === 'string') {
      if (apiConfig) {
        ...
        var name = superclass.serviceName || superclass.serviceIdentifier;
        var file = name + '-' + version;
        var path = __dirname + '/../node_modules/aws-sdk-apis/apis/' + file + '.json';
        try {
          var fs = require('fs');
