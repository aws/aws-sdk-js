...
AWS.Service = inherit({
  ...
  extractError: function extractError(httpResponse) {
    return (new this.ErrorParser()).extractError(httpResponse);
  },
...
AWS.util.update(AWS.Service, {
  ...
  defineMethod: function defineMethod(svc, method, operation) {
    svc.prototype[method] = function(params) {
      var serializer = new svc.__super__.prototype.RequestBuilder(operation);
      var parser = new svc.__super__.prototype.ResponseParser(operation);
