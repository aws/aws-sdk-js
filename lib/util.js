...
var util = {
  ...
  /**
   * For browsers with no/partial support for ReadableStream.pipeTo
   */
  pipeTo: function pipeTo(readable, writable) {
    try {
  ...
  /**
   * For browsers with no/partial support for ReadableStream.pipeThrough
   */
  pipeThrough: function pipeThrough(readable, transform) {
    try {
