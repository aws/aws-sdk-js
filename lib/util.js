...
var util = {
  ...
  isDualstackAvailable: function isDualstackAvailable(service) {
    ...
    if (service instanceof AWS.Service) {
      serviceIdentifier = service.__proto__.__proto__.constructor.serviceIdentifier;
    ...
    if (!serviceIdentifier || !metadata.hasOwnProperty(serviceIdentifier)) return false;
    return !!metadata[serviceIdentifier].dualstackAvailable;
  }
