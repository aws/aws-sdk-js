...
var util = {
  ...
  crypto: {
    ...
    hash: function(algorithm, data, digest, callback) {
      ...
      //Pass data into Buffer constructor if it is a typed array
      if (data instanceof ArrayBuffer) data._isBuffer = true;
      var sliceFn = util.arraySliceFn(data);
      var isBuffer = Buffer.isBuffer(data);
      if (util.isBrowser() && data && data.buffer && data.buffer instanceof ArrayBuffer) isBuffer = true;
