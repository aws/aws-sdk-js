 ...
 * @api private
 */
function addApiVersionHeader(request) {
  var api = request.service.api;
  var apiVersion = api.apiVersion;
  if (api.endpointOperation && apiVersion && !request.httpRequest.headers['x-amz-api-version']) {
    request.httpRequest.headers['x-amz-api-version'] = apiVersion;
  }
}
