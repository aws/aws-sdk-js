...
AWS.S3 = inherit(AWS.RESTXMLService, {
  ...
  extractData: function extractData(httpResponse, method) {
    ...
    if (method === 'getBucketLocation') {
      ...
      // Calling super on RESTService so it can still parser headers
      // but not parse the XML body.
      _super = AWS.RESTService.prototype.extractData;
      ...
      return _super.call(this, httpResponse, method);
    }
  },
