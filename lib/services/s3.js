...
AWS.util.update(AWS.S3.prototype, {
  ...
  optInUsEast1RegionalEndpoint: function optInUsEast1RegionalEndpoint(req) {
    ...
    config.s3UsEast1RegionalEndpoints = resolveRegionalEndpointsFlag(service._originalConfig, {
      env: 'AWS_S3_US_EAST_1_REGIONAL_ENDPOINT',
      sharedConfig: 's3_us_east_1_regional_endpoint',
      clientConfig: 's3UsEast1RegionalEndpoints'
    });
    if (req.httpRequest.region === 'us-east-1' && config.s3UsEast1RegionalEndpoints === 'regional') {
