...
AWS.util.update(AWS.S3.prototype, {
  ...
  setupRequestListeners: function setupRequestListeners(request) {
    ...
    request.addListener('validate', this.disallowDualstackAccelerate);
   ...
   * @api private
   */
  disallowDualstackAccelerate: function(req) {
    if (req.service.config.useAccelerateEndpoint && req.service.config.useDualstack) {
      var msg = 'Cannot use dualstack option for Accelerate endpoint.';
      throw AWS.util.error(new Error(),
        { code: 'ConfigError', message: msg });
    }
  },
