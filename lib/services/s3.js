...
AWS.S3.ManagedUpload = AWS.util.nodeRequire('../s3/managed_upload');
AWS.S3.prototype.upload = function upload(params, callback) {
  if (typeof params !== 'function' && typeof callback !== 'function') {
    return new AWS.S3.ManagedUpload(this, params);
  } else {
    new AWS.S3.ManagedUpload(this).send(params, callback);
  }
};
