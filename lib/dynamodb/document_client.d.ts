...
export class DocumentClient {
     ...
     */
    batchGet(params: DCInterfaces.BatchGetItemInput, callback?: (err: AWSError, data: DynamoDB.BatchGetItemOutput) => void): Request<DynamoDB.BatchGetItemOutput, AWSError>;
    /**
     * Puts or deletes multiple items in one or more tables by delegating to AWS.DynamoDB.batchWriteItem().
     */
    batchWrite(params: DCInterfaces.BatchWriteItemInput, callback?: (err: AWSError, data: DynamoDB.BatchWriteItemOutput) => void): Request<DynamoDB.BatchWriteItemOutput, AWSError>;
    /**
     * Deletes a single item in a table by primary key by delegating to AWS.DynamoDB.deleteItem().
     */
    delete(params: DCInterfaces.DeleteItemInput, callback?: (err: AWSError, data: DynamoDB.DeleteItemOutput) => void): Request<DynamoDB.DeleteItemOutput, AWSError>;
    /**
     * Returns a set of attributes for the item with the given primary key by delegating to AWS.DynamoDB.getItem().
     */
    get(params: DCInterfaces.GetItemInput, callback?: (err: AWSError, data: DynamoDB.GetItemOutput) => void): Request<DynamoDB.GetItemOutput, AWSError>;
    /**
     * Creates a new item, or replaces an old item with a new item by delegating to AWS.DynamoDB.putItem().
     */
    put(params: DCInterfaces.PutItemInput, callback?: (err: AWSError, data: DynamoDB.PutItemOutput) => void): Request<DynamoDB.PutItemOutput, AWSError>;
    /**
     * Directly access items from a table by primary key or a secondary index.
     */
    query(params: DCInterfaces.QueryInput, callback?: (err: AWSError, data: DynamoDB.QueryOutput) => void): Request<DynamoDB.QueryOutput, AWSError>;
    /**
     * Returns one or more items and item attributes by accessing every item in a table or a secondary index.
     */
    scan(params: DCInterfaces.ScanInput, callback?: (err: AWSError, data: DynamoDB.ScanOutput) => void): Request<DynamoDB.ScanOutput, AWSError>;
    /**
     ...
     */
    update(params: DCInterfaces.UpdateItemInput, callback?: (err: AWSError, data: DynamoDB.UpdateItemOutput) => void): Request<DynamoDB.UpdateItemOutput, AWSError>;
}
