...
AWS.DynamoDB.DocumentClient = AWS.util.inherit({
  ...
  configure: function configure(options) {
    ...
    self.attrValue =
      self.service.api.operations.putItem.input.members.Item.value;
  },
  ...
  put: function(input, callback) {
    var self = this;
    var shape = self.service.api.operations.putItem.input;
    var translator = new Translator({attrValue: self.attrValue});
    var params = translator.translateInput(input, shape);
    console.log(params);
    return params;
  },
