...
AWS.S3.ManagedUpload = AWS.util.inherit({
   ...
   * @note Content-MD5 should not be provided when using the managed upload object.
   *   Setting "computeChecksums" to true will enable automatic Content-MD5 generation
