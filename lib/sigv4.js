...
AWS.SignatureV4Signer = inherit(AWS.RequestSigner, {
  ...
  constructor: function SignatureV4Signer(request, serviceName) {
    AWS.RequestSigner.call(this, request);
    this.serviceName = serviceName;
  },

  // meant to be called from the context of a service
  signRequest: function signRequest(request) {
    new AWS.SignatureV4Signer(request, this.serviceName).
