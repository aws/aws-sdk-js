...
AWS.NodeHttpClient = AWS.util.inherit({
  ...
  writeBody: function writeBody(stream, httpRequest) {
    ...
    if (body instanceof Stream) {
      ...
      // emit progress event on the entire content length
      // since it was already loaded into memory (not a stream)
      // use totalBytes instead of body.length for proper bytes length
