...
require('../http');
var IntegrityCheckerStream = require('./node-response-validator/integrityCheckerStream');
var ContentLengthCheckerStream = require('./node-response-validator/lengthCheckerStream');
...
AWS.NodeHttpClient = AWS.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
    ...
    var stream = http.request(options, function (httpResp) {
      ...
      //attach headers to stream for calculating download process
      responseStream.statusCode = httpResp.statusCode;
      responseStream.headers = httpResp.headers;
      responseStream.statusMessage = httpResp.statusMessage;
