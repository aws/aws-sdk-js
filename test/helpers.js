...
(function() {
  var AWS, Buffer, EventEmitter, MockCredentialsProvider, MockServiceWithErrorCodeMapping, MockService, _createSpy, _it, _spyOn, globalEvents, ignoreRequire, matchXML, mockHttpResponse, mockHttpSuccessfulResponse, mockIntermittentFailureResponse, mockResponse, mockResponses, operationsForRequests, setupMockResponse, spies, topLevelScope;
  ...
  module.exports = {
    ...
    MockServiceWithErrorCodeMapping: MockServiceWithErrorCodeMapping
  };
