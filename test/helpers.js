...
(function() {
  var AWS, Buffer, EventEmitter, MockCredentialsProvider, MockService, _createSpy, _it, _spyOn, globalEvents, ignoreRequire, matchXML, mockHttpResponse, mockHttpSuccessfulResponse, mockIntermittentFailureResponse, mockResponse, mockResponses, operationsForRequests, setupMockResponse, spies, topLevelScope, uintArraySliceFn;
  ...
  //uintArray in 0.12 doesn't have slice()
  uintArraySliceFn = function(start, end) {
    if (end === undefined) end = this.length;
    if (start >= 0 && start < end && end <= this.length) {
      var array = new this.constructor(end - start);
  ...
  module.exports = {
    ...
    matchXML: matchXML,
    uintArraySliceFn: uintArraySliceFn,
