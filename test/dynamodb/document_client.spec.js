...
(function() {
  var AWS, Buffer, docClient, encode, helpers, translateInput;
  ...
  describe('AWS.DynamoDB.DocumentClient', function() {
    ...
    describe('supports sets', function() {
      ...
      return it('does not validate set elements if validate: true unset', function() {
        expect(function() {
          return docClient.createSet([1, 2, 'string']);
    ...
    describe('input', function() {
      it('translates strings', function() {
        ...
        return expect(translateInput(input)).to.eql(params);
      });
      it('converts empty strings to null when convertEmptyValues option set', function() {
        ...
        request.emit('validate', [request]);
        return expect(request.params).to.eql(params);
      });
      ...
      return it('translates nested sets', function() {
    ...
    describe('output', function() {
      ...
      return it('translates nested sets', function(done) {
    ...
    return describe('response.nextPage', function() {
      var client, fill, request, response;
      client = null;
      response = null;
      request = null;
      beforeEach(function() {
      ...
      it('uses untranslated params', function() {
        ...
        req = response.nextPage();
        return expect(req.params.ExpressionAttributeValues.foo).to.equal('bar');
      });
