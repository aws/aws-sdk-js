 ...
 *       * `CloudFrontOriginAccessIdentityConfig` &mdash; (`Object`)
 ...
 *       * `CacheBehaviors` &mdash; **required** &mdash; (`Object`)
 *         * `Quantity` &mdash; **required** &mdash; (`Integer`)
 *         * `Items` &mdash; (`Array<Object>`)
 ...
 *           * `MinTTL` &mdash; **required** &mdash; (`Integer`)
 *       * `Comment` &mdash; **required** &mdash; (`String`)
 *       * `Logging` &mdash; **required** &mdash; (`Object`)
 *         * `Enabled` &mdash; **required** &mdash; (`Boolean`)
 ...
 *       * `ActiveTrustedSigners` &mdash; (`Object`)
 *         * `Enabled` &mdash; (`Boolean`)
 *         * `Quantity` &mdash; (`Integer`)
 *         * `Items` &mdash; (`Array<Object>`)
 *           * `AwsAccountNumber` &mdash; (`String`)
 *           * `KeyPairIds` &mdash; (`Object`)
 *             * `Quantity` &mdash; (`Integer`)
 *             * `Items` &mdash; (`Array<String>`)
 *       * `DistributionConfig` &mdash; (`Object`)
 *         * `CallerReference` &mdash; (`String`)
 *         * `Aliases` &mdash; (`Object`)
 *           * `Quantity` &mdash; (`Integer`)
 *           * `Items` &mdash; (`Array<String>`)
 *         * `DefaultRootObject` &mdash; (`String`)
 *         * `Origins` &mdash; (`Object`)
 *           * `Quantity` &mdash; (`Integer`)
 *           * `Items` &mdash; (`Array<Object>`)
 *             * `Id` &mdash; (`String`)
 *             * `DomainName` &mdash; (`String`)
 ...
 *         * `DefaultCacheBehavior` &mdash; (`Object`)
 *           * `TargetOriginId` &mdash; (`String`)
 *           * `ForwardedValues` &mdash; (`Object`)
 *             * `QueryString` &mdash; (`Boolean`)
 *           * `TrustedSigners` &mdash; (`Object`)
 *             * `Enabled` &mdash; (`Boolean`)
 *             * `Quantity` &mdash; (`Integer`)
 *             * `Items` &mdash; (`Array<String>`)
 *           * `ViewerProtocolPolicy` &mdash; (`String`)
 *           * `MinTTL` &mdash; (`Integer`)
 *         * `CacheBehaviors` &mdash; (`Object`)
 *           * `Quantity` &mdash; (`Integer`)
 *           * `Items` &mdash; (`Array<Object>`)
 ...
 *       * `Paths` &mdash; **required** &mdash; (`Object`)
 *         * `Quantity` &mdash; **required** &mdash; (`Integer`)
 *         * `Items` &mdash; (`Array<String>`)
 *       * `CallerReference` &mdash; **required** &mdash; (`String`)
 *   @callback callback function(err, data)
 ...
 *       * `InvalidationBatch` &mdash; (`Object`)
 *         * `Paths` &mdash; (`Object`)
 *           * `Quantity` &mdash; (`Integer`)
 *           * `Items` &mdash; (`Array<String>`)
 *         * `CallerReference` &mdash; (`String`)
