 ...
 *         * `creationDate` &mdash; **required** &mdash; (`Date`)
 *         * `deprecationDate` &mdash; (`Date`)
 *       * `configuration` &mdash; **required** &mdash; (`Object`)
 ...
 *           * `name` &mdash; **required** &mdash; (`String`)
 *           * `version` &mdash; **required** &mdash; (`String`)
 *         * `startTimestamp` &mdash; **required** &mdash; (`Date`)
 *         * `closeTimestamp` &mdash; (`Date`)
 *         * `executionStatus` &mdash; **required** &mdash; (`String`)
 ...
 *       * `executionConfiguration` &mdash; **required** &mdash; (`Object`)
 *         * `taskStartToCloseTimeout` &mdash; **required** &mdash;
 *           (`String`)
 *         * `executionStartToCloseTimeout` &mdash; **required** &mdash;
 *           (`String`)
 *         * `taskList` &mdash; **required** &mdash; (`Object`)
 *           * `name` &mdash; **required** &mdash; (`String`)
 *         * `childPolicy` &mdash; **required** &mdash; (`String`)
 *       * `openCounts` &mdash; **required** &mdash; (`Object`)
 *         * `openActivityTasks` &mdash; **required** &mdash; (`Integer`)
 *         * `openDecisionTasks` &mdash; **required** &mdash; (`Integer`)
 *         * `openTimers` &mdash; **required** &mdash; (`Integer`)
 *         * `openChildWorkflowExecutions` &mdash; **required** &mdash;
 *           (`Integer`)
 ...
 *         * `eventId` &mdash; **required** &mdash; (`Integer`)
 ...
 *           * `result` &mdash; (`String`)
 *           * `decisionTaskCompletedEventId` &mdash; **required** &mdash;
 *             (`Integer`)
 *         * `completeWorkflowExecutionFailedEventAttributes` &mdash;
 *           (`Object`)
 *           * `cause` &mdash; **required** &mdash; (`String`)
 *           * `decisionTaskCompletedEventId` &mdash; **required** &mdash;
 *             (`Integer`)
 ...
 *           * `timeoutType` &mdash; **required** &mdash; (`String`)
 *           * `childPolicy` &mdash; **required** &mdash; (`String`)
 ...
 *           * `decisionTaskCompletedEventId` &mdash; **required** &mdash;
 *             (`Integer`)
 *           * `newExecutionRunId` &mdash; **required** &mdash; (`String`)
 *           * `executionStartToCloseTimeout` &mdash; (`String`)
 *           * `taskList` &mdash; **required** &mdash; (`Object`)
 *             * `name` &mdash; **required** &mdash; (`String`)
 *           * `taskStartToCloseTimeout` &mdash; (`String`)
 ...
 *           * `scheduledEventId` &mdash; **required** &mdash; (`Integer`)
 ...
 *             * `name` &mdash; **required** &mdash; (`String`)
 *             * `version` &mdash; **required** &mdash; (`String`)
 *           * `initiatedEventId` &mdash; **required** &mdash; (`Integer`)
