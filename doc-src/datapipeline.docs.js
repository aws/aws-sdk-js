 ...
 *   @param params [Object]
 *     * +pipelineId+ - (*required*, <tt>String</tt>) The identifier of
 *       the pipeline to activate.
 ...
 *   @param params [Object]
 *     * +name+ - (*required*, <tt>String</tt>) The name of the new
 *       pipeline. You can use the same name for multiple pipelines
 *       associated with your AWS account, because AWS Data Pipeline
 *       assigns each new pipeline a unique pipeline identifier.
 *     * +uniqueId+ - (*required*, <tt>String</tt>) A unique identifier
 *       that you specify. This identifier is not the same as the
 ...
 *       credentials.
 *     * +description+ - (<tt>String</tt>) The description of the new
 *       pipeline.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 ...
 *       * +pipelineId+ - (<tt>String</tt>) The ID that AWS
 *         Data Pipeline assigns the newly created pipeline. The ID is a
 ...
 *   @param params [Object]
 *     * +pipelineId+ - (*required*, <tt>String</tt>) Identifier of the
 *       pipeline that contains the object definitions.
 *     * +objectIds+ - (*required*, <tt>Array<String></tt>) Identifiers
 *       of the pipeline objects that contain the definitions to be
 *       described. You can pass as many as 25 identifiers in a single
 *       call to DescribeObjects
 *     * +evaluateExpressions+ - (<tt>Boolean</tt>)
 *     * +marker+ - (<tt>String</tt>) The starting point for the results
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +pipelineObjects+ - (<tt>Array<Object></tt>) An
 *         array of object definitions that are returned by the call to
 *         DescribeObjects.
 *         * +id+ - (<tt>String</tt>) Identifier of the object.
 *         * +name+ - (<tt>String</tt>) Name of the object.
 *         * +fields+ - (<tt>Array<Object></tt>) Key-value
 *           pairs that define the properties of the object.
 *           * +key+ - (<tt>String</tt>) The field identifier.
 *           * +stringValue+ - (<tt>String</tt>) The field value, expressed
 *             as a String.
 *           * +refValue+ - (<tt>String</tt>) The field value, expressed as
 *             the identifier of another object.
 *       * +marker+ - (<tt>String</tt>) The starting point for the next
 *         page of results. To view the next page of results, call
 *         DescribeObjects again with this marker value.
 *       * +hasMoreResults+ - (<tt>Boolean</tt>) If True, there are more
 ...
 *   @param params [Object]
 *     * +pipelineIds+ - (*required*, <tt>Array<String></tt>) Identifiers
 *       of the pipelines to describe. You can pass as many as 25
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +pipelineDescriptionList+ - (<tt>Array<Object></tt>)
 *         An array of descriptions returned for the specified pipelines.
 *         * +pipelineId+ - (<tt>String</tt>) The pipeline
 *           identifier that was assigned by AWS Data Pipeline. This is a
 *           string of the form df-297EG78HU43EEXAMPLE.
 *         * +name+ - (<tt>String</tt>) Name of the pipeline.
 *         * +fields+ - (<tt>Array<Object></tt>) A list of
 *           read-only fields that contain metadata about the pipeline:
 ...
 *           * +refValue+ - (<tt>String</tt>) The field value, expressed as
 *             the identifier of another object.
 *         * +description+ - (<tt>String</tt>) Description of the pipeline.
 *   @return [AWS.Request] a handle to the operation request for
 *     subsequent event callback registration.
 *
 ...
 *     * +pipelineId+ - (*required*, <tt>String</tt>) The identifier of
 *       the pipeline.
 *     * +objectId+ - (*required*, <tt>String</tt>) The identifier of the
 *       object.
 *     * +expression+ - (*required*, <tt>String</tt>) The expression to
 *       evaluate.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +evaluatedExpression+ - (<tt>String</tt>) The
 ...
 *     * +pipelineId+ - (*required*, <tt>String</tt>) The identifier of
 *       the pipeline.
 *     * +version+ - (<tt>String</tt>) The version of the pipeline
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +pipelineObjects+ - (<tt>Array<Object></tt>) An array of objects
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +pipelineIdList+ - (<tt>Array<Object></tt>) A list
 *         of all the pipeline identifiers that your account has permission
 *         to access. If you require additional information about the
 *         pipelines, you can use these identifiers to call
 *         DescribePipelines and GetPipelineDefinition.
 *         * +id+ - (<tt>String</tt>) Identifier of the pipeline that was
 *           assigned by AWS Data Pipeline. This is a string of the form
 *           df-297EG78HU43EEXAMPLE.
 *         * +name+ - (<tt>String</tt>) Name of the pipeline.
 *       * +marker+ - (<tt>String</tt>) If not null, indicates the starting
 ...
 *   @param params [Object]
 *     * +workerGroup+ - (*required*, <tt>String</tt>) Indicates the type
 *       of task the task runner is configured to accept and process. The
 *       worker group is set as a field on objects in the pipeline when
 ...
 *     * +hostname+ - (<tt>String</tt>) The public DNS name of the
 *       calling task runner.
 *     * +instanceIdentity+ - (<tt>Object</tt>) Identity information for
 ...
 *       * +document+ - (<tt>String</tt>) A description of an Amazon EC2
 ...
 *       * +signature+ - (<tt>String</tt>) A signature which can be used
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +taskObject+ - (<tt>Object</tt>) An instance of
 ...
 *         SetTaskStatus.
 *         * +taskId+ - (<tt>String</tt>) An internal identifier for the
 *           task. This ID is passed to the SetTaskStatus and
 *           ReportTaskProgress actions.
 *         * +pipelineId+ - (<tt>String</tt>) Identifier of the pipeline
 *           that provided the task.
 *         * +attemptId+ - (<tt>String</tt>) Identifier of the pipeline
 *           task attempt object. AWS Data Pipeline uses this value to
 *           track how many times a task is attempted.
 *         * +objects+ - (<tt>Object<Object></tt>) Connection information
 *           for the location where the task runner will publish the output
 *           of the task.
 *           * +id+ - (<tt>String</tt>) Identifier of the
 *             object.
 *           * +name+ - (<tt>String</tt>) Name of the object.
 *           * +fields+ - (<tt>Array<Object></tt>) Key-value
 *             pairs that define the properties of the object.
 *             * +key+ - (<tt>String</tt>) The field
 *               identifier.
 *             * +stringValue+ - (<tt>String</tt>) The field value,
 *               expressed as a String.
 *             * +refValue+ - (<tt>String</tt>) The field value, expressed
 ...
 *   @param params [Object]
 *     * +pipelineId+ - (*required*, <tt>String</tt>) The identifier of
 *       the pipeline to be configured.
 *     * +pipelineObjects+ - (*required*, <tt>Array<Object></tt>) The
 *       objects that define the pipeline. These will overwrite the
 *       existing pipeline definition.
 *       * +id+ - (*required*, <tt>String</tt>) Identifier of the object.
 *       * +name+ - (*required*, <tt>String</tt>) Name of the object.
 *       * +fields+ - (*required*, <tt>Array<Object></tt>) Key-value
 *         pairs that define the properties of the object.
 *         * +key+ - (*required*, <tt>String</tt>) The field identifier.
 *         * +stringValue+ - (<tt>String</tt>) The field value, expressed
 *           as a String.
 *         * +refValue+ - (<tt>String</tt>) The field value, expressed as
 *           the identifier of another object.
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +validationErrors+ - (<tt>Array<Object></tt>) A list of the
 *         validation errors that are associated with the objects defined
 *         in pipelineObjects.
 *         * +id+ - (<tt>String</tt>) The identifier of the object that
 *           contains the validation error.
 *         * +errors+ - (<tt>Array<String></tt>) A description of the
 *           validation error.
 *       * +errored+ - (<tt>Boolean</tt>) If True, there were
 *         validation errors. If errored is True, the pipeline definition
 *         is stored but cannot be activated until you correct the pipeline
 ...
 *   @param params [Object]
 *     * +pipelineId+ - (*required*, <tt>String</tt>) Identifier of the
 *       pipeline to be queried for object names.
 *     * +query+ - (<tt>Object</tt>) Query that defines the objects to be
 ...
 *       * +selectors+ - (<tt>Array<Object></tt>) List of selectors that
 *         define the query. An object must satisfy all of the selectors
 *         to match the query.
 *         * +fieldName+ - (<tt>String</tt>) The name of the field that
 ...
 *         * +operator+ - (<tt>Object</tt>)
 *           * +type+ - (<tt>String</tt>) The logical operation to be
 ...
 *           * +values+ - (<tt>Array<String></tt>) The value that the
 *             actual field value will be compared with.
 *     * +sphere+ - (*required*, <tt>String</tt>) Specifies whether the
 *       query applies to components or instances. Allowable values:
 ...
 *     * +limit+ - (<tt>Integer</tt>) Specifies the maximum number of
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +ids+ - (<tt>Array<String></tt>) A list of identifiers that
 *         match the query selectors.
 *       * +marker+ - (<tt>String</tt>) The starting point for the results
 ...
 *   @param params [Object]
 *     * +taskId+ - (*required*, <tt>String</tt>) Identifier of the task
 *       assigned to the task runner. This value is provided in the
 *       TaskObject that the service returns with the response for the
 *       PollForTask action.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +canceled+ - (<tt>Boolean</tt>) If True, the calling
 *         task runner should cancel processing of the task. The task
 ...
 *   @param params [Object]
 *     * +taskrunnerId+ - (*required*, <tt>String</tt>) The identifier of
 *       the task runner. This value should be unique across your AWS
 *       account. In the case of AWS Data Pipeline Task Runner launched
 *       on a resource managed by AWS Data Pipeline, the web service
 *       provides a unique identifier when it launches the application.
 *       If you have written a custom task runner, you should assign a
 *       unique identifier for the task runner.
 *     * +workerGroup+ - (<tt>String</tt>) Indicates the type of task the
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +terminate+ - (<tt>Boolean</tt>) Indicates whether
 *         the calling task runner should terminate. If True, the task
 ...
 *   @param params [Object]
 *     * +pipelineId+ - (*required*, <tt>String</tt>) Identifies the
 *       pipeline that contains the objects.
 *     * +objectIds+ - (*required*, <tt>Array<String></tt>) Identifies an
 *       array of objects. The corresponding objects can be either
 *       physical or components, but not a mix of both types.
 *     * +status+ - (*required*, <tt>String</tt>) Specifies the status to
 *       be set on all the objects in objectIds. For components, this can
 *       be either PAUSE or RESUME. For instances, this can be either
 ...
 *   @param params [Object]
 *     * +taskId+ - (*required*, <tt>String</tt>) Identifies the task
 *       assigned to the task runner. This value is set in the TaskObject
 *       that is returned by the PollForTask action.
 *     * +taskStatus+ - (*required*, <tt>String</tt>) If FINISHED, the
 *       task successfully completed. If FAILED the task ended
 *       unsuccessfully. The FALSE value is used by preconditions.
 *     * +errorCode+ - (<tt>Integer</tt>) If an error occurred during the
 ...
 *       parse this value.
 *     * +errorMessage+ - (<tt>String</tt>) If an error occurred during
 ...
 *       this value.
 *     * +errorStackTrace+ - (<tt>String</tt>) If an error occurred
 *       during the task, specifies the stack trace associated with the
 *       error. This value is set on the physical attempt object. It is
 *       used to display error information to the user. The web service
 ...
 *   @param params [Object]
 *     * +pipelineId+ - (*required*, <tt>String</tt>) Identifies the
 *       pipeline whose definition is to be validated.
 *     * +pipelineObjects+ - (*required*, <tt>Array<Object></tt>) A list
 *       of objects that define the pipeline changes to validate against
 *       the pipeline.
 *       * +id+ - (*required*, <tt>String</tt>) Identifier of the object.
 *       * +name+ - (*required*, <tt>String</tt>) Name of the object.
 *       * +fields+ - (*required*, <tt>Array<Object></tt>) Key-value
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +validationErrors+ - (<tt>Array<Object></tt>) Lists the
