 ...
 *   @param params [Object]
 *     * +accountId+ - (<tt>String</tt>) The AccountId is the AWS Account
 ...
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +uploadId+ - (<tt>String</tt>) The upload ID of the multipart
 *       upload to delete.
 ...
 *     * +uploadId+ - (<tt>String</tt>) The upload ID of the multipart
 *       upload.
 *     * +archiveSize+ - (<tt>String</tt>) The total size, in bytes, of
 *       the entire archive. This value should be the sum of all the
 *       sizes of the individual parts that you uploaded.
 *     * +checksum+ - (<tt>String</tt>) The SHA256 tree hash of the
 *       entire archive. It is the tree hash of SHA256 tree hash of the
 ...
 *       * +location+ - (<tt>String</tt>) The relative URI path of the
 *         newly added archive resource.
 *       * +checksum+ - (<tt>String</tt>) The checksum of the archive
 *         computed by Amazon Glacier.
 *       * +archiveId+ - (<tt>String</tt>) The ID of the archive. This
 *         value is also included as part of the location.
 *   @return [AWS.Request] a handle to the operation request for
 *     subsequent event callback registration.
 *
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +location+ - (<tt>String</tt>) The URI of the vault that was
 *         created.
 *   @return [AWS.Request] a handle to the operation request for
 *     subsequent event callback registration.
 *
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +archiveId+ - (<tt>String</tt>) The ID of the archive to delete.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 *     on the returned request object to initiate the request.
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +jobId+ - (<tt>String</tt>) The ID of the job to describe.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 *     on the returned request object to initiate the request.
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +JobId+ - (<tt>String</tt>) An opaque string that identifies an
 *         Amazon Glacier job.
 *       * +JobDescription+ - (<tt>String</tt>) The job description you
 *         provided when you initiated the job.
 *       * +Action+ - (<tt>String</tt>) The job type. It is either
 *         ArchiveRetrieval or InventoryRetrieval.
 *       * +ArchiveId+ - (<tt>String</tt>) For an ArchiveRetrieval job,
 *         this is the archive ID requested for download. Otherwise, this
 *         field is null.
 *       * +VaultARN+ - (<tt>String</tt>) The Amazon Resource Name (ARN) of
 *         the vault from which the archive retrieval was requested.
 *       * +CreationDate+ - (<tt>String</tt>) The UTC date when the job was
 *         created. A string representation of ISO 8601 date format, for
 *         example, "2012-03-20T17:03:43.221Z".
 *       * +Completed+ - (<tt>Boolean</tt>) The job status. When a job is
 *         completed, you get the job's output.
 *       * +StatusCode+ - (<tt>String</tt>) The status code can be
 *         InProgress, Succeeded, or Failed, and indicates the status of
 *         the job.
 *       * +StatusMessage+ - (<tt>String</tt>) A friendly message that
 *         describes the job status.
 *       * +ArchiveSizeInBytes+ - (<tt>Integer</tt>) For an
 *         ArchiveRetrieval job, this is the size in bytes of the archive
 *         being requested for download. For the InventoryRetrieval job,
 *         the value is null.
 *       * +InventorySizeInBytes+ - (<tt>Integer</tt>) For an
 *         InventoryRetrieval job, this is the size in bytes of the
 *         inventory requested for download. For the ArchiveRetrieval job,
 *         the value is null.
 *       * +SNSTopic+ - (<tt>String</tt>) An Amazon Simple Notification
 *         Service (Amazon SNS) topic that receives notification.
 *       * +CompletionDate+ - (<tt>String</tt>) The UTC time that the
 *         archive retrieval request completed. While the job is in
 *         progress, the value will be null.
 *       * +SHA256TreeHash+ - (<tt>String</tt>) For an ArchiveRetrieval
 *         job, it is the checksum of the archive. Otherwise, the value is
 *         null.
 *       * +ArchiveSHA256TreeHash+ - (<tt>String</tt>)
 *       * +RetrievalByteRange+ - (<tt>String</tt>)
 *   @return [AWS.Request] a handle to the operation request for
 *     subsequent event callback registration.
 *
 ...
 *       * +SizeInBytes+ - (<tt>Integer</tt>) Total size, in bytes, of the
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +jobId+ - (<tt>String</tt>) The job ID whose data is downloaded.
 *     * +range+ - (<tt>String</tt>) The range of bytes to retrieve from
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +body+ - (<tt>String</tt>) The job data, either archive data or
 *         inventory data.
 *       * +checksum+ - (<tt>String</tt>) The checksum of the data in the
 ...
 *         header.
 *       * +status+ - (<tt>Integer</tt>) The HTTP response code for a job
 *         output request. The value depends on whether a range was
 *         specified in the request.
 *       * +contentRange+ - (<tt>String</tt>) The range of bytes returned
 *         by Amazon Glacier. If only partial output is downloaded, the
 ...
 *         8 MB.
 *       * +acceptRanges+ - (<tt>String</tt>) Indicates the range units
 *         accepted. For more information, go to RFC2616.
 *       * +contentType+ - (<tt>String</tt>) The Content-Type depends on
 ...
 *         application/json.
 *       * +archiveDescription+ - (<tt>String</tt>) The description of an
 *         archive.
 *   @return [AWS.Request] a handle to the operation request for
 *     subsequent event callback registration.
 *
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +vaultNotificationConfig+ - (<tt>Object</tt>) Returns the
 *         notification configuration set on the vault.
 *         * +SNSTopic+ - (<tt>String</tt>) The Amazon Simple Notification
 *           Service (Amazon SNS) topic Amazon Resource Name (ARN).
 *         * +Events+ - (<tt>Array<String></tt>) A list of one or more
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +jobParameters+ - (<tt>Object</tt>) Provides options for
 *       specifying job information.
 *       * +Format+ - (<tt>String</tt>) When initiating a job to retrieve
 ...
 *       * +Type+ - (<tt>String</tt>) The job type. You can initiate a
 *         job to retrieve an archive or get an inventory of a vault.
 *         Valid Values are "archive-retrieval" and
 *         "inventory-retrieval".
 *       * +ArchiveId+ - (<tt>String</tt>) The ID of the archive that you
 ...
 *       * +Description+ - (<tt>String</tt>) The optional description for
 ...
 *       * +SNSTopic+ - (<tt>String</tt>) The Amazon SNS topic ARN to
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +location+ - (<tt>String</tt>) The relative URI path of the job.
 *       * +jobId+ - (<tt>String</tt>) The ID of the job.
 *   @return [AWS.Request] a handle to the operation request for
 *     subsequent event callback registration.
 *
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +archiveDescription+ - (<tt>String</tt>) The archive description
 ...
 *     * +partSize+ - (<tt>String</tt>) The size of each part except the
 ...
 *       * +uploadId+ - (<tt>String</tt>) The ID of the multipart upload.
 ...
 *       Jobs request.
 *     * +statuscode+ - (<tt>String</tt>) Specifies the type of job
 *       status to return. You can specify the following values:
 *       "InProgress", "Succeeded", or "Failed".
 *     * +completed+ - (<tt>String</tt>) Specifies the state of the jobs
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +JobList+ - (<tt>Array<Object></tt>) A list of job objects. Each
 *         job object contains metadata describing the job.
 *         * +JobId+ - (<tt>String</tt>) An opaque string that identifies
 ...
 *           this is the archive ID requested for download. Otherwise, this
 *           field is null.
 *         * +VaultARN+ - (<tt>String</tt>) The Amazon Resource Name (ARN)
 *           of the vault from which the archive retrieval was requested.
 *         * +CreationDate+ - (<tt>String</tt>) The UTC date when the job
 *           was created. A string representation of ISO 8601 date format,
 *           for example, "2012-03-20T17:03:43.221Z".
 *         * +Completed+ - (<tt>Boolean</tt>) The job status. When a job is
 *           completed, you get the job's output.
 ...
 *         * +ArchiveSHA256TreeHash+ - (<tt>String</tt>)
 *         * +RetrievalByteRange+ - (<tt>String</tt>)
 *       * +Marker+ - (<tt>String</tt>) An opaque string that represents
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +limit+ - (<tt>String</tt>) Specifies the maximum number of
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +UploadsList+ - (<tt>Array<Object></tt>) A list of in-progress
 *         multipart uploads.
 *         * +MultipartUploadId+ - (<tt>String</tt>) The ID of a multipart
 *           upload.
 *         * +VaultARN+ - (<tt>String</tt>) The Amazon Resource Name (ARN)
 *           of the vault that contains the archive.
 *         * +ArchiveDescription+ - (<tt>String</tt>) The description of
 *           the archive that was specified in the Initiate Multipart
 *           Upload request.
 *         * +PartSizeInBytes+ - (<tt>Integer</tt>) The part size, in
 ...
 *         * +CreationDate+ - (<tt>String</tt>) The UTC time at which the
 ...
 *     * +limit+ - (<tt>String</tt>) Specifies the maximum number of
 *       parts returned in the response body. If this value is not
 *       specified, the List Parts operation returns up to 1,000 uploads.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 *     on the returned request object to initiate the request.
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +MultipartUploadId+ - (<tt>String</tt>) The ID of the upload to
 *         which the parts are associated.
 *       * +VaultARN+ - (<tt>String</tt>) The Amazon Resource Name (ARN) of
 *         the vault to which the multipart upload was initiated.
 *       * +ArchiveDescription+ - (<tt>String</tt>) The description of the
 *         archive that was specified in the Initiate Multipart Upload
 *         request.
 *       * +PartSizeInBytes+ - (<tt>Integer</tt>) The part size in bytes.
 *       * +CreationDate+ - (<tt>String</tt>) The UTC time at which the
 *         multipart upload was initiated.
 *       * +Parts+ - (<tt>Array<Object></tt>) A list of the part sizes of
 *         the multipart upload.
 *         * +RangeInBytes+ - (<tt>String</tt>) The byte range of a part,
 *           inclusive of the upper value of the range.
 *         * +SHA256TreeHash+ - (<tt>String</tt>) The SHA256 tree hash
 *           value that Amazon Glacier calculated for the part. This field
 *           is never null.
 *       * +Marker+ - (<tt>String</tt>) An opaque string that represents
 *         where to continue pagination of the results. You use the marker
 ...
 *       associated with the credentials used to sign the request. If you
 *       specify your Account ID, do not include hyphens in it.
 *     * +marker+ - (<tt>String</tt>) A string used for pagination. The
 *       marker specifies the vault ARN after which the listing of vaults
 *       should begin.
 *     * +limit+ - (<tt>String</tt>) The maximum number of items returned
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +VaultList+ - (<tt>Array<Object></tt>) List of vaults.
 *         * +VaultARN+ - (<tt>String</tt>) The Amazon Resource Name (ARN)
 *           of the vault.
 *         * +VaultName+ - (<tt>String</tt>) The name of the vault.
 *         * +CreationDate+ - (<tt>String</tt>) The UTC date when the vault
 *           was created. A string representation of ISO 8601 date format,
 *           for example, "2012-03-20T17:03:43.221Z".
 *         * +LastInventoryDate+ - (<tt>String</tt>) The UTC date when
 ...
 *           return null if an inventory has not yet run on the vault, for
 *           example, if you just created the vault.
 *         * +SizeInBytes+ - (<tt>Integer</tt>) Total size, in bytes, of
 *           the archives in the vault as of the last inventory date. This
 *           field will return null if an inventory has not yet run on the
 *           vault, for example, if you just created the vault.
 *       * +Marker+ - (<tt>String</tt>) The vault ARN at which to continue
 ...
 *       specify your Account ID, do not include hyphens in it.
 *     * +vaultName+ - (<tt>String</tt>) The name of the vault.
 *     * +vaultNotificationConfig+ - (<tt>Object</tt>) Provides options
 ...
 *       associated with the credentials used to sign the request. If you
 *       specify your Account ID, do not include hyphens in it.
 *     * +archiveDescription+ - (<tt>String</tt>) The optional
 *       description of the archive you are uploading.
 *     * +checksum+ - (<tt>String</tt>) The SHA256 checksum (a linear
 *       hash) of the payload.
 *     * +body+ - (<tt>String</tt>) The data to upload.
 *   @callback callback function(err, data)
 *     Called when a response from the service is returned. If a
 *     callback is not supplied, you must call {AWS.Request.send}
 *     on the returned request object to initiate the request.
 ...
 *     * +uploadId+ - (<tt>String</tt>) The upload ID of the multipart
 *       upload.
 *     * +checksum+ - (<tt>String</tt>) The SHA256 tree hash of the data
 *       being uploaded.
 *     * +range+ - (<tt>String</tt>) Identifies the range of bytes in the
 ...
 *       the request. Set to +null+ if a request error occurs.
 *       The +data+ object has the following properties:
 *       * +checksum+ - (<tt>String</tt>) The SHA256 tree hash that Amazon
