 ...
 *         * +volumes+ - (*required*, <tt>Array<Object></tt>)
 *           * +bytesConverted+ - (*required*, <tt>Integer</tt>)
 *           * +availabilityZone+ - (*required*, <tt>String</tt>)
 *           * +image+ - (*required*, <tt>Object</tt>)
 *             * +format+ - (*required*, <tt>String</tt>)
 *             * +size+ - (*required*, <tt>Integer</tt>)
 *             * +importManifestUrl+ - (*required*, <tt>String</tt>)
 *             * +checksum+ - (<tt>String</tt>)
 *           * +volume+ - (*required*, <tt>Object</tt>)
 *             * +size+ - (<tt>Integer</tt>)
 *             * +id+ - (*required*, <tt>String</tt>)
